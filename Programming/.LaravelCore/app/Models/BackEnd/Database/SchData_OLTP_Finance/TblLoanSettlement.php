...
namespace App\Models\Database\SchData_OLTP_Finance
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblLoanSettlement                                                                                            |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Finance ► TblLoanSettlement                                         |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblLoanSettlement extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function setDataInsert(
            ...
            string $varDocumentDateTimeTZ = null, int $varCreditor_RefID = null, int $varDebitor_RefID = null, int $varLog_FileUpload_Pointer_RefID = null, string $varNotes = null,
