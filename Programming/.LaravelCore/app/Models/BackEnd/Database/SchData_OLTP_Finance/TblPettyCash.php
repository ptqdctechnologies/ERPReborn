...
namespace App\Models\Database\SchData_OLTP_Finance
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblPettyCash                                                                                                 |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Finance ► TblPettyCash                                              |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblPettyCash extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
