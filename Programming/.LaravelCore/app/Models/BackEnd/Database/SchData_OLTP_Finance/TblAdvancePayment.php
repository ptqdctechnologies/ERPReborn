...
namespace App\Models\Database\SchData_OLTP_Finance
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblAdvancePayment                                                                                            |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Finance ► TblAdvancePayment                                         |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblAdvancePayment extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
