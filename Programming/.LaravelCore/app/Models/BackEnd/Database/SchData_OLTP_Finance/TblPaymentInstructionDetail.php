...
namespace App\Models\Database\SchData_OLTP_Finance
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblPaymentInstructionDetail                                                                                  |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Finance ► TblPaymentInstructionDetail                               |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblPaymentInstructionDetail extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        |        ----------------------------------------                                                                          |
        |      ▪ (int)    varPaymentInstruction_RefID ► Payment Instruction Reference ID                                           |
        ...
        */
        public function setDataInsert(
            ...
            int $varPaymentInstruction_RefID = null, int $varUnderlying_RefID = null, int $varAmountCurrency_RefID = null, float $varAmountCurrencyValue = null, float $varAmountCurrencyExchangeRate = null, string $varRemarks = null
            )
            {
            $varReturn =
