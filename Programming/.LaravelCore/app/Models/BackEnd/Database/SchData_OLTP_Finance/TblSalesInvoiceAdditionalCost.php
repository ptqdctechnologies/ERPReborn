    ...
    */
    class TblSalesInvoiceAdditionalCost extends \App\Models\Database\DefaultClassPrototype
        ...
        */
        ...
        |        ----------------------------------------                                                                          |
        |      ▪ (int)    varSalesInvoice_RefID ► Invoice Supplier Reference ID                                                    |
        ...
        */
        public function setDataInsert(
            ...
            int $varSalesInvoice_RefID = null, int $varTransactionAdditionalCostType_RefID = null, int $varCurrency_RefID = null, float $varCurrencyValue = null, float $varCurrencyExchangeRate = null, string $varRemarks = null)
            {
            $varReturn =
