...
namespace App\Models\Database\SchData_OLTP_Finance
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblSupplierInvoiceDetail                                                                                     |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Finance ► TblSupplierInvoiceDetail                                  |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblSupplierInvoiceDetail extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
