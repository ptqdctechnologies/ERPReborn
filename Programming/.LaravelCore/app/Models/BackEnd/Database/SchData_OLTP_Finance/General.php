    ...
    */
    class General
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataList_CashReceipt_LatestVersion                                                    |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-29                                                                                           |
        | ▪ Creation Date   : 2026-07-29                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Daftar Penerimaan Kas (Cash Receipt) Versi Terakhir                       |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varSysBranch_RefID ► Branch ID                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataList_CashReceipt_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataList_CashReceipt',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataList_CashReceipt']
                        );
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataList_CreditNote_LatestVersion                                                     |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-13                                                                                           |
        | ▪ Creation Date   : 2026-07-13                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Daftar Nota Kredit (Credit Note) Versi Terakhir                           |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varSysBranch_RefID ► Branch ID                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataList_CreditNote_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataList_CreditNote',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataList_CreditNote']
                        );
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataList_DebitNote_LatestVersion                                                      |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-13                                                                                           |
        | ▪ Creation Date   : 2026-07-13                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Daftar Nota Debit (Debit Note) Versi Terakhir                             |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varSysBranch_RefID ► Branch ID                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataList_DebitNote_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataList_DebitNote',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataList_DebitNote']
                        );
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataList_Loan_LatestVersion                                                           |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-13                                                                                           |
        | ▪ Creation Date   : 2026-07-13                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Daftar Peminjaman Dana (Loan) Versi Terakhir                              |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varSysBranch_RefID ► Branch ID                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataList_Loan_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataList_Loan',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataList_Loan']
                        );
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataList_LoanSettlement_LatestVersion                                                 |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-20                                                                                           |
        | ▪ Creation Date   : 2026-07-20                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Daftar Pertanggungjawaban Peminjaman Dana (Loan Settlement) Versi         |
        |                     Terakhir                                                                                             |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataList_LoanSettlement_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataList_LoanSettlement',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataList_LoanSettlement']
                        );
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataList_Reimbursement_LatestVersion                                                  |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-13                                                                                           |
        | ▪ Creation Date   : 2026-07-13                                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataList_Reimbursement_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataList_Reimbursement',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataList_Reimbursement']
                        );
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataPickList_Advance_LatestVersion                                                    |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0001.0000000                                                                                       |
        | ▪ Last Update     : 2026-06-22                                                                                           |
        | ▪ Creation Date   : 2026-06-22                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Daftar Pilihan Uang Muka (Advance) Versi Terakhir                         |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varSysBranch_RefID ► Branch ID                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataPickList_Advance_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataPickList_Advance']
                        );
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataPickList_AdvanceSettlement_LatestVersion                                          |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0001.0000000                                                                                       |
        | ▪ Last Update     : 2026-06-30                                                                                           |
        | ▪ Creation Date   : 2026-06-30                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Daftar Pilihan Pertanggungjawaban Uang Muka (Advance Settlement) Versi    |
        |                     Terakhir                                                                                             |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataPickList_AdvanceSettlement_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataPickList_CashReceipt_LatestVersion                                                |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-29                                                                                           |
        | ▪ Creation Date   : 2026-07-29                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Daftar Pilihan Penerimaan Kas (Cash Receipt) Versi Terakhir               |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varSysBranch_RefID ► Branch ID                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataPickList_CashReceipt_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataPickList_CashReceipt',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataPickList_CashReceipt']
                        );
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataPickList_CreditNote_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataPickList_CreditNote',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataPickList_CreditNote']
                        );
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataPickList_DebitNote_LatestVersion                                                  |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-13                                                                                           |
        | ▪ Creation Date   : 2026-07-13                                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataPickList_DebitNote_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataPickList_DebitNote',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataPickList_DebitNote']
                        );
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataPickList_Loan_LatestVersion                                                       |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-13                                                                                           |
        | ▪ Creation Date   : 2026-07-13                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Daftar Pilihan Loan (Loan) Versi Terakhir                                 |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varSysBranch_RefID ► Branch ID                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataPickList_Loan_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataPickList_Loan',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataPickList_Loan']
                        );
        ...
        | ▪ Last Update     : 2026-07-20                                                                                           |
        | ▪ Creation Date   : 2026-07-20                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Daftar Pilihan Pertanggungjawaban Peminjaman Dana (Loan Settlement) Versi |
        |                     Terakhir                                                                                             |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataPickList_LoanSettlement_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataPickList_LoanSettlement',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataPickList_LoanSettlement']
                        );
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DataPickList_Reimbursement_LatestVersion                                              |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-20                                                                                           |
        | ▪ Creation Date   : 2026-07-20                                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DataPickList_Reimbursement_LatestVersion(
            $varUserSession, int $varSysBranch_RefID,
            int $varPagination_PageSize = null, int $varPagination_PageShow = null,
            string $varBusinessDocumentNumber = null, string $varDocumentDateStart = null, string $varDocumentDateFinish = null, string $varRequesterName = null, string $varCombinedBudget = null, string $varCombinedBudgetSection = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DataPickList_Reimbursement',
                            [
                                [$varUserSession, 'bigint'],
                                [$varSysBranch_RefID, 'bigint'],
                ...
                $varReturn['data'] =
                    \App\Helpers\ZhtHelper\General\Helper_Encode::getJSONDecode(
                        $varUserSession,
                        $varReturn['data'][0]['Func_GetReport_DataPickList_Reimbursement']
                        );
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getDataList_CreditNoteDetail_LatestVersion                                                           |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000001                                                                                       |
        ...
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varCreditNote_RefID ► CreditNote ID                                                                      |
        |        ------------------------------                                                                                    |
        |      ▪ (string) varPickStatement ► Pick Statement                                                                        |
        |      ▪ (string) varSortStatement ► Sort Statement                                                                        |
        |      ▪ (string) varFilterStatement ► Filter Statement                                                                    |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getDataList_CreditNoteDetail_LatestVersion(
            $varUserSession, int $varCreditNote_RefID = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getDataList_LoanDetail_LatestVersion                                                           |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000001                                                                                       |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getDataList_LoanDetail_LatestVersion(
            $varUserSession, int $varLoan_RefID = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetDataList_LoanDetail',
                            [
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getDataList_LoanSettlementDetail_LatestVersion                                                       |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000001                                                                                       |
        ...
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varLoanSettlement_RefID ► LoanSettlement ID                                                              |
        |        ------------------------------                                                                                    |
        |      ▪ (string) varPickStatement ► Pick Statement                                                                        |
        |      ▪ (string) varSortStatement ► Sort Statement                                                                        |
        |      ▪ (string) varFilterStatement ► Filter Statement                                                                    |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getDataList_LoanSettlementDetail_LatestVersion(
            $varUserSession, int $varLoanSettlement_RefID = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetDataList_LoanSettlementDetail',
                            [
        ...
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varPaymentInstruction_RefID ► PaymentInstruction ID                                                      |
        |        ------------------------------                                                                                    |
        |      ▪ (string) varPickStatement ► Pick Statement                                                                        |
        |      ▪ (string) varSortStatement ► Sort Statement                                                                        |
        |      ▪ (string) varFilterStatement ► Filter Statement                                                                    |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getDataList_PaymentInstructionDetail_LatestVersion(
            $varUserSession, int $varPaymentInstruction_RefID = null)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetDataList_PaymentInstructionDetail_NEW',
                            [
                                [$varPaymentInstruction_RefID, 'bigint' ],
                            ]
                            )
                        );
        ...
        */
            ...
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetDataPickList_DebitNote_NEW',
                            [
                                [$varSysBranch_RefID, 'bigint']
                            ]
                            )
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getDataPickList_Loan_LatestVersion                                                             |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2025-09-12                                                                                           |
        | ▪ Creation Date   : 2025-09-12                                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getDataPickList_Loan_LatestVersion(
            $varUserSession, int $varSysBranch_RefID)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetDataPickList_Loan',
                            [
                                [$varSysBranch_RefID, 'bigint']
                            ]
                            )
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getDataPickList_LoanSettlement_LatestVersion                                                             |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getDataPickList_LoanSettlement_LatestVersion(
            $varUserSession, int $varSysBranch_RefID)
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetDataPickList_LoanSettlement',
                            [
                                [$varSysBranch_RefID, 'bigint']
                            ]
                            )
        ...
        */
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getDataPickList_DebitNote_LatestVersion_OLD(
            $varUserSession, int $varSysBranch_RefID)
            {
            try {
                $varReturn =
        ...
        */
        public function getReport_Form_DocumentForm_AdvanceSettlementSummary(
            $varUserSession, int $varSysBranch_RefID, string  $varCombinedBudgetCode = null, string $varCombinedBudgetSectionCode = null, int $varRequesterWorkerJobsPosition_RefID = null, string  $varStartDate = null, string  $varEndDate = null, array $varPagingStatement = null
            )
            {
            try {
                $varReturn =
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DocumentForm_DebitNoteSummary                                                        |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2025-08-28                                                                                           |
        | ▪ Creation Date   : 2025-08-28                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Form Dokumen Debit Note                                                   |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varSysBranch_RefID ► Branch ID                                                                           |
            ...
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DocForm_DebitNoteSummary',
                            [
                                [$varCombinedBudgetCode, 'varchar' ],
                                [$varCombinedBudgetSectionCode, 'varchar' ],
                                [$varStartDate, 'varchar'],
            ...
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DocForm_LoanSummary',
                            [
                                [$varCombinedBudgetCode, 'varchar' ],
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DocumentForm_ReimbursementToDebitNoteSummary                                          |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2025-08-28                                                                                           |
        | ▪ Creation Date   : 2025-08-28                                                                                           |
        | ▪ Description     : Mendapatkan Laporan Form - Form Dokumen Reimbursement To Debit Note                                  |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Input Variable  :                                                                                                      |
        |      ▪ (mixed)  varUserSession ► User Session                                                                            |
        |      ▪ (int)    varSysBranch_RefID ► Branch ID                                                                           |
            ...
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DocForm_AdvanceSummary',
                            [
                                [$varCombinedBudgetCode, 'varchar' ],
                                [$varCombinedBudgetSectionCode, 'varchar' ],
                                [$varRequesterWorkerJobsPosition_RefID, 'bigint' ],
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getReport_Form_DocumentForm_PaymentInstructionSummary                                                |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        |      ▪ (string)    varCombinedBudgetCode ► Combined Budget Code                                                          |
        |      ▪ (string)    varCombinedBudgetSectionCode ► Combined Budget Section Code                                           |
        |      ▪ (int)    varSupplier_RefID ► Supplier_RefID                                                                       |
        | ▪ Output Variable :                                                                                                      |
        |      ▪ (array)  varReturn                                                                                                |
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getReport_Form_DocumentForm_PaymentInstructionSummary(
            $varUserSession, int $varSysBranch_RefID, string  $varCombinedBudgetCode = null, string $varCombinedBudgetSectionCode = null, int $varSupplier_RefID = null, string  $varStartDate = null, string  $varEndDate = null, array $varPagingStatement = null
            )
            {
            try {
                $varReturn =
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                        ...
                        \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                            $varUserSession,
                            'SchData-OLTP-Finance.Func_GetReport_DocForm_PaymentInstructionSummary',
                            [
                                [$varCombinedBudgetCode, 'varchar' ],
                                [$varCombinedBudgetSectionCode, 'varchar' ],
