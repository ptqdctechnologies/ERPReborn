...
namespace App\Models\Database\SchData_OLTP_Finance
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblSalesInvoiceRequisition                                                                                   |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Finance ► TblSalesInvoiceRequisition                                |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblSalesInvoiceRequisition extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        |      ▪ (int)    varRequisitionerWorkerJobsPosition_RefID ► Requisitioner Worker Jobs Position Reference ID               |
        ...
        */
        public function setDataInsert(
            ...
            string $varDocumentDateTimeTZ = null, int $varLog_FileUpload_Pointer_RefID = null, int $varRequisitionerWorkerJobsPosition_RefID = null, string $varRemarks = null,
                ...
                \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                    ...
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                        ...
                        [
                            ...
                            [$varRequisitionerWorkerJobsPosition_RefID, 'bigint'],
                            [$varRemarks, 'varchar'],
