...
namespace App\Models\Database\SchData_OLTP_Production
    ...
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Production ► TblBillOfMaterial                                      |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblBillOfMaterial extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
