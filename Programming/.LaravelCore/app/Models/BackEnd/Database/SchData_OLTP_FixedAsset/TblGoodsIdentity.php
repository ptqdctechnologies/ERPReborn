...
namespace App\Models\Database\SchData_OLTP_FixedAsset
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblGoodsIdentity                                                                                             |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-FixedAsset ► TblGoodsIdentity                                       |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblGoodsIdentity extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        |      ▪ (string) varSerialNumber ► Goods Serial Number                                                                    |
        |        ----------------------------------------                                                                          |
        | ▪ Output Variable :                                                                                                      |
        |      ▪ (array)  varReturn                                                                                                | 
        +--------------------------------------------------------------------------------------------------------------------------+
