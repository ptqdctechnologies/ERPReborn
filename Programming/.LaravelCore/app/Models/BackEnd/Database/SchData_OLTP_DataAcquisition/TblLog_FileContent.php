...
namespace App\Models\Database\SchData_OLTP_DataAcquisition
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblLog_FileContent                                                                                           |
    | ▪ Description : Menangani Models Database ► SchData_OLTP_DataAcquisition ► TblLog_FileContent                                |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblLog_FileContent  extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
