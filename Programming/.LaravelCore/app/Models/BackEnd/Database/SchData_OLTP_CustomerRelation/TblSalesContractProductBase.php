...
namespace App\Models\Database\SchData_OLTP_CustomerRelation
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblSalesContractProductBase                                                                                  |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-CustomerRelation ► TblSalesContractProductBase                      |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblSalesContractProductBase extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
