...
namespace App\Models\Database\SchData_OLTP_CustomerRelation
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblSalesContractAddendum                                                                                     |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-CustomerRelation ► TblSalesContractAddendum                         |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblSalesContractAddendum extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function setDataInsert(
            ...
            int $varLog_FileUpload_Pointer_RefID = null, int $varRequesterWorkerJobsPosition_RefID = null, int $varSalesContract_RefID = null, string $varRemarks = null,
