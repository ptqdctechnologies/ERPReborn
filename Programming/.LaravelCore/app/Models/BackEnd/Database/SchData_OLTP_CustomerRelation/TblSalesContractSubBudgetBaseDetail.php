...
namespace App\Models\Database\SchData_OLTP_CustomerRelation
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblSalesContractSubBudgetBaseDetail                                                                          |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-CustomerRelation ► TblSalesContractSubBudgetBaseDetail              |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblSalesContractSubBudgetBaseDetail extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
