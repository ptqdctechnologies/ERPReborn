...
namespace App\Models\Database\SchSysConfig
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblMapper_BusinessDocumentTypeToWorkFlow                                                                     |
    | ▪ Description : Menangani Models Database ► SchSysConfig ► TblMapper_BusinessDocumentTypeToWorkFlow                          |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblMapper_BusinessDocumentTypeToWorkFlow extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function setDataInsert(
            ...
            int $varBusinessDocumentType_RefID = null, int $varCombinedBudget_RefID = null, int $varWorkFlow_RefID = null)
            {
            $varReturn = 
