...
namespace App\Models\Database\SchSysConfig
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblDBObject_User                                                                                             |
    | ▪ Description : Menangani Models Database ► SchSysConfig ► TblDBObject_User                                                  |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblDBObject_User extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
