...
namespace App\Models\Database\SchSysConfig
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblAppObject_InstitutionBranch                                                                               |
    | ▪ Description : Menangani Models Database ► SchSysConfig ► TblAppObject_InstitutionBranch                                    |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblAppObject_InstitutionBranch extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
