...
namespace App\Models\Database\SchSysConfig
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblAppObject_WorkFlow                                                                                        |
    | ▪ Description : Menangani Models Database ► SchSysConfig ► TblAppObject_WorkFlow                                             |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblAppObject_WorkFlow extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        |        ----------------------------------------                                                                          |
        |      ▪ (string) varJSONDataInitGraph ► JSON Data Init Graph                                                              |
        ...
        */
        public function setDataInsert(
            ...
            string $varJSONDataInitGraph = null, string $varRemarks = null
            )
            {
            $varReturn = 
