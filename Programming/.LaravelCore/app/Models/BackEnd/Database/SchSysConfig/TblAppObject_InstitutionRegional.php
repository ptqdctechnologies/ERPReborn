...
namespace App\Models\Database\SchSysConfig
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblAppObject_InstitutionRegional                                                                             |
    | ▪ Description : Menangani Models Database ► SchSysConfig ► TblAppObject_InstitutionRegional                                  |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblAppObject_InstitutionRegional extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
