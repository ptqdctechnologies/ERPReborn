...
namespace App\Models\Database\SchData_OLTP_SupplyChain
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblMaterialServiceRequisition                                                                                |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-SupplyChain ► TblMaterialServiceRequisition                         |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblMaterialServiceRequisition extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
