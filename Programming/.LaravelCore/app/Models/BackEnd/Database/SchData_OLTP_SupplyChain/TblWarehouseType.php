...
namespace App\Models\Database\SchData_OLTP_SupplyChain
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblWarehouseType                                                                                             |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-SupplyChain ► TblWarehouseType                                      |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblWarehouseType extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function setDataInsert(
            ...
            string $varName = null, string $varAnnotation = null
            )
            {
            $varReturn =
                \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
