...
namespace App\Models\Database\SchData_OLTP_SupplyChain
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblWarehouseOutboundOrder                                                                                    |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-SupplyChain ► TblWarehouseOutboundOrder                             |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblWarehouseOutboundOrder extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function setDataInsert(
            ...
            string $varDocumentDateTimeTZ = null, int $varLog_FileUpload_Pointer_RefID = null, int $varRequesterPerson_RefID = null, int $varTransporter_RefID = null, string $varRemarks = null,
