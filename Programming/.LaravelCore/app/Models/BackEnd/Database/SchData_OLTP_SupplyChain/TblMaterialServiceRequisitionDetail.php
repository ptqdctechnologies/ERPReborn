...
namespace App\Models\Database\SchData_OLTP_SupplyChain
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblMaterialServiceRequisitionDetail                                                                          |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-SupplyChain ► TblMaterialServiceRequisitionDetail                   |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblMaterialServiceRequisitionDetail extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        |        ----------------------------------------                                                                          |
        |      ▪ (int)    varMaterialServiceRequisition_RefID ► Purchase Requisition Reference ID                                  |
