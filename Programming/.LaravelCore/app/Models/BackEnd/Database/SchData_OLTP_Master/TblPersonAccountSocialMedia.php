...
namespace App\Models\Database\SchData_OLTP_Master
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblPersonAccountSocialMedia                                                                                  |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Master ► TblPersonAccountSocialMedia                                |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblPersonAccountSocialMedia extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
