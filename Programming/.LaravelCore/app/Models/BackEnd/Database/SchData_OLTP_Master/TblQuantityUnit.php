...
namespace App\Models\Database\SchData_OLTP_Master
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblQuantityUnit                                                                                              |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Master ► TblQuantityUnit                                            |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblQuantityUnit extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
