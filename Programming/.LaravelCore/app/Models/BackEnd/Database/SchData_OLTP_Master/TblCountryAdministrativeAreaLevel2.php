...
namespace App\Models\Database\SchData_OLTP_Master
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblCountryAdministrativeAreaLevel2                                                                           |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Master ► TblCountryAdministrativeAreaLevel2                         |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblCountryAdministrativeAreaLevel2 extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        |        ----------------------------------------                                                                          |
        |      ▪ (int)    varCountryAdministrativeAreaLevel1_RefID ► Country Reference ID                                          |
        |      ▪ (string) varName ► Name                                                                                           |
        |        ----------------------------------------                                                                          |
        | ▪ Output Variable :                                                                                                      |
        |      ▪ (array)   varReturn                                                                                               | 
        ...
        */
        public function setDataInsert(
            ...
            int $varCountryAdministrativeAreaLevel1_RefID = null, string $varName = null)
            {
            $varReturn =
                \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                    $varUserSession, 
