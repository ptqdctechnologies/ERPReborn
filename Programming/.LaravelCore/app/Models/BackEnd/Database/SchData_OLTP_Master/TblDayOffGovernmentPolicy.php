...
namespace App\Models\Database\SchData_OLTP_Master
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblDayOffGovernmentPolicy                                                                                    |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Master ► TblDayOffGovernmentPolicy                                  |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblDayOffGovernmentPolicy extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */        
        public function setDataInsert(
            ...
            int $varCountry_RefID = null, string $varName = null, string $varStartDate = null, string $varFinishDate = null)
            {
            $varReturn =
                \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                    $varUserSession, 
