...
namespace App\Models\Database\SchData_OLTP_Master
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblCurrency                                                                                                  |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Master ► TblCurrency                                                |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblCurrency extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function getCurrencyIDByISOCode($varUserSession, string $varISOCode)
            ...
            return
                $varReturn['data'][0]['Func_General_GetCurrencyIDByISOCode'];
            }
        ...
        public function setDataInitialize($varUserSession)
            ...
            $varReturn =
                \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                    ...
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                        $varUserSession,
                        'SchSysConfig-Initialize.Func_DtOLTP_Mstr_TblCurrency',
                        []
                        )
                    );
        ...
        */
        public function setDataInsert(
            ...
            string $varISOCode = null, string $varName = null, string $varSymbol = null
            )
            {
            $varReturn =
                \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
