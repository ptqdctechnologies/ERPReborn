...
namespace App\Models\Database\SchData_OLTP_Master
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblReligion                                                                                                  |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Master ► TblReligion                                                |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblReligion extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
