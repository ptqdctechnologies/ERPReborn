...
namespace App\Models\Database\SchData_OLTP_Master
    ...
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblMIME                                                                                                      |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Master ► TblMIME                                                    |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblMIME extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        |        ----------------------------------------                                                                          |
        |      ▪ (string) varMIME ► MIME                                                                                           |
        |      ▪ (string) varFileExtension ► File Extension                                                                        |
        |      ▪ (string) varName ► Name                                                                                           |
        ...
        */
        public function setDataInsert(
            ...
            string $varMIME = null, string $varFileExtension = null, string $varName = null, string $varAnnotation = null)
            {
            $varReturn =
                \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                    $varUserSession, 
