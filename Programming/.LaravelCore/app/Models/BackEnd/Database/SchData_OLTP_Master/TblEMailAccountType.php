...
namespace App\Models\Database\SchData_OLTP_Master
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblEMailAccountType                                                                                          |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Master ► TblEMailAccountType                                        |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblEMailAccountType extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
            ...
            $varReturn =
                \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                    ...
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                        $varUserSession,
                        'SchSysConfig-Initialize.Func_DtOLTP_Mstr_TblEMailAccountType',
                        []
                        )
                    );
