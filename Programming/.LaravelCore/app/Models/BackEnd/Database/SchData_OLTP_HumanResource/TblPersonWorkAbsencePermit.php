    ...
    */
    class TblPersonWorkAbsencePermit extends \App\Models\Database\DefaultClassPrototype
        ...
        */
        ...
        |      ▪ (int)    varWorkAbsencePermit_RefID ► Work Absence Permit Reference ID                                            |
        |      ▪ (string) varPermitDateStart ► Permit Date Start                                                                   |
        |      ▪ (int)    varDuringDays ► During Days                                                                              |
        ...
        */
        public function setDataInsert(
            ...
            bool $varSignDataAuthentication = null, int $varPerson_RefID = null, int $varWorkAbsencePermit_RefID = null, string $varPermitDateStart = null, int $varDuringDays = null, string $varAnnotation = null)
            {
            $varReturn =
                \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                    ...
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                        ...
                        [
                            ...
                            [$varWorkAbsencePermit_RefID, 'bigint'],
                            [$varPermitDateStart, 'date'],
                            [$varDuringDays, 'smallint'],
