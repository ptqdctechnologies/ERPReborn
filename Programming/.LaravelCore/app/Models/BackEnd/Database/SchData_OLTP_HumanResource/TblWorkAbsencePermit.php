...
namespace App\Models\Database\SchData_OLTP_HumanResource
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblWorkAbsencePermit                                                                                         |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-HumanResource ► TblWorkAbsencePermit                                |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblWorkAbsencePermit extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        |        ----------------------------------------                                                                          |
        |      ▪ (int)    varWorkAbsencePermitType_RefID ► Work Absence Permit Type Reference ID                                   |
        |      ▪ (string) varName ► Name                                                                                           |
        |        ----------------------------------------                                                                          |
        | ▪ Output Variable :                                                                                                      |
        |      ▪ (array)  varReturn                                                                                                | 
        ...
        */
        public function setDataInsert(
            ...
            int $varWorkAbsencePermitType_RefID = null, string $varName = null)
            {
            $varReturn =
                \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                    ...
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                        ...
                        [
                            ...
                            [$varWorkAbsencePermitType_RefID, 'bigint'],
                            [$varName, 'varchar']
                        ]
                        )
                    );
