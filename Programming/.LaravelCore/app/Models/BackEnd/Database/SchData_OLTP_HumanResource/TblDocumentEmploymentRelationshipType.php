...
namespace App\Models\Database\SchData_OLTP_HumanResource
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblDocumentEmploymentRelationshipType                                                                        |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-HumanResource ► TblDocumentEmploymentRelationshipType               |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblDocumentEmploymentRelationshipType extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        |        ----------------------------------------                                                                          |
        |      ▪ (string) varName ► Document Employment Relationship Type Name                                                     |
        |        ----------------------------------------                                                                          |
        | ▪ Output Variable :                                                                                                      |
        |      ▪ (array)  varReturn                                                                                                |
        +--------------------------------------------------------------------------------------------------------------------------+
