...
namespace App\Models\Database\SchData_OLTP_HumanResource
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblPersonWorkAbsenceReplacement                                                                              |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-HumanResource ► TblPersonWorkAbsenceReplacement                     |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblPersonWorkAbsenceReplacement extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        |      ▪ (string) varOriginDate ► Origin Date                                                                              |
        |      ▪ (string) varDestinationDate ► Destination Date                                                                    |
        |        ----------------------------------------                                                                          |
        | ▪ Output Variable :                                                                                                      |
        |      ▪ (array)  varReturn                                                                                                | 
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function setDataInsert(
            ...
            int $varPerson_RefID = null, string $varOriginDate = null, string $varDestinationDate = null)
            {
            $varReturn =
