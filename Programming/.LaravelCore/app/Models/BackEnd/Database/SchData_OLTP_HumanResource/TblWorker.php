...
namespace App\Models\Database\SchData_OLTP_HumanResource
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblWorker                                                                                                    |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-HumanResource ► TblWorker                                           |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblWorker extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function getDataEntities($varUserSession, 
            int $varSysID)
            {
            $varFunctionName='Func_GetDataEntities_WorkerJobPosition';
