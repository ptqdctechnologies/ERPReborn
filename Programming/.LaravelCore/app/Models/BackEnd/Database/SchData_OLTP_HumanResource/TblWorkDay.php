...
namespace App\Models\Database\SchData_OLTP_HumanResource
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblWorkDay                                                                                                   |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-HumanResource ► TblWorkDay                                          |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblWorkDay extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
