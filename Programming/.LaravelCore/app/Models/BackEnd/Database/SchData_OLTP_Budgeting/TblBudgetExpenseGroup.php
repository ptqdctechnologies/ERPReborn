...
namespace App\Models\Database\SchData_OLTP_Budgeting
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblBudgetExpenseGroup                                                                                        |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Budgeting ► TblBudgetExpenseGroup                                   |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblBudgetExpenseGroup extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function setDataInsert(
            ...
            string $varName = null, string $varValidStartDateTimeTZ = null, string $varValidFinishDateTimeTZ = null, string $varCode = null)
            {
            $varReturn =
