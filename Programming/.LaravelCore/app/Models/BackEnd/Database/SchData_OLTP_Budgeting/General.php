    ...
    */
    class General
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Method Name     : getDataList_CombinedBudgetSectionUnsegmentedDetail                                                   |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2021-10-11                                                                                           |
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function getDataList_CombinedBudgetSectionUnsegmentedDetail($varUserSession, int $varBranchID,
            ...
            try {
                $varReturn = \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getQueryExecution(
                    ...
                    \App\Helpers\ZhtHelper\Database\Helper_PostgreSQL::getBuildStringLiteral_StoredProcedure(
                        $varUserSession,
                        'SchData-OLTP-Budgeting.Func_GetDataList_CombinedBudgetSectionUnsegmentedDetail',
                        [
                            [$varBranchID, 'bigint'],
