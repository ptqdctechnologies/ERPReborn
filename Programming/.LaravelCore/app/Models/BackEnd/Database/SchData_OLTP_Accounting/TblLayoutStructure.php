...
namespace App\Models\Database\SchData_OLTP_Accounting
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : TblLayoutStructure                                                                                           |
    | ▪ Description : Menangani Models Database ► SchData-OLTP-Accounting ► TblLayoutStructure                                     |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class TblLayoutStructure extends \App\Models\Database\DefaultClassPrototype
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
