...
| ▪ API Key     : report.form.dataPickList.customerRelation.salesContract.getAll                                                   |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2026 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\report\form\dataPickList\customerRelation\salesContract\getAll\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     report.form.dataPickList.customerRelation.salesContract.getAll.v1_throughAPIGateway                  |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       report.form.dataPickList.customerRelation.salesContract.getAll.v1_throughAPIGateway                |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.read.dataPickList.customerRelation.getAll.v1_throughAPIGatewayJQuery       |
        |                     ► http://172.28.0.4/transaction.read.dataPickList.customerRelation.getAll.v1_throughAPIGatewayJQuery    |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
            ...
            $varJQueryFunction =
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                    //-----[ METADATA ]-----( START )-----
                        \App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System(), 
                        $varAPIWebToken, 
                        'transaction.read.dataPickList.customerRelation.getAll', 
                        'latest',
                    //-----[ METADATA ]-----(  END  )-----
