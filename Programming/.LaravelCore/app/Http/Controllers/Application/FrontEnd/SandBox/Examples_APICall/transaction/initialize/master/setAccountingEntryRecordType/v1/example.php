...
| ▪ API Key     : transaction.initialize.master.setAccountingEntryRecordType                                                       |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
...
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\initialize\master\setAccountingEntryRecordType\v1
    ...
    class example extends \App\Http\Controllers\Controller
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.initialize.master.setAccountingEntryRecordType.v1_throughAPIGateway     |
        |                     ► http://172.28.0.4/transaction.initialize.master.setAccountingEntryRecordType.v1_throughAPIGateway  |
        +--------------------------------------------------------------------------------------------------------------------------+
