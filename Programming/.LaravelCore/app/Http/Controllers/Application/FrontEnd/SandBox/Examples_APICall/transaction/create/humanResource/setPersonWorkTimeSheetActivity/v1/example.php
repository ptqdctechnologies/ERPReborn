...
| ▪ API Key     : transaction.create.humanResource.setPersonWorkTimeSheetActivity                                                  |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
|| ▪ Copyleft 🄯 2025 Zheta (teguhpjs@gmail.com)                                                                                    |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\create\humanResource\setPersonWorkTimeSheetActivity\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.create.humanResource.setPersonWorkTimeSheetActivity.v1_throughAPIGateway                 |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.humanResource.setPersonWorkTimeSheetActivity.v1_throughAPIGateway               |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.create.humanResource.setPersonWorkTimeSheetActivity.v1_throughAPIGatewayJQuery  |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.humanResource.setPersonWorkTimeSheetActivity.v1_throughAPIGatewayJQuery                 |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
