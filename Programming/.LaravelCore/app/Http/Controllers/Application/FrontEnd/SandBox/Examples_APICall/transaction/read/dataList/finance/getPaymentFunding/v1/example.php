...
| ▪ API Key     : transaction.read.dataList.finance.getPaymentFunding                                                              |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\finance\getPaymentFunding\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.read.dataList.finance.getPaymentFunding.v1_throughAPIGateway            |
        |                     ► http://172.28.0.4/transaction.read.dataList.finance.getPaymentFunding.v1_throughAPIGateway         |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
            ...
            $varData = 
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                    //-----[ METADATA ]-----( START )-----
                        ...
                        $varAPIWebToken, 
                        'transaction.read.dataList.finance.getPaymentFunding', 
                        'latest',
                    //-----[ METADATA ]-----(  END  )-----
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.read.dataList.finance.getPaymentFunding.v1_throughAPIGatewayJQuery      |
        |                     ► http://172.28.0.4/transaction.read.dataList.finance.getPaymentFunding.v1_throughAPIGatewayJQuery   |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2022-09-08                                                                                           |
        | ▪ Creation Date   : 2022-09-08                                                                                           |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo        '<tr><td>Payment&nbsp;RefID</td><td><input type="text" id="dataInput_Payment_RefID" value=192000000000001></td></tr>';
