...
| ▪ API Key     : userAction.documentWorkFlow.approvalStage.setSystemApprovalRejection                                             |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\userAction\documentWorkFlow\approvalStage\setSystemApprovalRejection\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     userAction.documentWorkFlow.approvalStage.setSystemApprovalRejection.v1_throughAPIGateway            |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       userAction.documentWorkFlow.approvalStage.setSystemApprovalRejection.v1_throughAPIGateway          |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'userAction.documentWorkFlow.approvalStage.setSystemApprovalRejection', 
                'latest',
                [
                'entities' => [
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     userAction.documentWorkFlow.approvalStage.setSystemApprovalRejection.v1_throughAPIGatewayJQuery      |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       userAction.documentWorkFlow.approvalStage.setSystemApprovalRejection.                              |
