...
| ▪ Name Space  : \App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\report\form\dataList\finance                 |
|                 \getPaymentInstruction\v1                                                                                        |
| ▪ API Key     : report.form.dataList.finance.getPaymentInstruction                                                               |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2026 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\report\form\dataList\finance\getPaymentInstruction\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/report.form.dataList.finance.getPaymentInstruction.v1_throughAPIGateway             |
        |                     ► http://172.28.0.4/report.form.dataList.finance.getPaymentInstruction.v1_throughAPIGateway          |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
            ...
            $varData = 
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                    //-----[ METADATA ]-----( START )-----
                        \App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System(),
                        $varAPIWebToken, 
                        'report.form.dataList.finance.getPaymentInstruction', 
                        'latest',
                    //-----[ METADATA ]-----(  END  )-----
                    ...
                    //-----[ DATA ]---------( START )-----
                        ...
                        'parameter' => [
                            ...
                            'dataFilter' => [
                                'businessDocumentNumber' => NULL,   //'AP/QDC', 
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.read.dataList.finance.getPaymentInstruction.v1_throughAPIGatewayJQuery  |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.finance.getPaymentInstruction.v1_throughAPIGatewayJQuery                 |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-01                                                                                           |
        | ▪ Creation Date   : 2026-07-01                                                                                           |
            ...
            $varJQueryFunction =
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                    //-----[ METADATA ]-----( START )-----
                        \App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System(), 
                        $varAPIWebToken, 
                        'transaction.read.dataList.finance.getPaymentInstruction', 
                        'latest',
                    //-----[ METADATA ]-----(  END  )-----
