...
| ▪ API Key     : transaction.read.dataList.supplyChain.getMaterialServiceRequisitionDetail                                        |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2024 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\supplyChain\getMaterialServiceRequisitionDetail\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.read.dataList.supplyChain.getMaterialServiceRequisitionDetail.v1_throughAPIGateway       |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.supplyChain.getMaterialServiceRequisitionDetail.v1_throughAPIGateway     |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData =
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                    ...
                    $varAPIWebToken, 
                    'transaction.read.dataList.supplyChain.getMaterialServiceRequisitionDetail', 
                    'latest', 
                    [
                    'parameter' => [
                        'materialServiceRequisition_RefID' => 262000000000002
                        ],
                    'SQLStatement' => [
                        'pick' => null,
                        'sort' => null,
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.read.dataList.supplyChain.getMaterialServiceRequisitionDetail.v1_throughAPIGatewayJQuery |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.supplyChain.getMaterialServiceRequisitionDetail.                         |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo '<tr><td>MaterialServiceRequisition&nbsp;RefID</td><td><input type="text" id="dataInput_MaterialServiceRequisition_RefID" value=262000000000002></td></tr>';
