...
| ▪ API Key     : transaction.create.sysConfig.setMapper_BusinessDocumentTypeToWorkFlow                                            |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\create\sysConfig\setMapper_BusinessDocumentTypeToWorkFlow\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.create.sysConfig.setMapper_BusinessDocumentTypeToWorkFlow.v1_throughAPIGateway           |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.sysConfig.setMapper_BusinessDocumentTypeToWorkFlow.v1_throughAPIGateway         |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.create.sysConfig.setMapper_BusinessDocumentTypeToWorkFlow', 
                'latest', 
                [
                'entities' => [
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.create.sysConfig.setMapper_BusinessDocumentTypeToWorkFlow.v1_throughAPIGatewayJQuery     |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.sysConfig.setMapper_BusinessDocumentTypeToWorkFlow.v1_throughAPIGatewayJQuery   |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
