...
| ▪ API Key     : fileHandling.upload.stagingArea.localStorage.setFileThenCopyToCloudStorage                                       |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\fileHandlingOLD\upload\stagingArea\localStorage\setFileThenCopyToCloudStorage\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     fileHandling.upload.stagingArea.localStorage.setFileThenCopyToCloudStorage.v1_throughAPIGateway      |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       fileHandling.upload.stagingArea.localStorage.setFileThenCopyToCloudStorage.v1_throughAPIGateway    |
        +--------------------------------------------------------------------------------------------------------------------------+
