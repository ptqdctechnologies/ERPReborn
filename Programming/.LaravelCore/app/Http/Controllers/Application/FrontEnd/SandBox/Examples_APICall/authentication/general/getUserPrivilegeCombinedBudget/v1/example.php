...
|                 \getUserPrivilege_CombinedBudget\v1                                                                              |
| ▪ API Key     : authentication.general.getUserPrivilege_CombinedBudget                                                           |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\authentication\general\getUserPrivilegeCombinedBudget\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/authentication.general.getUserPrivilegeCombinedBudget.v1_throughAPIAuthentication   |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       authentication.general.getUserPrivilegeCombinedBudget.v1_throughAPIAuthentication                  |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIAuthentication($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken,
                'authentication.general.getUserPrivilegeCombinedBudget', 
                'latest', 
                [
                'parameter' => [
        ...
        |                     authentication.general.getUserPrivilegeCombinedBudget.v1_throughAPIAuthenticationJQuery              |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       authentication.general.getUserPrivilegeCombinedBudget.v1_throughAPIAuthenticationJQuery            |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
