...
|                 \getBudgetExpense\v1                                                                                             |
| ▪ API Key     : transaction.read.dataList.customerRelation.getBudgetExpense                                                      |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\budgeting\getBudgetExpense\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.read.dataList.budgeting.getBudgetExpense.v1_throughAPIGateway           |
        |                     ► http://172.28.0.4/transaction.read.dataList.budgeting.getBudgetExpense.v1_throughAPIGateway        |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.read.dataList.budgeting.getBudgetExpense.v1_throughAPIGatewayJQuery     |
        |                     ► http://172.28.0.4/transaction.read.dataList.budgeting.getBudgetExpense.v1_throughAPIGatewayJQuery  |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2022-09-24                                                                                           |
        | ▪ Creation Date   : 2022-09-24                                                                                           |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo '<tr><td>Budget&nbsp;RefID</td><td><input type="text" id="dataInput_Budget_RefID" value=103000000000002></td></tr>';
