...
| ▪ API Key     : transaction.create.sysConfig.setLog_BusinessDocumentWorkFlowPath                                                 |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\create\sysConfig\setLog_BusinessDocumentWorkFlowPath\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.create.sysConfig.setLog_BusinessDocumentWorkFlowPath.v1_throughAPIGateway                |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.sysConfig.setLog_BusinessDocumentWorkFlowPath.v1_throughAPIGateway              |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.create.sysConfig.setLog_BusinessDocumentWorkFlowPath', 
                'latest', 
                [
                'entities' => [
                    "businessDocument_RefID" => 74000000020323,
                    "lastLog_BusinessDocumentWorkFlowPathHistory_RefID" => NULL, //229000000000005,
                    "signActive" => true
                    ]
                ]
                );
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.create.sysConfig.setLog_BusinessDocumentWorkFlowPath.v1_throughAPIGatewayJQuery          |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.sysConfig.setLog_BusinessDocumentWorkFlowPath.v1_throughAPIGatewayJQuery        |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
