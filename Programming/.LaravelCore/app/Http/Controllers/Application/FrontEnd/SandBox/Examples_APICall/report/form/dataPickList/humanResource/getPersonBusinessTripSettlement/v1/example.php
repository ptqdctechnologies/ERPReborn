...
| ▪ API Key     : report.form.dataPickList.humanResource.getPersonBusinessTripSettlement                                           |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2026 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\report\form\dataPickList\humanResource\getPersonBusinessTripSettlement\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     report.form.dataPickList.humanResource.getPersonBusinessTripSettlement.v1_throughAPIGateway          |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       report.form.dataPickList.humanResource.getPersonBusinessTripSettlement.v1_throughAPIGateway        |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.read.dataPickList.humanResource.getPersonBusinessTripSettlement.                         |
