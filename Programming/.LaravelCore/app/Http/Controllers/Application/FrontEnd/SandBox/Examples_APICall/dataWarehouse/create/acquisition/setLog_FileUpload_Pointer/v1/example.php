...
| ▪ Name Space  : \App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\dataWarehouse\create\acquisition             |
|                 \setLog_FileUpload_Pointer\v1                                                                                    |
| ▪ API Key     : dataWarehouse.create.acquisition.setLog_FileUpload_Pointer                                                       |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2024 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\dataWarehouse\create\acquisition\setLog_FileUpload_Pointer\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     dataWarehouse.create.acquisition.setLog_FileUpload_Pointer.v1_throughAPIGateway                      |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       dataWarehouse.create.acquisition.setLog_FileUpload_Pointer.v1_throughAPIGateway                    |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     dataWarehouse.create.acquisition.setLog_FileUpload_Pointer.v1_throughAPIGatewayJQuery                |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       dataWarehouse.create.acquisition.setLog_FileUpload_Pointer.v1_throughAPIGatewayJQuery              |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
