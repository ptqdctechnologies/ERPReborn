...
|                 \chartOfAccount\getNonHeaderAccountReceivable\v1                                                                 |
| ▪ API Key     : report.form.dataPickList.accounting.chartOfAccount.getNonHeaderAccountReceivable                                 |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2026 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\report\form\dataPickList\accounting\chartOfAccount\getNonHeaderAccountReceivable\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     report.form.dataPickList.accounting.chartOfAccount.getNonHeaderAccountReceivable.                    |
        ...
        */
                    ...
                    \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                        ...
                        //-----[ DATA ]---------( START )-----
                            ...
                            'parameter' => [
                                ...
                                'dataFilter' => [
                                    'fullCode' => NULL,                 //'1-1201.01.000001'
                                    'fullName' => NULL                  //'Piutang Usaha'
                                    ]
                                ]
                            ]
                        //-----[ DATA ]---------(  END  )-----
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     dataPickList.accounting.chartOfAccount.getNonHeaderAccountReceivable.v1_throughAPIGatewayJQuery            |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       dataPickList.accounting.chartOfAccount.getNonHeaderAccountReceivable.v1_throughAPIGatewayJQuery          |
        +--------------------------------------------------------------------------------------------------------------------------+
