...
| ▪ API Key     : transaction.read.dataList.sysConfig.getAppObject_UserRoleGroup                                                   |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
...
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\sysConfig\getAppObject_UserRoleGroup\v1 {
    class example extends \App\Http\Controllers\Controller
    {
        ...
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.sysConfig.getAppObject_UserRoleGroup.v1_throughAPIGateway                |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        |                     transaction.read.dataList.sysConfig.getAppObject_UserRoleGroup.v1_throughAPIGatewayJQuery            |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.sysConfig.getAppObject_UserRoleGroup.v1_throughAPIGatewayJQuery          |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
