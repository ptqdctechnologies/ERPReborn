...
| ▪ Name Space  : \App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\instruction\server\external\www_bi_go_id     |
|                 \getTransactionExchangeRateOnSpecificDate\v1                                                                     |
| ▪ API Key     : instruction.server.external.www_bi_go_id.getTransactionExchangeRateOnSpecificDate                                |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\instruction\server\external\www_bi_go_id\getTransactionExchangeRateOnSpecificDate\v1
    {
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                [
                'parameter' => [
                    "transactionDateTimeTZ" => '2023-11-09 00:00:00'
                    ]
                ]                    
                );
            var_dump($varData);
