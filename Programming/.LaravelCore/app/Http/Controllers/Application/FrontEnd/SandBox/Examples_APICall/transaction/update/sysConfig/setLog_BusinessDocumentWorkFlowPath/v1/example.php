...
| ▪ API Key     : transaction.update.sysConfig.setLog_BusinessDocumentWorkFlowPath                                                 |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\update\sysConfig\setLog_BusinessDocumentWorkFlowPath\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.update.sysConfig.setLog_BusinessDocumentWorkFlowPath.v1_throughAPIGateway                |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.update.sysConfig.setLog_BusinessDocumentWorkFlowPath.v1_throughAPIGateway              |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.update.sysConfig.setLog_BusinessDocumentWorkFlowPath', 
                'latest', 
                [
                'recordID' => 228000000000001,
                'entities' => [
                    "businessDocument_RefID" => 74000000020323,
                    "lastLog_BusinessDocumentWorkFlowPathHistory_RefID" => 229000000000005,
                    "signActive" => false
                    ]
                ]
                );
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.update.sysConfig.setLog_BusinessDocumentWorkFlowPath.v1_throughAPIGatewayJQuery          |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.update.sysConfig.setLog_BusinessDocumentWorkFlowPath.v1_throughAPIGatewayJQuery        |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
