...
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataRecord\master\getCitizenFamilyRelationship\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.read.dataRecord.master.getCitizenFamilyRelationship.v1_throughAPIGateway                 |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataRecord.master.getCitizenFamilyRelationship.v1_throughAPIGateway               |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.read.dataRecord.master.getCitizenFamilyRelationship.v1_throughAPIGatewayJQuery           |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataRecord.master.getCitizenFamilyRelationship.v1_throughAPIGatewayJQuery         |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
