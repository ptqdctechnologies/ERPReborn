...
| ▪ API Key     : transaction.read.dataList.customerRelation.getBudgetExpenseLineCeiling                                           |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\budgeting\getBudgetExpenseLineCeiling\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.read.dataList.budgeting.getBudgetExpenseLineCeiling.v1_throughAPIGateway                 |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.budgeting.getBudgetExpenseLineCeiling.v1_throughAPIGateway               |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.read.dataList.budgeting.getBudgetExpenseLineCeiling.v1_throughAPIGatewayJQuery           |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.budgeting.getBudgetExpenseLineCeiling.v1_throughAPIGatewayJQuery         |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo '<tr><td>BudgetExpenseLine&nbsp;RefID</td><td><input type="text" id="dataInput_BudgetExpenseLine_RefID" value=105000000000001></td></tr>';
