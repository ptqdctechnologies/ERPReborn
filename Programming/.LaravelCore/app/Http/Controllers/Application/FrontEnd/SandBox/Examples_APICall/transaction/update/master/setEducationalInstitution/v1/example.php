...
| ▪ API Key     : transaction.update.master.setEducationalInstitution                                                              |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2025 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\update\master\setEducationalInstitution\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.update.master.setEducationalInstitution.v1_throughAPIGateway            |
        |                     ► http://172.28.0.4/transaction.update.master.setEducationalInstitution.v1_throughAPIGateway         |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData =
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                    ...
                    $varAPIWebToken, 
                    'transaction.update.master.setEducationalInstitution', 
                    'latest', 
                    [
                    'recordID' => 264000000000001,
                    'entities' => [
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.update.master.setEducationalInstitution.v1_throughAPIGatewayJQuery      |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.update.master.setEducationalInstitution.v1_throughAPIGatewayJQuery                     |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2025-01-06                                                                                           |
        | ▪ Creation Date   : 2025-01-06                                                                                           |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            //---Core---
            echo '<input type="text" id="dataInput_RecordID" value=264000000000001>';
            echo '<input type="text" id="dataInput_Name" value="SDN Tanjung Barat 05 Pagi">';
            echo '<input type="text" id="dataInput_EducationalInstitution_RefID" value="265000000000002">';
                ...
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                    ...
                    '{'.
                        ...
                        '"entities" : {'.
                            ...
                            '"educationalInstitutionType_RefID" : parseInt(document.getElementById("dataInput_EducationalInstitution_RefID").value), '.
