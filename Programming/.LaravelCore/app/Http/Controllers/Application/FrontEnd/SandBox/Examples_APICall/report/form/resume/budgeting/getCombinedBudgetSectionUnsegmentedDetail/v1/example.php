...
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\report\form\resume\budgeting\getCombinedBudgetSectionUnsegmentedDetail\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     report.form.resume.budgeting.getCombinedBudgetSectionUnsegmentedDetail.v1_throughAPIGateway          |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       report.form.resume.budgeting.getCombinedBudgetSectionUnsegmentedDetail.v1_throughAPIGateway        |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     report.form.resume.budgeting.getCombinedBudgetSectionUnsegmentedDetail.v1_throughAPIGatewayJQuery    |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       report.form.resume.budgeting.getCombinedBudgetSectionUnsegmentedDetail.v1_throughAPIGatewayJQuery  |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
