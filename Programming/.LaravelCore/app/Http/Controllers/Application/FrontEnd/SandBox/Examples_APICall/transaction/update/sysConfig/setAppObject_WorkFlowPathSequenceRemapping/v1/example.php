...
| ▪ API Key     : transaction.update.sysConfig.setAppObject_WorkFlowPathSequenceRemapping                                          |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\update\sysConfig\setAppObject_WorkFlowPathSequenceRemapping\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.update.sysConfig.setAppObject_WorkFlowPathSequenceRemapping.v1_throughAPIGateway         |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.update.sysConfig.setAppObject_WorkFlowPathSequenceRemapping.v1_throughAPIGateway       |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.update.sysConfig.setAppObject_WorkFlowPathSequenceRemapping', 
                'latest', 
                [
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.update.sysConfig.setAppObject_WorkFlowPathSequenceRemapping.v1_throughAPIGatewayJQuery   |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.update.sysConfig.setAppObject_WorkFlowPathSequenceRemapping.v1_throughAPIGatewayJQuery |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0001.0000000                                                                                       |
