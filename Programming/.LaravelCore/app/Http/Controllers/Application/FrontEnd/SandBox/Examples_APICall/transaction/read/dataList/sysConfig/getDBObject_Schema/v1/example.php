...
| ▪ API Key     : transaction.read.dataList.sysConfig.getDBObject_Schema                                                           |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\sysConfig\getDBObject_Schema\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.read.dataList.sysConfig.getDBObject_Schema.v1_throughAPIGateway         |
        |                     ► http://172.28.0.4/transaction.read.dataList.sysConfig.getDBObject_Schema.v1_throughAPIGateway      |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.read.dataList.sysConfig.getDBObject_Schema', 
                'latest', 
                [
                'parameter' => null,
                'SQLStatement' => [
        ...
        |                     transaction.read.dataList.sysConfig.getDBObject_Schema.v1_throughAPIGatewayJQuery                    |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.sysConfig.getDBObject_Schema.v1_throughAPIGatewayJQuery                  |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
