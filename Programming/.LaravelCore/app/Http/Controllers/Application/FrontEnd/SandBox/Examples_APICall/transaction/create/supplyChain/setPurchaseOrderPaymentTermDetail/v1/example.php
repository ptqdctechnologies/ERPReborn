...
| ▪ API Key     : transaction.create.supplyChain.setPurchaseOrderPaymentTermDetail                                                 |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\create\supplyChain\setPurchaseOrderPaymentTermDetail\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.create.supplyChain.setPurchaseOrderPaymentTermDetail.v1_throughAPIGateway                |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.supplyChain.setPurchaseOrderPaymentTermDetail.v1_throughAPIGateway              |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.create.supplyChain.setPurchaseOrderPaymentTermDetail.v1_throughAPIGatewayJQuery          |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.supplyChain.setPurchaseOrderPaymentTermDetail.v1_throughAPIGatewayJQuery        |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
