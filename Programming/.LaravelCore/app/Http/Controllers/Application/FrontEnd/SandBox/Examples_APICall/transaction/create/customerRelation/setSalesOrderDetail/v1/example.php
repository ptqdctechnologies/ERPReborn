...
| ▪ Name Space  : \App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\create\customerRelation          |
|                 \setSalesOrderDetail\v1                                                                                          |
| ▪ API Key     : transaction.create.customerRelation.setSalesOrderDetail                                                          |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\create\customerRelation\setSalesOrderDetail\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.create.customerRelation.setSalesOrderDetail.v1_throughAPIGateway        |
        |                     ► http://172.28.0.4/transaction.create.customerRelation.setSalesOrderDetail.v1_throughAPIGateway     |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.create.customerRelation.setSalesOrderDetail', 
                'latest', 
                [
                'entities' => [
        ...
        |                     transaction.create.customerRelation.setSalesOrderDetail.v1_throughAPIGatewayJQuery                   |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.customerRelation.setSalesOrderDetail.v1_throughAPIGatewayJQuery                 |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo    '<tr><td colspan="2" bgcolor="#6666cc" align="middle"><p style="color:#ffffff">Sales Order Detail Main Data</p></td></tr>';
            echo       '<tr><td>SalesOrder_RefID</td><td><input type="text" id="dataInput_SalesOrder_RefID" value=129000000000001></td></tr>';
