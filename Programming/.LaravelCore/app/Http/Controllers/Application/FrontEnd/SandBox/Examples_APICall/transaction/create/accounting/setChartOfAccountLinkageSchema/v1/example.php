...
| ▪ API Key     : transaction.create.accounting.setChartOfAccountLinkageSchema                                                     |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2024 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\create\accounting\setChartOfAccountLinkageSchema\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.create.accounting.setChartOfAccountLinkageSchema.v1_throughAPIGateway   |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.accounting.setChartOfAccountLinkageSchema.v1_throughAPIGateway                  |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
            ...
            //---Core---
             $varData =
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                    ...
                    $varAPIWebToken, 
                    'transaction.create.accounting.setChartOfAccountLinkageSchema', 
                    'latest', 
                    [
                    'entities' => [
        ...
        |                     transaction.create.accounting.setChartOfAccountLinkageSchema.v1_throughAPIGatewayJQuery              |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.accounting.setChartOfAccountLinkageSchema.v1_throughAPIGatewayJQuery            |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
