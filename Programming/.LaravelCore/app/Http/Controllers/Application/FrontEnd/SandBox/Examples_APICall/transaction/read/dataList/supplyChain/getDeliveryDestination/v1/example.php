...
| ▪ API Key     : transaction.read.dataList.supplyChain.getDeliveryDestination                                                     |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\supplyChain\getDeliveryDestination\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.read.dataList.supplyChain.getDeliveryDestination.v1_throughAPIGateway                    |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.supplyChain.getDeliveryDestination.v1_throughAPIGateway                  |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.read.dataList.supplyChain.getDeliveryDestination', 
                'latest', 
                [
                'parameter' => [
                    'deliveryDestinationType_RefID' => null    
                    ],
                'SQLStatement' => [
                    'pick' => null,
                    'sort' => null,
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.read.dataList.supplyChain.getDeliveryDestination.v1_throughAPIGatewayJQuery              |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.supplyChain.getDeliveryDestination.v1_throughAPIGatewayJQuery            |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo '<tr><td>DeliveryDestinationType&nbsp;RefID</td><td><input type="text" id="dataInput_DeliveryDestinationType_RefID" value=""></td></tr>';
            ...
            $varJQueryFunction = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                ...
                '{'.
                    '"parameter" : {'.
                        '"deliveryDestinationType_RefID" : parseInt(document.getElementById("dataInput_DeliveryDestinationType_RefID").value)'.
                        '}, '.
                    '"SQLStatement" : {'.
