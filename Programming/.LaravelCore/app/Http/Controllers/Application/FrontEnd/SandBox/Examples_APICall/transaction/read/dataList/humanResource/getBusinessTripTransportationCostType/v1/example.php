...
| ▪ API Key     : transaction.read.dataList.humanResource.getBusinessTripTransportationCostType                                    |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\humanResource\getBusinessTripTransportationCostType\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.read.dataList.humanResource.getBusinessTripTransportationCostType.v1_throughAPIGateway   |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.humanResource.getBusinessTripTransportationCostType.v1_throughAPIGateway |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.read.dataList.humanResource.getBusinessTripTransportationCostType', 
                'latest', 
                [
                'parameter' => [
