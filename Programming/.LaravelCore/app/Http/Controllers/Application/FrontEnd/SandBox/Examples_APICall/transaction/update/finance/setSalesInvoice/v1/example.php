...
| ▪ Name Space  : \App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\update\finance\setSalesInvoice   |
|                 \v1                                                                                                              |
                ...
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                    ...
                    //-----[ DATA ]-----( START )-----
                        ...
                        "entities" => [
                            ...
                            "remarks" => 'My Remarks Updated',
                            "additionalData" => [
                                "itemList" => [
                                    "items" => [
                                            [
                                            "recordID" => 139000000000003,
                                            "entities" => [
...
/*
            ...
            echo        '<tr><td>RecordIDDetail_RefID_1</td><td><input type="text" id="dataInput_RecordIDDetail_RefID_1" value=139000000000001></td></tr>';
