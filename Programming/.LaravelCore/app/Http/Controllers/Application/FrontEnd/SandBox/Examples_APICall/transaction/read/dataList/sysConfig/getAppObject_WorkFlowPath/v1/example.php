...
| ▪ API Key     : transaction.read.dataList.sysConfig.getAppObject_WorkFlowPath                                                    |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\sysConfig\getAppObject_WorkFlowPath\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.read.dataList.sysConfig.getAppObject_WorkFlowPath.v1_throughAPIGateway  |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.sysConfig.getAppObject_WorkFlowPath.v1_throughAPIGateway                 |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.read.dataList.sysConfig.getAppObject_WorkFlowPath', 
                'latest', 
                [
                'parameter' => [
                    'workFlowVersion_RefID' => 113000000000001
                    ],
                'SQLStatement' => [
                    'pick' => null,
                    'sort' => null,
        ...
        |                     transaction.read.dataList.sysConfig.getAppObject_WorkFlowPath.v1_throughAPIGatewayJQuery             |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.sysConfig.getAppObject_WorkFlowPath.v1_throughAPIGatewayJQuery           |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo '<tr><td>WorkFlow Version RefID</td><td><input type="text" id="dataInput_parameter_workFlowVersionRefID" value=113000000000001></td></tr>';
            ...
            $varJQueryFunction = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                ...
                '{'.
                    '"parameter" : {'.
                        '"workFlowVersion_RefID" : parseInt(document.getElementById("dataInput_parameter_workFlowVersionRefID").value)'.
                        '}, '.
                    '"SQLStatement" : {'.
