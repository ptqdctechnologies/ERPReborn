...
| ▪ API Key     : userAction.documentWorkFlow.general.getBusinessDocumentTypeWorkFlowPathBySubmitterEntityIDAndCombinedBudgetID    |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\userAction\documentWorkFlow\general\getBusinessDocumentTypeWorkFlowPathBySubmitterEntityIDAndCombinedBudgetID\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     userAction.documentWorkFlow.general.                                                                 |
        |                     getBusinessDocumentTypeWorkFlowPathBySubmitterEntityIDAndCombinedBudgetID.v1_throughAPIGateway       |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       userAction.documentWorkFlow.general.                                                               |
        |                       getBusinessDocumentTypeWorkFlowPathBySubmitterEntityIDAndCombinedBudgetID.v1_throughAPIGateway     |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     userAction.documentWorkFlow.general.                                                                 |
        |                     getBusinessDocumentTypeWorkFlowPathBySubmitterEntityIDAndCombinedBudgetID.v1_throughAPIGatewayJQuery |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       userAction.documentWorkFlow.general.                                                               |
        |                       getBusinessDocumentTypeWorkFlowPathBySubmitterEntityIDAndCombinedBudgetID.                         |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo '<tr><td>Submitter&nbsp;Entity&nbsp;Type&nbsp;RefID</td><td><input type="text" id="dataInput_SubmitterEntity_RefID" value=164000000000023></td></tr>';
            ...
            $varJQueryFunction = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                ...
                '{'.
                    '"parameter" : {'.
                        ...
                        '"submitterEntity_RefID" : parseInt(document.getElementById("dataInput_SubmitterEntity_RefID").value), '.
