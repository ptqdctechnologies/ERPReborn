...
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\master\getCountryAdministrativeAreaLevel4\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.read.dataList.master.getCountryAdministrativeAreaLevel4.v1_throughAPIGateway             |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.master.getCountryAdministrativeAreaLevel4.v1_throughAPIGateway           |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.read.dataList.master.getCountryAdministrativeAreaLevel4.v1_throughAPIGatewayJQuery       |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.master.getCountryAdministrativeAreaLevel4.v1_throughAPIGatewayJQuery     |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo '<tr><td>CountryAdministrativeAreaLevel3&nbsp;RefID</td><td><input type="text" id="dataInput_CountryAdministrativeAreaLevel3_RefID" value=23000000002670></td></tr>';
