...
| ▪ API Key     : transaction.create.finance.setLoanSettlement                                                                     |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2025 ijonk7 (jookeo.rizal@gmail.com)                                                                                |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\create\finance\setLoanSettlement\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.create.finance.setLoanSettlement.v1_throughAPIGateway                   |
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.create.finance.setLoanSettlement.v1_throughAPIGatewayJQuery             |
        |                     ► http://172.28.0.4/transaction.create.finance.setLoanSettlement.v1_throughAPIGatewayJQuery          |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
...
/*            //---Parameter Set---
            ...
            echo '<input type="text" id="dataInput_LoanSettlementDateTimeTZ" value="2022-03-08">';
            echo '<input type="text" id="dataInput_LoanSettlementDestination_RefID" value=173000000000001>';
            ...
            $varJQueryFunction = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                ...
                '{'.
                    ...
                    '"entities" : {'.
                        ...
                        '"LoanSettlementDateTimeTZ" : document.getElementById("dataInput_LoanSettlementDateTimeTZ").value, '.
                        '"LoanSettlementDestination_RefID" : parseInt(document.getElementById("dataInput_LoanSettlementDestination_RefID").value), '.
