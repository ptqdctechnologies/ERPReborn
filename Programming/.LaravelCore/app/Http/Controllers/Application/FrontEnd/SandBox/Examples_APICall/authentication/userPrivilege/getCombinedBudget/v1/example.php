...
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\authentication\userPrivilege\getCombinedBudget\v1
    ...
    class example extends \App\Http\Controllers\Controller
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/authentication.userPrivilege.getCombinedBudget.v1_throughAPIAuthentication          |
        |                     ► http://172.28.0.4/authentication.userPrivilege.getCombinedBudget.v1_throughAPIAuthentication       |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/authentication.userPrivilege.getCombinedBudget.v1_throughAPIAuthenticationJQuery    |
        |                     ► http://172.28.0.4/authentication.userPrivilege.getCombinedBudget.v1_throughAPIAuthenticationJQuery |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2023-07-31                                                                                           |
        | ▪ Creation Date   : 2023-07-31                                                                                           |
