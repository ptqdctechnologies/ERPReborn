...
| ▪ Name Space  : \App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\project            |
|                 \getProjectSectionItemWork\v1                                                                                    |
| ▪ API Key     : transaction.read.dataList.project.getProjectSectionItemWork                                                      |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\project\getProjectSectionItemWork\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.read.dataList.project.getProjectSectionItemWork.v1_throughAPIGateway    |
        |                     ► http://172.28.0.4/transaction.read.dataList.project.getProjectSectionItemWork.v1_throughAPIGateway |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                [
                'parameter' => [
                    'projectSectionItem_RefID' => 143000000000029
                    ],
                'SQLStatement' => [
                    'pick' => null,
                    'sort' => null,
        ...
        |                     transaction.read.dataList.project.getProjectSectionItemWork.v1_throughAPIGatewayJQuery               |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.project.getProjectSectionItemWork.v1_throughAPIGatewayJQuery             |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo '<tr><td>Project&nbsp;RefID</td><td><input type="text" id="dataInput_ProjectSectionItem_RefID" value=143000000000029></td></tr>';
