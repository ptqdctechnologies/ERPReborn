...
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\instruction\device\fingerprintAttendance\ALBox\FP800\getDataAttendance\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     instruction.device.fingerprintAttendance.ALBox.FP800.getDataAttendance.v1_throughAPIGateway          |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       instruction.device.fingerprintAttendance.ALBox.FP800.getDataAttendance.v1_throughAPIGateway        |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     instruction.device.fingerprintAttendance.ALBox.FP800.getDataAttendance.v1_throughAPIGatewayJQuery    |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       instruction.device.fingerprintAttendance.ALBox.FP800.getDataAttendance.v1_throughAPIGatewayJQuery  |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo    '<tr><td colspan="2" bgcolor="#6666cc" align="middle"><p style="color:#ffffff">Instruction Device Fingerprint Attendance ALBox FP800 Data</p></td></tr>';
            echo        '<tr><td>IPAddress</td><td><input type="text" id="dataInput_IPAddress" value="192.168.1.204"></td></tr>';
            echo        '<tr><td>Port</td><td><input type="text" id="dataInput_Port" value=4370></td></tr>';
            echo        '<tr><td>SerialNumber</td><td><input type="text" id="dataInput_SerialNumber" value="2065682450035"></td></tr>';
