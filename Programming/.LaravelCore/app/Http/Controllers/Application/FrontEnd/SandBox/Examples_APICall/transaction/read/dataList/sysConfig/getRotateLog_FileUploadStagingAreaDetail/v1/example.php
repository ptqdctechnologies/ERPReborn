...
| ▪ API Key     : transaction.read.dataList.sysConfig.getRotateLog_FileUploadStagingAreaDetail                                     |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\sysConfig\getRotateLog_FileUploadStagingAreaDetail\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.read.dataList.sysConfig.getRotateLog_FileUploadStagingAreaDetail.v1_throughAPIGateway    |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.sysConfig.getRotateLog_FileUploadStagingAreaDetail.v1_throughAPIGateway  |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                [
                'parameter' => [
                    'rotateLog_FileUploadStagingArea_RefRPK' => 63
                    ],
                'SQLStatement' => [
                    'pick' => null,
                    'sort' => null,
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo '<tr><td>Pick</td><td><input type="text" id="dataInput_RotateLog_FileUploadStagingArea_RefRPK" value=63></td></tr>';
