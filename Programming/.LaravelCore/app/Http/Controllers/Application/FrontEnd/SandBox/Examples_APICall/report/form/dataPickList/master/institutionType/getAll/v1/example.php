...
|                 \institutionType\getAll\v1                                                                                       |
| ▪ API Key     : report.form.dataPickList.master.institutionType.getAll                                                           |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2026 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\report\form\dataPickList\master\institutionType\getAll\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/report.form.dataPickList.master.institutionType.getAll.v1_throughAPIGateway         |
        |                     ► http://172.28.0.4/report.form.dataPickList.master.institutionType.getAll.v1_throughAPIGateway      |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
            ...
            $varData = 
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                    //-----[ METADATA ]-----( START )-----
                        \App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System(),
                        $varAPIWebToken, 
                        'report.form.dataPickList.master.institutionType.getAll', 
                        'latest',
                    //-----[ METADATA ]-----(  END  )-----
        ...
        |                     transaction.read.dataPickList.master.institutionType.getAll.v1_throughAPIGatewayJQuery               |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataPickList.master.institutionType.getAll.v1_throughAPIGatewayJQuery             |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
