...
| ▪ API Key     : transaction.update.supplyChain.setMaterialServiceRequisitionDetail                                               |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2024 - 2025 Zheta (teguhpjs@gmail.com)                                                                              |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\update\supplyChain\setMaterialServiceRequisitionDetail\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.update.supplyChain.setMaterialServiceRequisitionDetail.v1_throughAPIGateway              |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.update.supplyChain.setMaterialServiceRequisitionDetail.v1_throughAPIGateway            |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
            ...
            $varData = 
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                    //-----[ METADATA ]-----( START )-----
                        ...
                        $varAPIWebToken, 
                        'transaction.update.supplyChain.setMaterialServiceRequisitionDetail', 
                        'latest',
                    //-----[ METADATA ]-----(  END  )-----
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.update.supplyChain.setMaterialServiceRequisitionDetail.v1_throughAPIGatewayJQuery        |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.update.supplyChain.setMaterialServiceRequisitionDetail.v1_throughAPIGatewayJQuery      |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo       '<tr><td>RecordID</td><td><input type="text" id="dataInput_RecordID" value=263000000000001></td></tr>';
            echo       '<tr><td>MaterialServiceRequisition_RefID</td><td><input type="text" id="dataInput_MaterialService_RefID" value=262000000000001></td></tr>';
