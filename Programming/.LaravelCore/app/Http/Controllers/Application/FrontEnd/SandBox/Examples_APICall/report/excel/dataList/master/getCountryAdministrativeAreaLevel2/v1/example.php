...
| ▪ API Key     : report.excel.dataList.master.getCountryAdministrativeAreaLevel2                                                  |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\report\excel\dataList\master\getCountryAdministrativeAreaLevel2\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     report.excel.dataList.master.getCountryAdministrativeAreaLevel2.v1_throughAPIGateway                 |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       report.excel.dataList.master.getCountryAdministrativeAreaLevel2.v1_throughAPIGateway               |
        +--------------------------------------------------------------------------------------------------------------------------+
