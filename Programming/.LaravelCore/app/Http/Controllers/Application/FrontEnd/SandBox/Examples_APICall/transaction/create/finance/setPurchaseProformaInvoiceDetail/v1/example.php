...
| ▪ API Key     : transaction.create.finance.setPurchaseProformaInvoiceDetail                                                      |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\create\finance\setPurchaseProformaInvoiceDetail\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.create.finance.setPurchaseProformaInvoiceDetail.v1_throughAPIGateway    |
        |                     ► http://172.28.0.4/transaction.create.finance.setPurchaseProformaInvoiceDetail.v1_throughAPIGateway |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.create.finance.setPurchaseProformaInvoiceDetail', 
                'latest', 
                [
                'entities' => [
                    "proformaInvoiceSupplier_RefID" => 207000000000001,
        ...
        |                     transaction.create.finance.setPurchaseProformaInvoiceDetail.v1_throughAPIGatewayJQuery               |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.create.finance.setPurchaseProformaInvoiceDetail.v1_throughAPIGatewayJQuery             |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0001.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo    '<tr><td colspan="2" bgcolor="#6666cc" align="middle"><p style="color:#ffffff">Proforma Invoice Supplier Detail Main Data</p></td></tr>';
            echo    '<tr><td>ProformaInvoiceSupplier_RefID</td><td><input type="text" id="dataInput_ProformaInvoiceSupplier_RefID" value=207000000000001></td></tr>';
