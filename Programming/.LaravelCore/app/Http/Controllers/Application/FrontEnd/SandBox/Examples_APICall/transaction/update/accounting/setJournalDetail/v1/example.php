...
|                 \setJournalDetail\v1                                                                                             |
| ▪ API Key     : transaction.update.budgeting.setJournalDetail                                                                    |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\update\accounting\setJournalDetail\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.update.accounting.setJournalDetail.v1_throughAPIGateway                 |
        |                     ► http://172.28.0.4/transaction.update.accounting.setJournalDetail.v1_throughAPIGateway              |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
            ...
            //---Core---
             $varData =
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                    ...
                    $varAPIWebToken, 
                    'transaction.update.accounting.setJournalDetail', 
                    'latest', 
                    [
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.update.accounting.setJournalDetail.v1_throughAPIGatewayJQuery           |
        |                     ► http://172.28.0.4/transaction.update.accounting.setJournalDetail.v1_throughAPIGatewayJQuery        |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2023-10-27                                                                                           |
        | ▪ Creation Date   : 2023-10-27                                                                                           |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo        '<tr><td>RecordID</td><td><input type="text" id="dataInput_RecordID" value=69000000000001></td></tr>';
            ...
            echo        '<tr><td>CodeOfBudgeting_RefID</td><td><input type="text" id="dataInput_CodeOfBudgeting_RefID" value=""></td></tr>';
            echo '</table><br>';
            $varJQueryFunction =
