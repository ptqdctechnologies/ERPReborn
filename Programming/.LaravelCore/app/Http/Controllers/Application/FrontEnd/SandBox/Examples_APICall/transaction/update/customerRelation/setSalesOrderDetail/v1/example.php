...
| ▪ API Key     : transaction.update.customerRelation.setSalesOrderDetail                                                          |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\update\customerRelation\setSalesOrderDetail\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.update.customerRelation.setSalesOrderDetail.v1_throughAPIGateway        |
        |                     ► http://172.28.0.4/transaction.update.customerRelation.setSalesOrderDetail.v1_throughAPIGateway     |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.update.customerRelation.setSalesOrderDetail', 
                'latest', 
                [
        ...
        |                     transaction.update.customerRelation.setSalesOrderDetail.v1_throughAPIGatewayJQuery                   |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.update.customerRelation.setSalesOrderDetail.v1_throughAPIGatewayJQuery                 |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo        '<tr><td>RecordID</td><td><input type="text" id="dataInput_RecordID" value=130000000000001></td></tr>';
