...
|                 \setSalesContractProductBase\v1                                                                                  |
| ▪ API Key     : transaction.create.customerRelation.setSalesContractProductBase                                                  |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2026 ijonk7 (rizal.devapps@gmail.com)                                                                               |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\create\customerRelation\setSalesContractProductBase\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.create.customerRelation.setSalesContractProductBase.v1_throughAPIGateway    |
        |                     ► http://172.28.0.4/transaction.create.customerRelation.setSalesContractProductBase.v1_throughAPIGateway |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.create.customerRelation.setSalesContractProductBase.v1_throughAPIGatewayJQuery        |
        |                     ► http://172.28.0.4/transaction.create.customerRelation.setSalesContractProductBase.v1_throughAPIGatewayJQuery     |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        | ▪ Last Update     : 2026-07-07                                                                                           |
        | ▪ Creation Date   : 2026-07-07                                                                                           |
