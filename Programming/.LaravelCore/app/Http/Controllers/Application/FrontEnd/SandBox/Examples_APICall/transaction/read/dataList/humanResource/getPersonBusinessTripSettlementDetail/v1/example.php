...
| ▪ API Key     : transaction.read.dataList.humanResource.getPersonBusinessTripSettlementDetail                                    |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2026 ijonk7 (rizal.devapps@gmail.com)                                                                               |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\humanResource\getPersonBusinessTripSettlementDetail\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.read.dataList.humanResource.getPersonBusinessTripSettlementDetail.v1_throughAPIGateway   |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.humanResource.getPersonBusinessTripSettlementDetail.v1_throughAPIGateway |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
            ...
            $varData =
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                    ...
                    //-----[ DATA ]-----------------------------------------------------( START )-----
                        [
                        'parameter' => [
                            'personBusinessTrip_RefID' => 274000000000012
                            ],
                        'SQLStatement' => [
                            'pick' => null,
                            'sort' => null,
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.read.dataList.humanResource.getPersonBusinessTripSettlementDetail.v1_throughAPIGatewayJQuery   |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.humanResource.getPersonBusinessTripSettlementDetail.v1_throughAPIGatewayJQuery |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
