...
| ▪ API Key     : transaction.read.dataList.finance.getSalesInvoiceRequisition                                                     |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2024 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\finance\getSalesInvoiceRequisition\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.read.dataList.finance.getSalesInvoiceRequisition.v1_throughAPIGateway   |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.finance.getSalesInvoiceRequisition.v1_throughAPIGateway                  |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = 
                \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                    ...
                    $varAPIWebToken, 
                    'transaction.read.dataList.finance.getSalesInvoiceRequisition', 
                    'latest', 
                    [
                    'parameter' => [
                        ],
        ...
        |                     transaction.read.dataList.finance.getSalesInvoiceRequisition.v1_throughAPIGatewayJQuery              |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.finance.getSalesInvoiceRequisition.v1_throughAPIGatewayJQuery            |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
