...
| ▪ API Key     : transaction.read.dataList.sysConfig.getLog_BusinessDocumentWorkFlowPathHistory                                   |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\sysConfig\getLog_BusinessDocumentWorkFlowPathHistory\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.read.dataList.sysConfig.getLog_BusinessDocumentWorkFlowPathHistory.v1_throughAPIGateway  |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.sysConfig.getLog_BusinessDocumentWorkFlowPathHistory.                    |
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                [
                'parameter' => [
                    'log_BusinessDocumentWorkFlowPath_RefID' => 228000000000001
                    ],
                'SQLStatement' => [
                    'pick' => null,
                    'sort' => null,
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo '<tr><td>Log Business Document Work Flow Path RefID</td><td><input type="text" id="dataInput_parameter_logBusinessDocumentWorkFlowPathRefID" value=228000000000001></td></tr>';
            ...
            $varJQueryFunction = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                ...
                '{'.
                    '"parameter" : {'.
                        '"log_BusinessDocumentWorkFlowPath_RefID" : parseInt(document.getElementById("dataInput_parameter_logBusinessDocumentWorkFlowPathRefID").value)'.
                        '}, '.
                    '"SQLStatement" : {'.
