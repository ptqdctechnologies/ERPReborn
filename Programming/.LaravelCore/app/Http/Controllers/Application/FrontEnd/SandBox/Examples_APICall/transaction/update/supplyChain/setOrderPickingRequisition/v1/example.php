...
| ▪ API Key     : transaction.update.supplyChain.setOrderPickingRequisition                                                        |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2024 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\update\supplyChain\setOrderPickingRequisition\v1
    {
    class example extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/transaction.update.supplyChain.setOrderPickingRequisition.v1_throughAPIGateway      |
        |                     ► http://172.28.0.4/transaction.update.supplyChain.setOrderPickingRequisition.v1_throughAPIGateway   |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.update.supplyChain.setOrderPickingRequisition', 
                'latest', 
                [
                "recordID" => 248000000000001,
                'entities' => [
        ...
        |                     transaction.update.supplyChain.setOrderPickingRequisition.v1_throughAPIGatewayJQuery                 |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.update.supplyChain.setOrderPickingRequisition.v1_throughAPIGatewayJQuery               |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo        '<tr><td>RecordID</td><td><input type="text" id="dataInput_RecordID" value=248000000000001></td></tr>';
            ...
            echo        '<tr><td>RecordID_1</td><td><input type="text" id="dataInput_RecordID_1" value=249000000000001></td></tr>';
            ...
            echo        '<tr><td>RecordID_2</td><td><input type="text" id="dataInput_RecordID_2" value=249000000000002></td></tr>';
                    ...
                    '"entities" : {'.
                        ...
                        '"additionalData" : {'.
                            '"itemList" : {'.
                                '"items" : ['.
                                        '{'.
                                        '"recordID" : parseInt(document.getElementById("dataInput_RecordID_1").value), '.
                                        '"entities" : '.
                                            '{'.
                                        ...
                                        '}, '.
                                        '{'.
                                        '"recordID" : parseInt(document.getElementById("dataInput_RecordID_2").value), '.
                                        '"entities" : '.
                                            '{'.
