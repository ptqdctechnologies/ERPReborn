...
|                 \cloudStorage\getSubDirectoriesList\v1                                                                           |
| ▪ API Key     : fileHandling.upload.stagingArea.cloudStorage.getSubDirectoriesList                                               |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
...
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\fileHandling\upload\stagingArea\cloudStorage\getSubDirectoriesList\v1
    ...
    class example extends \App\Http\Controllers\Controller
        ...
        |                     fileHandling.upload.stagingArea.cloudStorage.getSubDirectoriesList.v1_throughAPIGateway              |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       fileHandling.upload.stagingArea.cloudStorage.getSubDirectoriesList.v1_throughAPIGateway            |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'fileHandling.upload.stagingArea.cloudStorage.getSubDirectoriesList', 
                'latest', 
                [
                    'parameter' => null
                ]
