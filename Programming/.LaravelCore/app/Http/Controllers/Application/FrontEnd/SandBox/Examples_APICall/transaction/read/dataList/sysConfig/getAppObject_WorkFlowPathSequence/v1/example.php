...
| ▪ API Key     : transaction.read.dataList.sysConfig.getAppObject_WorkFlowPathSequence                                            |
| ▪ API Version : 1                                                                                                                |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2023 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\transaction\read\dataList\sysConfig\getAppObject_WorkFlowPathSequence\v1
    {
    class example extends \App\Http\Controllers\Controller
        ...
        |                     transaction.read.dataList.sysConfig.getAppObject_WorkFlowPathSequence.v1_throughAPIGateway           |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.sysConfig.getAppObject_WorkFlowPathSequence.v1_throughAPIGateway         |
        +--------------------------------------------------------------------------------------------------------------------------+
        ...
        */
        public function throughAPIGateway($varAPIWebToken)
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                $varAPIWebToken, 
                'transaction.read.dataList.sysConfig.getAppObject_WorkFlowPathSequence', 
                'latest', 
                [
                'parameter' => [
                    'workFlowPath_RefID' => 116000000000002
                    ],
                'SQLStatement' => [
                    'pick' => null,
                    'sort' => null,
        ...
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Call URL        : http(s)://<HOST>/                                                                                    |
        |                     transaction.read.dataList.sysConfig.getAppObject_WorkFlowPathSequence.v1_throughAPIGatewayJQuery     |
        |                     ► http://172.28.0.4/                                                                                 |
        |                       transaction.read.dataList.sysConfig.getAppObject_WorkFlowPathSequence.v1_throughAPIGatewayJQuery   |
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ Version         : 1.0000.0000000                                                                                       |
        ...
        */
        public function throughAPIGatewayJQuery($varAPIWebToken)
            ...
            echo '<tr><td>WorkFlow Path RefID</td><td><input type="text" id="dataInput_parameter_workFlowPathRefID" value=116000000000002></td></tr>';
            ...
            $varJQueryFunction = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                ...
                '{'.
                    '"parameter" : {'.
                        '"workFlowPath_RefID" : parseInt(document.getElementById("dataInput_parameter_workFlowPathRefID").value)'.
                        '}, '.
                    '"SQLStatement" : {'.
