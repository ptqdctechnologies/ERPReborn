...
namespace App\Http\Controllers\Application\FrontEnd\SandBox
    ...
    class SendWSRequest extends \App\Http\Controllers\Controller
        ...
        public function APIGateway_getSessionData()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoidGVndWgucHJhdGFtYSIsImlhdCI6MTYwODc3ODc3NH0.tuJoQhmU_cA1wM7ZBkXs718y65mo5zAgTkNIhL7WKdg';
            //---Core---
