    ...
    class SendWSRequest extends \App\Http\Controllers\Controller
        ...
        */
        public function APIGateway_getSessionData()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoic3lzYWRtaW4iLCJpYXQiOjE2MjMzOTE0NTB9.H2WiwSw997CFfJQWHc65_lWCuSaGPO-jnCHs0SGweLY';
            //---Core---
...
//                    'filter' => '; drop table',
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ API Key     : transaction.read.budgeting.getDataListBudgetCeiling                                                      |
        | ▪ API Version : 1                                                                                                        |
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function APIGateway_getDataListBudgetCeiling()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoic3lzYWRtaW4iLCJpYXQiOjE2MjMzOTE0NTB9.H2WiwSw997CFfJQWHc65_lWCuSaGPO-jnCHs0SGweLY';
            //---Core---
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                \App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System(),
                $varAPIWebToken, 
                'transaction.read.budgeting.getDataListBudgetCeiling', 
                'latest', 
                [
                'budgetLine_RefID' => 105000000000001,
                'SQLStatement' => [
                    'pick' => null,
                    'sort' => null,
                    'filter' => null,
        ...
        public function APIGatewayJQuery_getDataListBudgetCeiling()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoic3lzYWRtaW4iLCJpYXQiOjE2MjMzOTE0NTB9.H2WiwSw997CFfJQWHc65_lWCuSaGPO-jnCHs0SGweLY';
            //---Core---
            echo '<input type="text" id="dataInput_BudgetLine_RefID" value=105000000000001>';
            echo \App\Helpers\ZhtHelper\General\Helper_JavaScript::setLibrary(\App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System());
            echo '<table border="1" style="border-collapse: collapse;">';
            echo '<tr><td colspan="2" bgcolor="#6666cc" align="middle"><p style="color:#ffffff">SQL Statement</p></td></tr>';
            echo '<tr><td>Pick</td><td><input type="text" id="dataInput_SQLStatement_pick" value=""></td></tr>';
            ...
            $varJQueryFunction = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                ...
                'latest', 
                '{'.
                    '"budgetLine_RefID" : parseInt(document.getElementById("dataInput_BudgetLine_RefID").value), '.
                    '"SQLStatement" : {'.
                        '"pick" : document.getElementById("dataInput_SQLStatement_pick").value, '.
                        '"sort" : document.getElementById("dataInput_SQLStatement_sort").value, '.
                        '"filter" : document.getElementById("dataInput_SQLStatement_filter").value, '.
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ API Key     : transaction.read.budgeting.getDataListBudgetCeilingObjects                                               |
        | ▪ API Version : 1                                                                                                        |
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function APIGateway_getDataListBudgetCeilingObjects()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoic3lzYWRtaW4iLCJpYXQiOjE2MjMzOTE0NTB9.H2WiwSw997CFfJQWHc65_lWCuSaGPO-jnCHs0SGweLY';
            //---Core---
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                \App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System(),
                $varAPIWebToken, 
                'transaction.read.budgeting.getDataListBudgetCeilingObjects', 
                'latest', 
                [
                'budgetCeiling_RefID' => 106000000000010,
                'SQLStatement' => [
                    'pick' => null,
                    'sort' => null,
                    'filter' => null,
        ...
        public function APIGatewayJQuery_getDataListBudgetCeilingObjects()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoic3lzYWRtaW4iLCJpYXQiOjE2MjMzOTE0NTB9.H2WiwSw997CFfJQWHc65_lWCuSaGPO-jnCHs0SGweLY';
            //---Core---
            echo '<input type="text" id="dataInput_BudgetCeiling_RefID" value=106000000000010>';
            echo \App\Helpers\ZhtHelper\General\Helper_JavaScript::setLibrary(\App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System());
            echo '<table border="1" style="border-collapse: collapse;">';
            echo '<tr><td colspan="2" bgcolor="#6666cc" align="middle"><p style="color:#ffffff">SQL Statement</p></td></tr>';
            echo '<tr><td>Pick</td><td><input type="text" id="dataInput_SQLStatement_pick" value=""></td></tr>';
            ...
            $varJQueryFunction = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                ...
                'latest', 
                '{'.
                    '"budgetCeiling_RefID" : parseInt(document.getElementById("dataInput_BudgetCeiling_RefID").value), '.
                    '"SQLStatement" : {'.
                        '"pick" : document.getElementById("dataInput_SQLStatement_pick").value, '.
                        '"sort" : document.getElementById("dataInput_SQLStatement_sort").value, '.
                        '"filter" : document.getElementById("dataInput_SQLStatement_filter").value, '.
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ API Key     : transaction.read.budgeting.getDataListBudgetLine                                                         |
        | ▪ API Version : 1                                                                                                        |
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function APIGateway_getDataListBudgetLine()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoic3lzYWRtaW4iLCJpYXQiOjE2MjMzOTE0NTB9.H2WiwSw997CFfJQWHc65_lWCuSaGPO-jnCHs0SGweLY';
            //---Core---
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                \App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System(),
                $varAPIWebToken, 
                'transaction.read.budgeting.getDataListBudgetLine', 
                'latest', 
                [
                'budgetSection_RefID' => 104000000000003,
                'SQLStatement' => [
                    'pick' => null,
                    'sort' => null,
                    'filter' => null,
        ...
        public function APIGatewayJQuery_getDataListBudgetLine()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoic3lzYWRtaW4iLCJpYXQiOjE2MjMzOTE0NTB9.H2WiwSw997CFfJQWHc65_lWCuSaGPO-jnCHs0SGweLY';
            //---Core---
            echo '<input type="text" id="dataInput_BudgetSection_RefID" value=104000000000003>';
            echo \App\Helpers\ZhtHelper\General\Helper_JavaScript::setLibrary(\App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System());
            echo '<table border="1" style="border-collapse: collapse;">';
            echo '<tr><td colspan="2" bgcolor="#6666cc" align="middle"><p style="color:#ffffff">SQL Statement</p></td></tr>';
            echo '<tr><td>Pick</td><td><input type="text" id="dataInput_SQLStatement_pick" value=""></td></tr>';
            ...
            $varJQueryFunction = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                ...
                'latest', 
                '{'.
                    '"budgetSection_RefID" : parseInt(document.getElementById("dataInput_BudgetSection_RefID").value), '.
                    '"SQLStatement" : {'.
                        '"pick" : document.getElementById("dataInput_SQLStatement_pick").value, '.
                        '"sort" : document.getElementById("dataInput_SQLStatement_sort").value, '.
                        '"filter" : document.getElementById("dataInput_SQLStatement_filter").value, '.
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ API Key     : transaction.read.budgeting.getDataListBudgetSection                                                      |
        | ▪ API Version : 1                                                                                                        |
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        public function APIGateway_getDataListBudgetSection()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoic3lzYWRtaW4iLCJpYXQiOjE2MjMzOTE0NTB9.H2WiwSw997CFfJQWHc65_lWCuSaGPO-jnCHs0SGweLY';
            //---Core---
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                \App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System(),
                $varAPIWebToken, 
                'transaction.read.budgeting.getDataListBudgetSection', 
                'latest', 
                [
        ...
        public function APIGatewayJQuery_getDataListBudgetSection()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoic3lzYWRtaW4iLCJpYXQiOjE2MjMzOTE0NTB9.H2WiwSw997CFfJQWHc65_lWCuSaGPO-jnCHs0SGweLY';
            //---Core---
