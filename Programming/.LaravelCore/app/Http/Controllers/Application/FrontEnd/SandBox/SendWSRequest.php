    ...
    class SendWSRequest extends \App\Http\Controllers\Controller
        ...
        */
        public function APIGateway_getSessionData()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoic3lzYWRtaW4iLCJpYXQiOjE2MjIxNzQwNjZ9.1mD1veXHTZpWhPI5MXZWmjGh6TI_RiPzT-_bxGdf6NI';
            //---Core---
...
//                    'filter' => '; drop table',
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ API Key     : transaction.read.budgeting.getDataListSalesOrder                                                  |
        | ▪ API Version : 1                                                                                                        |
        +--------------------------------------------------------------------------------------------------------------------------+
        */
