...
namespace App\Http\Controllers\Application\FrontEnd\SandBox
    ...
    class SendWSRequest extends \App\Http\Controllers\Controller
        ...
        public function APIGateway_GetSessionData()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoidGVndWgucHJhdGFtYSIsImlhdCI6MTYwNzMxNzYxMX0.lvblFfmJJhks3oKiThJFkc6DbDDEF-V-mVuzLLrQ9rI';
            //---Core---
        ...
        public function APIGateway_setDataCreateBusinessDocumentType()
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                [
                'entities' => [
                    'name' => 'New Business Document Type'
                    ]
                ]
                );
            var_dump($varData);
