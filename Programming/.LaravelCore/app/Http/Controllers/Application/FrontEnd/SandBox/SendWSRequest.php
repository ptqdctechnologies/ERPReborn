...
namespace App\Http\Controllers\Application\FrontEnd\SandBox
    ...
    class SendWSRequest extends \App\Http\Controllers\Controller
        ...
        public function APIGateway_getSessionData()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoidGVndWgucHJhdGFtYSIsImlhdCI6MTYwOTI5NTA4NX0.FG3KBjYdOv__hoUrwlu_WYGbNgjzw0RNWtcFouQiN4U';
            //---Core---
...
//                        'new ERPReborn_JSAPIRequest(); '.
            ...
            //echo "<button type='button' onclick='javascript:var varData=".$varJQueryFunction.";'>Click Me</button>";
//echo "<button type='button' onclick='javascript:var x = new ERPReborn_JSCore(); var varData=".$varJQueryFunction.";'>Click Me</button>";
          //  echo "<button type='button' onclick='javascript:new ERPReborn_JSCore(); var varData = ".$varJQueryFunction.";'>Click Me</button>";
            echo "<button type='button' onclick='javascript:new ERPReborn_JSCore(); var varData = ".$varJQueryFunction."; alert(\"No 1\");'>Click Me</button>";
            echo "<button type='button' onclick='javascript:new ERPReborn_JSCore(); var varData = ".$varJQueryFunction."; alert(\"No 2\");'>Click Me</button>";
