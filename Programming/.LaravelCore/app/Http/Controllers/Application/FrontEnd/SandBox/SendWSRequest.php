...
namespace App\Http\Controllers\Application\FrontEnd\SandBox
    ...
    class SendWSRequest extends \App\Http\Controllers\Controller
        ...
        public function APIGateway_GetSessionData()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoidGVndWgucHJhdGFtYSIsImlhdCI6MTYwNjA5Nzg4MH0.d1AB_XF31WOFS7dhxvEHyJmPybR5ju4YHiuF_ZbSf5Q';
            //---Core---
