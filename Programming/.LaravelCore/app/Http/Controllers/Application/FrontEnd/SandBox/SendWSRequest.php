    ...
    class SendWSRequest extends \App\Http\Controllers\Controller
        ...
        */
        public function APIGateway_getSessionData()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoidGVndWgucHJhdGFtYSIsImlhdCI6MTYxMjQyMDUzNX0._aenpNmjY4fgS-lSj0QgijcuP_PDF8mXTL-JU2WRAXk';
            //---Core---
        ...
        */
        ...
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
        | ▪ API Key     : transaction.synchronize.sysConfig.setLog_Device_PersonAccess                                             |
        | ▪ API Version : 1                                                                                                        |
        +--------------------------------------------------------------------------------------------------------------------------+
        */
        ...
        */
        ...
        public function APIGatewayJQuery_getDataListBloodAglutinogenType()
            ...
            //---Core---
            echo \App\Helpers\ZhtHelper\General\Helper_JavaScript::setLibrary(\App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System());
            echo '<input type="text" id="dataInput_SQLStatement_pick" value="">';
            echo '<input type="text" id="dataInput_SQLStatement_sort" value="">';
            echo '<input type="text" id="dataInput_SQLStatement_filter" value="">';
            echo '<input type="text" id="dataInput_SQLStatement_paging" value="">';
            $varJQueryFunction = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                \App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System(), 
                $varAPIWebToken, 
                'transaction.read.master.getDataListBloodAglutinogenType', 
        ...
        */
        ...
        public function APIGateway_getWebSiteScraper_CentralBankExchangeRateTimeSeriesDataFromOfflineFile()
            ...
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                ...
                [
                'entities' => [
                    'pathFile' => '/zhtConf/tmp/download/Kurs-BI-20130102-20200203/Kurs-BI-USD.html'
                    ]
                ]
                );
            dd($varData);
