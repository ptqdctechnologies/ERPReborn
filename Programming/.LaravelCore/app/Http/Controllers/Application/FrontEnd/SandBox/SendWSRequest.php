...
namespace App\Http\Controllers\Application\FrontEnd\SandBox
    ...
    class SendWSRequest extends \App\Http\Controllers\Controller
        ...
        public function APIGateway_GetSessionData()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoidGVndWgucHJhdGFtYSIsImlhdCI6MTYwNzY1MjkzMn0.NHYXoiXFGfL4ZQWsibeXqfMNm3ibTykhYmsJt9agcj8';
            //---Core---
