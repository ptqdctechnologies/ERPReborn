    ...
    class SendWSRequest extends \App\Http\Controllers\Controller
        ...
        */
        public function APIGateway_getSessionData()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoic3lzYWRtaW4iLCJpYXQiOjE2MjMyMDQ3NDF9.hr5PJC2qa93md7MEXZ0G8tKZCxkfnrdjUDbo_EV6Zao';
            //---Core---
