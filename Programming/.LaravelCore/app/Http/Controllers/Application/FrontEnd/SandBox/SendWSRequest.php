...
namespace App\Http\Controllers\Application\FrontEnd\SandBox
    ...
    class SendWSRequest extends \App\Http\Controllers\Controller
        ...
        public function APIGateway_GetSessionData()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoidGVndWgucHJhdGFtYSIsImlhdCI6MTYwODI1ODI4MX0.mDbWyzPLn-kx4vz5iDxUb4oaNkaUH40FhEbxuBhaD2A';
            //---Core---
        ...
        public function APIGateway_GetSessionUserPrivilegesMenu()
            {
            //---Parameter Set---
            $varAPIWebToken = 'xxxeyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoidGVndWgucHJhdGFtYSIsImlhdCI6MTYwODI1ODI4MX0.mDbWyzPLn-kx4vz5iDxUb4oaNkaUH40FhEbxuBhaD2A';
            //---Core---
            $varData = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGateway(
                \App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System(),
                $varAPIWebToken, 
        ...
        public function APIGatewayJQuery_GetSessionUserPrivilegesMenu()
            ...
            echo \App\Helpers\ZhtHelper\General\Helper_JQuery::setLibrary($varUserSession);
            
            $varJQuery = \App\Helpers\ZhtHelper\System\FrontEnd\Helper_APICall::setCallAPIGatewayJQuery(
                \App\Helpers\ZhtHelper\System\Helper_Environment::getUserSessionID_System(), 
                'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoidGVndWgucHJhdGFtYSIsImlhdCI6MTYwODI1ODI4MX0.mDbWyzPLn-kx4vz5iDxUb4oaNkaUH40FhEbxuBhaD2A', 
                'environment.general.session.getUserPrivilegesMenu', 
                'latest', 
                []
                );
            
            echo "<button type='button' onclick='javascript:".$varJQuery."; alert(varData);'>Klik</button>";
