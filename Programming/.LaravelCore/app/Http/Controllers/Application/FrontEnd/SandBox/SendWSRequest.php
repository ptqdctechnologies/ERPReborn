    ...
    class SendWSRequest extends \App\Http\Controllers\Controller
        ...
        */
        public function APIGateway_getSessionData()
            {
            //---Parameter Set---
            $varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoidGVndWgucHJhdGFtYSIsImlhdCI6MTYxMzUyODI3MH0.zm-qAPcbJhDvy-sgpH7BVBEJPK9VeRqi2B6jTCIra4E';
            //---Core---
