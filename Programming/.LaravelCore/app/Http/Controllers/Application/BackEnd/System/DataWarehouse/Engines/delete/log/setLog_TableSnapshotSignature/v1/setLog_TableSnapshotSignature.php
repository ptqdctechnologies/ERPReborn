...
| ▪ Name Space : \App\Http\Controllers\Application\BackEnd\System\DataWarehouse\Engines\delete\log\setLog_TableSnapshotSignature   |
|                \v1                                                                                                               |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2024 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\BackEnd\System\DataWarehouse\Engines\delete\acquisition\setLog_TableSnapshotSignature\v1
    {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : setLog_TableSnapshotSignature                                                                                |
    | ▪ Description : Menangani API dataWarehouse.delete.log.setLog_TableSnapshotSignature Version 1                               |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
