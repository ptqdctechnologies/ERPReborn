    ...
    class getBloodAglutinogenType extends \App\Http\Controllers\Controller
        ...
        */
        function main($varUserSession, $varData)
            ...
            try {
                $varSysDataProcess = \App\Helpers\ZhtHelper\Logger\Helper_SystemLog::setLogOutputMethodProcessHeader($varUserSession, __CLASS__, __FUNCTION__, 'Get Blood Aglutinogen Type Data List PDF Report(version 1)');
                try {
                    ...
                    try{
                        if(!($varDataSend = $this->dataProcessing(
                            $varUserSession,
                            [
                            'Title' => 'Blood Aglutinogen Type List',
                            'SubTitle' => [
                                ]
                            ],
