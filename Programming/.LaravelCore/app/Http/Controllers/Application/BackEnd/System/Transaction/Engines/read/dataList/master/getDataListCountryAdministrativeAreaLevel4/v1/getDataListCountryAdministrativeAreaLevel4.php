...
|                \getDataListCountryAdministrativeAreaLevel4\v1                                                                    |
|                                                                                                                                  |
...
namespace App\Http\Controllers\Application\BackEnd\System\Transaction\Engines\read\master\getDataListCountryAdministrativeAreaLevel4\v1
    ...
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : getDataListCountryAdministrativeAreaLevel4                                                                   |
    | ▪ Description : Menangani API transaction.read.master.getDataListCountryAdministrativeAreaLevel4 Version 1                   |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
