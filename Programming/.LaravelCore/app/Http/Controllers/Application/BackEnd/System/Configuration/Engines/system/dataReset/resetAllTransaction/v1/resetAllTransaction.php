...
| ▪ Name Space : \App\Http\Controllers\Application\BackEnd\System\Configuration\Engines\system\dataReset\resetAllTransaction\v1    |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2022 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\BackEnd\System\Configuration\Engines\system\dataReset\resetAllTransaction\v1
    {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : resetAllTransaction                                                                                          |
    | ▪ Description : Menangani API configuration.system.dataReset.resetAllTransaction Version 1                                   |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class resetAllTransaction extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
