...
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\BackEnd\System\Transaction\Engines\update\humanResource\setPersonBusinessTripSettlement\v1
    {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : setPersonBusinessTripSettlement                                                                              |
    | ▪ Description : Menangani API transaction.update.humanResource.setPersonBusinessTripSettlement Version 1                     |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
        ...
        function main($varUserSession, $varData)
            ...
            try {
                $varSysDataProcess =
                    ...
                    'Update Person Business Trip Settlement Data (version 1)'
                    );
                    ...
                    try {
                        if (!($varDataSend =
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataUpdate(
                                $varUserSession,
                                (new \App\Models\Database\SchData_OLTP_HumanResource\TblPersonBusinessTripSettlement())->setDataUpdate(
                                    $varUserSession,
                                    $varData['recordID'],
