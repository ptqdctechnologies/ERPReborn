        ...
        function main($varUserSession, $varData)
            ...
            try {
                ...
                try {
                    ...
                    try{
                        if(!($varDataSend = \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataInitialize($varUserSession, (new \App\Models\Database\SchData_OLTP_Master\TblAccountingEntryRecordType())->setDataInitialize(
                            $varUserSession
                            ))))
                            {
                            throw new \Exception();
