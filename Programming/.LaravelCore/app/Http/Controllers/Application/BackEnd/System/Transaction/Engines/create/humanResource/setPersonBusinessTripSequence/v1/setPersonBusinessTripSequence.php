            ...
            try {
                $varSysDataProcess =
                    \App\Helpers\ZhtHelper\Logger\Helper_SystemLog::setLogOutputMethodProcessHeader($varUserSession, __CLASS__, __FUNCTION__,
                        'Create Person Business Trip Sequence Data (version 1)'
                        );
                    ...
                    try {
                        if (!($varDataSend =
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataCreate(
                                $varUserSession,
                                (new \App\Models\Database\SchData_OLTP_HumanResource\TblPersonBusinessTripSequence())->setDataInsert(
                                    $varUserSession,
                                    ...
                                    $varData['entities']['departurePoint'],
                                    $varData['entities']['destinationPoint'],
                                    $varData['entities']['reasonToTravel'],
