...
| ▪ Name Space : \App\Http\Controllers\Application\BackEnd\System\FileHandling\Engines\upload\stagingArea\general\getNewID\v1      |
|                                                                                                                                  |
...
namespace App\Http\Controllers\Application\BackEnd\System\FileHandlingOLD\Engines\upload\stagingArea\general\getNewID\v1
    ...
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : getNewID                                                                                                     |
    | ▪ Description : Menangani API fileHandling.upload.stagingArea.general.getNewID Version 1                                     |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
