                ...
                try {
                    ...
                    try{
                        if(!($varDataSend = $this->dataProcessing(
                            $varUserSession, 
                            [
                            'Title' => 'Person Account EMail List',
                            'SubTitle' => [
                                (new \App\Models\Database\SchSysConfig\General())->getReferenceTextByReferenceID($varUserSession, $varData['parameter']['person_RefID'])
                                ]
                            ],
