...
namespace App\Http\Controllers\Application\BackEnd\System\Transaction\Engines\read\dataList\budgeting\getCombinedBudgetStockDetail\v1 {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : getCombinedBudgetStockDetail                                                                                 |
    | ▪ Description : Menangani API transaction.read.dataList.budgeting.getCombinedBudgetStockDetail Version 1                     |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class getCombinedBudgetStockDetail extends \App\Http\Controllers\Controller
    {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
                    ...
                    try {
                        ...
                        if (!($varDataSend = 
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataRead(
                                $varUserSession, 
                                (new \App\Models\Database\SchData_OLTP_Budgeting\General())->getDataList_CombinedBudgetStockDetail_LatestVersion(
                                    $varUserSession,
