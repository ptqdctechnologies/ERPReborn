            ...
            try {
                $varSysDataProcess =
                    \App\Helpers\ZhtHelper\Logger\Helper_SystemLog::setLogOutputMethodProcessHeader($varUserSession, __CLASS__, __FUNCTION__,
                        'Delete Budget Expense Line Ceiling Objects Data (version 1)');
                    ...
                    try {
                        if (!($varDataSend = 
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataDelete(
                                $varUserSession, 
                                (new \App\Models\Database\SchData_OLTP_Budgeting\TblBudgetExpenseLineCeilingObjects())->setDataDelete(
                                    $varUserSession,
                                    $varData['recordID']
                                    )
                                )
