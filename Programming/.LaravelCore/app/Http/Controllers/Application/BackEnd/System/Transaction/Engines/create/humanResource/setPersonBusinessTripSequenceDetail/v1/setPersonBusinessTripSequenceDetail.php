        ...
        function main($varUserSession, $varData)
            ...
            try {
                $varSysDataProcess = 
                    ...
                    'Create Person Business Trip Sequence Detail Data (version 1)'
                    );
                    ...
                    try {
                        if (!($varDataSend =
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataCreate(
                                $varUserSession,
                                (new \App\Models\Database\SchData_OLTP_HumanResource\TblPersonBusinessTripSequenceDetail())->setDataInsert(
                                    $varUserSession,
