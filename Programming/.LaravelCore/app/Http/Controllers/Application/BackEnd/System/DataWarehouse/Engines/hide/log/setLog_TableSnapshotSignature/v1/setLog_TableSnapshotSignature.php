...
| ▪ Name Space : \App\Http\Controllers\Application\BackEnd\System\DataWarehouse\Engines\hide\log\setLog_TableSnapshotSignature\v1  |
|                                                                                                                                  |
...
namespace App\Http\Controllers\Application\BackEnd\System\DataWarehouse\Engines\hide\log\setLog_TableSnapshotSignature\v1
    ...
    | ▪ Description : Menangani API dataWarehouse.hide.log.setLog_TableSnapshotSignature Version 1                                 |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
                    ...
                    try {
                        if (!($varDataSend = 
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataDelete(
                                $varUserSession, 
                                (new \App\Models\Database\SchData_Warehouse_Log\TblLog_TableSnapshotSignature())->setDataHide(
                                    $varUserSession,
                                    $varData['recordID']
                                    )
                                )
