...
| ▪ Name Space : \App\Http\Controllers\Application\BackEnd\System\DataWarehouse\Engines\unhide\acquisition                         |
|                \setLog_Device_PersonAccess\v1                                                                                    |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2021 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\BackEnd\System\DataWarehouse\Engines\unhide\acquisition\setLog_Device_PersonAccess\v1
    {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : setLog_Device_PersonAccess                                                                                   |
    | ▪ Description : Menangani API dataWarehouse.unhide.acquisition.setLog_Device_PersonAccess Version 1                          |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
                    ...
                    try {
                        if (!($varDataSend =
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataUndelete(
                                $varUserSession,
                                (new \App\Models\Database\SchData_Warehouse_Acquisition\TblLog_Device_PersonAccess())->unsetDataHide(
                                    $varUserSession,
                                    $varData['recordID']
                                    )
                                )
