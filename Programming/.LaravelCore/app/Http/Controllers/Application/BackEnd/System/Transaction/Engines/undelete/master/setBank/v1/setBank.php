...
namespace App\Http\Controllers\Application\BackEnd\System\Transaction\Engines\undelete\master\setBank\v1
    ...
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : setBank                                                                                                      |
    | ▪ Description : Menangani API transaction.undelete.master.setBank Version 1                                                  |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
        ...
        function main($varUserSession, $varData)
            ...
            try {
                ...
                try {
                    ...
                    try{
                        if(!($varDataSend = \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataUndelete($varUserSession, (new \App\Models\Database\SchData_OLTP_Master\TblBank())->unsetDataDelete(
                            $varUserSession,
                            $varData['recordID']
                            ))))
                            {
