...
| ▪ Name Space : \App\Http\Controllers\Application\BackEnd\System\Report\Engines\form\dataPickList\master\getWorkStructure                  |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2026 Wisnu (wisnu.wirayuda01@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/

namespace App\Http\Controllers\Application\BackEnd\System\Report\Engines\form\dataPickList\master\getWorkStructure\v1 {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : getWorkStructure                                                                                                      |
    | ▪ Description : Menangani API report.form.dataPickList.master.getWorkStructure Version 1                                              |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class getWorkStructure extends \App\Http\Controllers\Controller
    {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
            ...
            try {
                $varSysDataProcess =
                    \App\Helpers\ZhtHelper\Logger\Helper_SystemLog::setLogOutputMethodProcessHeader(
                        ...
                        __CLASS__,
                        __FUNCTION__,
                        'Get Report Form - DataPickList - Work Structure (version 1)'
                    );
                        ...
                        if (
                            !($varDataSend =
                                \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataRead(
                                    $varUserSession,
                                    (new \App\Models\Database\SchData_OLTP_Master\General())->getReport_Form_DataPickList_Work_Structure(
                                        ...
                                        (
                                            \App\Helpers\ZhtHelper\General\Helper_Array::isKeyExist(
                                                ...
                                                (!is_null($varData['parameter']['dataFilter']['code']))
