...
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\BackEnd\System\Transaction\Engines\undelete\humanResource\setPersonBusinessTripSequenceDetail\v1
    {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : setPersonBusinessTripSequenceDetail                                                                          |
    | ▪ Description : Menangani API transaction.undelete.humanResource.setPersonBusinessTripSequenceDetail Version 1               |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
            ...
            try {
                $varSysDataProcess =
                    \App\Helpers\ZhtHelper\Logger\Helper_SystemLog::setLogOutputMethodProcessHeader($varUserSession, __CLASS__, __FUNCTION__,
                        'Undelete Person Business Trip Sequence Detail Data (version 1)');
                    ...
                    try {
                        if (!($varDataSend =
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataUndelete(
                                $varUserSession,
                                (new \App\Models\Database\SchData_OLTP_HumanResource\TblPersonBusinessTripSequenceDetail())->unsetDataDelete(
                                    $varUserSession,
                                    $varData['recordID']
                                    )
                                )
