...
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\BackEnd\System\Transaction\Engines\delete\budgeting\setCombinedBudgetSectionDetail\v1
    {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : setCombinedBudgetSectionDetail                                                                                                |
    | ▪ Description : Menangani API transaction.delete.budgeting.setCombinedBudgetSectionDetail Version 1                                           |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
            ...
            try {
                $varSysDataProcess =
                    \App\Helpers\ZhtHelper\Logger\Helper_SystemLog::setLogOutputMethodProcessHeader($varUserSession, __CLASS__, __FUNCTION__,
                        'Delete Combined Budget Section Detail Data (version 1)');
                    ...
                    try {
                        if (!($varDataSend = 
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataDelete(
                                $varUserSession, 
                                (new \App\Models\Database\SchData_OLTP_Budgeting\TblCombinedBudgetSectionDetail())->setDataDelete(
                                    $varUserSession,
                                    $varData['recordID']
                                    )
                                )
