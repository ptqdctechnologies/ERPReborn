...
|                \chartOfAccount\getNonHeaderAdvance                                                                               |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2026 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/

namespace App\Http\Controllers\Application\BackEnd\System\Report\Engines\form\dataPickList\accounting\chartOfAccount\getNonHeaderAdvance\v1
    {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : getNonHeaderAdvance                                                                                          |
    | ▪ Description : Menangani API report.form.dataPickList.accounting.chartOfAccount.getNonHeaderAdvance Version 1               |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class getNonHeaderAdvance extends \App\Http\Controllers\Controller
        {
        /*
        +--------------------------------------------------------------------------------------------------------------------------+
            ...
            try {
                $varSysDataProcess =
                    \App\Helpers\ZhtHelper\Logger\Helper_SystemLog::setLogOutputMethodProcessHeader($varUserSession, __CLASS__, __FUNCTION__,
                        'Get Report Form - DataPickList - Chart Of Account - Non Header - Advance (version 1)'
                        );
                            ...
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataRead(
                                ...
                                (new \App\Models\Database\SchData_OLTP_Accounting\General())->getReport_Form_DataPickList_ChartOfAccountNonHeader(
                                    ...
                                    //-----[ Filter Parameter ]-----------------------------------------------------( START POINT )-----
                                        //---► fullCodeBase
                                            '1-0000 ► 1-1000 ► 1-1700 ► 1-1700.01',
                                        //---► fullNameBase
                                            'Uang Muka',
                                        //---► fullCode
                                            (\App\Helpers\ZhtHelper\General\Helper_Array::isKeyExist(
