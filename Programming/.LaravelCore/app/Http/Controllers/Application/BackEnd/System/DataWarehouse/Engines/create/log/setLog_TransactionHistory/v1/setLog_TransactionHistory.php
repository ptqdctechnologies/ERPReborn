...
| ▪ Name Space : \App\Http\Controllers\Application\BackEnd\System\DataWarehouse\Engines\create\log\setLog_TransactionHistory\v1    |
|                                                                                                                                  |
| ▪ Copyleft 🄯 2024 Zheta (teguhpjs@gmail.com)                                                                                     |
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\BackEnd\System\DataWarehouse\Engines\create\log\setLog_TransactionHistory\v1
    {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : setLog_TransactionHistory                                                                                    |
    | ▪ Description : Menangani API dataWarehouse.create.log.setLog_TransactionHistory Version 1                                   |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
