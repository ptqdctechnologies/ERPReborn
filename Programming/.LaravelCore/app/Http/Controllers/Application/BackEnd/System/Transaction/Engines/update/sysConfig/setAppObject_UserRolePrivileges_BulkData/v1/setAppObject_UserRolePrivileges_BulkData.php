...
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\BackEnd\System\Transaction\Engines\update\sysConfig\setAppObject_UserRolePrivileges_BulkData\v1
    {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : setAppObject_UserRolePrivileges_BulkData                                                                     |
    | ▪ Description : Menangani API transaction.update.sysConfig.setAppObject_UserRolePrivileges_BulkData Version 1                |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
    class setAppObject_UserRolePrivileges_BulkData extends \App\Http\Controllers\Controller
        ...
        */
        function main($varUserSession, $varData)
            ...
            try {
                $varSysDataProcess = \App\Helpers\ZhtHelper\Logger\Helper_SystemLog::setLogOutputMethodProcessHeader($varUserSession, __CLASS__, __FUNCTION__, 'Update User Role Privileges Bulk Data (version 1)');
                try {
                    ...
                    try {
                        if (!($varDataSend = 
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataUpdate(
                                $varUserSession, 
                                (new \App\Models\Database\SchSysConfig\TblAppObject_UserRolePrivileges())->setDataUpdate_BulkData(
                                    $varUserSession,
                                    null, //$varData['recordID'],
                                    null,
                                    null,
                                    ...
                                    $varData['entities']['menuAction_RefIDArray']
                                    )
                                )
                            ))
                            {
