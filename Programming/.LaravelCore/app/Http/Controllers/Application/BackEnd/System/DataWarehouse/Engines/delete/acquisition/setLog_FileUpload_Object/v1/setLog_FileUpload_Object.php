...
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\BackEnd\System\DataWarehouse\Engines\delete\acquisition\setLog_FileUpload_Object\v1
    {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : setLog_FileUpload_Object                                                                                     |
    | ▪ Description : Menangani API dataWarehouse.delete.acquisition.setLog_FileUpload_Object Version 1                            |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
                    ...
                    try {
                        if (!($varDataSend = 
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataDelete(
                                $varUserSession, 
                                (new \App\Models\Database\SchData_Warehouse_Acquisition\TblLog_FileUpload_Object())->setDataDelete(
                                    $varUserSession,
                                    $varData['recordID']
                                    )
                                )
