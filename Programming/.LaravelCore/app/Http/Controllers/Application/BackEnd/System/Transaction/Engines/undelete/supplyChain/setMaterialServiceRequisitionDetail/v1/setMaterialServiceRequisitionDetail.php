...
+----------------------------------------------------------------------------------------------------------------------------------+
*/
namespace App\Http\Controllers\Application\BackEnd\System\Transaction\Engines\undelete\supplyChain\setMaterialServiceRequisitionDetail\v1
    {
    /*
    +------------------------------------------------------------------------------------------------------------------------------+
    | ▪ Class Name  : setMaterialServiceRequisitionDetail                                                                          |
    | ▪ Description : Menangani API transaction.undelete.supplyChain.setMaterialServiceRequisitionDetail Version 1                 |
    +------------------------------------------------------------------------------------------------------------------------------+
    */
            ...
            try {
                $varSysDataProcess =
                    \App\Helpers\ZhtHelper\Logger\Helper_SystemLog::setLogOutputMethodProcessHeader($varUserSession, __CLASS__, __FUNCTION__,
                        'Undelete Material Service Requisition Detail Data (version 1)');
                    ...
                    try {
                        if (!($varDataSend =
                            \App\Helpers\ZhtHelper\System\BackEnd\Helper_API::getEngineDataSend_DataUndelete(
                                $varUserSession,
                                (new \App\Models\Database\SchData_OLTP_SupplyChain\TblMaterialServiceRequisitionDetail())->unsetDataDelete(
                                    $varUserSession,
                                    $varData['recordID']
                                    )
                                )
