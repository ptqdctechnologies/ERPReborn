...
//                     $varDatas = \App\Helpers\ZhtHelper\General\Helper_Array::setRemoveElementByKey(
//                         \App\Helpers\ZhtHelper\General\Helper_HTTPHeader::generateDate($varUserSession), 
//                         'header', 
//                         $varData);
//                 // dd($varDatas);
...
//                     'verify' => false,
//                     'headers' => $varHeaders, 
//                     'body' =>  json_encode($varDatas, true)
//                     //'timeout' => 5,
//                     //'connect_timeout' => 2
//                     ]
//                     );
...
//                 $varReturn = $varResponse->getBody()->getContents();


//                 $varDatax = (json_decode($varReturn, TRUE));
//                 dd($varDatax);
