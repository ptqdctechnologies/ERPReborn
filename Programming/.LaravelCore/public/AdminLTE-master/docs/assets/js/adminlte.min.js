          ...
          return (
            ...
            (n._fixHeight = function () {
              ...
              if (t("body").hasClass(u)) {
                ...
                (t("body").hasClass(C) ||
                  ...
                  (s = e - i - n),
                  t(o + " " + a).css("height", s),
                  "undefined" != typeof t.fn.overlayScrollbars &&
            ...
            (e._jQueryInterface = function (n) {
              return this.each(function () {
                ...
                if (
                  (s || ((s = new e(this, o)), t(this).data(i, s)),
                  "undefined" === s[n])
                )
              ...
              !0 === d && (d = 0),
                !1 !== d &&
                  (l == s.control_sidebar
                    ...
                    : l == s.window
                    ? t(a).css("min-height", l + d - s.header - s.footer)
                    : t(a).css("min-height", l + d - s.header),
                  this._isFooterFixed() &&
                    t(a).css(
                      "min-height",
                      parseFloat(t(a).css("min-height")) + s.footer
                    )),
                t("body").hasClass(g) &&
                  (!1 !== d &&
                    t(a).css("min-height", l + d - s.header - s.footer),
            ...
            (e._jQueryInterface = function (i) {
              return (
                ...
                this.each(function () {
                  ...
                  n || ((n = new e(t(this), s)), t(this).data("lte.layout", n)),
                    "init" === i || "" === i
                      ? n._init()
                      : ("fixLayoutHeight" !== i &&
                          "fixLoginRegisterHeight" !== i) ||
                        n[i]();
                })
              );
            }),
          ...
          return (
            (n.expand = function () {
              this._options.autoCollapseSize &&
                t(window).width() <= this._options.autoCollapseSize &&
                t(r).addClass(h),
            ...
            (e._jQueryInterface = function (i) {
              return this.each(function () {
                ...
                n || ((n = new e(this, s)), t(this).data("lte.pushmenu", n)),
                  "string" == typeof i &&
        ...
        h = (function () {
          ...
          return (
            ...
            (i.toggle = function (e) {
              ...
              if (
                a.is(o) ||
                (n.is(s) || (a = n.parent().find("> " + o)), a.is(o))
              ) {
                e.preventDefault();
            ...
            (i._expandSidebar = function () {
              t("body").hasClass(c) &&
                t(this._config.sidebarButtonSelector).PushMenu("expand");
            }),
            (e._jQueryInterface = function (i) {
              return this.each(function () {
                var n = t(this).data("lte.treeview"),
                  s = t.extend({}, d, t(this).data());
                n || ((n = new e(t(this), s)), t(this).data("lte.treeview", n)),
                  "init" === i && n[i]();
              });
            }),
            e
          ...
          return (
            ...
            (e._jQueryInterface = function (i) {
              return this.each(function () {
                ...
                n || ((n = new e(t(this))), t(this).data("lte.directchat", n)),
                  n[i]();
              });
            }),
            e
            ...
            (e._jQueryInterface = function (i) {
              return this.each(function () {
                var n = t(this).data("lte.todolist"),
                  s = t.extend({}, o, t(this).data());
                n || ((n = new e(t(this), s)), t(this).data("lte.todolist", n)),
                  "init" === i && n[i]();
              });
            }),
            e
              ...
              this._parent
                ...
                this._parent
                  ...
                  .queue(function () {
                    t(this).addClass(d),
                      t("html").addClass(d),
                      t(this).hasClass(a) && t(this).addClass(c),
                      t(this).dequeue();
                  });
                ...
                this._parent
                  ...
                  .queue(function () {
                    t(this).removeClass(d),
                      ...
                      t(this).css({ height: "inherit", width: "inherit" }),
                      t(this).hasClass(c) && t(this).removeClass(c),
                      t(this).dequeue();
                  });
                  ...
                  function (e) {
                    this._settings.loadInContent &&
                      ("" != this._settings.sourceSelector &&
                        (e = t(e).find(this._settings.sourceSelector).html()),
        ...
        c = (function () {
          ...
          return (
            ...
            (i.fixPosition = function () {
              ...
              if (0 !== e.length) {
                e.hasClass(r)
                  ? (e.css("left", "inherit"), e.css("right", 0))
                  : (e.css("left", 0), e.css("right", "inherit"));
                var i = e.offset(),
                  n = e.width(),
                  s = t(window).width() - i.left;
                i.left < 0
                  ? (e.css("left", "inherit"), e.css("right", i.left - 5))
                  : s < n && (e.css("left", "inherit"), e.css("right", 0));
              }
            }),
            (e._jQueryInterface = function (i) {
              return this.each(function () {
                ...
                n || ((n = new e(t(this), s)), t(this).data("lte.dropdown", n)),
                  ("toggleSubmenu" !== i && "fixPosition" != i) || n[i]();
              });
            }),
            e
          );
            ...
            (i.create = function () {
              ...
              if (null != this._config.image) {
                ...
                null != this._config.imageHeight &&
                  s.height(this._config.imageHeight).width("auto"),
                  i.append(s);
              }
              if (
                (null != this._config.icon &&
                  i.append(
                    t("<i />").addClass("mr-2").addClass(this._config.icon)
                  ),
                null != this._config.title &&
                  i.append(
                    t("<strong />").addClass("mr-auto").html(this._config.title)
                  ),
              ...
              e.append(i),
                null != this._config.body &&
                  e.append(
                    t('<div class="toast-body" />').html(this._config.body)
                  ),
            ...
            (i._prepareContainer = function () {
              if (0 === t(this._getContainerId()).length) {
                ...
                this._config.position == f
                  ...
                  : this._config.position == g
                  ? e.addClass(d)
                  : this._config.position == p && e.addClass(h),
                  t("body").append(e);
              }
              this._config.fixed
                ? t(this._getContainerId()).addClass("fixed")
                : t(this._getContainerId()).removeClass("fixed");
            }),
