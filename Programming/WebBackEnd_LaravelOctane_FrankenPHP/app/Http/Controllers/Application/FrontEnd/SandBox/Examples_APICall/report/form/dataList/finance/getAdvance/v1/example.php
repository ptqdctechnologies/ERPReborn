...
namespace
    App\Http\Controllers\Application\FrontEnd\SandBox\Examples_APICall\report\form\dataList\finance\getAdvance\v1
        {
        /*
        ┌───────────────┬──────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐
        │ ▪ Class Name  │ example                                                                                                          │
        ...
        class
            example extends \App\Http\Controllers\Controller
                ...
                */
                    ...
                    throughAPIGateway (
                        string $varAPIWebToken = null
                            ...
                            //---> Data Initialization
                                ...
                                if (!$varAPIWebToken) {
                                    $varAPIWebToken =
                                        \App\Http\Helpers\ZhtHelper\General\System\Helper_API::getAPIWebToken_System ();
                                    }

                                //---> Initializing : $varUserSession
                                $varUserSession =
                                    \App\Http\Helpers\ZhtHelper\General\System\Helper_API::getUserSessionIDByAPIWebToken (
                                        $varAPIWebToken
                                        );

                            //---> Data Process
                                try {
                                    \App\Http\Helpers\ZhtHelper\General\System\Helper_API::setCallAPIGateway (
                                        //-----[ METADATA ]-----( START )-----
                                            $varUserSession,
                                            $varAPIWebToken,
                ...
                ├───────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
                │ ▪ Call URL        │ http(s)://<HOST>/report.form.dataList.finance.getAdvance.v1_throughAPIGatewayJQuery                  │
                │                   │    ► http://172.28.0.4/report.form.dataList.finance.getAdvance.v1_throughAPIGatewayJQuery            │
                ├───────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
                │ ▪ Version         │ 1.0000.0000001                                                                                       │
                │ ▪ Last Update     │ 2025-12-23                                                                                           │
                │ ▪ Creation Date   │ 2025-11-05                                                                                           │
