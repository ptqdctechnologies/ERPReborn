 ...
 * @method \Aws\Result associateStreamForSegments(array $args = [])
 * @phpstan-method \Aws\Result associateStreamForSegments(array{DomainName?: string, DestinationArn?: string, DestinationRoleArn?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise associateStreamForSegmentsAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise associateStreamForSegmentsAsync(array{DomainName?: string, DestinationArn?: string, DestinationRoleArn?: string, ...} $args = [])
 ...
 *     Statistic?: 'AVERAGE'|'COUNT'|'FIRST_OCCURRENCE'|'LAST_OCCURRENCE'|'MAXIMUM'|'MAX_OCCURRENCE'|'MINIMUM'|'RECENT_OCCURRENCES'|'SUM',
 ...
 * @method \Aws\Result deleteSegmentSubscription(array $args = [])
 * @phpstan-method \Aws\Result deleteSegmentSubscription(array{DomainName?: string, SegmentDefinitionName?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteSegmentSubscriptionAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise deleteSegmentSubscriptionAsync(array{DomainName?: string, SegmentDefinitionName?: string, ...} $args = [])
 ...
 * @method \Aws\Result disassociateStreamForSegments(array $args = [])
 * @phpstan-method \Aws\Result disassociateStreamForSegments(array{DomainName?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise disassociateStreamForSegmentsAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise disassociateStreamForSegmentsAsync(array{DomainName?: string, ...} $args = [])
 ...
 * @method \Aws\Result getSegmentSubscription(array $args = [])
 * @phpstan-method \Aws\Result getSegmentSubscription(array{DomainName?: string, SegmentDefinitionName?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getSegmentSubscriptionAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getSegmentSubscriptionAsync(array{DomainName?: string, SegmentDefinitionName?: string, ...} $args = [])
 ...
 *     ...,
 * } $args = [])
 * @method \Aws\Result getStreamForSegments(array $args = [])
 * @phpstan-method \Aws\Result getStreamForSegments(array{DomainName?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getStreamForSegmentsAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getStreamForSegmentsAsync(array{DomainName?: string, ...} $args = [])
 ...
 * @method \Aws\Result listSegmentSubscriptionEvents(array $args = [])
 * @phpstan-method \Aws\Result listSegmentSubscriptionEvents(array{DomainName?: string, SegmentDefinitionName?: string, MaxResults?: int, NextToken?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise listSegmentSubscriptionEventsAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise listSegmentSubscriptionEventsAsync(array{DomainName?: string, SegmentDefinitionName?: string, MaxResults?: int, NextToken?: string, ...} $args = [])
 ...
 *     ...,
 * } $args = [])
 * @method \Aws\Result putSegmentSubscription(array $args = [])
 * @phpstan-method \Aws\Result putSegmentSubscription(array{
 *     DomainName?: string,
 *     SegmentDefinitionName?: string,
 *     ScheduleConfiguration?: array{Interval?: int, Unit?: 'HOURLY', ...},
 *     ...,
 * } $args = [])
 * @method \GuzzleHttp\Promise\Promise putSegmentSubscriptionAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise putSegmentSubscriptionAsync(array{
 *     DomainName?: string,
 *     SegmentDefinitionName?: string,
 *     ScheduleConfiguration?: array{Interval?: int, Unit?: 'HOURLY', ...},
 *     ...,
