 ...
 * @phpstan-method \Aws\Result associateVirtualMachinesToExadbVmCluster(array{exadbVmClusterId?: string, desiredNodeCount?: int, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise associateVirtualMachinesToExadbVmClusterAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise associateVirtualMachinesToExadbVmClusterAsync(array{exadbVmClusterId?: string, desiredNodeCount?: int, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result createExadbVmCluster(array{
 *     displayName?: string,
 ...
 *     shapeAttribute?: 'BLOCK_STORAGE'|'SMART_STORAGE',
 *     systemVersion?: string,
 *     tags?: array<string, string>,
 *     timeZone?: string,
 *     clientToken?: string,
 ...
 * @phpstan-method \GuzzleHttp\Promise\Promise createExadbVmClusterAsync(array{
 *     displayName?: string,
 *     enabledEcpuCount?: int,
 *     exascaleDbStorageVaultId?: string,
 *     gridImageId?: string,
 ...
 * @phpstan-method \Aws\Result createExascaleDbStorageVault(array{
 *     displayName?: string,
 ...
 * @phpstan-method \GuzzleHttp\Promise\Promise createExascaleDbStorageVaultAsync(array{
 *     displayName?: string,
 *     highCapacityDatabaseStorageTotalSizeInGBs?: int,
 *     additionalFlashCacheInPercent?: int,
 *     autoscaleLimitInGBs?: int,
 ...
 * @phpstan-method \Aws\Result deleteExadbVmCluster(array{exadbVmClusterId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteExadbVmClusterAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise deleteExadbVmClusterAsync(array{exadbVmClusterId?: string, ...} $args = [])
 * @method \Aws\Result deleteExascaleDbStorageVault(array $args = [])
 * @phpstan-method \Aws\Result deleteExascaleDbStorageVault(array{exascaleDbStorageVaultId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteExascaleDbStorageVaultAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise deleteExascaleDbStorageVaultAsync(array{exascaleDbStorageVaultId?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result disassociateVirtualMachinesFromExadbVmCluster(array{exadbVmClusterId?: string, dbNodeIds?: list<string>, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise disassociateVirtualMachinesFromExadbVmClusterAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise disassociateVirtualMachinesFromExadbVmClusterAsync(array{exadbVmClusterId?: string, dbNodeIds?: list<string>, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result getDbNode(array{cloudVmClusterId?: string, exadbVmClusterId?: string, dbNodeId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getDbNodeAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getDbNodeAsync(array{cloudVmClusterId?: string, exadbVmClusterId?: string, dbNodeId?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result getExadbVmCluster(array{exadbVmClusterId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getExadbVmClusterAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getExadbVmClusterAsync(array{exadbVmClusterId?: string, ...} $args = [])
 * @method \Aws\Result getExascaleDbStorageVault(array $args = [])
 * @phpstan-method \Aws\Result getExascaleDbStorageVault(array{exascaleDbStorageVaultId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getExascaleDbStorageVaultAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getExascaleDbStorageVaultAsync(array{exascaleDbStorageVaultId?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result listDbNodes(array{maxResults?: int, nextToken?: string, cloudVmClusterId?: string, exadbVmClusterId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise listDbNodesAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise listDbNodesAsync(array{maxResults?: int, nextToken?: string, cloudVmClusterId?: string, exadbVmClusterId?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result listDbSystemShapes(array{
 *     maxResults?: int,
 *     nextToken?: string,
 *     availabilityZone?: string,
 *     availabilityZoneId?: string,
 ...
 * @phpstan-method \GuzzleHttp\Promise\Promise listDbSystemShapesAsync(array{
 *     maxResults?: int,
 *     nextToken?: string,
 *     availabilityZone?: string,
 *     availabilityZoneId?: string,
 ...
 * @phpstan-method \Aws\Result listExadbVmClusters(array{exascaleDbStorageVaultId?: string, maxResults?: int, nextToken?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise listExadbVmClustersAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise listExadbVmClustersAsync(array{exascaleDbStorageVaultId?: string, maxResults?: int, nextToken?: string, ...} $args = [])
 * @method \Aws\Result listExascaleDbStorageVaults(array $args = [])
 * @phpstan-method \Aws\Result listExascaleDbStorageVaults(array{maxResults?: int, nextToken?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise listExascaleDbStorageVaultsAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise listExascaleDbStorageVaultsAsync(array{maxResults?: int, nextToken?: string, ...} $args = [])
 * @method \Aws\Result listFlexComponents(array $args = [])
 * @phpstan-method \Aws\Result listFlexComponents(array{maxResults?: int, nextToken?: string, shape?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise listFlexComponentsAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise listFlexComponentsAsync(array{maxResults?: int, nextToken?: string, shape?: string, ...} $args = [])
 * @method \Aws\Result listGiMinorVersions(array $args = [])
 * @phpstan-method \Aws\Result listGiMinorVersions(array{
 *     giVersion?: string,
 *     maxResults?: int,
 *     nextToken?: string,
 *     shapeFamily?: string,
 ...
 * @phpstan-method \GuzzleHttp\Promise\Promise listGiMinorVersionsAsync(array{
 *     giVersion?: string,
 *     maxResults?: int,
 *     nextToken?: string,
 *     shapeFamily?: string,
 ...
 * @phpstan-method \Aws\Result rebootDbNode(array{cloudVmClusterId?: string, exadbVmClusterId?: string, dbNodeId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise rebootDbNodeAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise rebootDbNodeAsync(array{cloudVmClusterId?: string, exadbVmClusterId?: string, dbNodeId?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result startDbNode(array{cloudVmClusterId?: string, exadbVmClusterId?: string, dbNodeId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise startDbNodeAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise startDbNodeAsync(array{cloudVmClusterId?: string, exadbVmClusterId?: string, dbNodeId?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result stopDbNode(array{cloudVmClusterId?: string, exadbVmClusterId?: string, dbNodeId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise stopDbNodeAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise stopDbNodeAsync(array{cloudVmClusterId?: string, exadbVmClusterId?: string, dbNodeId?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result updateExadbVmCluster(array{
 ...
 *     systemVersion?: string,
 *     totalEcpuCount?: int,
 *     updateAction?: 'NON_ROLLING_APPLY'|'PRECHECK'|'ROLLBACK'|'ROLLING_APPLY',
 *     vmFileSystemStorageTotalSizeInGBs?: int,
 *     ...,
 * } $args = [])
 * @method \GuzzleHttp\Promise\Promise updateExadbVmClusterAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise updateExadbVmClusterAsync(array{
 *     exadbVmClusterId?: string,
 *     dataCollectionOptions?: array{isDiagnosticsEventsEnabled?: bool, isHealthMonitoringEnabled?: bool, isIncidentLogsEnabled?: bool, ...},
 *     displayName?: string,
 *     enabledEcpuCount?: int,
 ...
 * @phpstan-method \Aws\Result updateExascaleDbStorageVault(array{
 *     exascaleDbStorageVaultId?: string,
 *     additionalFlashCacheInPercent?: int,
 *     autoscaleLimitInGBs?: int,
 *     description?: string,
 ...
 * @phpstan-method \GuzzleHttp\Promise\Promise updateExascaleDbStorageVaultAsync(array{
 *     exascaleDbStorageVaultId?: string,
 *     additionalFlashCacheInPercent?: int,
 *     autoscaleLimitInGBs?: int,
 *     description?: string,
