 ...
 * @phpstan-method \Aws\Result createWhatsAppDataset(array{id?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise createWhatsAppDatasetAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise createWhatsAppDatasetAsync(array{id?: string, ...} $args = [])
 ...
 * @method \Aws\Result getWhatsAppBusinessPublicKey(array $args = [])
 ...
 * @method \Aws\Result putWhatsAppBusinessPublicKey(array $args = [])
 ...
 * @phpstan-method \GuzzleHttp\Promise\Promise sendWhatsAppConversionEventAsync(array{id?: string, datasetId?: string, eventData?: string|resource|\Psr\Http\Message\StreamInterface, ...} $args = [])
