 ...
 * @phpstan-method \Aws\Result batchDeleteMemoryRecords(array{memoryId?: string, records?: list<array{memoryRecordId?: string, namespace?: string, ...}>, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise batchDeleteMemoryRecordsAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise batchDeleteMemoryRecordsAsync(array{memoryId?: string, records?: list<array{memoryRecordId?: string, namespace?: string, ...}>, ...} $args = [])
 ...
 *     payload?: list<array{conversational?: array, blob?: array, json?: array, ...}>,
 *     branch?: array{rootEventId?: string, name?: string, ...},
 *     clientToken?: string,
 *     metadata?: array<string, array{stringValue?: string, ...}>,
 *     extractionMode?: 'SKIP',
 *     extractionConfig?: array{namespaceVariables?: array<string, string>, ...},
 *     ...,
 * } $args = [])
 ...
 * @phpstan-method \Aws\Result deleteCapacityProviderSession(array{capacityProviderId?: string, sessionId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteCapacityProviderSessionAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise deleteCapacityProviderSessionAsync(array{capacityProviderId?: string, sessionId?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result deleteMemoryRecord(array{memoryId?: string, memoryRecordId?: string, namespace?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteMemoryRecordAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise deleteMemoryRecordAsync(array{memoryId?: string, memoryRecordId?: string, namespace?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result getMemoryRecord(array{memoryId?: string, memoryRecordId?: string, namespace?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getMemoryRecordAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getMemoryRecordAsync(array{memoryId?: string, memoryRecordId?: string, namespace?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result ingestData(array{
 *     memoryId?: string,
 *     source?: array{inline?: array{payload?: list<array>, ...}, ...},
 *     contentTimestamp?: int|string|\DateTimeInterface,
 *     actorId?: string,
 *     sessionId?: string,
 *     extractionConfig?: array{namespaceVariables?: array<string, string>, ...},
 *     metadata?: array<string, array{stringValue?: string, ...}>,
 ...
 * @phpstan-method \GuzzleHttp\Promise\Promise ingestDataAsync(array{
 *     memoryId?: string,
 *     source?: array{inline?: array{payload?: list<array>, ...}, ...},
 *     contentTimestamp?: int|string|\DateTimeInterface,
 *     actorId?: string,
 ...
 *     paymentInput?: array{
 *         cryptoX402?: array{version?: string, payload?: array, permit2AllowanceLimit?: string, ...},
 *         mpp?: array{version?: string, wwwAuthenticateHeaders?: list<string>, buyerPaysGasFees?: bool, ...},
 *         ...,
 *     },
 *     clientToken?: string,
 *     ...,
