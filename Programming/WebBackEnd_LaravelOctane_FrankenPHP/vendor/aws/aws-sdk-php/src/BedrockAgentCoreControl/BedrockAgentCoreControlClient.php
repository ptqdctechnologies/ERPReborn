 ...
 * @phpstan-method \Aws\Result batchPutGatewayRateLimits(array{
 *     gatewayIdentifier?: string,
 *     clientToken?: string,
 *     rateLimits?: list<array{rateLimitId?: string, description?: string, dimensionKeys?: list<string>, entries?: list<array>, ...}>,
 *     ...,
 * } $args = [])
 * @method \GuzzleHttp\Promise\Promise batchPutGatewayRateLimitsAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise batchPutGatewayRateLimitsAsync(array{
 *     gatewayIdentifier?: string,
 *     clientToken?: string,
 *     rateLimits?: list<array{rateLimitId?: string, description?: string, dimensionKeys?: list<string>, entries?: list<array>, ...}>,
 *     ...,
 ...
 *         s3FilesAccessPoint?: array,
 *         efsAccessPoint?: array,
 *         capacityProviderVolume?: array,
 *         ...,
 *     }>,
 ...
 *     name?: string,
 *     description?: string,
 *     permissionsConfiguration?: array{capacityProviderOperatorRoleArn?: string, ...},
 *     clientToken?: string,
 *     tags?: array<string, string>,
 *     computeConfiguration?: array{
 *         ec2Configuration?: array{
 *             launchTemplateSource?: array,
 ...
 *     ...,
 * } $args = [])
 * @method \Aws\Result createConsentPortal(array $args = [])
 * @phpstan-method \Aws\Result createConsentPortal(array{
 *     executionRoleArn?: string,
 *     idpConfig?: array{credentialProviderArn?: string, scopes?: list<string>, audience?: string, ...},
 *     name?: string,
 *     sources?: list<array{identifier?: string, type?: 'agentcore-gateway', ...}>,
 *     description?: string,
 *     tags?: array<string, string>,
 *     ...,
 * } $args = [])
 * @method \GuzzleHttp\Promise\Promise createConsentPortalAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise createConsentPortalAsync(array{
 *     executionRoleArn?: string,
 *     idpConfig?: array{credentialProviderArn?: string, scopes?: list<string>, audience?: string, ...},
 *     name?: string,
 *     sources?: list<array{identifier?: string, type?: 'agentcore-gateway', ...}>,
 ...
 *         derived?: array{baseEvaluatorId?: string, modelConfig?: array, ...},
 *         ...,
 *     },
 ...
 * @phpstan-method \Aws\Result createGatewayRateLimit(array{
 *     gatewayIdentifier?: string,
 *     clientToken?: string,
 *     rateLimitId?: string,
 *     description?: string,
 ...
 * @phpstan-method \GuzzleHttp\Promise\Promise createGatewayRateLimitAsync(array{
 *     gatewayIdentifier?: string,
 *     clientToken?: string,
 *     rateLimitId?: string,
 *     description?: string,
 ...
 *             ...,
 *         },
 *         http?: array{agentcoreRuntime?: array, passthrough?: array, connector?: array, ...},
 ...
 *     namespaceKeys?: list<array{key?: string, validation?: array, ...}>,
 ...
 *         cloudWatchLogs?: array{logGroupNames?: list<string>, logGroupNamePrefixes?: list<string>, serviceNames?: list<string>, ...},
 *         ...,
 *     },
 ...
 * @phpstan-method \Aws\Result deleteAgentRuntime(array{agentRuntimeId?: string, agentRuntimeVersion?: string, clientToken?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteAgentRuntimeAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise deleteAgentRuntimeAsync(array{agentRuntimeId?: string, agentRuntimeVersion?: string, clientToken?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result deleteCapacityProvider(array{capacityProviderId?: string, clientToken?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteCapacityProviderAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise deleteCapacityProviderAsync(array{capacityProviderId?: string, clientToken?: string, ...} $args = [])
 ...
 * @method \Aws\Result deleteConsentPortal(array $args = [])
 * @phpstan-method \Aws\Result deleteConsentPortal(array{consentPortalIdentifier?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteConsentPortalAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise deleteConsentPortalAsync(array{consentPortalIdentifier?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result deleteGatewayRateLimit(array{gatewayIdentifier?: string, rateLimitId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteGatewayRateLimitAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise deleteGatewayRateLimitAsync(array{gatewayIdentifier?: string, rateLimitId?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result getCapacityProvider(array{capacityProviderId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getCapacityProviderAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getCapacityProviderAsync(array{capacityProviderId?: string, ...} $args = [])
 ...
 * @method \Aws\Result getConsentPortal(array $args = [])
 * @phpstan-method \Aws\Result getConsentPortal(array{consentPortalIdentifier?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getConsentPortalAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getConsentPortalAsync(array{consentPortalIdentifier?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result getGatewayRateLimit(array{gatewayIdentifier?: string, rateLimitId?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getGatewayRateLimitAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getGatewayRateLimitAsync(array{gatewayIdentifier?: string, rateLimitId?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result listAgentRuntimeVersionsByCapacityProvider(array{capacityProviderId?: string, maxResults?: int, nextToken?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise listAgentRuntimeVersionsByCapacityProviderAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise listAgentRuntimeVersionsByCapacityProviderAsync(array{capacityProviderId?: string, maxResults?: int, nextToken?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result listCapacityProviders(array{maxResults?: int, nextToken?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise listCapacityProvidersAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise listCapacityProvidersAsync(array{maxResults?: int, nextToken?: string, ...} $args = [])
 ...
 * @method \Aws\Result listConsentPortals(array $args = [])
 * @phpstan-method \Aws\Result listConsentPortals(array{maxResults?: int, nextToken?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise listConsentPortalsAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise listConsentPortalsAsync(array{maxResults?: int, nextToken?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result listGatewayRateLimits(array{gatewayIdentifier?: string, maxResults?: int, nextToken?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise listGatewayRateLimitsAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise listGatewayRateLimitsAsync(array{gatewayIdentifier?: string, maxResults?: int, nextToken?: string, ...} $args = [])
 ...
 *     ...,
 * } $args = [])
 * @method \Aws\Result updateConsentPortal(array $args = [])
 * @phpstan-method \Aws\Result updateConsentPortal(array{
 ...
 *     ...,
 * } $args = [])
 * @method \GuzzleHttp\Promise\Promise updateConsentPortalAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise updateConsentPortalAsync(array{
 *     consentPortalIdentifier?: string,
 *     executionRoleArn?: string,
 *     idpConfig?: array{credentialProviderArn?: string, scopes?: list<string>, audience?: string, ...},
 *     description?: string,
 ...
 * @phpstan-method \Aws\Result updateGatewayRateLimit(array{
 *     gatewayIdentifier?: string,
 *     rateLimitId?: string,
 *     description?: string,
 *     entries?: list<array{
 ...
 * @phpstan-method \GuzzleHttp\Promise\Promise updateGatewayRateLimitAsync(array{
 *     gatewayIdentifier?: string,
 *     rateLimitId?: string,
 *     description?: string,
 *     entries?: list<array{
