 ...
 * @phpstan-method \Aws\Result describeAssessment(array{Catalog?: string, AssessmentIdentifier?: string, MaxResults?: int, NextToken?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise describeAssessmentAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise describeAssessmentAsync(array{Catalog?: string, AssessmentIdentifier?: string, MaxResults?: int, NextToken?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result listAssessments(array{
 *     Catalog?: string,
 *     FrameworkId?: string,
 *     AssessmentTargetFilter?: array{EntityId?: string, ChangeSetId?: string, ...},
 *     FrameworkFilters?: array{
 *         AMISecurityFilters?: array{DeliveryOptionId?: string, ...},
 *         ContainerSecurityFilters?: array{DeliveryOptionId?: string, ...},
 *         ...,
 *     },
 *     MaxResults?: int,
 *     NextToken?: string,
 ...
 * @phpstan-method \GuzzleHttp\Promise\Promise listAssessmentsAsync(array{
 *     Catalog?: string,
 *     FrameworkId?: string,
 *     AssessmentTargetFilter?: array{EntityId?: string, ChangeSetId?: string, ...},
 *     FrameworkFilters?: array{
 ...
 *             OfferSetId?: array,
 *             TargetAgreementId?: array,
 *             TargetAgreementIntent?: array,
 *             CreatedBySource?: array,
 *             ...,
 *         },
 ...
 *         },
 *         OfferSort?: array{
 *             SortBy?: 'AvailabilityEndDate'|'BuyerAccounts'|'CreatedBySource'|'EntityId'|'LastModifiedDate'|'Name'|'OfferSetId'|'ProductId'|'ReleaseDate'|'ResaleAuthorizationId'|'State'|'TargetAgreementId'|'TargetAgreementIntent'|'Targeting',
 *             SortOrder?: 'ASCENDING'|'DESCENDING',
 *             ...,
 *         },
