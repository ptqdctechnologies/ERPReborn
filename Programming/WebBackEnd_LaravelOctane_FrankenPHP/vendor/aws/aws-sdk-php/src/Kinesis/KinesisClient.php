 ...
 *     StreamConfigurationList?: list<array{StreamARN?: string, RecordConfiguration?: array, ...}>,
 *     S3DestinationConfiguration?: array{
 *         DataFreshnessInSeconds?: int,
 *         DeadLetterQueueS3Configuration?: array{BucketARN?: string, ExpectedBucketOwner?: string, ErrorOutputPrefix?: string, ...},
 ...
 *         ...,
 *     },
 *     S3TablesDestinationConfiguration?: array{
 *         DataFreshnessInSeconds?: int,
 *         DeadLetterQueueS3Configuration?: array{BucketARN?: string, ExpectedBucketOwner?: string, ErrorOutputPrefix?: string, ...},
 *         S3TablesConfigurationList?: list<array>,
 *         ...,
 *     },
 *     EncryptionConfiguration?: array{EncryptionType?: 'KMS', KeyId?: string, ...},
 *     Tags?: array<string, string>,
 *     LoggingConfiguration?: array{CloudWatchLogs?: array{Enabled?: bool, LogGroupName?: string, LogStreamName?: string, ...}, ...},
 *     ...,
 * } $args = [])
 ...
 * @phpstan-method \Aws\Result deleteChannel(array{ChannelARN?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise deleteChannelAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise deleteChannelAsync(array{ChannelARN?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result describeChannel(array{ChannelARN?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise describeChannelAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise describeChannelAsync(array{ChannelARN?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result getRecords(array{ShardIterator?: string, Limit?: int, StreamARN?: string, StreamId?: string, DryRun?: bool, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getRecordsAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getRecordsAsync(array{ShardIterator?: string, Limit?: int, StreamARN?: string, StreamId?: string, DryRun?: bool, ...} $args = [])
 ...
 *     StreamFilter?: list<array{StreamARN?: string, StreamCreationTimestamp?: int|string|\DateTimeInterface, ...}>,
 *     MaxResults?: int,
 *     NextToken?: string,
 *     ...,
 * } $args = [])
 ...
 *     ChannelARN?: string,
 *     S3DestinationConfiguration?: array{DataFreshnessInSeconds?: int, ...},
 *     S3TablesDestinationConfiguration?: array{DataFreshnessInSeconds?: int, ...},
 *     LoggingConfiguration?: array{CloudWatchLogs?: array{Enabled?: bool, LogGroupName?: string, LogStreamName?: string, ...}, ...},
 *     ...,
 * } $args = [])
