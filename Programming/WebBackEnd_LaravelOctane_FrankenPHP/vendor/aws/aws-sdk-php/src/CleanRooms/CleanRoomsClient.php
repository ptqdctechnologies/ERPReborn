 ...
 *     members?: list<array{
 *         accountId?: string,
 *         memberAbilities?: list<'CAN_EXPORT_QUERY_ANALYSIS_LOG'|'CAN_QUERY'|'CAN_RECEIVE_RESULTS'|'CAN_RUN_JOB'>,
 ...
 *     name?: string,
 *     description?: string,
 *     creatorMemberAbilities?: list<'CAN_EXPORT_QUERY_ANALYSIS_LOG'|'CAN_QUERY'|'CAN_RECEIVE_RESULTS'|'CAN_RUN_JOB'>,
 ...
 *     autoApprovedChangeRequestTypes?: list<'ADD_MEMBER'|'GRANT_EXPORT_QUERY_ANALYSIS_LOG_ABILITY'|'GRANT_RECEIVE_RESULTS_ABILITY'|'REVOKE_EXPORT_QUERY_ANALYSIS_LOG_ABILITY'|'REVOKE_RECEIVE_RESULTS_ABILITY'>,
 ...
 * @phpstan-method \Aws\Result getAnalysisLogExport(array{membershipIdentifier?: string, analysisLogExportIdentifier?: string, ...} $args = [])
 * @method \GuzzleHttp\Promise\Promise getAnalysisLogExportAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise getAnalysisLogExportAsync(array{membershipIdentifier?: string, analysisLogExportIdentifier?: string, ...} $args = [])
 ...
 * @phpstan-method \Aws\Result listAnalysisLogExports(array{
 *     membershipIdentifier?: string,
 ...
 * @phpstan-method \GuzzleHttp\Promise\Promise listAnalysisLogExportsAsync(array{
 *     membershipIdentifier?: string,
 *     analysisIdentifier?: string,
 *     status?: 'FAILED'|'IN_PROGRESS'|'SUCCESS',
 *     nextToken?: string,
 ...
 *         queryComputeConfiguration?: array{type?: 'CR.1X'|'CR.4X'|'CR.8X', number?: int, properties?: array, ...},
 *         ...,
 *     },
 ...
 * @phpstan-method \Aws\Result startAnalysisLogExport(array{
 *     membershipIdentifier?: string,
 *     analysisId?: string,
 *     analysisType?: 'PROTECTED_QUERY',
 *     resultConfiguration?: array{outputConfiguration?: array{s3?: array, ...}, ...},
 *     ...,
 * } $args = [])
 * @method \GuzzleHttp\Promise\Promise startAnalysisLogExportAsync(array $args = [])
 * @phpstan-method \GuzzleHttp\Promise\Promise startAnalysisLogExportAsync(array{
 *     membershipIdentifier?: string,
 *     analysisId?: string,
 *     analysisType?: 'PROTECTED_QUERY',
 *     resultConfiguration?: array{outputConfiguration?: array{s3?: array, ...}, ...},
 ...
 *         ...,
 *     },
 *     computeConfiguration?: array{worker?: array{type?: 'CR.1X'|'CR.4X'|'CR.8X', number?: int, properties?: array, ...}, ...},
