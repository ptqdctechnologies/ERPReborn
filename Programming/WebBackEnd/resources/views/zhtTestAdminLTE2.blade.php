...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('AdminLTE-master/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('AdminLTE-master/plugins/bs-stepper/css/bs-stepper.min.css') }}">
    <link rel="stylesheet" href="{{ asset('AdminLTE-master/plugins/dropzone/min/dropzone.min.css') }}">
...
<body class="sidebar-mini sidebar-closed sidebar-collapse" style="height: auto;">
    ...
    <script src="{{ asset('AdminLTE-master/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js') }}"></script>
    ...
    <script src="{{ asset('AdminLTE-master/plugins/bs-stepper/js/bs-stepper.min.js') }}"></script>
    <script src="{{ asset('AdminLTE-master/plugins/dropzone/min/dropzone.min.js') }}"></script>
