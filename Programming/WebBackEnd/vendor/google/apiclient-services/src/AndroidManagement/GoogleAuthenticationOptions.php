...
class GoogleAuthenticationOptions extends \Google\Model
{
  /**
   * The setting googleAuthenticationSettings for the enterprise that this
   * enrollment token belongs to is used to determine whether the user needs to
   ...
   * during enrollment. This field can only be set if AuthenticationRequirement
   * is set to REQUIRED.
   *
   * @var string
   */
...
class_alias(GoogleAuthenticationOptions::class, 'Google_Service_AndroidManagement_GoogleAuthenticationOptions');
