...
class EnrollmentToken extends \Google\Model
{
  ...
  protected $googleAuthenticationOptionsType = GoogleAuthenticationOptions::class;
   ...
   *
   * @param GoogleAuthenticationOptions $googleAuthenticationOptions
   */
  public function setGoogleAuthenticationOptions(GoogleAuthenticationOptions $googleAuthenticationOptions)
  {
