 ...
 *   $locations = $cloudnumberregistryService->organizations_locations;
 *  </code>
 */
...
class_alias(OrganizationsLocations::class, 'Google_Service_CloudNumberRegistry_Resource_OrganizationsLocations');
