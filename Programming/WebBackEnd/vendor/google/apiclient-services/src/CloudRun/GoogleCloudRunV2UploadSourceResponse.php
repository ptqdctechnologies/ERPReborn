...
class GoogleCloudRunV2UploadSourceResponse extends \Google\Model
{
...
class_alias(GoogleCloudRunV2UploadSourceResponse::class, 'Google_Service_CloudRun_GoogleCloudRunV2UploadSourceResponse');
