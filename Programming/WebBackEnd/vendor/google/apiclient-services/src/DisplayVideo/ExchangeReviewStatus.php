...
class ExchangeReviewStatus extends \Google\Model
{
   ...
   */
  public const STATUS_REVIEW_STATUS_UNSPECIFIED = 'REVIEW_STATUS_UNSPECIFIED';
  /**
   * The creative is approved.
   */
  public const STATUS_REVIEW_STATUS_APPROVED = 'REVIEW_STATUS_APPROVED';
  /**
   * The creative is rejected.
   */
  public const STATUS_REVIEW_STATUS_REJECTED = 'REVIEW_STATUS_REJECTED';
  /**
   * The creative is pending review.
   */
  public const STATUS_REVIEW_STATUS_PENDING = 'REVIEW_STATUS_PENDING';
  /**
