...
class RetrievePlannableUserInterestsResponse extends \Google\Collection
{
  protected $collection_key = 'plannableUserInterests';
  protected $plannableUserInterestsType = PlannableUserInterest::class;
  protected $plannableUserInterestsDataType = 'array';

  /**
   * The list of plannable user interests (Google Audiences).
   *
   * @param PlannableUserInterest[] $plannableUserInterests
   */
...
class_alias(RetrievePlannableUserInterestsResponse::class, 'Google_Service_DisplayVideo_RetrievePlannableUserInterestsResponse');
