...
class GuaranteedOrder extends \Google\Collection
{
   ...
   * there is no default advertiser.
   *
   * @param string $defaultAdvertiserId
   */
   ...
   * SDF and UI.
   *
   * @param string $legacyGuaranteedOrderId
   */
   ...
   * the default advertiser of the guaranteed order.
   *
   * @param string $readWriteAdvertiserId
   */
   ...
   * The partner with read/write access to the guaranteed order.
   *
   * @param string $readWritePartnerId
   */
   ...
   *
   * @param GuaranteedOrderStatus $status
   */
