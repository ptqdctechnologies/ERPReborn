 ...
 *   $dbControlComplianceSummaries = $assuredworkloadsService->folders_locations_dbFrameworkComplianceReports_dbControlComplianceSummaries;
 *  </code>
 */
class FoldersLocationsDbFrameworkComplianceReportsDbControlComplianceSummaries extends \Google\Service\Resource
{
  /**
   * Lists the control compliance summary for a given scope. (dbControlComplianceS
   * ummaries.listFoldersLocationsDbFrameworkComplianceReportsDbControlComplianceS
   * ummaries)
   *
   ...
   */
  public function listFoldersLocationsDbFrameworkComplianceReportsDbControlComplianceSummaries($parent, $optParams = [])
  {
...
class_alias(FoldersLocationsDbFrameworkComplianceReportsDbControlComplianceSummaries::class, 'Google_Service_Assuredworkloads_Resource_FoldersLocationsDbFrameworkComplianceReportsDbControlComplianceSummaries');
