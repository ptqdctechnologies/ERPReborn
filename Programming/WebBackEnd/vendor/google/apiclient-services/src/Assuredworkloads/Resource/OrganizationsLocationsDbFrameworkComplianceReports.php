 ...
 *   $dbFrameworkComplianceReports = $assuredworkloadsService->organizations_locations_dbFrameworkComplianceReports;
 *  </code>
 */
class OrganizationsLocationsDbFrameworkComplianceReports extends \Google\Service\Resource
{
  /**
...
class_alias(OrganizationsLocationsDbFrameworkComplianceReports::class, 'Google_Service_Assuredworkloads_Resource_OrganizationsLocationsDbFrameworkComplianceReports');
