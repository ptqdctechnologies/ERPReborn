 ...
 *   $dbFrameworkComplianceSummaries = $assuredworkloadsService->organizations_locations_dbFrameworkComplianceSummaries;
 *  </code>
 */
class OrganizationsLocationsDbFrameworkComplianceSummaries extends \Google\Service\Resource
{
  /**
   * Lists the framework compliance summary for a given scope. (dbFrameworkComplia
   * nceSummaries.listOrganizationsLocationsDbFrameworkComplianceSummaries)
   *
   ...
   */
  public function listOrganizationsLocationsDbFrameworkComplianceSummaries($parent, $optParams = [])
  {
...
class_alias(OrganizationsLocationsDbFrameworkComplianceSummaries::class, 'Google_Service_Assuredworkloads_Resource_OrganizationsLocationsDbFrameworkComplianceSummaries');
