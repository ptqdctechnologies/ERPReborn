 ...
 *   $dbFindingSummaries = $assuredworkloadsService->folders_locations_dbFindingSummaries;
 *  </code>
 */
class FoldersLocationsDbFindingSummaries extends \Google\Service\Resource
{
  /**
   * Lists the finding summary by category for a given scope.
   * (dbFindingSummaries.listFoldersLocationsDbFindingSummaries)
   *
   ...
   */
  public function listFoldersLocationsDbFindingSummaries($parent, $optParams = [])
  {
...
class_alias(FoldersLocationsDbFindingSummaries::class, 'Google_Service_Assuredworkloads_Resource_FoldersLocationsDbFindingSummaries');
