...
class AgentGatewayNetworkConfigEgress extends \Google\Model
{
  /**
...
class_alias(AgentGatewayNetworkConfigEgress::class, 'Google_Service_NetworkServices_AgentGatewayNetworkConfigEgress');
