 ...
 *   $aiApplications = $agentregistryService->projects_locations_aiApplications;
 *  </code>
 */
class ProjectsLocationsAiApplications extends \Google\Service\Resource
{
   ...
   * `PERMISSION_DENIED` errors. (aiApplications.setIamPolicy)
   *
   * @param string $resource REQUIRED: The resource for which the policy is being
   ...
   * (aiApplications.testIamPermissions)
   *
...
class_alias(ProjectsLocationsAiApplications::class, 'Google_Service_AgentRegistry_Resource_ProjectsLocationsAiApplications');
