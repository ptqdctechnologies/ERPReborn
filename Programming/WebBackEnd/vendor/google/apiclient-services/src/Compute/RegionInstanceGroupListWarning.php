...
class RegionInstanceGroupListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = RegionInstanceGroupListWarningData::class;
   ...
   *
   * @param RegionInstanceGroupListWarningData[] $data
   */
...
class_alias(RegionInstanceGroupListWarning::class, 'Google_Service_Compute_RegionInstanceGroupListWarning');
