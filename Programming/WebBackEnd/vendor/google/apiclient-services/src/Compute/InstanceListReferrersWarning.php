...
class InstanceListReferrersWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param InstanceListReferrersWarningData[] $data
   */
...
class_alias(InstanceListReferrersWarning::class, 'Google_Service_Compute_InstanceListReferrersWarning');
