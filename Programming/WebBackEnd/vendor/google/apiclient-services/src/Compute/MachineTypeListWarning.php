...
class MachineTypeListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = MachineTypeListWarningData::class;
   ...
   *
   * @param MachineTypeListWarningData[] $data
   */
...
class_alias(MachineTypeListWarning::class, 'Google_Service_Compute_MachineTypeListWarning');
