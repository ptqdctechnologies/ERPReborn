...
use Google\Service\Compute\ImageView;
use Google\Service\Compute\ImageViewsListResponse;
 ...
 *   $imageViews = $computeService->imageViews;
 *  </code>
 */
class ImageViews extends \Google\Service\Resource
{
  /**
   ...
   * @param string $region Required. Name of the region for this request.
   * @param string $resourceId Name of the image resource to return.
   * @param array $optParams Optional parameters.
   * @return ImageView
   * @throws \Google\Service\Exception
   */
  public function get($project, $region, $resourceId, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region, 'resourceId' => $resourceId];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], ImageView::class);
  }
  /**
   * Returns a list of global ImageView resources, with a regional context.
   * (imageViews.listImageViews)
   *
   * @param string $project Required. Project ID for this request.
   * @param string $region Required. Name of the region for this request.
   * @param array $optParams Optional parameters.
   ...
   * with an error code.
   * @return ImageViewsListResponse
   * @throws \Google\Service\Exception
   */
  public function listImageViews($project, $region, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region];
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], ImageViewsListResponse::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ImageViews::class, 'Google_Service_Compute_Resource_ImageViews');
