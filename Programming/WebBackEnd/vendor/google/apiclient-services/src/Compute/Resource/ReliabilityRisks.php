...
use Google\Service\Compute\ReliabilityRisk;
use Google\Service\Compute\ReliabilityRisksListResponse;
 ...
 *   $reliabilityRisks = $computeService->reliabilityRisks;
 *  </code>
 */
class ReliabilityRisks extends \Google\Service\Resource
{
  /**
   * Returns the specified ReliabilityRisk resource. (reliabilityRisks.get)
   *
   * @param string $project Project ID for this request.
   * @param string $reliabilityRisk Name of the ReliabilityRisk resource to
   * return.
   * @param array $optParams Optional parameters.
   * @return ReliabilityRisk
   * @throws \Google\Service\Exception
   */
  public function get($project, $reliabilityRisk, $optParams = [])
  {
    $params = ['project' => $project, 'reliabilityRisk' => $reliabilityRisk];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], ReliabilityRisk::class);
  }
  /**
   * Retrieves the list of reliabilityRisks available in the specified project.
   * (reliabilityRisks.listReliabilityRisks)
   *
   * @param string $project Project ID for this request.
   * @param array $optParams Optional parameters.
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listReliabilityRisks($project, $optParams = [])
  {
    $params = ['project' => $project];
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], ReliabilityRisksListResponse::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ReliabilityRisks::class, 'Google_Service_Compute_Resource_ReliabilityRisks');
