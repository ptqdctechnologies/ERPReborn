...
use Google\Service\Compute\ManagedRuleset;
use Google\Service\Compute\ManagedRulesetList;
 ...
 *   $managedRulesets = $computeService->managedRulesets;
 *  </code>
 */
class ManagedRulesets extends \Google\Service\Resource
{
  /**
   ...
   * @param string $managedRuleset Name of the managed ruleset to return.
   * @param array $optParams Optional parameters.
   * @return ManagedRuleset
   * @throws \Google\Service\Exception
   */
  public function get($project, $managedRuleset, $optParams = [])
  {
    $params = ['project' => $project, 'managedRuleset' => $managedRuleset];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], ManagedRuleset::class);
  }
  /**
   * Retrieves the list of all the managed rulesets available.
   * (managedRulesets.listManagedRulesets)
   *
   * @param string $project Project ID for this request.
   * @param array $optParams Optional parameters.
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listManagedRulesets($project, $optParams = [])
  {
    $params = ['project' => $project];
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], ManagedRulesetList::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ManagedRulesets::class, 'Google_Service_Compute_Resource_ManagedRulesets');
