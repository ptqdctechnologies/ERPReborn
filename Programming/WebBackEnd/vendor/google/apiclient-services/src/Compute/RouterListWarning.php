...
class RouterListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = RouterListWarningData::class;
   ...
   *
   * @param RouterListWarningData[] $data
   */
...
class_alias(RouterListWarning::class, 'Google_Service_Compute_RouterListWarning');
