...
class ReservationSubBlocksListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = ReservationSubBlocksListResponseWarningData::class;
   ...
   *
   * @param ReservationSubBlocksListResponseWarningData[] $data
   */
  ...
  /**
   * @return ReservationSubBlocksListResponseWarningData[]
   */
...
class_alias(ReservationSubBlocksListResponseWarning::class, 'Google_Service_Compute_ReservationSubBlocksListResponseWarning');
