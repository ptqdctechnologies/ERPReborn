...
class TargetHttpProxiesScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param TargetHttpProxiesScopedListWarningData[] $data
   */
...
class_alias(TargetHttpProxiesScopedListWarning::class, 'Google_Service_Compute_TargetHttpProxiesScopedListWarning');
