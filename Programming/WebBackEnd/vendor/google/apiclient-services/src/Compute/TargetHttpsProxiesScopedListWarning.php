...
class TargetHttpsProxiesScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = TargetHttpsProxiesScopedListWarningData::class;
   ...
   *
   * @param TargetHttpsProxiesScopedListWarningData[] $data
   */
...
class_alias(TargetHttpsProxiesScopedListWarning::class, 'Google_Service_Compute_TargetHttpsProxiesScopedListWarning');
