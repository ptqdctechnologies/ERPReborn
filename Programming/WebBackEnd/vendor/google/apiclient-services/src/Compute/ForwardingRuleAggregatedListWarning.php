...
class ForwardingRuleAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param ForwardingRuleAggregatedListWarningData[] $data
   */
...
class_alias(ForwardingRuleAggregatedListWarning::class, 'Google_Service_Compute_ForwardingRuleAggregatedListWarning');
