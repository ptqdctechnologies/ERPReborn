...
class CompositeHealthCheckAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = CompositeHealthCheckAggregatedListWarningData::class;
   ...
   *
   * @param CompositeHealthCheckAggregatedListWarningData[] $data
   */
  ...
  /**
   * @return CompositeHealthCheckAggregatedListWarningData[]
   */
...
class_alias(CompositeHealthCheckAggregatedListWarning::class, 'Google_Service_Compute_CompositeHealthCheckAggregatedListWarning');
