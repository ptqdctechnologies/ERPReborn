...
class CapacityAdviceRequestInstancePropertiesScheduling extends \Google\Model
{
  /**
...
class_alias(CapacityAdviceRequestInstancePropertiesScheduling::class, 'Google_Service_Compute_CapacityAdviceRequestInstancePropertiesScheduling');
