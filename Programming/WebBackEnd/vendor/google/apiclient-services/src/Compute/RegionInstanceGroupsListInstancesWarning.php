...
class RegionInstanceGroupsListInstancesWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param RegionInstanceGroupsListInstancesWarningData[] $data
   */
...
class_alias(RegionInstanceGroupsListInstancesWarning::class, 'Google_Service_Compute_RegionInstanceGroupsListInstancesWarning');
