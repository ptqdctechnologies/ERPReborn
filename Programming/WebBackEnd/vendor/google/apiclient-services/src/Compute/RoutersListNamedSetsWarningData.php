...
class RoutersListNamedSetsWarningData extends \Google\Model
{
  /**
...
class_alias(RoutersListNamedSetsWarningData::class, 'Google_Service_Compute_RoutersListNamedSetsWarningData');
