...
class VmExtensionPolicyListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = VmExtensionPolicyListWarningData::class;
   ...
   *
   * @param VmExtensionPolicyListWarningData[] $data
   */
  ...
  /**
   * @return VmExtensionPolicyListWarningData[]
   */
...
class_alias(VmExtensionPolicyListWarning::class, 'Google_Service_Compute_VmExtensionPolicyListWarning');
