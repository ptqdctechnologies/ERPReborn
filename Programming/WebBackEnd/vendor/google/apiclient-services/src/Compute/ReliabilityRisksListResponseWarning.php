...
class ReliabilityRisksListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = ReliabilityRisksListResponseWarningData::class;
   ...
   *
   * @param ReliabilityRisksListResponseWarningData[] $data
   */
  ...
  /**
   * @return ReliabilityRisksListResponseWarningData[]
   */
...
class_alias(ReliabilityRisksListResponseWarning::class, 'Google_Service_Compute_ReliabilityRisksListResponseWarning');
