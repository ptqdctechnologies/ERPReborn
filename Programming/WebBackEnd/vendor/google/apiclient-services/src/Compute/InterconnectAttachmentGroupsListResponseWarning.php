...
class InterconnectAttachmentGroupsListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InterconnectAttachmentGroupsListResponseWarningData::class;
   ...
   *
   * @param InterconnectAttachmentGroupsListResponseWarningData[] $data
   */
  ...
  /**
   * @return InterconnectAttachmentGroupsListResponseWarningData[]
   */
...
class_alias(InterconnectAttachmentGroupsListResponseWarning::class, 'Google_Service_Compute_InterconnectAttachmentGroupsListResponseWarning');
