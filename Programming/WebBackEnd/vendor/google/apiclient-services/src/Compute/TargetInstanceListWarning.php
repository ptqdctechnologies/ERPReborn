...
class TargetInstanceListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param TargetInstanceListWarningData[] $data
   */
...
class_alias(TargetInstanceListWarning::class, 'Google_Service_Compute_TargetInstanceListWarning');
