...
class HealthCheckServicesScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = HealthCheckServicesScopedListWarningData::class;
   ...
   *
   * @param HealthCheckServicesScopedListWarningData[] $data
   */
...
class_alias(HealthCheckServicesScopedListWarning::class, 'Google_Service_Compute_HealthCheckServicesScopedListWarning');
