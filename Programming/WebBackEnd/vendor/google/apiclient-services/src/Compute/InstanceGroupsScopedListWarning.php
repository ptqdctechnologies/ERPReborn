...
class InstanceGroupsScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InstanceGroupsScopedListWarningData::class;
   ...
   *
   * @param InstanceGroupsScopedListWarningData[] $data
   */
...
class_alias(InstanceGroupsScopedListWarning::class, 'Google_Service_Compute_InstanceGroupsScopedListWarning');
