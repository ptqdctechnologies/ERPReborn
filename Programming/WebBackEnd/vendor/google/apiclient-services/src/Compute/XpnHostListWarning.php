...
class XpnHostListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param XpnHostListWarningData[] $data
   */
...
class_alias(XpnHostListWarning::class, 'Google_Service_Compute_XpnHostListWarning');
