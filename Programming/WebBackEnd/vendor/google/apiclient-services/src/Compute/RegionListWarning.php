...
class RegionListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param RegionListWarningData[] $data
   */
...
class_alias(RegionListWarning::class, 'Google_Service_Compute_RegionListWarning');
