...
class TargetHttpProxyListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = TargetHttpProxyListWarningData::class;
   ...
   *
   * @param TargetHttpProxyListWarningData[] $data
   */
...
class_alias(TargetHttpProxyListWarning::class, 'Google_Service_Compute_TargetHttpProxyListWarning');
