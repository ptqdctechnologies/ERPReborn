...
class PublicDelegatedPrefixListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param PublicDelegatedPrefixListWarningData[] $data
   */
...
class_alias(PublicDelegatedPrefixListWarning::class, 'Google_Service_Compute_PublicDelegatedPrefixListWarning');
