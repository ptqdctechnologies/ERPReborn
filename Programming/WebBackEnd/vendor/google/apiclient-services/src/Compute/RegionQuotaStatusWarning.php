...
class RegionQuotaStatusWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = RegionQuotaStatusWarningData::class;
   ...
   *
   * @param RegionQuotaStatusWarningData[] $data
   */
  ...
  /**
   * @return RegionQuotaStatusWarningData[]
   */
...
class_alias(RegionQuotaStatusWarning::class, 'Google_Service_Compute_RegionQuotaStatusWarning');
