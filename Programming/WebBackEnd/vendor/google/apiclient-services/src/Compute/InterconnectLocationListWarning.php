...
class InterconnectLocationListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param InterconnectLocationListWarningData[] $data
   */
...
class_alias(InterconnectLocationListWarning::class, 'Google_Service_Compute_InterconnectLocationListWarning');
