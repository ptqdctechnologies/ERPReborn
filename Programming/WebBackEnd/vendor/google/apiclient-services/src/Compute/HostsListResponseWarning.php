...
class HostsListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = HostsListResponseWarningData::class;
   ...
   *
   * @param HostsListResponseWarningData[] $data
   */
  ...
  /**
   * @return HostsListResponseWarningData[]
   */
...
class_alias(HostsListResponseWarning::class, 'Google_Service_Compute_HostsListResponseWarning');
