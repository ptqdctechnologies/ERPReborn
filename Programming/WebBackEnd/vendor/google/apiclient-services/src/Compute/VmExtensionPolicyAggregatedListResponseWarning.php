...
class VmExtensionPolicyAggregatedListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = VmExtensionPolicyAggregatedListResponseWarningData::class;
   ...
   *
   * @param VmExtensionPolicyAggregatedListResponseWarningData[] $data
   */
  ...
  /**
   * @return VmExtensionPolicyAggregatedListResponseWarningData[]
   */
...
class_alias(VmExtensionPolicyAggregatedListResponseWarning::class, 'Google_Service_Compute_VmExtensionPolicyAggregatedListResponseWarning');
