...
class ServiceAttachmentListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = ServiceAttachmentListWarningData::class;
   ...
   *
   * @param ServiceAttachmentListWarningData[] $data
   */
...
class_alias(ServiceAttachmentListWarning::class, 'Google_Service_Compute_ServiceAttachmentListWarning');
