...
class TargetInstanceAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = TargetInstanceAggregatedListWarningData::class;
   ...
   *
   * @param TargetInstanceAggregatedListWarningData[] $data
   */
...
class_alias(TargetInstanceAggregatedListWarning::class, 'Google_Service_Compute_TargetInstanceAggregatedListWarning');
