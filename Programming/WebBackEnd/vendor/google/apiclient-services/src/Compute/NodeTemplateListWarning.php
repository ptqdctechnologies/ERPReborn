...
class NodeTemplateListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NodeTemplateListWarningData::class;
   ...
   *
   * @param NodeTemplateListWarningData[] $data
   */
...
class_alias(NodeTemplateListWarning::class, 'Google_Service_Compute_NodeTemplateListWarning');
