...
class NodeTypeAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param NodeTypeAggregatedListWarningData[] $data
   */
...
class_alias(NodeTypeAggregatedListWarning::class, 'Google_Service_Compute_NodeTypeAggregatedListWarning');
