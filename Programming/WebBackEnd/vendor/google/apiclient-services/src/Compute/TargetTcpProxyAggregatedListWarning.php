...
class TargetTcpProxyAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param TargetTcpProxyAggregatedListWarningData[] $data
   */
...
class_alias(TargetTcpProxyAggregatedListWarning::class, 'Google_Service_Compute_TargetTcpProxyAggregatedListWarning');
