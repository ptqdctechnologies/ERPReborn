...
class InterconnectGroupsListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InterconnectGroupsListResponseWarningData::class;
   ...
   *
   * @param InterconnectGroupsListResponseWarningData[] $data
   */
  ...
  /**
   * @return InterconnectGroupsListResponseWarningData[]
   */
...
class_alias(InterconnectGroupsListResponseWarning::class, 'Google_Service_Compute_InterconnectGroupsListResponseWarning');
