...
class SslCertificatesScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param SslCertificatesScopedListWarningData[] $data
   */
...
class_alias(SslCertificatesScopedListWarning::class, 'Google_Service_Compute_SslCertificatesScopedListWarning');
