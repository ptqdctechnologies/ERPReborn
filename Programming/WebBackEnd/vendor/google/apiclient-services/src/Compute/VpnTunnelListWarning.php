...
class VpnTunnelListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param VpnTunnelListWarningData[] $data
   */
...
class_alias(VpnTunnelListWarning::class, 'Google_Service_Compute_VpnTunnelListWarning');
