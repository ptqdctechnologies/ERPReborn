...
class ImageViewsListResponseWarningData extends \Google\Model
{
  /**
...
class_alias(ImageViewsListResponseWarningData::class, 'Google_Service_Compute_ImageViewsListResponseWarningData');
