...
class InstanceGroupsListInstancesWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param InstanceGroupsListInstancesWarningData[] $data
   */
  ...
  /**
   * @return InstanceGroupsListInstancesWarningData[]
   */
...
class_alias(InstanceGroupsListInstancesWarning::class, 'Google_Service_Compute_InstanceGroupsListInstancesWarning');
