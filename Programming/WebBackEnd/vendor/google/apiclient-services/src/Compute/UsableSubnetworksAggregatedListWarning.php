...
class UsableSubnetworksAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param UsableSubnetworksAggregatedListWarningData[] $data
   */
...
class_alias(UsableSubnetworksAggregatedListWarning::class, 'Google_Service_Compute_UsableSubnetworksAggregatedListWarning');
