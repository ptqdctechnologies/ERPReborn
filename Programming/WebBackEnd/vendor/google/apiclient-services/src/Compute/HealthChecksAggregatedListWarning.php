...
class HealthChecksAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param HealthChecksAggregatedListWarningData[] $data
   */
...
class_alias(HealthChecksAggregatedListWarning::class, 'Google_Service_Compute_HealthChecksAggregatedListWarning');
