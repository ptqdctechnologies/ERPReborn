...
class PacketMirroringListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param PacketMirroringListWarningData[] $data
   */
...
class_alias(PacketMirroringListWarning::class, 'Google_Service_Compute_PacketMirroringListWarning');
