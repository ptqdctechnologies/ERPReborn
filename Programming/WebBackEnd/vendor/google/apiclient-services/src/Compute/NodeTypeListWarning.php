...
class NodeTypeListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param NodeTypeListWarningData[] $data
   */
...
class_alias(NodeTypeListWarning::class, 'Google_Service_Compute_NodeTypeListWarning');
