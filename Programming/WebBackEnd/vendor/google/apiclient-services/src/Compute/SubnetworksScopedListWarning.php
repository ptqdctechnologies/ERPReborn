...
class SubnetworksScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param SubnetworksScopedListWarningData[] $data
   */
...
class_alias(SubnetworksScopedListWarning::class, 'Google_Service_Compute_SubnetworksScopedListWarning');
