...
class DiskTypeListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = DiskTypeListWarningData::class;
   ...
   *
   * @param DiskTypeListWarningData[] $data
   */
...
class_alias(DiskTypeListWarning::class, 'Google_Service_Compute_DiskTypeListWarning');
