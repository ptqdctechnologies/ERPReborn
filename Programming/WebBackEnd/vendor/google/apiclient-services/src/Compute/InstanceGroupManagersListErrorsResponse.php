...
class InstanceGroupManagersListErrorsResponse extends \Google\Collection
{
...
class_alias(InstanceGroupManagersListErrorsResponse::class, 'Google_Service_Compute_InstanceGroupManagersListErrorsResponse');
