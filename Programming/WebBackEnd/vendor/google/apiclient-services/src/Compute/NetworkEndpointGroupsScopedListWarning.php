...
class NetworkEndpointGroupsScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param NetworkEndpointGroupsScopedListWarningData[] $data
   */
...
class_alias(NetworkEndpointGroupsScopedListWarning::class, 'Google_Service_Compute_NetworkEndpointGroupsScopedListWarning');
