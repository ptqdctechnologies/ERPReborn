...
class StoragePoolListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = StoragePoolListWarningData::class;
   ...
   *
   * @param StoragePoolListWarningData[] $data
   */
  ...
  /**
   * @return StoragePoolListWarningData[]
   */
...
class_alias(StoragePoolListWarning::class, 'Google_Service_Compute_StoragePoolListWarning');
