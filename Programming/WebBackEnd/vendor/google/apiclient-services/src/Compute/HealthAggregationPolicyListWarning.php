...
class HealthAggregationPolicyListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = HealthAggregationPolicyListWarningData::class;
   ...
   *
   * @param HealthAggregationPolicyListWarningData[] $data
   */
  ...
  /**
   * @return HealthAggregationPolicyListWarningData[]
   */
...
class_alias(HealthAggregationPolicyListWarning::class, 'Google_Service_Compute_HealthAggregationPolicyListWarning');
