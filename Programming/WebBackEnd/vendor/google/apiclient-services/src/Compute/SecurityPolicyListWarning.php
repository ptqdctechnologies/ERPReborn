...
class SecurityPolicyListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = SecurityPolicyListWarningData::class;
   ...
   *
   * @param SecurityPolicyListWarningData[] $data
   */
...
class_alias(SecurityPolicyListWarning::class, 'Google_Service_Compute_SecurityPolicyListWarning');
