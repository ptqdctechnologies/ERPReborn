...
class InstanceGroupManagerResizeRequestStatusLastAttemptErrorErrorsErrorDetails extends \Google\Model
{
...
class_alias(InstanceGroupManagerResizeRequestStatusLastAttemptErrorErrorsErrorDetails::class, 'Google_Service_Compute_InstanceGroupManagerResizeRequestStatusLastAttemptErrorErrorsErrorDetails');
