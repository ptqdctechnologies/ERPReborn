...
class TargetPoolAggregatedListWarning extends \Google\Collection
{
  /**
...
class_alias(TargetPoolAggregatedListWarning::class, 'Google_Service_Compute_TargetPoolAggregatedListWarning');
