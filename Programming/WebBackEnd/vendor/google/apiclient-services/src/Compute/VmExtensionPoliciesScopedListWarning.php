...
class VmExtensionPoliciesScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = VmExtensionPoliciesScopedListWarningData::class;
   ...
   *
   * @param VmExtensionPoliciesScopedListWarningData[] $data
   */
  ...
  /**
   * @return VmExtensionPoliciesScopedListWarningData[]
   */
...
class_alias(VmExtensionPoliciesScopedListWarning::class, 'Google_Service_Compute_VmExtensionPoliciesScopedListWarning');
