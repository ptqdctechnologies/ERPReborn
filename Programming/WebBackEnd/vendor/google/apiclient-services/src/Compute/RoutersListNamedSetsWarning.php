...
class RoutersListNamedSetsWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = RoutersListNamedSetsWarningData::class;
   ...
   *
   * @param RoutersListNamedSetsWarningData[] $data
   */
  ...
  /**
   * @return RoutersListNamedSetsWarningData[]
   */
...
class_alias(RoutersListNamedSetsWarning::class, 'Google_Service_Compute_RoutersListNamedSetsWarning');
