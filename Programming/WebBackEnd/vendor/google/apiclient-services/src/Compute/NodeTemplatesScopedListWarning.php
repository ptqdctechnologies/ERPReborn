...
class NodeTemplatesScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NodeTemplatesScopedListWarningData::class;
   ...
   *
   * @param NodeTemplatesScopedListWarningData[] $data
   */
...
class_alias(NodeTemplatesScopedListWarning::class, 'Google_Service_Compute_NodeTemplatesScopedListWarning');
