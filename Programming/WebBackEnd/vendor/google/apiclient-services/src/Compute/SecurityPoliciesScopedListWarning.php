...
class SecurityPoliciesScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param SecurityPoliciesScopedListWarningData[] $data
   */
...
class_alias(SecurityPoliciesScopedListWarning::class, 'Google_Service_Compute_SecurityPoliciesScopedListWarning');
