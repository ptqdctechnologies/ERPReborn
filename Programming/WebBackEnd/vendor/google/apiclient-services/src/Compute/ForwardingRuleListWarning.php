...
class ForwardingRuleListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = ForwardingRuleListWarningData::class;
   ...
   *
   * @param ForwardingRuleListWarningData[] $data
   */
...
class_alias(ForwardingRuleListWarning::class, 'Google_Service_Compute_ForwardingRuleListWarning');
