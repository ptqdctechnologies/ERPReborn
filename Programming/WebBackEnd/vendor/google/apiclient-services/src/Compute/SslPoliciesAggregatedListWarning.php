...
class SslPoliciesAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = SslPoliciesAggregatedListWarningData::class;
   ...
   *
   * @param SslPoliciesAggregatedListWarningData[] $data
   */
...
class_alias(SslPoliciesAggregatedListWarning::class, 'Google_Service_Compute_SslPoliciesAggregatedListWarning');
