...
class FirewallListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param FirewallListWarningData[] $data
   */
...
class_alias(FirewallListWarning::class, 'Google_Service_Compute_FirewallListWarning');
