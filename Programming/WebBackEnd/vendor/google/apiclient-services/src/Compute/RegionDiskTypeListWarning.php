...
class RegionDiskTypeListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param RegionDiskTypeListWarningData[] $data
   */
...
class_alias(RegionDiskTypeListWarning::class, 'Google_Service_Compute_RegionDiskTypeListWarning');
