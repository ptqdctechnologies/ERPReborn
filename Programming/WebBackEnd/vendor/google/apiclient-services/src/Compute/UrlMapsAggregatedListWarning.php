...
class UrlMapsAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param UrlMapsAggregatedListWarningData[] $data
   */
...
class_alias(UrlMapsAggregatedListWarning::class, 'Google_Service_Compute_UrlMapsAggregatedListWarning');
