...
class HttpHealthCheckListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = HttpHealthCheckListWarningData::class;
   ...
   *
   * @param HttpHealthCheckListWarningData[] $data
   */
...
class_alias(HttpHealthCheckListWarning::class, 'Google_Service_Compute_HttpHealthCheckListWarning');
