...
class VpnGatewayListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = VpnGatewayListWarningData::class;
   ...
   *
   * @param VpnGatewayListWarningData[] $data
   */
...
class_alias(VpnGatewayListWarning::class, 'Google_Service_Compute_VpnGatewayListWarning');
