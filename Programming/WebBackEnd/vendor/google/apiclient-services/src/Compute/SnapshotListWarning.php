...
class SnapshotListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param SnapshotListWarningData[] $data
   */
...
class_alias(SnapshotListWarning::class, 'Google_Service_Compute_SnapshotListWarning');
