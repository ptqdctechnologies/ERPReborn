...
class CommitmentListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param CommitmentListWarningData[] $data
   */
...
class_alias(CommitmentListWarning::class, 'Google_Service_Compute_CommitmentListWarning');
