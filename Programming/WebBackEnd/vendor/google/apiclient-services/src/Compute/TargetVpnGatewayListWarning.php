...
class TargetVpnGatewayListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param TargetVpnGatewayListWarningData[] $data
   */
...
class_alias(TargetVpnGatewayListWarning::class, 'Google_Service_Compute_TargetVpnGatewayListWarning');
