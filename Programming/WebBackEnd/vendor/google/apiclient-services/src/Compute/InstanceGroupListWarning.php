...
class InstanceGroupListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param InstanceGroupListWarningData[] $data
   */
...
class_alias(InstanceGroupListWarning::class, 'Google_Service_Compute_InstanceGroupListWarning');
