...
class InstanceGroupManagerListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InstanceGroupManagerListWarningData::class;
   ...
   *
   * @param InstanceGroupManagerListWarningData[] $data
   */
...
class_alias(InstanceGroupManagerListWarning::class, 'Google_Service_Compute_InstanceGroupManagerListWarning');
