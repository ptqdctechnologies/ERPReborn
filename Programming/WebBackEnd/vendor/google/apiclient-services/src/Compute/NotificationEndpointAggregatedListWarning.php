...
class NotificationEndpointAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NotificationEndpointAggregatedListWarningData::class;
   ...
   *
   * @param NotificationEndpointAggregatedListWarningData[] $data
   */
...
class_alias(NotificationEndpointAggregatedListWarning::class, 'Google_Service_Compute_NotificationEndpointAggregatedListWarning');
