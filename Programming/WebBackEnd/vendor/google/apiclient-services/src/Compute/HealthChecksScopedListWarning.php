...
class HealthChecksScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param HealthChecksScopedListWarningData[] $data
   */
...
class_alias(HealthChecksScopedListWarning::class, 'Google_Service_Compute_HealthChecksScopedListWarning');
