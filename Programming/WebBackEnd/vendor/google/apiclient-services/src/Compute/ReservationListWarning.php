...
class ReservationListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param ReservationListWarningData[] $data
   */
...
class_alias(ReservationListWarning::class, 'Google_Service_Compute_ReservationListWarning');
