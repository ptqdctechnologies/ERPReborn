...
class RegionAutoscalerListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param RegionAutoscalerListWarningData[] $data
   */
...
class_alias(RegionAutoscalerListWarning::class, 'Google_Service_Compute_RegionAutoscalerListWarning');
