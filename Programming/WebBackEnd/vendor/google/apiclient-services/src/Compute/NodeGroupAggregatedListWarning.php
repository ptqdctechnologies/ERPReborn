...
class NodeGroupAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NodeGroupAggregatedListWarningData::class;
   ...
   *
   * @param NodeGroupAggregatedListWarningData[] $data
   */
...
class_alias(NodeGroupAggregatedListWarning::class, 'Google_Service_Compute_NodeGroupAggregatedListWarning');
