...
class HealthSourceAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = HealthSourceAggregatedListWarningData::class;
   ...
   *
   * @param HealthSourceAggregatedListWarningData[] $data
   */
  ...
  /**
   * @return HealthSourceAggregatedListWarningData[]
   */
...
class_alias(HealthSourceAggregatedListWarning::class, 'Google_Service_Compute_HealthSourceAggregatedListWarning');
