...
class InstanceGroupManagersListPerInstanceConfigsRespWarning extends \Google\Collection
{
  /**
...
class_alias(InstanceGroupManagersListPerInstanceConfigsRespWarning::class, 'Google_Service_Compute_InstanceGroupManagersListPerInstanceConfigsRespWarning');
