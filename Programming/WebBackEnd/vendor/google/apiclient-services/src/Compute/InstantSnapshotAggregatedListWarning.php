...
class InstantSnapshotAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InstantSnapshotAggregatedListWarningData::class;
   ...
   *
   * @param InstantSnapshotAggregatedListWarningData[] $data
   */
...
class_alias(InstantSnapshotAggregatedListWarning::class, 'Google_Service_Compute_InstantSnapshotAggregatedListWarning');
