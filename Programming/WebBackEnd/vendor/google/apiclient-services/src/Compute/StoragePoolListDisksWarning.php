...
class StoragePoolListDisksWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = StoragePoolListDisksWarningData::class;
   ...
   *
   * @param StoragePoolListDisksWarningData[] $data
   */
  ...
  /**
   * @return StoragePoolListDisksWarningData[]
   */
...
class_alias(StoragePoolListDisksWarning::class, 'Google_Service_Compute_StoragePoolListDisksWarning');
