...
class InstanceGroupManagersScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param InstanceGroupManagersScopedListWarningData[] $data
   */
...
class_alias(InstanceGroupManagersScopedListWarning::class, 'Google_Service_Compute_InstanceGroupManagersScopedListWarning');
