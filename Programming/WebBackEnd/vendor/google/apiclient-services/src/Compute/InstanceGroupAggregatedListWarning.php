...
class InstanceGroupAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InstanceGroupAggregatedListWarningData::class;
   ...
   *
   * @param InstanceGroupAggregatedListWarningData[] $data
   */
  ...
  /**
   * @return InstanceGroupAggregatedListWarningData[]
   */
...
class_alias(InstanceGroupAggregatedListWarning::class, 'Google_Service_Compute_InstanceGroupAggregatedListWarning');
