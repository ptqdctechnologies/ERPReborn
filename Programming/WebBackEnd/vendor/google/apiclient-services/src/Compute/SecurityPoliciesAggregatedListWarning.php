...
class SecurityPoliciesAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param SecurityPoliciesAggregatedListWarningData[] $data
   */
...
class_alias(SecurityPoliciesAggregatedListWarning::class, 'Google_Service_Compute_SecurityPoliciesAggregatedListWarning');
