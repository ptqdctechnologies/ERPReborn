...
class MachineImageListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param MachineImageListWarningData[] $data
   */
...
class_alias(MachineImageListWarning::class, 'Google_Service_Compute_MachineImageListWarning');
