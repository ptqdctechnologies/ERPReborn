...
class HealthCheckListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param HealthCheckListWarningData[] $data
   */
...
class_alias(HealthCheckListWarning::class, 'Google_Service_Compute_HealthCheckListWarning');
