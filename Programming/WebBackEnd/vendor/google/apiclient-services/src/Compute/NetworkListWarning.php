...
class NetworkListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NetworkListWarningData::class;
   ...
   *
   * @param NetworkListWarningData[] $data
   */
...
class_alias(NetworkListWarning::class, 'Google_Service_Compute_NetworkListWarning');
