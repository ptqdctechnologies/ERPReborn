...
class NetworkAttachmentAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NetworkAttachmentAggregatedListWarningData::class;
   ...
   *
   * @param NetworkAttachmentAggregatedListWarningData[] $data
   */
...
class_alias(NetworkAttachmentAggregatedListWarning::class, 'Google_Service_Compute_NetworkAttachmentAggregatedListWarning');
