...
class NodeGroupListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NodeGroupListWarningData::class;
   ...
   *
   * @param NodeGroupListWarningData[] $data
   */
...
class_alias(NodeGroupListWarning::class, 'Google_Service_Compute_NodeGroupListWarning');
