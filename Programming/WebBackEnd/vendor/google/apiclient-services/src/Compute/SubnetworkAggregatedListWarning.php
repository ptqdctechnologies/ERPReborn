...
class SubnetworkAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param SubnetworkAggregatedListWarningData[] $data
   */
...
class_alias(SubnetworkAggregatedListWarning::class, 'Google_Service_Compute_SubnetworkAggregatedListWarning');
