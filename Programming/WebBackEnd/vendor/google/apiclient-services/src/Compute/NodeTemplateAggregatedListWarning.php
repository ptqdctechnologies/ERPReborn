...
class NodeTemplateAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NodeTemplateAggregatedListWarningData::class;
   ...
   *
   * @param NodeTemplateAggregatedListWarningData[] $data
   */
...
class_alias(NodeTemplateAggregatedListWarning::class, 'Google_Service_Compute_NodeTemplateAggregatedListWarning');
