...
class RegionInstanceGroupManagerResizeRequestsListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = RegionInstanceGroupManagerResizeRequestsListResponseWarningData::class;
   ...
   *
   * @param RegionInstanceGroupManagerResizeRequestsListResponseWarningData[] $data
   */
  ...
  /**
   * @return RegionInstanceGroupManagerResizeRequestsListResponseWarningData[]
   */
...
class_alias(RegionInstanceGroupManagerResizeRequestsListResponseWarning::class, 'Google_Service_Compute_RegionInstanceGroupManagerResizeRequestsListResponseWarning');
