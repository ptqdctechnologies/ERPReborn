...
class ListInstantSnapshotGroupsWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = ListInstantSnapshotGroupsWarningData::class;
   ...
   *
   * @param ListInstantSnapshotGroupsWarningData[] $data
   */
  ...
  /**
   * @return ListInstantSnapshotGroupsWarningData[]
   */
...
class_alias(ListInstantSnapshotGroupsWarning::class, 'Google_Service_Compute_ListInstantSnapshotGroupsWarning');
