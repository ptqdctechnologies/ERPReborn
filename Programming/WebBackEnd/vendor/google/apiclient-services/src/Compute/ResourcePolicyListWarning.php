...
class ResourcePolicyListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = ResourcePolicyListWarningData::class;
   ...
   *
   * @param ResourcePolicyListWarningData[] $data
   */
...
class_alias(ResourcePolicyListWarning::class, 'Google_Service_Compute_ResourcePolicyListWarning');
