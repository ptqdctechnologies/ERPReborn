...
class CommitmentAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = CommitmentAggregatedListWarningData::class;
   ...
   *
   * @param CommitmentAggregatedListWarningData[] $data
   */
...
class_alias(CommitmentAggregatedListWarning::class, 'Google_Service_Compute_CommitmentAggregatedListWarning');
