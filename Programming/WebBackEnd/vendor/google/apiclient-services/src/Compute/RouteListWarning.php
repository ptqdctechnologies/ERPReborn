...
class RouteListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = RouteListWarningData::class;
   ...
   *
   * @param RouteListWarningData[] $data
   */
...
class_alias(RouteListWarning::class, 'Google_Service_Compute_RouteListWarning');
