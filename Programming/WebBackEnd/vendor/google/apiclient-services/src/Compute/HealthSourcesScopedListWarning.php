...
class HealthSourcesScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = HealthSourcesScopedListWarningData::class;
   ...
   *
   * @param HealthSourcesScopedListWarningData[] $data
   */
  ...
  /**
   * @return HealthSourcesScopedListWarningData[]
   */
...
class_alias(HealthSourcesScopedListWarning::class, 'Google_Service_Compute_HealthSourcesScopedListWarning');
