...
class FutureReservationsListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = FutureReservationsListResponseWarningData::class;
   ...
   *
   * @param FutureReservationsListResponseWarningData[] $data
   */
...
class_alias(FutureReservationsListResponseWarning::class, 'Google_Service_Compute_FutureReservationsListResponseWarning');
