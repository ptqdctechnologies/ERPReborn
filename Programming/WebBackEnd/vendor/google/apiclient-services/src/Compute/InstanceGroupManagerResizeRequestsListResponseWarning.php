...
class InstanceGroupManagerResizeRequestsListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InstanceGroupManagerResizeRequestsListResponseWarningData::class;
   ...
   *
   * @param InstanceGroupManagerResizeRequestsListResponseWarningData[] $data
   */
  ...
  /**
   * @return InstanceGroupManagerResizeRequestsListResponseWarningData[]
   */
...
class_alias(InstanceGroupManagerResizeRequestsListResponseWarning::class, 'Google_Service_Compute_InstanceGroupManagerResizeRequestsListResponseWarning');
