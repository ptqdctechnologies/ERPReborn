...
class TargetTcpProxyListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = TargetTcpProxyListWarningData::class;
   ...
   *
   * @param TargetTcpProxyListWarningData[] $data
   */
...
class_alias(TargetTcpProxyListWarning::class, 'Google_Service_Compute_TargetTcpProxyListWarning');
