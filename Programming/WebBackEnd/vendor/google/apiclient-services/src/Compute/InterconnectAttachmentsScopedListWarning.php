...
class InterconnectAttachmentsScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InterconnectAttachmentsScopedListWarningData::class;
   ...
   *
   * @param InterconnectAttachmentsScopedListWarningData[] $data
   */
...
class_alias(InterconnectAttachmentsScopedListWarning::class, 'Google_Service_Compute_InterconnectAttachmentsScopedListWarning');
