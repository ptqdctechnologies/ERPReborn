...
class HttpsHealthCheckListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param HttpsHealthCheckListWarningData[] $data
   */
...
class_alias(HttpsHealthCheckListWarning::class, 'Google_Service_Compute_HttpsHealthCheckListWarning');
