...
class NodeGroupsListNodesWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param NodeGroupsListNodesWarningData[] $data
   */
...
class_alias(NodeGroupsListNodesWarning::class, 'Google_Service_Compute_NodeGroupsListNodesWarning');
