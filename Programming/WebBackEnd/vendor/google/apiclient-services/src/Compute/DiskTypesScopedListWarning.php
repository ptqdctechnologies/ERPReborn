...
class DiskTypesScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = DiskTypesScopedListWarningData::class;
   ...
   *
   * @param DiskTypesScopedListWarningData[] $data
   */
...
class_alias(DiskTypesScopedListWarning::class, 'Google_Service_Compute_DiskTypesScopedListWarning');
