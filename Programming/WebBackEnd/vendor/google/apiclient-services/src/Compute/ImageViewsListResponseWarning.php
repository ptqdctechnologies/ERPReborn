...
class ImageViewsListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = ImageViewsListResponseWarningData::class;
   ...
   *
   * @param ImageViewsListResponseWarningData[] $data
   */
  ...
  /**
   * @return ImageViewsListResponseWarningData[]
   */
...
class_alias(ImageViewsListResponseWarning::class, 'Google_Service_Compute_ImageViewsListResponseWarning');
