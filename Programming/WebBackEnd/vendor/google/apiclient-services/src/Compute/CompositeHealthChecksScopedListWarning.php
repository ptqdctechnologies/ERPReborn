...
class CompositeHealthChecksScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = CompositeHealthChecksScopedListWarningData::class;
   ...
   *
   * @param CompositeHealthChecksScopedListWarningData[] $data
   */
  ...
  /**
   * @return CompositeHealthChecksScopedListWarningData[]
   */
...
class_alias(CompositeHealthChecksScopedListWarning::class, 'Google_Service_Compute_CompositeHealthChecksScopedListWarning');
