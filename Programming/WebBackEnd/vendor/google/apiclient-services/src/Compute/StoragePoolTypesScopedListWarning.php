...
class StoragePoolTypesScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = StoragePoolTypesScopedListWarningData::class;
   ...
   *
   * @param StoragePoolTypesScopedListWarningData[] $data
   */
  ...
  /**
   * @return StoragePoolTypesScopedListWarningData[]
   */
...
class_alias(StoragePoolTypesScopedListWarning::class, 'Google_Service_Compute_StoragePoolTypesScopedListWarning');
