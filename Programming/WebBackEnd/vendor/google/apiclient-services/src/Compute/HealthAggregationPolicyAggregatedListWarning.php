...
class HealthAggregationPolicyAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = HealthAggregationPolicyAggregatedListWarningData::class;
   ...
   *
   * @param HealthAggregationPolicyAggregatedListWarningData[] $data
   */
  ...
  /**
   * @return HealthAggregationPolicyAggregatedListWarningData[]
   */
...
class_alias(HealthAggregationPolicyAggregatedListWarning::class, 'Google_Service_Compute_HealthAggregationPolicyAggregatedListWarning');
