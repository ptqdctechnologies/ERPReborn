...
class TargetSslProxyListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param TargetSslProxyListWarningData[] $data
   */
...
class_alias(TargetSslProxyListWarning::class, 'Google_Service_Compute_TargetSslProxyListWarning');
