...
class HostsListResponseWarningData extends \Google\Model
{
  /**
...
class_alias(HostsListResponseWarningData::class, 'Google_Service_Compute_HostsListResponseWarningData');
