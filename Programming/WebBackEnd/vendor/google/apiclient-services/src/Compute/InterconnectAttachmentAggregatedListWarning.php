...
class InterconnectAttachmentAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InterconnectAttachmentAggregatedListWarningData::class;
   ...
   *
   * @param InterconnectAttachmentAggregatedListWarningData[] $data
   */
...
class_alias(InterconnectAttachmentAggregatedListWarning::class, 'Google_Service_Compute_InterconnectAttachmentAggregatedListWarning');
