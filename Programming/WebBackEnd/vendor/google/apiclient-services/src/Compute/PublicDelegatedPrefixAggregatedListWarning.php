...
class PublicDelegatedPrefixAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = PublicDelegatedPrefixAggregatedListWarningData::class;
   ...
   *
   * @param PublicDelegatedPrefixAggregatedListWarningData[] $data
   */
...
class_alias(PublicDelegatedPrefixAggregatedListWarning::class, 'Google_Service_Compute_PublicDelegatedPrefixAggregatedListWarning');
