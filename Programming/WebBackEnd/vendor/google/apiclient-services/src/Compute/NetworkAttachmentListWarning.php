...
class NetworkAttachmentListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param NetworkAttachmentListWarningData[] $data
   */
...
class_alias(NetworkAttachmentListWarning::class, 'Google_Service_Compute_NetworkAttachmentListWarning');
