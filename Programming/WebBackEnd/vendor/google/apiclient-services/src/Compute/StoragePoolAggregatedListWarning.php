...
class StoragePoolAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = StoragePoolAggregatedListWarningData::class;
   ...
   *
   * @param StoragePoolAggregatedListWarningData[] $data
   */
  ...
  /**
   * @return StoragePoolAggregatedListWarningData[]
   */
...
class_alias(StoragePoolAggregatedListWarning::class, 'Google_Service_Compute_StoragePoolAggregatedListWarning');
