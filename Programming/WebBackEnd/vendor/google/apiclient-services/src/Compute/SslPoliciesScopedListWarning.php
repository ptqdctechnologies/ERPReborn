...
class SslPoliciesScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = SslPoliciesScopedListWarningData::class;
   ...
   *
   * @param SslPoliciesScopedListWarningData[] $data
   */
...
class_alias(SslPoliciesScopedListWarning::class, 'Google_Service_Compute_SslPoliciesScopedListWarning');
