...
class InstanceGroupManagerResizeRequestStatusErrorErrorsErrorDetails extends \Google\Model
{
...
class_alias(InstanceGroupManagerResizeRequestStatusErrorErrorsErrorDetails::class, 'Google_Service_Compute_InstanceGroupManagerResizeRequestStatusErrorErrorsErrorDetails');
