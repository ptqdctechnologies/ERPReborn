...
class NotificationEndpointsScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NotificationEndpointsScopedListWarningData::class;
   ...
   *
   * @param NotificationEndpointsScopedListWarningData[] $data
   */
...
class_alias(NotificationEndpointsScopedListWarning::class, 'Google_Service_Compute_NotificationEndpointsScopedListWarning');
