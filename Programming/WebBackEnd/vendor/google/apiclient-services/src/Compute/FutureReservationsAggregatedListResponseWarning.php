...
class FutureReservationsAggregatedListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = FutureReservationsAggregatedListResponseWarningData::class;
   ...
   *
   * @param FutureReservationsAggregatedListResponseWarningData[] $data
   */
...
class_alias(FutureReservationsAggregatedListResponseWarning::class, 'Google_Service_Compute_FutureReservationsAggregatedListResponseWarning');
