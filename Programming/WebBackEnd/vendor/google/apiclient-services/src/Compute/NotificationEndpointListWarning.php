...
class NotificationEndpointListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param NotificationEndpointListWarningData[] $data
   */
...
class_alias(NotificationEndpointListWarning::class, 'Google_Service_Compute_NotificationEndpointListWarning');
