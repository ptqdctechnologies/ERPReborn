...
class ManagedRulesetListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = ManagedRulesetListWarningData::class;
   ...
   *
   * @param ManagedRulesetListWarningData[] $data
   */
  ...
  /**
   * @return ManagedRulesetListWarningData[]
   */
...
class_alias(ManagedRulesetListWarning::class, 'Google_Service_Compute_ManagedRulesetListWarning');
