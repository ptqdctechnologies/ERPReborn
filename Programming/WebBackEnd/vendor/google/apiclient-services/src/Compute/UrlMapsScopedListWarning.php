...
class UrlMapsScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param UrlMapsScopedListWarningData[] $data
   */
...
class_alias(UrlMapsScopedListWarning::class, 'Google_Service_Compute_UrlMapsScopedListWarning');
