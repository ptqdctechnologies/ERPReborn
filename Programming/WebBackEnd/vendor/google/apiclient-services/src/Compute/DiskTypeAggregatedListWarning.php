...
class DiskTypeAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = DiskTypeAggregatedListWarningData::class;
   ...
   *
   * @param DiskTypeAggregatedListWarningData[] $data
   */
...
class_alias(DiskTypeAggregatedListWarning::class, 'Google_Service_Compute_DiskTypeAggregatedListWarning');
