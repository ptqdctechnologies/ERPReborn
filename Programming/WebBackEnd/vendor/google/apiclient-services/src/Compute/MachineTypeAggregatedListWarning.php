...
class MachineTypeAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param MachineTypeAggregatedListWarningData[] $data
   */
...
class_alias(MachineTypeAggregatedListWarning::class, 'Google_Service_Compute_MachineTypeAggregatedListWarning');
