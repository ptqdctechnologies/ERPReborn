...
class TargetPoolsScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param TargetPoolsScopedListWarningData[] $data
   */
...
class_alias(TargetPoolsScopedListWarning::class, 'Google_Service_Compute_TargetPoolsScopedListWarning');
