...
class RoutersScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param RoutersScopedListWarningData[] $data
   */
...
class_alias(RoutersScopedListWarning::class, 'Google_Service_Compute_RoutersScopedListWarning');
