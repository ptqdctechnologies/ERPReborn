...
class HealthAggregationPoliciesScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = HealthAggregationPoliciesScopedListWarningData::class;
   ...
   *
   * @param HealthAggregationPoliciesScopedListWarningData[] $data
   */
  ...
  /**
   * @return HealthAggregationPoliciesScopedListWarningData[]
   */
...
class_alias(HealthAggregationPoliciesScopedListWarning::class, 'Google_Service_Compute_HealthAggregationPoliciesScopedListWarning');
