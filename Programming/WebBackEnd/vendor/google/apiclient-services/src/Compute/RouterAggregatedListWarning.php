...
class RouterAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param RouterAggregatedListWarningData[] $data
   */
...
class_alias(RouterAggregatedListWarning::class, 'Google_Service_Compute_RouterAggregatedListWarning');
