...
class TargetInstancesScopedListWarning extends \Google\Collection
{
   ...
   */
  public $code;
  protected $dataType = TargetInstancesScopedListWarningData::class;
   ...
   *
   * @param TargetInstancesScopedListWarningData[] $data
   */
...
class_alias(TargetInstancesScopedListWarning::class, 'Google_Service_Compute_TargetInstancesScopedListWarning');
