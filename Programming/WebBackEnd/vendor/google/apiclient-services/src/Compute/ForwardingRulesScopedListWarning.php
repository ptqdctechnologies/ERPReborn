...
class ForwardingRulesScopedListWarning extends \Google\Collection
{
   ...
   *
   * @param ForwardingRulesScopedListWarningData[] $data
   */
...
class_alias(ForwardingRulesScopedListWarning::class, 'Google_Service_Compute_ForwardingRulesScopedListWarning');
