...
class NetworkEndpointGroupListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NetworkEndpointGroupListWarningData::class;
   ...
   *
   * @param NetworkEndpointGroupListWarningData[] $data
   */
...
class_alias(NetworkEndpointGroupListWarning::class, 'Google_Service_Compute_NetworkEndpointGroupListWarning');
