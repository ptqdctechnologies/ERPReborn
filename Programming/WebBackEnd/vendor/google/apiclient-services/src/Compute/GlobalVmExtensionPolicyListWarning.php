...
class GlobalVmExtensionPolicyListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = GlobalVmExtensionPolicyListWarningData::class;
   ...
   *
   * @param GlobalVmExtensionPolicyListWarningData[] $data
   */
  ...
  /**
   * @return GlobalVmExtensionPolicyListWarningData[]
   */
...
class_alias(GlobalVmExtensionPolicyListWarning::class, 'Google_Service_Compute_GlobalVmExtensionPolicyListWarning');
