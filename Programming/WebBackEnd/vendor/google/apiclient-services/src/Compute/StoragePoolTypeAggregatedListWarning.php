...
class StoragePoolTypeAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = StoragePoolTypeAggregatedListWarningData::class;
   ...
   *
   * @param StoragePoolTypeAggregatedListWarningData[] $data
   */
  ...
  /**
   * @return StoragePoolTypeAggregatedListWarningData[]
   */
...
class_alias(StoragePoolTypeAggregatedListWarning::class, 'Google_Service_Compute_StoragePoolTypeAggregatedListWarning');
