...
class VpnTunnelAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = VpnTunnelAggregatedListWarningData::class;
   ...
   *
   * @param VpnTunnelAggregatedListWarningData[] $data
   */
...
class_alias(VpnTunnelAggregatedListWarning::class, 'Google_Service_Compute_VpnTunnelAggregatedListWarning');
