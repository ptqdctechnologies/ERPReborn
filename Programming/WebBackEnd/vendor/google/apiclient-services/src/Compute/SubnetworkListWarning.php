...
class SubnetworkListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = SubnetworkListWarningData::class;
   ...
   *
   * @param SubnetworkListWarningData[] $data
   */
...
class_alias(SubnetworkListWarning::class, 'Google_Service_Compute_SubnetworkListWarning');
