...
class InstantSnapshotListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InstantSnapshotListWarningData::class;
   ...
   *
   * @param InstantSnapshotListWarningData[] $data
   */
...
class_alias(InstantSnapshotListWarning::class, 'Google_Service_Compute_InstantSnapshotListWarning');
