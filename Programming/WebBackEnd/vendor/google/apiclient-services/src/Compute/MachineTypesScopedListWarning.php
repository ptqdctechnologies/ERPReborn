...
class MachineTypesScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param MachineTypesScopedListWarningData[] $data
   */
  ...
  /**
   * @return MachineTypesScopedListWarningData[]
   */
...
class_alias(MachineTypesScopedListWarning::class, 'Google_Service_Compute_MachineTypesScopedListWarning');
