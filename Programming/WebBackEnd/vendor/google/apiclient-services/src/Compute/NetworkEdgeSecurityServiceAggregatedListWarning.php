...
class NetworkEdgeSecurityServiceAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param NetworkEdgeSecurityServiceAggregatedListWarningData[] $data
   */
...
class_alias(NetworkEdgeSecurityServiceAggregatedListWarning::class, 'Google_Service_Compute_NetworkEdgeSecurityServiceAggregatedListWarning');
