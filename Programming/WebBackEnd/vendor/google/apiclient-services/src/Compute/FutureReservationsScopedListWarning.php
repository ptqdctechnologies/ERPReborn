...
class FutureReservationsScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = FutureReservationsScopedListWarningData::class;
   ...
   *
   * @param FutureReservationsScopedListWarningData[] $data
   */
...
class_alias(FutureReservationsScopedListWarning::class, 'Google_Service_Compute_FutureReservationsScopedListWarning');
