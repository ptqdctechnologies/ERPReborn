...
class WireGroupListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = WireGroupListWarningData::class;
   ...
   *
   * @param WireGroupListWarningData[] $data
   */
  ...
  /**
   * @return WireGroupListWarningData[]
   */
...
class_alias(WireGroupListWarning::class, 'Google_Service_Compute_WireGroupListWarning');
