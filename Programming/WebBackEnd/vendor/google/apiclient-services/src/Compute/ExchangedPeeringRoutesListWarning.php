...
class ExchangedPeeringRoutesListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param ExchangedPeeringRoutesListWarningData[] $data
   */
...
class_alias(ExchangedPeeringRoutesListWarning::class, 'Google_Service_Compute_ExchangedPeeringRoutesListWarning');
