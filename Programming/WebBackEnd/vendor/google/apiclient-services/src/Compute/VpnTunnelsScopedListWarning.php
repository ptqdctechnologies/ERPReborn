...
class VpnTunnelsScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param VpnTunnelsScopedListWarningData[] $data
   */
...
class_alias(VpnTunnelsScopedListWarning::class, 'Google_Service_Compute_VpnTunnelsScopedListWarning');
