...
class TargetGrpcProxyListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param TargetGrpcProxyListWarningData[] $data
   */
...
class_alias(TargetGrpcProxyListWarning::class, 'Google_Service_Compute_TargetGrpcProxyListWarning');
