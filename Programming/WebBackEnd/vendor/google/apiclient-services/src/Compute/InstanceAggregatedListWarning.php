...
class InstanceAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param InstanceAggregatedListWarningData[] $data
   */
...
class_alias(InstanceAggregatedListWarning::class, 'Google_Service_Compute_InstanceAggregatedListWarning');
