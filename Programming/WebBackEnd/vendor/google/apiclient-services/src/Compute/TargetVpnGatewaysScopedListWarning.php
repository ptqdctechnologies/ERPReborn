...
class TargetVpnGatewaysScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = TargetVpnGatewaysScopedListWarningData::class;
   ...
   *
   * @param TargetVpnGatewaysScopedListWarningData[] $data
   */
...
class_alias(TargetVpnGatewaysScopedListWarning::class, 'Google_Service_Compute_TargetVpnGatewaysScopedListWarning');
