...
class OperationAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = OperationAggregatedListWarningData::class;
   ...
   *
   * @param OperationAggregatedListWarningData[] $data
   */
...
class_alias(OperationAggregatedListWarning::class, 'Google_Service_Compute_OperationAggregatedListWarning');
