...
class ReliabilityRisksListResponseWarningData extends \Google\Model
{
  /**
...
class_alias(ReliabilityRisksListResponseWarningData::class, 'Google_Service_Compute_ReliabilityRisksListResponseWarningData');
