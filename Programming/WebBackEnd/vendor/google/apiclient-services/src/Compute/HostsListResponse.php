...
class HostsListResponse extends \Google\Collection
{
   ...
   */
  public $id;
  protected $itemsType = Host::class;
   ...
   */
  public $unreachables;
  protected $warningType = HostsListResponseWarning::class;
   ...
   *
   * @param HostsListResponseWarning $warning
   */
  public function setWarning(HostsListResponseWarning $warning)
  {
    $this->warning = $warning;
  }
  /**
   * @return HostsListResponseWarning
   */
...
class_alias(HostsListResponse::class, 'Google_Service_Compute_HostsListResponse');
