...
class PublicAdvertisedPrefixListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = PublicAdvertisedPrefixListWarningData::class;
   ...
   *
   * @param PublicAdvertisedPrefixListWarningData[] $data
   */
  ...
  /**
   * @return PublicAdvertisedPrefixListWarningData[]
   */
...
class_alias(PublicAdvertisedPrefixListWarning::class, 'Google_Service_Compute_PublicAdvertisedPrefixListWarning');
