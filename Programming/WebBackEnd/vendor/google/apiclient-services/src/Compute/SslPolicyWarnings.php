...
class SslPolicyWarnings extends \Google\Collection
{
  /**
   ...
   *
   * @param SslPolicyWarningsData[] $data
   */
...
class_alias(SslPolicyWarnings::class, 'Google_Service_Compute_SslPolicyWarnings');
