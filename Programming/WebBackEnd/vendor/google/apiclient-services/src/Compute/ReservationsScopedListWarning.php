...
class ReservationsScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param ReservationsScopedListWarningData[] $data
   */
...
class_alias(ReservationsScopedListWarning::class, 'Google_Service_Compute_ReservationsScopedListWarning');
