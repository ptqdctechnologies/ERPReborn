...
class FirewallPolicyListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = FirewallPolicyListWarningData::class;
   ...
   *
   * @param FirewallPolicyListWarningData[] $data
   */
...
class_alias(FirewallPolicyListWarning::class, 'Google_Service_Compute_FirewallPolicyListWarning');
