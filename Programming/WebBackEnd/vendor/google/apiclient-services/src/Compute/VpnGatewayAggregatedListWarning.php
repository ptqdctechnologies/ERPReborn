...
class VpnGatewayAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = VpnGatewayAggregatedListWarningData::class;
   ...
   *
   * @param VpnGatewayAggregatedListWarningData[] $data
   */
...
class_alias(VpnGatewayAggregatedListWarning::class, 'Google_Service_Compute_VpnGatewayAggregatedListWarning');
