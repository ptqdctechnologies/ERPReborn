...
class PacketMirroringAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param PacketMirroringAggregatedListWarningData[] $data
   */
...
class_alias(PacketMirroringAggregatedListWarning::class, 'Google_Service_Compute_PacketMirroringAggregatedListWarning');
