...
class PacketMirroringsScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param PacketMirroringsScopedListWarningData[] $data
   */
...
class_alias(PacketMirroringsScopedListWarning::class, 'Google_Service_Compute_PacketMirroringsScopedListWarning');
