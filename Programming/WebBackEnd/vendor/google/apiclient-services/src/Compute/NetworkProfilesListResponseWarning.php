...
class NetworkProfilesListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NetworkProfilesListResponseWarningData::class;
   ...
   *
   * @param NetworkProfilesListResponseWarningData[] $data
   */
  ...
  /**
   * @return NetworkProfilesListResponseWarningData[]
   */
...
class_alias(NetworkProfilesListResponseWarning::class, 'Google_Service_Compute_NetworkProfilesListResponseWarning');
