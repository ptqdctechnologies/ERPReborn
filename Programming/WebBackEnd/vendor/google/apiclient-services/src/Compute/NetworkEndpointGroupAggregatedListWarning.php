...
class NetworkEndpointGroupAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param NetworkEndpointGroupAggregatedListWarningData[] $data
   */
...
class_alias(NetworkEndpointGroupAggregatedListWarning::class, 'Google_Service_Compute_NetworkEndpointGroupAggregatedListWarning');
