...
class RolloutsListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = RolloutsListResponseWarningData::class;
   ...
   *
   * @param RolloutsListResponseWarningData[] $data
   */
  ...
  /**
   * @return RolloutsListResponseWarningData[]
   */
...
class_alias(RolloutsListResponseWarning::class, 'Google_Service_Compute_RolloutsListResponseWarning');
