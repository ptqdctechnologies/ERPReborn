...
class ServiceAttachmentsScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param ServiceAttachmentsScopedListWarningData[] $data
   */
...
class_alias(ServiceAttachmentsScopedListWarning::class, 'Google_Service_Compute_ServiceAttachmentsScopedListWarning');
