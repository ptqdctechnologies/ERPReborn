...
class ResourcePolicyAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param ResourcePolicyAggregatedListWarningData[] $data
   */
...
class_alias(ResourcePolicyAggregatedListWarning::class, 'Google_Service_Compute_ResourcePolicyAggregatedListWarning');
