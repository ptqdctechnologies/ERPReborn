...
class SslPoliciesListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = SslPoliciesListWarningData::class;
   ...
   *
   * @param SslPoliciesListWarningData[] $data
   */
  ...
  /**
   * @return SslPoliciesListWarningData[]
   */
...
class_alias(SslPoliciesListWarning::class, 'Google_Service_Compute_SslPoliciesListWarning');
