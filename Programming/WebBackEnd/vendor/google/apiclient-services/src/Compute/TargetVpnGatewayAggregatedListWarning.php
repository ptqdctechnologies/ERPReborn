...
class TargetVpnGatewayAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param TargetVpnGatewayAggregatedListWarningData[] $data
   */
...
class_alias(TargetVpnGatewayAggregatedListWarning::class, 'Google_Service_Compute_TargetVpnGatewayAggregatedListWarning');
