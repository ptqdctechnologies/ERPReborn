...
class RoutersListRoutePoliciesWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = RoutersListRoutePoliciesWarningData::class;
   ...
   *
   * @param RoutersListRoutePoliciesWarningData[] $data
   */
  ...
  /**
   * @return RoutersListRoutePoliciesWarningData[]
   */
...
class_alias(RoutersListRoutePoliciesWarning::class, 'Google_Service_Compute_RoutersListRoutePoliciesWarning');
