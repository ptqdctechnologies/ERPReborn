...
class HealthCheckServiceAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = HealthCheckServiceAggregatedListWarningData::class;
   ...
   *
   * @param HealthCheckServiceAggregatedListWarningData[] $data
   */
...
class_alias(HealthCheckServiceAggregatedListWarning::class, 'Google_Service_Compute_HealthCheckServiceAggregatedListWarning');
