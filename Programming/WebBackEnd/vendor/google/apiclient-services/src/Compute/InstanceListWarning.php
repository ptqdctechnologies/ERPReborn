...
class InstanceListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InstanceListWarningData::class;
   ...
   *
   * @param InstanceListWarningData[] $data
   */
...
class_alias(InstanceListWarning::class, 'Google_Service_Compute_InstanceListWarning');
