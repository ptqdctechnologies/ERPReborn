...
class ReservationSlotsListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = ReservationSlotsListResponseWarningData::class;
   ...
   *
   * @param ReservationSlotsListResponseWarningData[] $data
   */
  ...
  /**
   * @return ReservationSlotsListResponseWarningData[]
   */
...
class_alias(ReservationSlotsListResponseWarning::class, 'Google_Service_Compute_ReservationSlotsListResponseWarning');
