...
class HealthSourceListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = HealthSourceListWarningData::class;
   ...
   *
   * @param HealthSourceListWarningData[] $data
   */
  ...
  /**
   * @return HealthSourceListWarningData[]
   */
...
class_alias(HealthSourceListWarning::class, 'Google_Service_Compute_HealthSourceListWarning');
