...
class OperationListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param OperationListWarningData[] $data
   */
...
class_alias(OperationListWarning::class, 'Google_Service_Compute_OperationListWarning');
