...
class InstanceGroupManagerAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param InstanceGroupManagerAggregatedListWarningData[] $data
   */
...
class_alias(InstanceGroupManagerAggregatedListWarning::class, 'Google_Service_Compute_InstanceGroupManagerAggregatedListWarning');
