...
class TargetTcpProxiesScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param TargetTcpProxiesScopedListWarningData[] $data
   */
...
class_alias(TargetTcpProxiesScopedListWarning::class, 'Google_Service_Compute_TargetTcpProxiesScopedListWarning');
