...
class StoragePoolsScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = StoragePoolsScopedListWarningData::class;
   ...
   *
   * @param StoragePoolsScopedListWarningData[] $data
   */
  ...
  /**
   * @return StoragePoolsScopedListWarningData[]
   */
...
class_alias(StoragePoolsScopedListWarning::class, 'Google_Service_Compute_StoragePoolsScopedListWarning');
