...
class ManagedRulesetListWarningData extends \Google\Model
{
  /**
...
class_alias(ManagedRulesetListWarningData::class, 'Google_Service_Compute_ManagedRulesetListWarningData');
