...
class TargetPoolListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = TargetPoolListWarningData::class;
   ...
   *
   * @param TargetPoolListWarningData[] $data
   */
...
class_alias(TargetPoolListWarning::class, 'Google_Service_Compute_TargetPoolListWarning');
