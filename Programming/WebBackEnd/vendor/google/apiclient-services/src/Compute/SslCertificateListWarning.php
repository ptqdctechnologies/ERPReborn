...
class SslCertificateListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = SslCertificateListWarningData::class;
   ...
   *
   * @param SslCertificateListWarningData[] $data
   */
...
class_alias(SslCertificateListWarning::class, 'Google_Service_Compute_SslCertificateListWarning');
