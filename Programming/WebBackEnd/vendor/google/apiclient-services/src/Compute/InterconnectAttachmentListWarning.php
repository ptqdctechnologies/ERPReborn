...
class InterconnectAttachmentListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param InterconnectAttachmentListWarningData[] $data
   */
...
class_alias(InterconnectAttachmentListWarning::class, 'Google_Service_Compute_InterconnectAttachmentListWarning');
