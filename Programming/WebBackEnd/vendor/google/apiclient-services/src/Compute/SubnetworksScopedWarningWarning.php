...
class SubnetworksScopedWarningWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = SubnetworksScopedWarningWarningData::class;
   ...
   *
   * @param SubnetworksScopedWarningWarningData[] $data
   */
  ...
  /**
   * @return SubnetworksScopedWarningWarningData[]
   */
...
class_alias(SubnetworksScopedWarningWarning::class, 'Google_Service_Compute_SubnetworksScopedWarningWarning');
