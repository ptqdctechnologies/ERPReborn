...
class ResourcePoliciesScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param ResourcePoliciesScopedListWarningData[] $data
   */
...
class_alias(ResourcePoliciesScopedListWarning::class, 'Google_Service_Compute_ResourcePoliciesScopedListWarning');
