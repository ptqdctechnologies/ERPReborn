...
class NetworkFirewallPolicyAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NetworkFirewallPolicyAggregatedListWarningData::class;
   ...
   *
   * @param NetworkFirewallPolicyAggregatedListWarningData[] $data
   */
  ...
  /**
   * @return NetworkFirewallPolicyAggregatedListWarningData[]
   */
...
class_alias(NetworkFirewallPolicyAggregatedListWarning::class, 'Google_Service_Compute_NetworkFirewallPolicyAggregatedListWarning');
