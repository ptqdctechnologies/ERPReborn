...
class VpnGatewaysScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = VpnGatewaysScopedListWarningData::class;
   ...
   *
   * @param VpnGatewaysScopedListWarningData[] $data
   */
...
class_alias(VpnGatewaysScopedListWarning::class, 'Google_Service_Compute_VpnGatewaysScopedListWarning');
