...
class CommitmentsScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param CommitmentsScopedListWarningData[] $data
   */
...
class_alias(CommitmentsScopedListWarning::class, 'Google_Service_Compute_CommitmentsScopedListWarning');
