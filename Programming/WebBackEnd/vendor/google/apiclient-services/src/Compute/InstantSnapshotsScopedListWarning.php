...
class InstantSnapshotsScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InstantSnapshotsScopedListWarningData::class;
   ...
   *
   * @param InstantSnapshotsScopedListWarningData[] $data
   */
...
class_alias(InstantSnapshotsScopedListWarning::class, 'Google_Service_Compute_InstantSnapshotsScopedListWarning');
