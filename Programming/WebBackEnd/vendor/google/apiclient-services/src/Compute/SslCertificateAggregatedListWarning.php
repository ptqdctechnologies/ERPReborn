...
class SslCertificateAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param SslCertificateAggregatedListWarningData[] $data
   */
...
class_alias(SslCertificateAggregatedListWarning::class, 'Google_Service_Compute_SslCertificateAggregatedListWarning');
