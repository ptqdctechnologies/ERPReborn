...
class InstancesScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InstancesScopedListWarningData::class;
   ...
   *
   * @param InstancesScopedListWarningData[] $data
   */
...
class_alias(InstancesScopedListWarning::class, 'Google_Service_Compute_InstancesScopedListWarning');
