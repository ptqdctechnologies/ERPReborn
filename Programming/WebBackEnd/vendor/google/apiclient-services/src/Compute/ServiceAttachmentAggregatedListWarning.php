...
class ServiceAttachmentAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param ServiceAttachmentAggregatedListWarningData[] $data
   */
...
class_alias(ServiceAttachmentAggregatedListWarning::class, 'Google_Service_Compute_ServiceAttachmentAggregatedListWarning');
