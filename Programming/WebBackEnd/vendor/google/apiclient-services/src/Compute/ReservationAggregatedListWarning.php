...
class ReservationAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = ReservationAggregatedListWarningData::class;
   ...
   *
   * @param ReservationAggregatedListWarningData[] $data
   */
...
class_alias(ReservationAggregatedListWarning::class, 'Google_Service_Compute_ReservationAggregatedListWarning');
