...
class InterconnectListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = InterconnectListWarningData::class;
   ...
   *
   * @param InterconnectListWarningData[] $data
   */
...
class_alias(InterconnectListWarning::class, 'Google_Service_Compute_InterconnectListWarning');
