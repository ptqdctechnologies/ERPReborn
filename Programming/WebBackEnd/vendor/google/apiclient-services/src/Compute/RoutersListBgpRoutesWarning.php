...
class RoutersListBgpRoutesWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = RoutersListBgpRoutesWarningData::class;
   ...
   *
   * @param RoutersListBgpRoutesWarningData[] $data
   */
  ...
  /**
   * @return RoutersListBgpRoutesWarningData[]
   */
...
class_alias(RoutersListBgpRoutesWarning::class, 'Google_Service_Compute_RoutersListBgpRoutesWarning');
