...
class LicensesListResponseWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param LicensesListResponseWarningData[] $data
   */
...
class_alias(LicensesListResponseWarning::class, 'Google_Service_Compute_LicensesListResponseWarning');
