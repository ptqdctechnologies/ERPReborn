...
class NodeTypesScopedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = NodeTypesScopedListWarningData::class;
   ...
   *
   * @param NodeTypesScopedListWarningData[] $data
   */
...
class_alias(NodeTypesScopedListWarning::class, 'Google_Service_Compute_NodeTypesScopedListWarning');
