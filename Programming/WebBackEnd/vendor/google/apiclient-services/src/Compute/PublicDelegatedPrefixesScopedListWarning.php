...
class PublicDelegatedPrefixesScopedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param PublicDelegatedPrefixesScopedListWarningData[] $data
   */
...
class_alias(PublicDelegatedPrefixesScopedListWarning::class, 'Google_Service_Compute_PublicDelegatedPrefixesScopedListWarning');
