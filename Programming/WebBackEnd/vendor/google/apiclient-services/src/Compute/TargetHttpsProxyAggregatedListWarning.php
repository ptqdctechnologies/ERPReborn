...
class TargetHttpsProxyAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param TargetHttpsProxyAggregatedListWarningData[] $data
   */
...
class_alias(TargetHttpsProxyAggregatedListWarning::class, 'Google_Service_Compute_TargetHttpsProxyAggregatedListWarning');
