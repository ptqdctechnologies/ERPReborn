...
class CompositeHealthCheckListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = CompositeHealthCheckListWarningData::class;
   ...
   *
   * @param CompositeHealthCheckListWarningData[] $data
   */
  ...
  /**
   * @return CompositeHealthCheckListWarningData[]
   */
...
class_alias(CompositeHealthCheckListWarning::class, 'Google_Service_Compute_CompositeHealthCheckListWarning');
