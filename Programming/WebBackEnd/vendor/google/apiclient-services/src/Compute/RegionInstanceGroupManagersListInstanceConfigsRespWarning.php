...
class RegionInstanceGroupManagersListInstanceConfigsRespWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param RegionInstanceGroupManagersListInstanceConfigsRespWarningData[] $data
   */
...
class_alias(RegionInstanceGroupManagersListInstanceConfigsRespWarning::class, 'Google_Service_Compute_RegionInstanceGroupManagersListInstanceConfigsRespWarning');
