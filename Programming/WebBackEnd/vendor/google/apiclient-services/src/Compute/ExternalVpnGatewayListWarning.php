...
class ExternalVpnGatewayListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param ExternalVpnGatewayListWarningData[] $data
   */
...
class_alias(ExternalVpnGatewayListWarning::class, 'Google_Service_Compute_ExternalVpnGatewayListWarning');
