...
class PreviewFeatureListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = PreviewFeatureListWarningData::class;
   ...
   *
   * @param PreviewFeatureListWarningData[] $data
   */
  ...
  /**
   * @return PreviewFeatureListWarningData[]
   */
...
class_alias(PreviewFeatureListWarning::class, 'Google_Service_Compute_PreviewFeatureListWarning');
