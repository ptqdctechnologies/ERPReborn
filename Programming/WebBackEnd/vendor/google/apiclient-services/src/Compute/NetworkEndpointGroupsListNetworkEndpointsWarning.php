...
class NetworkEndpointGroupsListNetworkEndpointsWarning extends \Google\Collection
{
   ...
   *
   * @param NetworkEndpointGroupsListNetworkEndpointsWarningData[] $data
   */
...
class_alias(NetworkEndpointGroupsListNetworkEndpointsWarning::class, 'Google_Service_Compute_NetworkEndpointGroupsListNetworkEndpointsWarning');
