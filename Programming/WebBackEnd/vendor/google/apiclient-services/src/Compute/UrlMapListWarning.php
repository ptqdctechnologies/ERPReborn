...
class UrlMapListWarning extends \Google\Collection
{
  /**
   ...
   *
   * @param UrlMapListWarningData[] $data
   */
...
class_alias(UrlMapListWarning::class, 'Google_Service_Compute_UrlMapListWarning');
