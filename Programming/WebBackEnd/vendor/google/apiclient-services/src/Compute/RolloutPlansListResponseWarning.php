...
class RolloutPlansListResponseWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = RolloutPlansListResponseWarningData::class;
   ...
   *
   * @param RolloutPlansListResponseWarningData[] $data
   */
  ...
  /**
   * @return RolloutPlansListResponseWarningData[]
   */
...
class_alias(RolloutPlansListResponseWarning::class, 'Google_Service_Compute_RolloutPlansListResponseWarning');
