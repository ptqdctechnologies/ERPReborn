...
class DiskAggregatedListWarning extends \Google\Collection
{
  /**
   ...
   */
  public $code;
  protected $dataType = DiskAggregatedListWarningData::class;
   ...
   *
   * @param DiskAggregatedListWarningData[] $data
   */
...
class_alias(DiskAggregatedListWarning::class, 'Google_Service_Compute_DiskAggregatedListWarning');
