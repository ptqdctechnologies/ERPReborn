...
class ListCapabilityConfigsResponse extends \Google\Collection
{
  protected $collection_key = 'capabilityConfigs';
  protected $capabilityConfigsType = CapabilityConfig::class;
  protected $capabilityConfigsDataType = 'array';
  /**
   ...
   *
   * @param CapabilityConfig[] $capabilityConfigs
   */
  public function setCapabilityConfigs($capabilityConfigs)
  {
   ...
   */
  public function getCapabilityConfigs()
  {
...
class_alias(ListCapabilityConfigsResponse::class, 'Google_Service_CloudResourceManager_ListCapabilityConfigsResponse');
