 ...
 *   $capabilityConfigs = $cloudresourcemanagerService->projects_capabilityConfigs;
 *  </code>
 */
class ProjectsCapabilityConfigs extends \Google\Service\Resource
{
  /**
   ...
   * (capabilityConfigs.listProjectsCapabilityConfigs)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsCapabilityConfigs($parent, $optParams = [])
  {
...
class_alias(ProjectsCapabilityConfigs::class, 'Google_Service_CloudResourceManager_Resource_ProjectsCapabilityConfigs');
