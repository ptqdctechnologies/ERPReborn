...
class GoogleCloudApigeeV1PayloadOperationConfig extends \Google\Collection
{
  ...
  protected $operationsType = GoogleCloudApigeeV1PayloadOperation::class;
   ...
   * be applied.
   *
   * @param GoogleCloudApigeeV1PayloadOperation[] $operations
   */
  ...
  /**
   * @return GoogleCloudApigeeV1PayloadOperation[]
   */
...
class_alias(GoogleCloudApigeeV1PayloadOperationConfig::class, 'Google_Service_Apigee_GoogleCloudApigeeV1PayloadOperationConfig');
