...
class GoogleChromeManagementV1SaasUsageProfileReport extends \Google\Model
{
  /**
...
class_alias(GoogleChromeManagementV1SaasUsageProfileReport::class, 'Google_Service_ChromeManagement_GoogleChromeManagementV1SaasUsageProfileReport');
