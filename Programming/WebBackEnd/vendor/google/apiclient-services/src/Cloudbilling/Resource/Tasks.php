...
use Google\Service\Cloudbilling\CancelTaskRequest;
use Google\Service\Cloudbilling\StreamResponse;
use Google\Service\Cloudbilling\Task;
 ...
 *   $tasks = $cloudbillingService->tasks;
 *  </code>
 */
...
class_alias(Tasks::class, 'Google_Service_Cloudbilling_Resource_Tasks');
