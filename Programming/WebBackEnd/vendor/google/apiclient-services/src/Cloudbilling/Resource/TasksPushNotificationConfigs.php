...
use Google\Service\Cloudbilling\CloudbillingEmpty;
use Google\Service\Cloudbilling\ListTaskPushNotificationConfigResponse;
use Google\Service\Cloudbilling\TaskPushNotificationConfig;
 ...
 *   $pushNotificationConfigs = $cloudbillingService->tasks_pushNotificationConfigs;
 *  </code>
 */
class TasksPushNotificationConfigs extends \Google\Service\Resource
{
  ...
  public function delete($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('delete', [$params], CloudbillingEmpty::class);
  }
  /**
...
class_alias(TasksPushNotificationConfigs::class, 'Google_Service_Cloudbilling_Resource_TasksPushNotificationConfigs');
