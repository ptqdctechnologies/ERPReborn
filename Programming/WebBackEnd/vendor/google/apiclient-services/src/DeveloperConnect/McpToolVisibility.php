...
class McpToolVisibility extends \Google\Collection
{
  /**
  ...
  protected $fieldVisibilityType = FieldVisibility::class;
...
class_alias(McpToolVisibility::class, 'Google_Service_DeveloperConnect_McpToolVisibility');
