 ...
 *   $dataDomains = $dataplexService->projects_locations_dataDomains;
 *  </code>
 */
class ProjectsLocationsDataDomains extends \Google\Service\Resource
{
   ...
   * errors. (dataDomains.setIamPolicy)
   *
   * @param string $resource REQUIRED: The resource for which the policy is being
   ...
   * (dataDomains.testIamPermissions)
   *
...
class_alias(ProjectsLocationsDataDomains::class, 'Google_Service_CloudDataplex_Resource_ProjectsLocationsDataDomains');
