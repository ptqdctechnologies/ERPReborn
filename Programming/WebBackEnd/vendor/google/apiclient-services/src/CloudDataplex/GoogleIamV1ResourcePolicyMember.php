...
class GoogleIamV1ResourcePolicyMember extends \Google\Model
{
  /**
   ...
   * the new resource.Example: principal://parametermanager.googleapis.com/proje
   * cts/12345/name/locations/us-central1-a/parameters/my-parameter
   *
   * @var string
   */
   ...
   * be applicable to the new resourceExample: principal://parametermanager.goog
   * leapis.com/projects/12345/uid/locations/us-central1-a/parameters/a918fed5
   *
   * @var string
   */
...
class_alias(GoogleIamV1ResourcePolicyMember::class, 'Google_Service_CloudDataplex_GoogleIamV1ResourcePolicyMember');
