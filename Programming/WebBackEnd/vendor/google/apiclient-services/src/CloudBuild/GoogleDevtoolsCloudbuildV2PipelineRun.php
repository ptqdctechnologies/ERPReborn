...
class GoogleDevtoolsCloudbuildV2PipelineRun extends \Google\Collection
{
  /**
...
class_alias(GoogleDevtoolsCloudbuildV2PipelineRun::class, 'Google_Service_CloudBuild_GoogleDevtoolsCloudbuildV2PipelineRun');
