 ...
 *   $configStoreSettings = $dataflowService->organizations_locations_configStoreSettings;
 *  </code>
 */
class OrganizationsLocationsConfigStoreSettings extends \Google\Service\Resource
{
  /**
   ...
   * (configStoreSettings.listOrganizationsLocationsConfigStoreSettings)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listOrganizationsLocationsConfigStoreSettings($parent, $optParams = [])
  {
...
class_alias(OrganizationsLocationsConfigStoreSettings::class, 'Google_Service_Dataflow_Resource_OrganizationsLocationsConfigStoreSettings');
