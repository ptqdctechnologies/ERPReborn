 ...
 *   $configStoreSettings = $dataflowService->folders_locations_configStoreSettings;
 *  </code>
 */
class FoldersLocationsConfigStoreSettings extends \Google\Service\Resource
{
  /**
   ...
   * (configStoreSettings.listFoldersLocationsConfigStoreSettings)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listFoldersLocationsConfigStoreSettings($parent, $optParams = [])
  {
...
class_alias(FoldersLocationsConfigStoreSettings::class, 'Google_Service_Dataflow_Resource_FoldersLocationsConfigStoreSettings');
