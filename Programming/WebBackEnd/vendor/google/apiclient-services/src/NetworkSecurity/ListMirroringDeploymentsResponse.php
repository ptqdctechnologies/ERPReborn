...
class ListMirroringDeploymentsResponse extends \Google\Collection
{
  ...
  {
    $this->mirroringDeployments = $mirroringDeployments;
  }
  /**
...
class_alias(ListMirroringDeploymentsResponse::class, 'Google_Service_NetworkSecurity_ListMirroringDeploymentsResponse');
