 ...
 *   $auditScopeReports = $auditmanagerService->folders_locations_auditScopeReports;
 *  </code>
 */
class FoldersLocationsAuditScopeReports extends \Google\Service\Resource
{
  /**
...
class_alias(FoldersLocationsAuditScopeReports::class, 'Google_Service_CloudAuditManager_Resource_FoldersLocationsAuditScopeReports');
