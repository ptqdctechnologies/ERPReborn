 ...
 *   $controls = $auditmanagerService->folders_locations_standards_controls;
 *  </code>
 */
class FoldersLocationsStandardsControls extends \Google\Service\Resource
{
  /**
   * Lists the controls that you must implement to become compliant to a
   * regulatory standard. (controls.listFoldersLocationsStandardsControls)
   *
   ...
   */
  public function listFoldersLocationsStandardsControls($parent, $optParams = [])
  {
...
class_alias(FoldersLocationsStandardsControls::class, 'Google_Service_CloudAuditManager_Resource_FoldersLocationsStandardsControls');
