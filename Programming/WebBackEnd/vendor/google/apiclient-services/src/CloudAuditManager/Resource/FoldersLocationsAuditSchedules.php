 ...
 *   $auditSchedules = $auditmanagerService->folders_locations_auditSchedules;
 *  </code>
 */
class FoldersLocationsAuditSchedules extends \Google\Service\Resource
{
  /**
   ...
   * (auditSchedules.listFoldersLocationsAuditSchedules)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listFoldersLocationsAuditSchedules($parent, $optParams = [])
  {
...
class_alias(FoldersLocationsAuditSchedules::class, 'Google_Service_CloudAuditManager_Resource_FoldersLocationsAuditSchedules');
