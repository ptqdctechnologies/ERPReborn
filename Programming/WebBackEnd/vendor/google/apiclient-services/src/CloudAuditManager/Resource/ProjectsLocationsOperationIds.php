 ...
 *   $operationIds = $auditmanagerService->projects_locations_operationIds;
 *  </code>
 */
class ProjectsLocationsOperationIds extends \Google\Service\Resource
{
  /**
...
class_alias(ProjectsLocationsOperationIds::class, 'Google_Service_CloudAuditManager_Resource_ProjectsLocationsOperationIds');
