 ...
 *   $controls = $auditmanagerService->projects_locations_standards_controls;
 *  </code>
 */
class ProjectsLocationsStandardsControls extends \Google\Service\Resource
{
  /**
   * Lists the controls that you must implement to become compliant to a
   * regulatory standard. (controls.listProjectsLocationsStandardsControls)
   *
   ...
   */
  public function listProjectsLocationsStandardsControls($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsStandardsControls::class, 'Google_Service_CloudAuditManager_Resource_ProjectsLocationsStandardsControls');
