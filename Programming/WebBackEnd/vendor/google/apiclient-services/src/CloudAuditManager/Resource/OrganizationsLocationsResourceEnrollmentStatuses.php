 ...
 *   $resourceEnrollmentStatuses = $auditmanagerService->organizations_locations_resourceEnrollmentStatuses;
 *  </code>
 */
class OrganizationsLocationsResourceEnrollmentStatuses extends \Google\Service\Resource
{
  /**
   ...
   * their enrollments. (resourceEnrollmentStatuses.listOrganizationsLocationsReso
   * urceEnrollmentStatuses)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listOrganizationsLocationsResourceEnrollmentStatuses($parent, $optParams = [])
  {
...
class_alias(OrganizationsLocationsResourceEnrollmentStatuses::class, 'Google_Service_CloudAuditManager_Resource_OrganizationsLocationsResourceEnrollmentStatuses');
