 ...
 *   $auditReports = $auditmanagerService->projects_locations_auditReports;
 *  </code>
 */
class ProjectsLocationsAuditReports extends \Google\Service\Resource
{
  /**
   ...
   * specify as the parent scope. (auditReports.listProjectsLocationsAuditReports)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsAuditReports($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsAuditReports::class, 'Google_Service_CloudAuditManager_Resource_ProjectsLocationsAuditReports');
