 ...
 *   $auditReports = $auditmanagerService->folders_locations_auditReports;
 *  </code>
 */
class FoldersLocationsAuditReports extends \Google\Service\Resource
{
  /**
   ...
   * specify as the parent scope. (auditReports.listFoldersLocationsAuditReports)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listFoldersLocationsAuditReports($parent, $optParams = [])
  {
...
class_alias(FoldersLocationsAuditReports::class, 'Google_Service_CloudAuditManager_Resource_FoldersLocationsAuditReports');
