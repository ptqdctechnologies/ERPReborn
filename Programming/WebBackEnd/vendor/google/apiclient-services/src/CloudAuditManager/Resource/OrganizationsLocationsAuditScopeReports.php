 ...
 *   $auditScopeReports = $auditmanagerService->organizations_locations_auditScopeReports;
 *  </code>
 */
class OrganizationsLocationsAuditScopeReports extends \Google\Service\Resource
{
  /**
...
class_alias(OrganizationsLocationsAuditScopeReports::class, 'Google_Service_CloudAuditManager_Resource_OrganizationsLocationsAuditScopeReports');
