 ...
 *   $operationDetails = $auditmanagerService->folders_locations_operationDetails;
 *  </code>
 */
class FoldersLocationsOperationDetails extends \Google\Service\Resource
{
  /**
...
class_alias(FoldersLocationsOperationDetails::class, 'Google_Service_CloudAuditManager_Resource_FoldersLocationsOperationDetails');
