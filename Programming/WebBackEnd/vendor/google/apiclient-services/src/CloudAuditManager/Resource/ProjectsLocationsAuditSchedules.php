 ...
 *   $auditSchedules = $auditmanagerService->projects_locations_auditSchedules;
 *  </code>
 */
class ProjectsLocationsAuditSchedules extends \Google\Service\Resource
{
  /**
   ...
   * (auditSchedules.listProjectsLocationsAuditSchedules)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsAuditSchedules($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsAuditSchedules::class, 'Google_Service_CloudAuditManager_Resource_ProjectsLocationsAuditSchedules');
