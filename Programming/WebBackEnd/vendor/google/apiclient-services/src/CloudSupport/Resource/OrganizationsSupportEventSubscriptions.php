 ...
 *   $supportEventSubscriptions = $cloudsupportService->organizations_supportEventSubscriptions;
 *  </code>
 */
class OrganizationsSupportEventSubscriptions extends \Google\Service\Resource
{
  /**
  ...
  /**
   * Expunges a support event subscription. EXAMPLES: cURL: ```shell support_event
   * _subscription="organizations/123456789/supportEventSubscriptions/abcdef123456
   ...
   * name="organizations/123456789/supportEventSubscriptions/abcdef123456" )
   * print(request.execute()) ``` (supportEventSubscriptions.expunge)
   *
   * @param string $name Required. The name of the support event subscription to
   * expunge. Format:
   * organizations/{organization_id}/supportEventSubscriptions/{subscription_id}
   ...
   * (supportEventSubscriptions.listOrganizationsSupportEventSubscriptions)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listOrganizationsSupportEventSubscriptions($parent, $optParams = [])
  {
   ...
   * name="organizations/123456789/supportEventSubscriptions/abcdef123456" )
   * print(request.execute()) ``` (supportEventSubscriptions.undelete)
   *
   * @param string $name Required. The name of the support event subscription to
   * undelete. Format:
   * organizations/{organization_id}/supportEventSubscriptions/{subscription_id}
...
class_alias(OrganizationsSupportEventSubscriptions::class, 'Google_Service_CloudSupport_Resource_OrganizationsSupportEventSubscriptions');
