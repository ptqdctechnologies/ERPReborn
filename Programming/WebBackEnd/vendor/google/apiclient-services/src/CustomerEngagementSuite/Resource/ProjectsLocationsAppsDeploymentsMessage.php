 ...
 *   $message = $cesService->projects_locations_apps_deployments_message;
 *  </code>
 */
class ProjectsLocationsAppsDeploymentsMessage extends \Google\Service\Resource
{
  /**
...
class_alias(ProjectsLocationsAppsDeploymentsMessage::class, 'Google_Service_CustomerEngagementSuite_Resource_ProjectsLocationsAppsDeploymentsMessage');
