...
class LfA2aV1HTTPAuthSecurityScheme extends \Google\Model
{
  /**
...
class_alias(LfA2aV1HTTPAuthSecurityScheme::class, 'Google_Service_CustomerEngagementSuite_LfA2aV1HTTPAuthSecurityScheme');
