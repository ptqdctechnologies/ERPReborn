...
class LfA2aV1PasswordOAuthFlow extends \Google\Model
{
  /**
...
class_alias(LfA2aV1PasswordOAuthFlow::class, 'Google_Service_CustomerEngagementSuite_LfA2aV1PasswordOAuthFlow');
