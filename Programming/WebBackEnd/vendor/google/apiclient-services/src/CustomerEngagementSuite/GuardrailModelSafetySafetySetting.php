...
class GuardrailModelSafetySafetySetting extends \Google\Model
{
  /**
...
class_alias(GuardrailModelSafetySafetySetting::class, 'Google_Service_CustomerEngagementSuite_GuardrailModelSafetySafetySetting');
