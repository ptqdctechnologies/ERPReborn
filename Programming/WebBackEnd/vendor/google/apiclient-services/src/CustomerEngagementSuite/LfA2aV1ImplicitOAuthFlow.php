...
class LfA2aV1ImplicitOAuthFlow extends \Google\Model
{
  /**
...
class_alias(LfA2aV1ImplicitOAuthFlow::class, 'Google_Service_CustomerEngagementSuite_LfA2aV1ImplicitOAuthFlow');
