 ...
 *   $infoTypes = $dlpService->projects_locations_infoTypes;
 *  </code>
 */
class ProjectsLocationsInfoTypes extends \Google\Service\Resource
{
  /**
   ...
   */
  public function listProjectsLocationsInfoTypes($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsInfoTypes::class, 'Google_Service_DLP_Resource_ProjectsLocationsInfoTypes');
