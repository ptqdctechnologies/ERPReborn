 ...
 *   $infoTypes = $dlpService->organizations_locations_infoTypes;
 *  </code>
 */
class OrganizationsLocationsInfoTypes extends \Google\Service\Resource
{
  /**
   * Returns a list of the sensitive information types that the DLP API supports.
   * See https://docs.cloud.google.com/sensitive-data-protection/docs/infotypes-
   * reference to learn more. (infoTypes.listOrganizationsLocationsInfoTypes)
   *
   ...
   */
  public function listOrganizationsLocationsInfoTypes($parent, $optParams = [])
  {
...
class_alias(OrganizationsLocationsInfoTypes::class, 'Google_Service_DLP_Resource_OrganizationsLocationsInfoTypes');
