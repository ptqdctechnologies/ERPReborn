...
class GooglePrivacyDlpV2LabelFieldMetadata extends \Google\Model
{
  /**
...
class_alias(GooglePrivacyDlpV2LabelFieldMetadata::class, 'Google_Service_DLP_GooglePrivacyDlpV2LabelFieldMetadata');
