...
class GooglePrivacyDlpV2LogToBigQuery extends \Google\Model
{
  /**
...
class_alias(GooglePrivacyDlpV2LogToBigQuery::class, 'Google_Service_DLP_GooglePrivacyDlpV2LogToBigQuery');
