...
class AllowedConsumer extends \Google\Model
{
  /**
   * Required. The connection limit for the consumer. Value must be greater than
   * 0.
   *
   * @var string
   */
...
class_alias(AllowedConsumer::class, 'Google_Service_CloudFTP_AllowedConsumer');
