...
use Google\Service\CloudFTP\ListLocationsResponse;
use Google\Service\CloudFTP\Location;
 ...
 *   $locations = $ftpService->projects_locations;
 *  </code>
 */
...
class_alias(ProjectsLocations::class, 'Google_Service_CloudFTP_Resource_ProjectsLocations');
