...
class CheckPrewarmedArtifactResponse extends \Google\Model
{
...
class_alias(CheckPrewarmedArtifactResponse::class, 'Google_Service_ArtifactRegistry_CheckPrewarmedArtifactResponse');
