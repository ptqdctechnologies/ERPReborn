...
class RemovePrewarmedArtifactRequest extends \Google\Model
{
  /**
...
class_alias(RemovePrewarmedArtifactRequest::class, 'Google_Service_ArtifactRegistry_RemovePrewarmedArtifactRequest');
