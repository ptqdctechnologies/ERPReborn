...
class ComputeDetailedFlightEmissionsRequest extends \Google\Collection
{
...
class_alias(ComputeDetailedFlightEmissionsRequest::class, 'Google_Service_TravelImpactModel_ComputeDetailedFlightEmissionsRequest');
