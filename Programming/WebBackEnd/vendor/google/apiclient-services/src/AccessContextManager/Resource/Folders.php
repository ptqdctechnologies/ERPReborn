 ...
 *   $folders = $accesscontextmanagerService->folders;
 *  </code>
 */
class Folders extends \Google\Service\Resource
{
   ...
   * (folders.lookupConfiguredServicePerimeter)
   *
...
class_alias(Folders::class, 'Google_Service_AccessContextManager_Resource_Folders');
