...
class ConferenceRecordsTranscriptsEntries extends \Google\Service\Resource
{
   ...
   * [Work with artifacts](https://developers.google.com/workspace/meet/api/guides
   * /artifacts). Note: The transcript entries returned by the Google Meet API
   * might not match the transcription found in the Google Docs transcript file.
   * This can occur when 1) we have interleaved speakers within milliseconds, or
   ...
   * (entries.listConferenceRecordsTranscriptsEntries)
   *
