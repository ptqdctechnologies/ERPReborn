...
class GoogleAdsSearchads360V23ServicesMutateConversionValueRuleSetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesConversionValueRuleSetOperation::class;
   ...
   * rule sets.
   *
   * @param GoogleAdsSearchads360V23ServicesConversionValueRuleSetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateConversionValueRuleSetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateConversionValueRuleSetsRequest');
