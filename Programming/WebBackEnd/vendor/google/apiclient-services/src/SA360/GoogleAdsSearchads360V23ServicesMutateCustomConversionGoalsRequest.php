...
class GoogleAdsSearchads360V23ServicesMutateCustomConversionGoalsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCustomConversionGoalOperation::class;
   ...
   * goal.
   *
   * @param GoogleAdsSearchads360V23ServicesCustomConversionGoalOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCustomConversionGoalsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCustomConversionGoalsRequest');
