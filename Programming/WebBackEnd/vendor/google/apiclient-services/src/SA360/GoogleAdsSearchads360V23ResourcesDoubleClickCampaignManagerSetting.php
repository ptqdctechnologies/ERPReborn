...
class GoogleAdsSearchads360V23ResourcesDoubleClickCampaignManagerSetting extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesDoubleClickCampaignManagerSetting::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesDoubleClickCampaignManagerSetting');
