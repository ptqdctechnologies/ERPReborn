...
class GoogleAdsSearchads360V23ResourcesAssetFieldTypePolicySummary extends \Google\Model
{
  /**
   * Not specified.
   */
   ...
   * Not specified.
   */
  public const ASSET_SOURCE_UNSPECIFIED = 'UNSPECIFIED';
  /**
   * Used for return value only. Represents value unknown in this version.
   */
  public const ASSET_SOURCE_UNKNOWN = 'UNKNOWN';
  /**
   * The asset or asset link is provided by advertiser.
   */
  public const ASSET_SOURCE_ADVERTISER = 'ADVERTISER';
  /**
   * The asset or asset link is generated by Google.
   */
  public const ASSET_SOURCE_AUTOMATICALLY_CREATED = 'AUTOMATICALLY_CREATED';
  /**
   ...
   */
  public $assetSource;
  protected $policySummaryInfoType = GoogleAdsSearchads360V23ResourcesAssetPolicySummary::class;
   ...
   *
   * @param self::ASSET_SOURCE_* $assetSource
   */
   ...
   *
   * @param GoogleAdsSearchads360V23ResourcesAssetPolicySummary $policySummaryInfo
   */
  public function setPolicySummaryInfo(GoogleAdsSearchads360V23ResourcesAssetPolicySummary $policySummaryInfo)
  {
...
class_alias(GoogleAdsSearchads360V23ResourcesAssetFieldTypePolicySummary::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAssetFieldTypePolicySummary');
