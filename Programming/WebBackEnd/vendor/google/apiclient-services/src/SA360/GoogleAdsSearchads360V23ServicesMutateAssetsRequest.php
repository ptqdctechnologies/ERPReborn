...
class GoogleAdsSearchads360V23ServicesMutateAssetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAssetOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAssetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAssetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAssetsRequest');
