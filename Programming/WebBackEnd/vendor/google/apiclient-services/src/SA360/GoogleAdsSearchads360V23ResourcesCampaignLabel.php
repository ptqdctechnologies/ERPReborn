...
class GoogleAdsSearchads360V23ResourcesCampaignLabel extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesCampaignLabel::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesCampaignLabel');
