...
class GoogleAdsSearchads360V23CommonProductTypeInfo extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonProductTypeInfo::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonProductTypeInfo');
