...
class GoogleAdsSearchads360V23ResourcesRecommendationShoppingTargetAllOffersRecommendation extends \Google\Model
{
  /**
   ...
   * Output only. The number of untargeted offers.
   *
   * @param string $untargetedOffersCount
   */
  public function setUntargetedOffersCount($untargetedOffersCount)
  {
    $this->untargetedOffersCount = $untargetedOffersCount;
  }
  /**
   * @return string
   */
  ...
  {
    return $this->untargetedOffersCount;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleAdsSearchads360V23ResourcesRecommendationShoppingTargetAllOffersRecommendation::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesRecommendationShoppingTargetAllOffersRecommendation');
