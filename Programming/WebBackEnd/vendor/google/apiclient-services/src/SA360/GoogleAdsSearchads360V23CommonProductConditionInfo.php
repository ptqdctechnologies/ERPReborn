...
class GoogleAdsSearchads360V23CommonProductConditionInfo extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonProductConditionInfo::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonProductConditionInfo');
