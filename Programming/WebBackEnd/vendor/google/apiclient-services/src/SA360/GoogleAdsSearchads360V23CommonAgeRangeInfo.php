...
class GoogleAdsSearchads360V23CommonAgeRangeInfo extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonAgeRangeInfo::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonAgeRangeInfo');
