...
class GoogleAdsSearchads360V23ServicesMutateConversionActionsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesConversionActionOperation::class;
   ...
   * actions.
   *
   * @param GoogleAdsSearchads360V23ServicesConversionActionOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateConversionActionsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateConversionActionsRequest');
