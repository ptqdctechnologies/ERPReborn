...
class GoogleAdsSearchads360V23ServicesMutateSearchAds360CampaignsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesSearchAds360CampaignOperation::class;
   ...
   * campaigns.
   *
   * @param GoogleAdsSearchads360V23ServicesSearchAds360CampaignOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateSearchAds360CampaignsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateSearchAds360CampaignsRequest');
