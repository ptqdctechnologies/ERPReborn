...
class GoogleAdsSearchads360V23ServicesMutateAssetGroupSignalsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAssetGroupSignalOperation::class;
   ...
   * signals.
   *
   * @param GoogleAdsSearchads360V23ServicesAssetGroupSignalOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAssetGroupSignalsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAssetGroupSignalsRequest');
