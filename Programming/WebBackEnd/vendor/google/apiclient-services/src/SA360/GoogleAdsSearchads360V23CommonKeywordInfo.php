...
class GoogleAdsSearchads360V23CommonKeywordInfo extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonKeywordInfo::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonKeywordInfo');
