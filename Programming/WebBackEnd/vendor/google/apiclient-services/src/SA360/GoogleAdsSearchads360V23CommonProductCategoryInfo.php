...
class GoogleAdsSearchads360V23CommonProductCategoryInfo extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonProductCategoryInfo::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonProductCategoryInfo');
