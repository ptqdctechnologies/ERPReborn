...
class GoogleAdsSearchads360V23ServicesMutateAdGroupBidModifiersRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdGroupBidModifierOperation::class;
   ...
   * modifiers.
   *
   * @param GoogleAdsSearchads360V23ServicesAdGroupBidModifierOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupBidModifiersRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupBidModifiersRequest');
