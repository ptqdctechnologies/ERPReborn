...
class GoogleAdsSearchads360V23CommonMaximizeConversionValue extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23CommonMaximizeConversionValue::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonMaximizeConversionValue');
