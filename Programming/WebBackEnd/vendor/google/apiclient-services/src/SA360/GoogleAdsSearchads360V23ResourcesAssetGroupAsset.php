...
class GoogleAdsSearchads360V23ResourcesAssetGroupAsset extends \Google\Collection
{
  /**
   * Not specified.
   */
   ...
   */
  public $fieldType;
  protected $policySummaryType = GoogleAdsSearchads360V23CommonPolicySummary::class;
  protected $policySummaryDataType = '';
  /**
   * Output only. Provides the PrimaryStatus of this asset link. Primary status
   * is meant essentially to differentiate between the plain "status" field,
   * which has advertiser set values of enabled, paused, or removed. The primary
   * status takes into account other signals (for assets its mainly policy and
   * quality approvals) to come up with a more comprehensive status to indicate
   * its serving state.
   *
   * @var string
   */
  public $primaryStatus;
  protected $primaryStatusDetailsType = GoogleAdsSearchads360V23CommonAssetLinkPrimaryStatusDetails::class;
  protected $primaryStatusDetailsDataType = 'array';
  /**
   ...
   *
   * @param GoogleAdsSearchads360V23CommonPolicySummary $policySummary
   */
  public function setPolicySummary(GoogleAdsSearchads360V23CommonPolicySummary $policySummary)
  {
    $this->policySummary = $policySummary;
  }
  /**
   * @return GoogleAdsSearchads360V23CommonPolicySummary
   */
   ...
   * reasons.
   *
   * @param GoogleAdsSearchads360V23CommonAssetLinkPrimaryStatusDetails[] $primaryStatusDetails
   */
  public function setPrimaryStatusDetails($primaryStatusDetails)
  {
    $this->primaryStatusDetails = $primaryStatusDetails;
  }
  /**
   * @return GoogleAdsSearchads360V23CommonAssetLinkPrimaryStatusDetails[]
   */
  public function getPrimaryStatusDetails()
  {
    return $this->primaryStatusDetails;
  }
  /**
   * Output only. Provides a list of reasons for why an asset is not serving or
   * not serving at full capacity.
...
class_alias(GoogleAdsSearchads360V23ResourcesAssetGroupAsset::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAssetGroupAsset');
