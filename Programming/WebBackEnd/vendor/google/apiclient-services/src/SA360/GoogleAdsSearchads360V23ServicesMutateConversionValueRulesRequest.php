...
class GoogleAdsSearchads360V23ServicesMutateConversionValueRulesRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesConversionValueRuleOperation::class;
   ...
   * rules.
   *
   * @param GoogleAdsSearchads360V23ServicesConversionValueRuleOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateConversionValueRulesRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateConversionValueRulesRequest');
