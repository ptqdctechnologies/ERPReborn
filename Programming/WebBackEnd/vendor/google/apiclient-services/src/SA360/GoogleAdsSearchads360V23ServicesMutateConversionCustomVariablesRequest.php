...
class GoogleAdsSearchads360V23ServicesMutateConversionCustomVariablesRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesConversionCustomVariableOperation::class;
   ...
   * variables.
   *
   * @param GoogleAdsSearchads360V23ServicesConversionCustomVariableOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateConversionCustomVariablesRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateConversionCustomVariablesRequest');
