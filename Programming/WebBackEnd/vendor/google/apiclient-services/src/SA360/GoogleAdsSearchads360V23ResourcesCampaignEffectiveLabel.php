...
class GoogleAdsSearchads360V23ResourcesCampaignEffectiveLabel extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesCampaignEffectiveLabel::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesCampaignEffectiveLabel');
