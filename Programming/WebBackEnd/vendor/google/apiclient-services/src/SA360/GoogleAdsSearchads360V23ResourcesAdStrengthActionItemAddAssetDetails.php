...
class GoogleAdsSearchads360V23ResourcesAdStrengthActionItemAddAssetDetails extends \Google\Model
{
  /**
   * Not specified.
   */
   ...
   */
  public const ASSET_FIELD_TYPE_DEMAND_GEN_CAROUSEL_CARD = 'DEMAND_GEN_CAROUSEL_CARD';
  /**
   * The asset is linked for use as a Business Message.
   */
  public const ASSET_FIELD_TYPE_BUSINESS_MESSAGE = 'BUSINESS_MESSAGE';
  /**
   * The asset is linked for use as a tall portrait marketing image.
   */
  public const ASSET_FIELD_TYPE_TALL_PORTRAIT_MARKETING_IMAGE = 'TALL_PORTRAIT_MARKETING_IMAGE';
  /**
   * The asset is linked for use as a landing page preview image.
   */
  public const ASSET_FIELD_TYPE_LANDING_PAGE_PREVIEW = 'LANDING_PAGE_PREVIEW';
  /**
   ...
   * Not specified.
   */
  public const VIDEO_ASPECT_RATIO_REQUIREMENT_UNSPECIFIED = 'UNSPECIFIED';
  /**
   * The received value is not known in this version.
   */
  public const VIDEO_ASPECT_RATIO_REQUIREMENT_UNKNOWN = 'UNKNOWN';
  /**
   * The video requires a horizontal aspect ratio.
   */
  public const VIDEO_ASPECT_RATIO_REQUIREMENT_HORIZONTAL = 'HORIZONTAL';
  /**
   * The video requires a square aspect ratio.
   */
  public const VIDEO_ASPECT_RATIO_REQUIREMENT_SQUARE = 'SQUARE';
  /**
   * The video requires a vertical aspect ratio.
   */
  public const VIDEO_ASPECT_RATIO_REQUIREMENT_VERTICAL = 'VERTICAL';
  /**
   ...
   * @var string
   */
  public $videoAspectRatioRequirement;
   ...
   * advertiser upload any YouTube video, regardless of aspect ratio.
   *
   * Accepted values: UNSPECIFIED, UNKNOWN, HORIZONTAL, SQUARE, VERTICAL
   *
   * @param self::VIDEO_ASPECT_RATIO_REQUIREMENT_* $videoAspectRatioRequirement
   */
  public function setVideoAspectRatioRequirement($videoAspectRatioRequirement)
  {
    $this->videoAspectRatioRequirement = $videoAspectRatioRequirement;
  }
  /**
   * @return self::VIDEO_ASPECT_RATIO_REQUIREMENT_*
   */
  public function getVideoAspectRatioRequirement()
  {
    return $this->videoAspectRatioRequirement;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleAdsSearchads360V23ResourcesAdStrengthActionItemAddAssetDetails::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAdStrengthActionItemAddAssetDetails');
