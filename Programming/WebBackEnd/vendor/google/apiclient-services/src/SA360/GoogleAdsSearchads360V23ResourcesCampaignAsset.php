...
class GoogleAdsSearchads360V23ResourcesCampaignAsset extends \Google\Collection
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesCampaignAsset::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesCampaignAsset');
