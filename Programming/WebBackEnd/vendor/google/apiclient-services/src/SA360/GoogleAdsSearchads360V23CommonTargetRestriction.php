...
class GoogleAdsSearchads360V23CommonTargetRestriction extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonTargetRestriction::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonTargetRestriction');
