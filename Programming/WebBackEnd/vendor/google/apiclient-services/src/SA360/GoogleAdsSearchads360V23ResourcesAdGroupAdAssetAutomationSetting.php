...
class GoogleAdsSearchads360V23ResourcesAdGroupAdAssetAutomationSetting extends \Google\Model
{
  /**
   * Not specified.
   */
   ...
   */
  public const ASSET_AUTOMATION_TYPE_GENERATE_LANDING_PAGE_TEXT = 'GENERATE_LANDING_PAGE_TEXT';
  /**
   ...
   * by default for Performance Max campaigns. Enabling final URL expansion also
   ...
   * GENERATE_LANDING_PAGE_PREVIEW, GENERATE_LANDING_PAGE_TEXT,
...
class_alias(GoogleAdsSearchads360V23ResourcesAdGroupAdAssetAutomationSetting::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAdGroupAdAssetAutomationSetting');
