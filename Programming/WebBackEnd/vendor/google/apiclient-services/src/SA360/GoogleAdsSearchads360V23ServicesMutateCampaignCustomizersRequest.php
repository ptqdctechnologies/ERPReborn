...
class GoogleAdsSearchads360V23ServicesMutateCampaignCustomizersRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCampaignCustomizerOperation::class;
   ...
   * customizers.
   *
   * @param GoogleAdsSearchads360V23ServicesCampaignCustomizerOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignCustomizersRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignCustomizersRequest');
