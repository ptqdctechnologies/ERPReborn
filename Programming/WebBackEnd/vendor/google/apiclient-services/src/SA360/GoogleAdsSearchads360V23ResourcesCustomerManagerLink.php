...
class GoogleAdsSearchads360V23ResourcesCustomerManagerLink extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesCustomerManagerLink::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesCustomerManagerLink');
