...
class GoogleAdsSearchads360V23ServicesMutateAdGroupAssetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdGroupAssetOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAdGroupAssetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupAssetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupAssetsRequest');
