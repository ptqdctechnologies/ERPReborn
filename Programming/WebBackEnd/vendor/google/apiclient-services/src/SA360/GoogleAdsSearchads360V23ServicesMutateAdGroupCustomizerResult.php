...
class GoogleAdsSearchads360V23ServicesMutateAdGroupCustomizerResult extends \Google\Model
{
  ...
  /**
   * The mutated AdGroupCustomizer with only mutable fields after mutate. The
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupCustomizerResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupCustomizerResult');
