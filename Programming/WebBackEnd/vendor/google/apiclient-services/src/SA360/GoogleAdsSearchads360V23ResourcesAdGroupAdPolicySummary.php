...
class GoogleAdsSearchads360V23ResourcesAdGroupAdPolicySummary extends \Google\Collection
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesAdGroupAdPolicySummary::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAdGroupAdPolicySummary');
