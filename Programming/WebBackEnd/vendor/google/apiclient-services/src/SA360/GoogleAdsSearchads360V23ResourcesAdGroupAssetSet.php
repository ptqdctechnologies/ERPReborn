...
class GoogleAdsSearchads360V23ResourcesAdGroupAssetSet extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesAdGroupAssetSet::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAdGroupAssetSet');
