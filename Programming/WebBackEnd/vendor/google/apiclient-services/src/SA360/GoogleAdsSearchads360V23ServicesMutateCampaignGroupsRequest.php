...
class GoogleAdsSearchads360V23ServicesMutateCampaignGroupsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCampaignGroupOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesCampaignGroupOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignGroupsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignGroupsRequest');
