...
class GoogleAdsSearchads360V23ResourcesCampaignGeoTargetTypeSetting extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesCampaignGeoTargetTypeSetting::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesCampaignGeoTargetTypeSetting');
