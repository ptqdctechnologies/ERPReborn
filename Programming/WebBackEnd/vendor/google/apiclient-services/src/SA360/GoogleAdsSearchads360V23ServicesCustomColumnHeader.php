...
class GoogleAdsSearchads360V23ServicesCustomColumnHeader extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ServicesCustomColumnHeader::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesCustomColumnHeader');
