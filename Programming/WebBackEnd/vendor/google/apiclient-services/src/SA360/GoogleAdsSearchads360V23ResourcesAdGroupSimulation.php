...
class GoogleAdsSearchads360V23ResourcesAdGroupSimulation extends \Google\Model
{
  /**
   * Not specified.
   */
  ...
  protected $cpvBidPointListType = GoogleAdsSearchads360V23CommonCpvBidSimulationPointList::class;
  protected $cpvBidPointListDataType = '';
  /**
  ...
  /**
   * Output only. The resource name of the ad group simulation. Ad group
   * simulation resource names have the form: `customers/{customer_id}/adGroupSi
   * mulations/{ad_group_id}~{type}~{modification_method}~{start_date}~{end_date
   * }`
   *
   * @var string
   */
   ...
   *
   * @param GoogleAdsSearchads360V23CommonCpvBidSimulationPointList $cpvBidPointList
   */
  public function setCpvBidPointList(GoogleAdsSearchads360V23CommonCpvBidSimulationPointList $cpvBidPointList)
  {
    $this->cpvBidPointList = $cpvBidPointList;
  }
  /**
   * @return GoogleAdsSearchads360V23CommonCpvBidSimulationPointList
   */
  public function getCpvBidPointList()
  {
    return $this->cpvBidPointList;
  }
  /**
   * Output only. Last day on which the simulation is based, in YYYY-MM-DD
   * format
...
class_alias(GoogleAdsSearchads360V23ResourcesAdGroupSimulation::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAdGroupSimulation');
