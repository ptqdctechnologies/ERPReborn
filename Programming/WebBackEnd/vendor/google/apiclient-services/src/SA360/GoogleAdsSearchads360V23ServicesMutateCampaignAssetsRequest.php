...
class GoogleAdsSearchads360V23ServicesMutateCampaignAssetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCampaignAssetOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesCampaignAssetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignAssetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignAssetsRequest');
