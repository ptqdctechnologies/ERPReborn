...
class GoogleAdsSearchads360V23ResourcesCustomerCustomizer extends \Google\Model
{
  /**
  ...
  /**
   * Immutable. The resource name of the customer customizer. Customer
   * customizer resource names have the form:
...
class_alias(GoogleAdsSearchads360V23ResourcesCustomerCustomizer::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesCustomerCustomizer');
