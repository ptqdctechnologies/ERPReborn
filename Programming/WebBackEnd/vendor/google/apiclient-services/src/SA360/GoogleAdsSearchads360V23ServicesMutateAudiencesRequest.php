...
class GoogleAdsSearchads360V23ServicesMutateAudiencesRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAudienceOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAudienceOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAudiencesRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAudiencesRequest');
