...
class GoogleAdsSearchads360V23CommonCallToActionAsset extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonCallToActionAsset::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonCallToActionAsset');
