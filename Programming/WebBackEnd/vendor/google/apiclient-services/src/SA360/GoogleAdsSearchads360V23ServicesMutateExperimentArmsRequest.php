...
class GoogleAdsSearchads360V23ServicesMutateExperimentArmsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesExperimentArmOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesExperimentArmOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateExperimentArmsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateExperimentArmsRequest');
