...
class GoogleAdsSearchads360V23ResourcesAssetFieldTypeView extends \Google\Model
{
  /**
   * Not specified.
   */
  ...
  public $fieldType;
  /**
   * Output only. The resource name of the asset field type view. Asset field
   * type view resource names have the form:
...
class_alias(GoogleAdsSearchads360V23ResourcesAssetFieldTypeView::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAssetFieldTypeView');
