...
class GoogleAdsSearchads360V23ResourcesAssetGroupTopCombinationView extends \Google\Collection
{
  protected $collection_key = 'assetGroupTopCombinations';
  protected $assetGroupTopCombinationsType = GoogleAdsSearchads360V23ResourcesAssetGroupAssetCombinationData::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ResourcesAssetGroupAssetCombinationData[] $assetGroupTopCombinations
   */
  ...
  /**
   * @return GoogleAdsSearchads360V23ResourcesAssetGroupAssetCombinationData[]
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesAssetGroupTopCombinationView::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAssetGroupTopCombinationView');
