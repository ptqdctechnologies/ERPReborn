...
class GoogleAdsSearchads360V23ServicesMutateAdGroupAdLabelsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdGroupAdLabelOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAdGroupAdLabelOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupAdLabelsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupAdLabelsRequest');
