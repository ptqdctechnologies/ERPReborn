...
class GoogleAdsSearchads360V23ServicesMutateConversionValueRuleResult extends \Google\Model
{
  ...
  /**
   * The mutated conversion value rule with only mutable fields after mutate.
...
class_alias(GoogleAdsSearchads360V23ServicesMutateConversionValueRuleResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateConversionValueRuleResult');
