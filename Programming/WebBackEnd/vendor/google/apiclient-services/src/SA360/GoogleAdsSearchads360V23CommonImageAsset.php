...
class GoogleAdsSearchads360V23CommonImageAsset extends \Google\Model
{
  /**
   ...
   */
  public $fileSize;
  protected $fullSizeType = GoogleAdsSearchads360V23CommonImageDimension::class;
   ...
   *
   * @param GoogleAdsSearchads360V23CommonImageDimension $fullSize
   */
  public function setFullSize(GoogleAdsSearchads360V23CommonImageDimension $fullSize)
  {
    $this->fullSize = $fullSize;
  }
  /**
   * @return GoogleAdsSearchads360V23CommonImageDimension
   */
...
class_alias(GoogleAdsSearchads360V23CommonImageAsset::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonImageAsset');
