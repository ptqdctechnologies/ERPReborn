...
class GoogleAdsSearchads360V23ResourcesCampaignAssetSet extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesCampaignAssetSet::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesCampaignAssetSet');
