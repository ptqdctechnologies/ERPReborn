...
class GoogleAdsSearchads360V23ResourcesAdGroupCriterionEffectiveLabel extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesAdGroupCriterionEffectiveLabel::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAdGroupCriterionEffectiveLabel');
