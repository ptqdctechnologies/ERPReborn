...
class GoogleAdsSearchads360V23CommonTargetImpressionShare extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonTargetImpressionShare::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonTargetImpressionShare');
