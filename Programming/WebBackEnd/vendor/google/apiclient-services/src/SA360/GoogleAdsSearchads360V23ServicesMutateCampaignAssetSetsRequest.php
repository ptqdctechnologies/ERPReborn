...
class GoogleAdsSearchads360V23ServicesMutateCampaignAssetSetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCampaignAssetSetOperation::class;
   ...
   * sets.
   *
   * @param GoogleAdsSearchads360V23ServicesCampaignAssetSetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignAssetSetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignAssetSetsRequest');
