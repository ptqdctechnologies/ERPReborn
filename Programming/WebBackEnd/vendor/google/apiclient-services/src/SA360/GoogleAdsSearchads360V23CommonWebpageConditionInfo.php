...
class GoogleAdsSearchads360V23CommonWebpageConditionInfo extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonWebpageConditionInfo::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonWebpageConditionInfo');
