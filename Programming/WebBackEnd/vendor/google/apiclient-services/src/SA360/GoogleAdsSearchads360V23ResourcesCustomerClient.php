...
class GoogleAdsSearchads360V23ResourcesCustomerClient extends \Google\Collection
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesCustomerClient::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesCustomerClient');
