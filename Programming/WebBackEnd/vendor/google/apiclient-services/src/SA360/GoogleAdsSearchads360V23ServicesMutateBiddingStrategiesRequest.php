...
class GoogleAdsSearchads360V23ServicesMutateBiddingStrategiesRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesBiddingStrategyOperation::class;
   ...
   * strategies.
   *
   * @param GoogleAdsSearchads360V23ServicesBiddingStrategyOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateBiddingStrategiesRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateBiddingStrategiesRequest');
