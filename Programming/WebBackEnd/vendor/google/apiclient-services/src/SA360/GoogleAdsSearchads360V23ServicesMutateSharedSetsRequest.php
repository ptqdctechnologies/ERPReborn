...
class GoogleAdsSearchads360V23ServicesMutateSharedSetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesSharedSetOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesSharedSetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateSharedSetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateSharedSetsRequest');
