...
class GoogleAdsSearchads360V23ServicesMutateKeywordPlanAdGroupsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesKeywordPlanAdGroupOperation::class;
   ...
   * groups.
   *
   * @param GoogleAdsSearchads360V23ServicesKeywordPlanAdGroupOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateKeywordPlanAdGroupsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateKeywordPlanAdGroupsRequest');
