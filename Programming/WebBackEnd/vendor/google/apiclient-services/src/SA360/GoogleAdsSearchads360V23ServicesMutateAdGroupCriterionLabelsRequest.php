...
class GoogleAdsSearchads360V23ServicesMutateAdGroupCriterionLabelsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdGroupCriterionLabelOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAdGroupCriterionLabelOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupCriterionLabelsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupCriterionLabelsRequest');
