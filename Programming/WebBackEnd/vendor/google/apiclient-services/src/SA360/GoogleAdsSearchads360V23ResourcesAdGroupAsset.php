...
class GoogleAdsSearchads360V23ResourcesAdGroupAsset extends \Google\Collection
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesAdGroupAsset::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAdGroupAsset');
