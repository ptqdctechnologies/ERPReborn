...
class GoogleAdsSearchads360V23ResourcesExperimentArmAssetGroupAssetInfo extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesExperimentArmAssetGroupAssetInfo::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesExperimentArmAssetGroupAssetInfo');
