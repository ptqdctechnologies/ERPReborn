...
class GoogleAdsSearchads360V23CommonTargetSpend extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23CommonTargetSpend::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonTargetSpend');
