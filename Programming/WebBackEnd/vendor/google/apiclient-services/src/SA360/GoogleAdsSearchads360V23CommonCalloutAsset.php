...
class GoogleAdsSearchads360V23CommonCalloutAsset extends \Google\Collection
{
  ...
  /**
   * Required. The callout text. The length of this string should be between 1
   * and 25, inclusive.
   *
   * @var string
   */
...
class_alias(GoogleAdsSearchads360V23CommonCalloutAsset::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonCalloutAsset');
