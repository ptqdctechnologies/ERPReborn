...
class GoogleAdsSearchads360V23ServicesMutateAdGroupLabelsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdGroupLabelOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAdGroupLabelOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupLabelsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupLabelsRequest');
