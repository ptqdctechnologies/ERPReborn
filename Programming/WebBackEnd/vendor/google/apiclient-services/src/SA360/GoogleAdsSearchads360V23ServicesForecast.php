...
class GoogleAdsSearchads360V23ServicesForecast extends \Google\Collection
{
   ...
   */
  public $conversions;
  protected $effectiveFrequencyBreakdownsType = GoogleAdsSearchads360V23ServicesEffectiveFrequencyBreakdown::class;
   ...
   * matches the Targeting. Note that a minimum number of unique people must be
   * reached in order for data to be reported. If the minimum number is not met,
   * the on_target_reach value will be rounded to 0.
   *
   * @var string
   */
   ...
   * people that may fall outside the specified Targeting. Note that a minimum
   * number of unique people must be reached in order for data to be reported.
   * If the minimum number is not met, the total_reach value will be rounded to
   * 0.
   *
   * @var string
   */
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesEffectiveFrequencyBreakdown[] $effectiveFrequencyBreakdowns
   */
  ...
  /**
   * @return GoogleAdsSearchads360V23ServicesEffectiveFrequencyBreakdown[]
   */
...
class_alias(GoogleAdsSearchads360V23ServicesForecast::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesForecast');
