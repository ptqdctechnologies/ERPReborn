...
class GoogleAdsSearchads360V23ServicesMutateCustomerCustomizerResult extends \Google\Model
{
  ...
  /**
   * The mutated CustomerCustomizer with only mutable fields after mutate. The
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCustomerCustomizerResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCustomerCustomizerResult');
