...
class GoogleAdsSearchads360V23ServicesCreateCustomerClientResponse extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ServicesCreateCustomerClientResponse::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesCreateCustomerClientResponse');
