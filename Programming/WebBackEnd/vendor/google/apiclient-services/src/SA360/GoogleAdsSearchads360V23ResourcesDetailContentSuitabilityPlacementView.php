...
class GoogleAdsSearchads360V23ResourcesDetailContentSuitabilityPlacementView extends \Google\Model
{
  /**
   * Not specified.
   */
   ...
   * form: `customers/{customer_id}/detailContentSuitabilityPlacementViews/{plac
   * ement_fingerprint}`
   *
   * @var string
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesDetailContentSuitabilityPlacementView::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesDetailContentSuitabilityPlacementView');
