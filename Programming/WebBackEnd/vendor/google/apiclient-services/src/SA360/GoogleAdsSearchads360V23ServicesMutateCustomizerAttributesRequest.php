...
class GoogleAdsSearchads360V23ServicesMutateCustomizerAttributesRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCustomizerAttributeOperation::class;
   ...
   * attributes.
   *
   * @param GoogleAdsSearchads360V23ServicesCustomizerAttributeOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCustomizerAttributesRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCustomizerAttributesRequest');
