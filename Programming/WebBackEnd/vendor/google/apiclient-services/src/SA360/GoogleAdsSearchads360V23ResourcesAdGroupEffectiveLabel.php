...
class GoogleAdsSearchads360V23ResourcesAdGroupEffectiveLabel extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesAdGroupEffectiveLabel::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAdGroupEffectiveLabel');
