...
class GoogleAdsSearchads360V23CommonPercentCpc extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23CommonPercentCpc::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonPercentCpc');
