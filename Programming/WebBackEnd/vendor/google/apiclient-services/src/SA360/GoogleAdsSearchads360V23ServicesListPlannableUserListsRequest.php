...
class GoogleAdsSearchads360V23ServicesListPlannableUserListsRequest extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ServicesListPlannableUserListsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesListPlannableUserListsRequest');
