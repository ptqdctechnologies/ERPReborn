...
class GoogleAdsSearchads360V23CommonLifecycleGoalValueSettings extends \Google\Model
{
  /**
  ...
  public function setHighLifetimeValue($highLifetimeValue)
  {
    $this->highLifetimeValue = $highLifetimeValue;
  }
  public function getHighLifetimeValue()
  {
    return $this->highLifetimeValue;
  }
...
class_alias(GoogleAdsSearchads360V23CommonLifecycleGoalValueSettings::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonLifecycleGoalValueSettings');
