...
class GoogleAdsSearchads360V23ServicesMutateCampaignAssetResult extends \Google\Model
{
  ...
  /**
   * The mutated campaign asset with only mutable fields after mutate. The field
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignAssetResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignAssetResult');
