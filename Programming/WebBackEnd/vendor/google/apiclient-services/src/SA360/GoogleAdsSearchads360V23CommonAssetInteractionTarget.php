...
class GoogleAdsSearchads360V23CommonAssetInteractionTarget extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23CommonAssetInteractionTarget::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonAssetInteractionTarget');
