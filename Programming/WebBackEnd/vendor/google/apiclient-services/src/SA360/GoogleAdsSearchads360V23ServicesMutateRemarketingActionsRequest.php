...
class GoogleAdsSearchads360V23ServicesMutateRemarketingActionsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesRemarketingActionOperation::class;
   ...
   * actions.
   *
   * @param GoogleAdsSearchads360V23ServicesRemarketingActionOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateRemarketingActionsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateRemarketingActionsRequest');
