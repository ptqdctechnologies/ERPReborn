...
class GoogleAdsSearchads360V23CommonWebpageInfo extends \Google\Collection
{
  protected $collection_key = 'conditions';
  protected $conditionsType = GoogleAdsSearchads360V23CommonWebpageConditionInfo::class;
  ...
  protected $sampleType = GoogleAdsSearchads360V23CommonWebpageSampleInfo::class;
   ...
   *
   * @param GoogleAdsSearchads360V23CommonWebpageConditionInfo[] $conditions
   */
  ...
  /**
   * @return GoogleAdsSearchads360V23CommonWebpageConditionInfo[]
   */
   ...
   *
   * @param GoogleAdsSearchads360V23CommonWebpageSampleInfo $sample
   */
  public function setSample(GoogleAdsSearchads360V23CommonWebpageSampleInfo $sample)
  {
    $this->sample = $sample;
  }
  /**
   * @return GoogleAdsSearchads360V23CommonWebpageSampleInfo
   */
...
class_alias(GoogleAdsSearchads360V23CommonWebpageInfo::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonWebpageInfo');
