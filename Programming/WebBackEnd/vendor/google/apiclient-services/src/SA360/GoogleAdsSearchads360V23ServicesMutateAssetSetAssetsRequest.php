...
class GoogleAdsSearchads360V23ServicesMutateAssetSetAssetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAssetSetAssetOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAssetSetAssetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAssetSetAssetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAssetSetAssetsRequest');
