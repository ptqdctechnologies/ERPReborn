...
class GoogleAdsSearchads360V23ResourcesListingGroupFilterDimensionProductCategory extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesListingGroupFilterDimensionProductCategory::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesListingGroupFilterDimensionProductCategory');
