...
class GoogleAdsSearchads360V23ServicesMutateCustomerAssetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCustomerAssetOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesCustomerAssetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCustomerAssetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCustomerAssetsRequest');
