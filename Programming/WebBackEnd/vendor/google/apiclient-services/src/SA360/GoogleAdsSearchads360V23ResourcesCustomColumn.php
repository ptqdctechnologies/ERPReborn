...
class GoogleAdsSearchads360V23ResourcesCustomColumn extends \Google\Collection
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesCustomColumn::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesCustomColumn');
