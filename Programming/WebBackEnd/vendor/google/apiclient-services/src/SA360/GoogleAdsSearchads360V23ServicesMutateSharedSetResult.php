...
class GoogleAdsSearchads360V23ServicesMutateSharedSetResult extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ServicesMutateSharedSetResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateSharedSetResult');
