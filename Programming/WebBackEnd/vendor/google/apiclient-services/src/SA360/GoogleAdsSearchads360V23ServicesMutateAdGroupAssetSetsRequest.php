...
class GoogleAdsSearchads360V23ServicesMutateAdGroupAssetSetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdGroupAssetSetOperation::class;
   ...
   * sets.
   *
   * @param GoogleAdsSearchads360V23ServicesAdGroupAssetSetOperation[] $operations
   */
  ...
  /**
   * @return GoogleAdsSearchads360V23ServicesAdGroupAssetSetOperation[]
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupAssetSetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupAssetSetsRequest');
