...
class GoogleAdsSearchads360V23ResourcesListingGroupFilterDimensionProductType extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesListingGroupFilterDimensionProductType::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesListingGroupFilterDimensionProductType');
