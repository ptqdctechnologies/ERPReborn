...
class GoogleAdsSearchads360V23ServicesMutateAdGroupCustomizersRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdGroupCustomizerOperation::class;
   ...
   * customizers.
   *
   * @param GoogleAdsSearchads360V23ServicesAdGroupCustomizerOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupCustomizersRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupCustomizersRequest');
