...
class GoogleAdsSearchads360V23ServicesMutateCampaignCustomizerResult extends \Google\Model
{
  ...
  /**
   * The mutated CampaignCustomizer with only mutable fields after mutate. The
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignCustomizerResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignCustomizerResult');
