...
class GoogleAdsSearchads360V23ServicesMutateAdGroupCriteriaRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdGroupCriterionOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAdGroupCriterionOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupCriteriaRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupCriteriaRequest');
