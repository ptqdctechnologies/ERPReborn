...
class GoogleAdsSearchads360V23ResourcesConversionActionFloodlightSettings extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesConversionActionFloodlightSettings::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesConversionActionFloodlightSettings');
