...
class GoogleAdsSearchads360V23ServicesMutateCustomerAssetResult extends \Google\Model
{
  ...
  /**
   * The mutated customer asset with only mutable fields after mutate. The field
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCustomerAssetResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCustomerAssetResult');
