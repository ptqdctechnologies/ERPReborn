...
class GoogleAdsSearchads360V23ServicesMutateAdGroupAssetResult extends \Google\Model
{
  ...
  /**
   * The mutated ad group asset with only mutable fields after mutate. The field
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupAssetResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupAssetResult');
