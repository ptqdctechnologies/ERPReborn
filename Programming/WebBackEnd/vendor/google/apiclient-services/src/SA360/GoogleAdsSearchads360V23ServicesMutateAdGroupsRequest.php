...
class GoogleAdsSearchads360V23ServicesMutateAdGroupsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdGroupOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAdGroupOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupsRequest');
