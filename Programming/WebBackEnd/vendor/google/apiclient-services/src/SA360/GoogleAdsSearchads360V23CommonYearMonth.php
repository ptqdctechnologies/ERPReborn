...
class GoogleAdsSearchads360V23CommonYearMonth extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonYearMonth::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonYearMonth');
