...
class GoogleAdsSearchads360V23ServicesMutateCampaignLabelsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesCampaignLabelOperation::class;
   ...
   * relationships.
   *
   * @param GoogleAdsSearchads360V23ServicesCampaignLabelOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignLabelsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignLabelsRequest');
