...
class GoogleAdsSearchads360V23ServicesMutateCustomerLabelsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesCustomerLabelOperation::class;
   ...
   * relationships.
   *
   * @param GoogleAdsSearchads360V23ServicesCustomerLabelOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCustomerLabelsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCustomerLabelsRequest');
