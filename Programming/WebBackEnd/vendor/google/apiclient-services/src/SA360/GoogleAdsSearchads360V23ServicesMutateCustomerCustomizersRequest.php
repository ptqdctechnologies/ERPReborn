...
class GoogleAdsSearchads360V23ServicesMutateCustomerCustomizersRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCustomerCustomizerOperation::class;
   ...
   * customizers.
   *
   * @param GoogleAdsSearchads360V23ServicesCustomerCustomizerOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCustomerCustomizersRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCustomerCustomizersRequest');
