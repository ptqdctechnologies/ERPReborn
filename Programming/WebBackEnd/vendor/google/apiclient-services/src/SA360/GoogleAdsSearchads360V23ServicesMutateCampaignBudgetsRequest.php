...
class GoogleAdsSearchads360V23ServicesMutateCampaignBudgetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCampaignBudgetOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesCampaignBudgetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignBudgetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignBudgetsRequest');
