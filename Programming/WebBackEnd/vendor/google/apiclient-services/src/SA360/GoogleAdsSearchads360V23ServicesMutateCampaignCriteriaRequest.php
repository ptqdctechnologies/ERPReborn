...
class GoogleAdsSearchads360V23ServicesMutateCampaignCriteriaRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCampaignCriterionOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesCampaignCriterionOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignCriteriaRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignCriteriaRequest');
