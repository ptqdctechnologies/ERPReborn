...
class GoogleAdsSearchads360V23ResourcesPerformanceMaxPlacementView extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesPerformanceMaxPlacementView::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesPerformanceMaxPlacementView');
