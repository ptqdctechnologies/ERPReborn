...
class GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategy extends \Google\Model
{
  /**
   * Not specified.
   */
   ...
   */
  public const TYPE_TARGET_CPC = 'TARGET_CPC';
  /**
   ...
   */
  public $id;
  protected $maximizeConversionValueType = GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyMaximizeConversionValue::class;
  protected $maximizeConversionValueDataType = '';
  protected $maximizeConversionsType = GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyMaximizeConversions::class;
   ...
   */
  public $resourceName;
  protected $targetCpaType = GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetCpa::class;
  protected $targetCpaDataType = '';
  protected $targetImpressionShareType = GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetImpressionShare::class;
  protected $targetImpressionShareDataType = '';
  protected $targetRoasType = GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetRoas::class;
  protected $targetRoasDataType = '';
  protected $targetSpendType = GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetSpend::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyMaximizeConversionValue $maximizeConversionValue
   */
  public function setMaximizeConversionValue(GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyMaximizeConversionValue $maximizeConversionValue)
  {
    $this->maximizeConversionValue = $maximizeConversionValue;
  }
  /**
   * @return GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyMaximizeConversionValue
   */
   ...
   *
   * @param GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyMaximizeConversions $maximizeConversions
   */
  public function setMaximizeConversions(GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyMaximizeConversions $maximizeConversions)
  {
    $this->maximizeConversions = $maximizeConversions;
  }
  /**
   * @return GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyMaximizeConversions
   */
   ...
   * conversions as possible at the target cost-per-acquisition (CPA) you set.
   *
   * @param GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetCpa $targetCpa
   */
  public function setTargetCpa(GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetCpa $targetCpa)
  {
    $this->targetCpa = $targetCpa;
  }
  /**
   * @return GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetCpa
   */
   ...
   *
   * @param GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetImpressionShare $targetImpressionShare
   */
  public function setTargetImpressionShare(GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetImpressionShare $targetImpressionShare)
  {
    $this->targetImpressionShare = $targetImpressionShare;
  }
  /**
   * @return GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetImpressionShare
   */
   ...
   *
   * @param GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetRoas $targetRoas
   */
  public function setTargetRoas(GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetRoas $targetRoas)
  {
    $this->targetRoas = $targetRoas;
  }
  /**
   * @return GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetRoas
   */
   ...
   *
   * @param GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetSpend $targetSpend
   */
  public function setTargetSpend(GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetSpend $targetSpend)
  {
    $this->targetSpend = $targetSpend;
  }
  /**
   * @return GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetSpend
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategy::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategy');
