...
class GoogleAdsSearchads360V23ResourcesAdGroupAdAssetPolicySummary extends \Google\Collection
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesAdGroupAdAssetPolicySummary::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAdGroupAdAssetPolicySummary');
