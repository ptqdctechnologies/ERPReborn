...
class GoogleAdsSearchads360V23ServicesMutateBiddingDataExclusionsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesBiddingDataExclusionOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesBiddingDataExclusionOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateBiddingDataExclusionsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateBiddingDataExclusionsRequest');
