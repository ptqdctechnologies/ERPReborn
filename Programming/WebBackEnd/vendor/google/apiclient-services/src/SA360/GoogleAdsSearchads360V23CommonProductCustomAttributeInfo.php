...
class GoogleAdsSearchads360V23CommonProductCustomAttributeInfo extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonProductCustomAttributeInfo::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonProductCustomAttributeInfo');
