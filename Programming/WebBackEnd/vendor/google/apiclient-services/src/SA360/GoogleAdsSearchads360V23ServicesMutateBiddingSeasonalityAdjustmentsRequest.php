...
class GoogleAdsSearchads360V23ServicesMutateBiddingSeasonalityAdjustmentsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesBiddingSeasonalityAdjustmentOperation::class;
   ...
   * adjustments.
   *
   * @param GoogleAdsSearchads360V23ServicesBiddingSeasonalityAdjustmentOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateBiddingSeasonalityAdjustmentsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateBiddingSeasonalityAdjustmentsRequest');
