...
class GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetSpend extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetSpend::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetSpend');
