...
class GoogleAdsSearchads360V23ResourcesLeadFormSubmissionField extends \Google\Model
{
  /**
   * Not specified.
   */
   ...
   */
  public const FIELD_TYPE_FULL_NAME = 'FULL_NAME';
  /**
   ...
   */
  public const FIELD_TYPE_STREET_ADDRESS = 'STREET_ADDRESS';
  /**
   * The user will be asked to fill in their city.
   */
  public const FIELD_TYPE_CITY = 'CITY';
  /**
   ...
   */
  public const FIELD_TYPE_WORK_EMAIL = 'WORK_EMAIL';
  /**
   * The user will be asked to fill in their company name.
   */
  public const FIELD_TYPE_COMPANY_NAME = 'COMPANY_NAME';
  /**
   * The user will be asked to fill in their work phone.
   */
  public const FIELD_TYPE_WORK_PHONE = 'WORK_PHONE';
  /**
   * The user will be asked to fill in their job title.
   */
  public const FIELD_TYPE_JOB_TITLE = 'JOB_TITLE';
  /**
   * The user will be asked to fill in their CPF for Brazil users.
   */
  public const FIELD_TYPE_GOVERNMENT_ISSUED_ID_CPF_BR = 'GOVERNMENT_ISSUED_ID_CPF_BR';
  /**
   * The user will be asked to fill in their DNI for Argentina users.
   */
  public const FIELD_TYPE_GOVERNMENT_ISSUED_ID_DNI_AR = 'GOVERNMENT_ISSUED_ID_DNI_AR';
  /**
   * The user will be asked to fill in their DNI for Peru users.
   */
  public const FIELD_TYPE_GOVERNMENT_ISSUED_ID_DNI_PE = 'GOVERNMENT_ISSUED_ID_DNI_PE';
  /**
   * The user will be asked to fill in their RUT for Chile users.
   */
  public const FIELD_TYPE_GOVERNMENT_ISSUED_ID_RUT_CL = 'GOVERNMENT_ISSUED_ID_RUT_CL';
  /**
   * The user will be asked to fill in their CC for Colombia users.
   */
  public const FIELD_TYPE_GOVERNMENT_ISSUED_ID_CC_CO = 'GOVERNMENT_ISSUED_ID_CC_CO';
  /**
   * The user will be asked to fill in their CI for Ecuador users.
   */
  public const FIELD_TYPE_GOVERNMENT_ISSUED_ID_CI_EC = 'GOVERNMENT_ISSUED_ID_CI_EC';
  /**
   * The user will be asked to fill in their RFC for Mexico users.
   */
  public const FIELD_TYPE_GOVERNMENT_ISSUED_ID_RFC_MX = 'GOVERNMENT_ISSUED_ID_RFC_MX';
  /**
   * The user will be asked to fill in their first name. This field can not be
   * set at the same time as FULL_NAME.
   */
  public const FIELD_TYPE_FIRST_NAME = 'FIRST_NAME';
  /**
   * The user will be asked to fill in their last name. This field can not be
   * set at the same time as FULL_NAME.
   */
  public const FIELD_TYPE_LAST_NAME = 'LAST_NAME';
  /**
   ...
   */
  public const FIELD_TYPE_VEHICLE_MODEL = 'VEHICLE_MODEL';
  /**
   ...
   */
  public const FIELD_TYPE_VEHICLE_TYPE = 'VEHICLE_TYPE';
  /**
   * Question: "What is your preferred dealership?" Category: "Auto" This field
   * is subject to a limit of 5 qualifying questions per form and cannot be used
   * if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_PREFERRED_DEALERSHIP = 'PREFERRED_DEALERSHIP';
  /**
   ...
   */
  public const FIELD_TYPE_VEHICLE_PURCHASE_TIMELINE = 'VEHICLE_PURCHASE_TIMELINE';
  /**
   ...
   */
  public const FIELD_TYPE_VEHICLE_OWNERSHIP = 'VEHICLE_OWNERSHIP';
  /**
   ...
   */
  public const FIELD_TYPE_VEHICLE_PAYMENT_TYPE = 'VEHICLE_PAYMENT_TYPE';
  /**
   * Question: "What type of vehicle condition are you interested in?" Category:
   * "Auto" This field is subject to a limit of 5 qualifying questions per form
   * and cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_VEHICLE_CONDITION = 'VEHICLE_CONDITION';
  /**
   ...
   * be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_CATEGORY = 'CATEGORY';
  /**
   * Question: "What is your preferred method of contact?" Category: "General"
   * This field is subject to a limit of 5 qualifying questions per form and
   * cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_PREFERRED_CONTACT_METHOD = 'PREFERRED_CONTACT_METHOD';
  /**
   * Question: "What is your preferred location?" Category: "General" This field
   * is subject to a limit of 5 qualifying questions per form and cannot be used
   * if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_PREFERRED_LOCATION = 'PREFERRED_LOCATION';
  /**
   * Question: "What is the best time to contact you?" Category: "General" This
   * field is subject to a limit of 5 qualifying questions per form and cannot
   * be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_PREFERRED_CONTACT_TIME = 'PREFERRED_CONTACT_TIME';
  /**
   * Question: "When are you looking to make a purchase?" Category: "General"
   * This field is subject to a limit of 5 qualifying questions per form and
   * cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_PURCHASE_TIMELINE = 'PURCHASE_TIMELINE';
  /**
   * Question: "How many years of work experience do you have?" Category: "Jobs"
   * This field is subject to a limit of 5 qualifying questions per form and
   * cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_YEARS_OF_EXPERIENCE = 'YEARS_OF_EXPERIENCE';
  /**
   * Question: "What industry do you work in?" Category: "Jobs" This field is
   * subject to a limit of 5 qualifying questions per form and cannot be used if
   * values are set using custom_question_fields.
   */
  public const FIELD_TYPE_JOB_INDUSTRY = 'JOB_INDUSTRY';
  /**
   * Question: "What is your highest level of education?" Category: "Jobs" This
   * field is subject to a limit of 5 qualifying questions per form and cannot
   * be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_LEVEL_OF_EDUCATION = 'LEVEL_OF_EDUCATION';
  /**
   ...
   * and cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_PROPERTY_TYPE = 'PROPERTY_TYPE';
  /**
   * Question: "What do you need a realtor's help with?" Category: "Real Estate"
   * This field is subject to a limit of 5 qualifying questions per form and
   * cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_REALTOR_HELP_GOAL = 'REALTOR_HELP_GOAL';
  /**
   * Question: "What neighborhood are you interested in?" Category: "Real
   * Estate" This field is subject to a limit of 5 qualifying questions per form
   * and cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_PROPERTY_COMMUNITY = 'PROPERTY_COMMUNITY';
  /**
   * Question: "What price range are you looking for?" Category: "Real Estate"
   * This field is subject to a limit of 5 qualifying questions per form and
   * cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_PRICE_RANGE = 'PRICE_RANGE';
  /**
   * Question: "How many bedrooms are you looking for?" Category: "Real Estate"
   * This field is subject to a limit of 5 qualifying questions per form and
   * cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_NUMBER_OF_BEDROOMS = 'NUMBER_OF_BEDROOMS';
  /**
   * Question: "Are you looking for a fully furnished property?" Category: "Real
   * Estate" This field is subject to a limit of 5 qualifying questions per form
   * and cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_FURNISHED_PROPERTY = 'FURNISHED_PROPERTY';
  /**
   * Question: "Are you looking for properties that allow pets?" Category: "Real
   * Estate" This field is subject to a limit of 5 qualifying questions per form
   * and cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_PETS_ALLOWED_PROPERTY = 'PETS_ALLOWED_PROPERTY';
  /**
   ...
   */
  public const FIELD_TYPE_NEXT_PLANNED_PURCHASE = 'NEXT_PLANNED_PURCHASE';
  /**
   * Question: "Would you like to sign up for an event?" Category: "Retail" This
   * field is subject to a limit of 5 qualifying questions per form and cannot
   * be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_EVENT_SIGNUP_INTEREST = 'EVENT_SIGNUP_INTEREST';
  /**
   * Question: "Where are you interested in shopping?" Category: "Retail" This
   * field is subject to a limit of 5 qualifying questions per form and cannot
   * be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_PREFERRED_SHOPPING_PLACES = 'PREFERRED_SHOPPING_PLACES';
  /**
   * Question: "What is your favorite brand?" Category: "Retail" This field is
   * subject to a limit of 5 qualifying questions per form and cannot be used if
   * values are set using custom_question_fields.
   */
  public const FIELD_TYPE_FAVORITE_BRAND = 'FAVORITE_BRAND';
  /**
   ...
   */
  public const FIELD_TYPE_TRANSPORTATION_COMMERCIAL_LICENSE_TYPE = 'TRANSPORTATION_COMMERCIAL_LICENSE_TYPE';
  /**
   * Question: "Interested in booking an event?" Category: "Travel" This field
   * is subject to a limit of 5 qualifying questions per form and cannot be used
   * if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_EVENT_BOOKING_INTEREST = 'EVENT_BOOKING_INTEREST';
  /**
   * Question: "What is your destination country?" Category: "Travel" This field
   * is subject to a limit of 5 qualifying questions per form and cannot be used
   * if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_DESTINATION_COUNTRY = 'DESTINATION_COUNTRY';
  /**
   * Question: "What is your destination city?" Category: "Travel" This field is
   * subject to a limit of 5 qualifying questions per form and cannot be used if
   * values are set using custom_question_fields.
   */
  public const FIELD_TYPE_DESTINATION_CITY = 'DESTINATION_CITY';
  /**
   * Question: "What is your departure country?" Category: "Travel" This field
   * is subject to a limit of 5 qualifying questions per form and cannot be used
   * if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_DEPARTURE_COUNTRY = 'DEPARTURE_COUNTRY';
  /**
   * Question: "What is your departure city?" Category: "Travel" This field is
   * subject to a limit of 5 qualifying questions per form and cannot be used if
   * values are set using custom_question_fields.
   */
  public const FIELD_TYPE_DEPARTURE_CITY = 'DEPARTURE_CITY';
  /**
   * Question: "What is your departure date?" Category: "Travel" This field is
   * subject to a limit of 5 qualifying questions per form and cannot be used if
   * values are set using custom_question_fields.
   */
  public const FIELD_TYPE_DEPARTURE_DATE = 'DEPARTURE_DATE';
  /**
   * Question: "What is your return date?" Category: "Travel" This field is
   * subject to a limit of 5 qualifying questions per form and cannot be used if
   * values are set using custom_question_fields.
   */
  public const FIELD_TYPE_RETURN_DATE = 'RETURN_DATE';
  /**
   * Question: "How many people are you traveling with?" Category: "Travel" This
   * field is subject to a limit of 5 qualifying questions per form and cannot
   * be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_NUMBER_OF_TRAVELERS = 'NUMBER_OF_TRAVELERS';
  /**
   * Question: "What is your travel budget?" Category: "Travel" This field is
   * subject to a limit of 5 qualifying questions per form and cannot be used if
   * values are set using custom_question_fields.
   */
  public const FIELD_TYPE_TRAVEL_BUDGET = 'TRAVEL_BUDGET';
  /**
   ...
   * form and cannot be used if values are set using custom_question_fields.
   */
  public const FIELD_TYPE_TRAVEL_ACCOMMODATION = 'TRAVEL_ACCOMMODATION';
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesLeadFormSubmissionField::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesLeadFormSubmissionField');
