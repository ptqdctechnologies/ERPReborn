...
class GoogleAdsSearchads360V23CommonUnifiedCallAsset extends \Google\Collection
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonUnifiedCallAsset::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonUnifiedCallAsset');
