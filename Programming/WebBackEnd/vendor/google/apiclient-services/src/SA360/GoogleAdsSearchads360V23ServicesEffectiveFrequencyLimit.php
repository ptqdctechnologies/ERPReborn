...
class GoogleAdsSearchads360V23ServicesEffectiveFrequencyLimit extends \Google\Model
{
  /**
   * The highest effective frequency value to include in
   * Forecast.effective_frequency_breakdowns. This field supports frequencies
   * 1-10, inclusive.
   *
   * @var int
   */
...
class_alias(GoogleAdsSearchads360V23ServicesEffectiveFrequencyLimit::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesEffectiveFrequencyLimit');
