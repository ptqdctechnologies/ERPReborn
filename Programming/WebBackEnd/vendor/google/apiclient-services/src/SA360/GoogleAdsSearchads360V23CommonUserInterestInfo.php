...
class GoogleAdsSearchads360V23CommonUserInterestInfo extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23CommonUserInterestInfo::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonUserInterestInfo');
