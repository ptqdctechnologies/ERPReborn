...
class GoogleAdsSearchads360V23ResourcesCampaignDynamicSearchAdsSetting extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesCampaignDynamicSearchAdsSetting::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesCampaignDynamicSearchAdsSetting');
