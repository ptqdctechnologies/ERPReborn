...
class GoogleAdsSearchads360V23ServicesMutateSharedCriteriaRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesSharedCriterionOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesSharedCriterionOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateSharedCriteriaRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateSharedCriteriaRequest');
