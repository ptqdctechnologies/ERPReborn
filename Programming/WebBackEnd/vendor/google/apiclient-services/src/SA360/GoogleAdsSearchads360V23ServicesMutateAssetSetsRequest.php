...
class GoogleAdsSearchads360V23ServicesMutateAssetSetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAssetSetOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAssetSetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAssetSetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAssetSetsRequest');
