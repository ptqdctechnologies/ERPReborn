...
class GoogleAdsSearchads360V23ServicesMutateCampaignBidModifiersRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCampaignBidModifierOperation::class;
   ...
   * modifiers.
   *
   * @param GoogleAdsSearchads360V23ServicesCampaignBidModifierOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignBidModifiersRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignBidModifiersRequest');
