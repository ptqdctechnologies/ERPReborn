...
class GoogleAdsSearchads360V23ServicesMutateCampaignsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCampaignOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesCampaignOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignsRequest');
