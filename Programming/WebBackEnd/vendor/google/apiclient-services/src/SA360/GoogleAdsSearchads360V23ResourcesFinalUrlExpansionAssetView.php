...
class GoogleAdsSearchads360V23ResourcesFinalUrlExpansionAssetView extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesFinalUrlExpansionAssetView::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesFinalUrlExpansionAssetView');
