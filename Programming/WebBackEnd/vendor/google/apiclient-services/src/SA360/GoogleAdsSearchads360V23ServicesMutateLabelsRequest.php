...
class GoogleAdsSearchads360V23ServicesMutateLabelsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesLabelOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesLabelOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateLabelsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateLabelsRequest');
