...
class GoogleAdsSearchads360V23CommonLocationAsset extends \Google\Collection
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonLocationAsset::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonLocationAsset');
