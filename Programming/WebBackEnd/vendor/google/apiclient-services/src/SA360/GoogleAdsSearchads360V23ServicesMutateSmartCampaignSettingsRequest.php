...
class GoogleAdsSearchads360V23ServicesMutateSmartCampaignSettingsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesSmartCampaignSettingOperation::class;
   ...
   * settings.
   *
   * @param GoogleAdsSearchads360V23ServicesSmartCampaignSettingOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateSmartCampaignSettingsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateSmartCampaignSettingsRequest');
