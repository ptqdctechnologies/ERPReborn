...
class GoogleAdsSearchads360V23ServicesMutateExperimentsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesExperimentOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesExperimentOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateExperimentsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateExperimentsRequest');
