...
class GoogleAdsSearchads360V23CommonPolicySummary extends \Google\Collection
{
  /**
...
class_alias(GoogleAdsSearchads360V23CommonPolicySummary::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonPolicySummary');
