...
class GoogleAdsSearchads360V23ResourcesConversionActionValueSettings extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesConversionActionValueSettings::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesConversionActionValueSettings');
