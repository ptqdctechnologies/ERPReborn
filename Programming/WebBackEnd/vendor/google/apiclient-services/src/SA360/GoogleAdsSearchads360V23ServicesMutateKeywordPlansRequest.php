...
class GoogleAdsSearchads360V23ServicesMutateKeywordPlansRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesKeywordPlanOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesKeywordPlanOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateKeywordPlansRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateKeywordPlansRequest');
