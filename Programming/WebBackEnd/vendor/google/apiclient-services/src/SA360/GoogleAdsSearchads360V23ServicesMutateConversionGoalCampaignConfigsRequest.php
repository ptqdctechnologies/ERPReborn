...
class GoogleAdsSearchads360V23ServicesMutateConversionGoalCampaignConfigsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesConversionGoalCampaignConfigOperation::class;
   ...
   * campaign config.
   *
   * @param GoogleAdsSearchads360V23ServicesConversionGoalCampaignConfigOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateConversionGoalCampaignConfigsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateConversionGoalCampaignConfigsRequest');
