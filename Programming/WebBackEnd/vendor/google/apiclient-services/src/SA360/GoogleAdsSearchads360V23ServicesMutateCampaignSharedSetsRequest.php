...
class GoogleAdsSearchads360V23ServicesMutateCampaignSharedSetsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCampaignSharedSetOperation::class;
   ...
   * sets.
   *
   * @param GoogleAdsSearchads360V23ServicesCampaignSharedSetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignSharedSetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignSharedSetsRequest');
