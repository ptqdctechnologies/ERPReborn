...
class GoogleAdsSearchads360V23ServicesMutateAdGroupAdsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdGroupAdOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAdGroupAdOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdGroupAdsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdGroupAdsRequest');
