...
class GoogleAdsSearchads360V23ServicesSuggestKeywordThemesResponseKeywordTheme extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ServicesSuggestKeywordThemesResponseKeywordTheme::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesSuggestKeywordThemesResponseKeywordTheme');
