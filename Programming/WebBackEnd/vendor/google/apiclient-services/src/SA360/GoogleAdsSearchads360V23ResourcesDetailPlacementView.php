...
class GoogleAdsSearchads360V23ResourcesDetailPlacementView extends \Google\Model
{
  /**
   * Not specified.
   */
   ...
   * @var string
   */
  public $groupPlacementTargetUrl;
  /**
  ...
  /**
   * Output only. The resource name of the detail placement view. Detail
   * placement view resource names have the form: `customers/{customer_id}/detai
   * lPlacementViews/{ad_group_id}~{base64_placement}`
   *
   * @var string
   */
  public $resourceName;
   ...
   * mobile application in app store, or a YouTube channel URL.
   *
   * @param string $groupPlacementTargetUrl
   */
  public function setGroupPlacementTargetUrl($groupPlacementTargetUrl)
  {
  ...
  {
    return $this->groupPlacementTargetUrl;
  }
  /**
   * Output only. The automatic placement string at detail level, e. g. website
   * URL, mobile application ID, or a YouTube video ID.
...
class_alias(GoogleAdsSearchads360V23ResourcesDetailPlacementView::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesDetailPlacementView');
