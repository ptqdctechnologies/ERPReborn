...
class GoogleAdsSearchads360V23CommonMetrics extends \Google\Collection
{
  /**
   * Not specified.
   */
  ...
  protected $conversionCustomMetricsType = GoogleAdsSearchads360V23CommonValue::class;
   ...
   */
  public $orders;
  protected $rawEventConversionMetricsType = GoogleAdsSearchads360V23CommonValue::class;
   ...
   *
   * @param GoogleAdsSearchads360V23CommonValue[] $conversionCustomMetrics
   */
   ...
   *
   * @param GoogleAdsSearchads360V23CommonValue[] $rawEventConversionMetrics
   */
...
class_alias(GoogleAdsSearchads360V23CommonMetrics::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonMetrics');
