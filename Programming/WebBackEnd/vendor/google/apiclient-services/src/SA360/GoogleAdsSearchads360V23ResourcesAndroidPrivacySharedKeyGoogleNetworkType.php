...
class GoogleAdsSearchads360V23ResourcesAndroidPrivacySharedKeyGoogleNetworkType extends \Google\Model
{
  /**
   * Not specified.
   */
   ...
   * ndroidPrivacySharedKeyGoogleNetworkTypes/{campaign_id}~{android_privacy_int
   * eraction_type}~{android_privacy_network_type}~{android_privacy_interaction_
   * date(yyyy-mm-dd)}`
   *
   * @var string
   */
   ...
   * retrieve the Aggregate API Report in Android Privacy Sandbox.
   *
   * @param string $sharedNetworkTypeKey
   */
  public function setSharedNetworkTypeKey($sharedNetworkTypeKey)
  {
  ...
  {
    return $this->sharedNetworkTypeKey;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleAdsSearchads360V23ResourcesAndroidPrivacySharedKeyGoogleNetworkType::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAndroidPrivacySharedKeyGoogleNetworkType');
