...
class GoogleAdsSearchads360V23ResourcesListingGroupFilterDimensionProductCondition extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesListingGroupFilterDimensionProductCondition::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesListingGroupFilterDimensionProductCondition');
