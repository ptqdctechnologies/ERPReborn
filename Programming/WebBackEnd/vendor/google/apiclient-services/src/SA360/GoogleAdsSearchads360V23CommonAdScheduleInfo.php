...
class GoogleAdsSearchads360V23CommonAdScheduleInfo extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonAdScheduleInfo::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonAdScheduleInfo');
