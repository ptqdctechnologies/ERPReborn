...
class GoogleAdsSearchads360V23ServicesMutateUserListsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesUserListOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesUserListOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateUserListsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateUserListsRequest');
