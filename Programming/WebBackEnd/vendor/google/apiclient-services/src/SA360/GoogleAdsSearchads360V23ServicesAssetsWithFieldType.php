...
class GoogleAdsSearchads360V23ServicesAssetsWithFieldType extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ServicesAssetsWithFieldType::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesAssetsWithFieldType');
