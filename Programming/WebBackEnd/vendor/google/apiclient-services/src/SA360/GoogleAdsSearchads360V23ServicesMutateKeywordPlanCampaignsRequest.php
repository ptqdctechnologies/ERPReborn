...
class GoogleAdsSearchads360V23ServicesMutateKeywordPlanCampaignsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesKeywordPlanCampaignOperation::class;
   ...
   * campaigns.
   *
   * @param GoogleAdsSearchads360V23ServicesKeywordPlanCampaignOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateKeywordPlanCampaignsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateKeywordPlanCampaignsRequest');
