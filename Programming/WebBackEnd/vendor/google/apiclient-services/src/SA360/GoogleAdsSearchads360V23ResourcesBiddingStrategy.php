...
class GoogleAdsSearchads360V23ResourcesBiddingStrategy extends \Google\Model
{
  /**
  ...
  /**
   * ID of the campaign budget that this portfolio bidding strategy is aligned
   * with. When a portfolio and a campaign budget are aligned, that means that
   * they are attached to the same set of campaigns. After a bidding strategy is
   * aligned with a campaign budget, campaigns that are added to the bidding
   * strategy must also use the aligned campaign budget.
   *
   * @var string
   */
  public $alignedCampaignBudgetId;
  /**
  ...
  protected $enhancedCpcType = GoogleAdsSearchads360V23CommonEnhancedCpc::class;
   ...
   * strategy must also use the aligned campaign budget.
   *
   * @param string $alignedCampaignBudgetId
   */
  public function setAlignedCampaignBudgetId($alignedCampaignBudgetId)
  {
  ...
  {
    return $this->alignedCampaignBudgetId;
  }
  /**
   * Output only. The number of campaigns attached to this bidding strategy.
   * This field is read-only.
   ...
   * likely.
   *
   * @param GoogleAdsSearchads360V23CommonEnhancedCpc $enhancedCpc
   */
  public function setEnhancedCpc(GoogleAdsSearchads360V23CommonEnhancedCpc $enhancedCpc)
  {
    $this->enhancedCpc = $enhancedCpc;
  }
  /**
   * @return GoogleAdsSearchads360V23CommonEnhancedCpc
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesBiddingStrategy::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesBiddingStrategy');
