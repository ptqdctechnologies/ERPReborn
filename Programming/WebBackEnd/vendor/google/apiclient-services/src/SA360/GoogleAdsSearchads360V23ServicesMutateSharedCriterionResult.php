...
class GoogleAdsSearchads360V23ServicesMutateSharedCriterionResult extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ServicesMutateSharedCriterionResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateSharedCriterionResult');
