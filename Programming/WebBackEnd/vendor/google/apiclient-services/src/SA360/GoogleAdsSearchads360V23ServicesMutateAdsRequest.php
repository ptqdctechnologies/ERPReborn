...
class GoogleAdsSearchads360V23ServicesMutateAdsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAdOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdsRequest');
