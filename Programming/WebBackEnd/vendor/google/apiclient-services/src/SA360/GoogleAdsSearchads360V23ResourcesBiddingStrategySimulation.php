...
class GoogleAdsSearchads360V23ResourcesBiddingStrategySimulation extends \Google\Model
{
  /**
   * Not specified.
   */
   ...
   * biddingStrategySimulations/{bidding_strategy_id}~{type}~{modification_metho
...
class_alias(GoogleAdsSearchads360V23ResourcesBiddingStrategySimulation::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesBiddingStrategySimulation');
