...
class GoogleAdsSearchads360V23ResourcesGranularLicenseStatus extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesGranularLicenseStatus::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesGranularLicenseStatus');
