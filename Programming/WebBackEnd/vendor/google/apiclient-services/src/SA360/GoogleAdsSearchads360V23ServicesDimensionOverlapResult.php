...
class GoogleAdsSearchads360V23ServicesDimensionOverlapResult extends \Google\Collection
{
  /**
   * Not specified.
   */
   ...
   */
  public $dimension;
  protected $itemsType = GoogleAdsSearchads360V23ServicesAudienceOverlapItem::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAudienceOverlapItem[] $items
   */
  ...
  /**
   * @return GoogleAdsSearchads360V23ServicesAudienceOverlapItem[]
   */
...
class_alias(GoogleAdsSearchads360V23ServicesDimensionOverlapResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesDimensionOverlapResult');
