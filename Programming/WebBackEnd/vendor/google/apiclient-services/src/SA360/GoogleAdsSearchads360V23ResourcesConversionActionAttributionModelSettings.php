...
class GoogleAdsSearchads360V23ResourcesConversionActionAttributionModelSettings extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesConversionActionAttributionModelSettings::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesConversionActionAttributionModelSettings');
