...
class GoogleAdsSearchads360V23ServicesMutateCustomizerAttributeResult extends \Google\Model
{
  ...
  /**
   * The mutated CustomizerAttribute with only mutable fields after mutate. The
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCustomizerAttributeResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCustomizerAttributeResult');
