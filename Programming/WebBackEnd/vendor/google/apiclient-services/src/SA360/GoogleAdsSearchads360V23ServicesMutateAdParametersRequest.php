...
class GoogleAdsSearchads360V23ServicesMutateAdParametersRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesAdParameterOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesAdParameterOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAdParametersRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAdParametersRequest');
