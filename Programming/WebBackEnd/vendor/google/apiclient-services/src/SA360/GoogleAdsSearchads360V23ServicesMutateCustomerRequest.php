...
class GoogleAdsSearchads360V23ServicesMutateCustomerRequest extends \Google\Model
{
  /**
  ...
  protected $operationType = GoogleAdsSearchads360V23ServicesCustomerOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesCustomerOperation $operation
   */
  public function setOperation(GoogleAdsSearchads360V23ServicesCustomerOperation $operation)
  {
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCustomerRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCustomerRequest');
