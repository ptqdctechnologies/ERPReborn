...
class GoogleAdsSearchads360V23CommonUnifiedLocationAsset extends \Google\Collection
{
  /**
   * Not specified.
   */
  ...
  protected $businessProfileLocationsType = GoogleAdsSearchads360V23CommonBusinessProfileLocation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23CommonBusinessProfileLocation[] $businessProfileLocations
   */
  ...
  /**
   * @return GoogleAdsSearchads360V23CommonBusinessProfileLocation[]
   */
...
class_alias(GoogleAdsSearchads360V23CommonUnifiedLocationAsset::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonUnifiedLocationAsset');
