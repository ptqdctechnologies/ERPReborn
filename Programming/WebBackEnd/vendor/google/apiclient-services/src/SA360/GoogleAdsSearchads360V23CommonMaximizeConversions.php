...
class GoogleAdsSearchads360V23CommonMaximizeConversions extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23CommonMaximizeConversions::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonMaximizeConversions');
