...
class GoogleAdsSearchads360V23CommonFinalAppUrl extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23CommonFinalAppUrl::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonFinalAppUrl');
