...
class GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetCpa extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetCpa::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetCpa');
