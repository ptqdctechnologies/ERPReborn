...
class GoogleAdsSearchads360V23CommonTargetCpaSimulationPoint extends \Google\Model
{
  /**
   ...
   * CPA targets relevant to the simulated entity are scaled by this modifier.
   *
   * @var 
   */
  public $targetCpaScalingModifier;
  /**
  ...
  public function setAppInstalls($appInstalls)
  {
  ...
  public function setInAppActions($inAppActions)
  {
  ...
  public function setTargetCpaScalingModifier($targetCpaScalingModifier)
  {
    $this->targetCpaScalingModifier = $targetCpaScalingModifier;
  }
  public function getTargetCpaScalingModifier()
  {
    return $this->targetCpaScalingModifier;
  }
  /**
   * Projected number of top slot impressions. Only search advertising channel
   * type supports this field.
...
class_alias(GoogleAdsSearchads360V23CommonTargetCpaSimulationPoint::class, 'Google_Service_SA360_GoogleAdsSearchads360V23CommonTargetCpaSimulationPoint');
