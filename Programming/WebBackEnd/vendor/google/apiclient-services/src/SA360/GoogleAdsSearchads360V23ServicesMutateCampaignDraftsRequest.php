...
class GoogleAdsSearchads360V23ServicesMutateCampaignDraftsRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesCampaignDraftOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesCampaignDraftOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCampaignDraftsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCampaignDraftsRequest');
