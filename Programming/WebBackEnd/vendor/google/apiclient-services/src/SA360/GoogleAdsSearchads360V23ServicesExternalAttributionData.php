...
class GoogleAdsSearchads360V23ServicesExternalAttributionData extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ServicesExternalAttributionData::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesExternalAttributionData');
