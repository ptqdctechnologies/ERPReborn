...
class GoogleAdsSearchads360V23ServicesMutateAssetGroupAssetsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesAssetGroupAssetOperation::class;
   ...
   * assets.
   *
   * @param GoogleAdsSearchads360V23ServicesAssetGroupAssetOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateAssetGroupAssetsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateAssetGroupAssetsRequest');
