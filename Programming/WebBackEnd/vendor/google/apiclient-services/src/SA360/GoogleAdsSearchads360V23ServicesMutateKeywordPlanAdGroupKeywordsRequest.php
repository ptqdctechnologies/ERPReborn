...
class GoogleAdsSearchads360V23ServicesMutateKeywordPlanAdGroupKeywordsRequest extends \Google\Collection
{
  protected $collection_key = 'operations';
  protected $operationsType = GoogleAdsSearchads360V23ServicesKeywordPlanAdGroupKeywordOperation::class;
   ...
   * group keywords.
   *
   * @param GoogleAdsSearchads360V23ServicesKeywordPlanAdGroupKeywordOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateKeywordPlanAdGroupKeywordsRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateKeywordPlanAdGroupKeywordsRequest');
