...
class GoogleAdsSearchads360V23ResourcesAdGroupAdEffectiveLabel extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesAdGroupAdEffectiveLabel::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAdGroupAdEffectiveLabel');
