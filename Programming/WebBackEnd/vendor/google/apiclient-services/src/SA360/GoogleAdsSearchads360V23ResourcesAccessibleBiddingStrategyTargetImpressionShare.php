...
class GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetImpressionShare extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetImpressionShare::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyTargetImpressionShare');
