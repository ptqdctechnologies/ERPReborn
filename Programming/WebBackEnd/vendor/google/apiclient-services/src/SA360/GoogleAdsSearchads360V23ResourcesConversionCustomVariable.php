...
class GoogleAdsSearchads360V23ResourcesConversionCustomVariable extends \Google\Collection
{
  /**
   * Not specified.
   */
   ...
   */
  public $family;
  protected $floodlightConversionCustomVariableInfoType = GoogleAdsSearchads360V23ResourcesConversionCustomVariableFloodlightConversionCustomVariableInfo::class;
   ...
   * variables.
   *
   * @param GoogleAdsSearchads360V23ResourcesConversionCustomVariableFloodlightConversionCustomVariableInfo $floodlightConversionCustomVariableInfo
   */
  public function setFloodlightConversionCustomVariableInfo(GoogleAdsSearchads360V23ResourcesConversionCustomVariableFloodlightConversionCustomVariableInfo $floodlightConversionCustomVariableInfo)
  {
    $this->floodlightConversionCustomVariableInfo = $floodlightConversionCustomVariableInfo;
  }
  /**
   * @return GoogleAdsSearchads360V23ResourcesConversionCustomVariableFloodlightConversionCustomVariableInfo
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesConversionCustomVariable::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesConversionCustomVariable');
