...
class GoogleAdsSearchads360V23ServicesMutateRecommendationSubscriptionRequest extends \Google\Collection
{
  /**
  ...
  protected $operationsType = GoogleAdsSearchads360V23ServicesRecommendationSubscriptionOperation::class;
   ...
   *
   * @param GoogleAdsSearchads360V23ServicesRecommendationSubscriptionOperation[] $operations
   */
...
class_alias(GoogleAdsSearchads360V23ServicesMutateRecommendationSubscriptionRequest::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateRecommendationSubscriptionRequest');
