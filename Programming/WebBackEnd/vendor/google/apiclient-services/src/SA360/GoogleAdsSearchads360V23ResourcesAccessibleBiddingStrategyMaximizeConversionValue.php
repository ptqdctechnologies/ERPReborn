...
class GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyMaximizeConversionValue extends \Google\Model
{
  /**
...
class_alias(GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyMaximizeConversionValue::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesAccessibleBiddingStrategyMaximizeConversionValue');
