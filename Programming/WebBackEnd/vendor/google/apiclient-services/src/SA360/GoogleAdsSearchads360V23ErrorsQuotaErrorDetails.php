...
class GoogleAdsSearchads360V23ErrorsQuotaErrorDetails extends \Google\Model
{
  /**
   * Unspecified enum
   */
...
class_alias(GoogleAdsSearchads360V23ErrorsQuotaErrorDetails::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ErrorsQuotaErrorDetails');
