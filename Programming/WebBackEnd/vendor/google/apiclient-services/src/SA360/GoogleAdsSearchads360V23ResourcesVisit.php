...
class GoogleAdsSearchads360V23ResourcesVisit extends \Google\Model
{
  /**
   * Not specified.
   */
...
class_alias(GoogleAdsSearchads360V23ResourcesVisit::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ResourcesVisit');
