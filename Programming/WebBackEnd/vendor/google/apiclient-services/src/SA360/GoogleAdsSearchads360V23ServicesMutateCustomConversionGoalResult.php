...
class GoogleAdsSearchads360V23ServicesMutateCustomConversionGoalResult extends \Google\Model
{
  ...
  /**
   * The mutated CustomConversionGoal with only mutable fields after mutate. The
...
class_alias(GoogleAdsSearchads360V23ServicesMutateCustomConversionGoalResult::class, 'Google_Service_SA360_GoogleAdsSearchads360V23ServicesMutateCustomConversionGoalResult');
