...
class GoogleCloudDialogflowV2KnowledgeAssistAnswerAdditionalSuggestedQueryResult extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(GoogleCloudDialogflowV2KnowledgeAssistAnswerAdditionalSuggestedQueryResult::class, 'Google_Service_Dialogflow_GoogleCloudDialogflowV2KnowledgeAssistAnswerAdditionalSuggestedQueryResult');
