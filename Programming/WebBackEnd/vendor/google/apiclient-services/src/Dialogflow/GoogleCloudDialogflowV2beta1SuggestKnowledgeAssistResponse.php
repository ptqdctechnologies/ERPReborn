...
class GoogleCloudDialogflowV2beta1SuggestKnowledgeAssistResponse extends \Google\Collection
{
   ...
   */
  public $contextSize;
  protected $knowledgeAssistAnswerType = GoogleCloudDialogflowV2beta1KnowledgeAssistAnswer::class;
  ...
  /**
   * @return GoogleCloudDialogflowV2beta1KnowledgeAssistAnswer
   */
...
class_alias(GoogleCloudDialogflowV2beta1SuggestKnowledgeAssistResponse::class, 'Google_Service_Dialogflow_GoogleCloudDialogflowV2beta1SuggestKnowledgeAssistResponse');
