...
class AggregateQueryStatsResponse extends \Google\Collection
{
  ...
  protected $queryStatsType = QueryStatsInfo::class;
   ...
   *
   * @param QueryStatsInfo[] $queryStats
   */
...
class_alias(AggregateQueryStatsResponse::class, 'Google_Service_DatabaseCenter_AggregateQueryStatsResponse');
