...
class AutomatedBackupPolicyInfo extends \Google\Model
{
  /**
...
class_alias(AutomatedBackupPolicyInfo::class, 'Google_Service_DatabaseCenter_AutomatedBackupPolicyInfo');
