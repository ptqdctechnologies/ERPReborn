...
class QueryIssuesResponse extends \Google\Collection
{
  ...
  protected $resourceIssuesType = DatabaseResourceIssue::class;
   ...
   *
   * @param DatabaseResourceIssue[] $resourceIssues
   */
...
class_alias(QueryIssuesResponse::class, 'Google_Service_DatabaseCenter_QueryIssuesResponse');
