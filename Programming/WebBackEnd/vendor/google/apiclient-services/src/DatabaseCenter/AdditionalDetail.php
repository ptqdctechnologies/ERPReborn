...
class AdditionalDetail extends \Google\Model
{
  /**
   * Unspecified.
   */
  public const SIGNAL_SOURCE_SIGNAL_SOURCE_UNSPECIFIED = 'SIGNAL_SOURCE_UNSPECIFIED';
  /**
   * Signal comes from resource metadata.
   */
  public const SIGNAL_SOURCE_SIGNAL_SOURCE_RESOURCE_METADATA = 'SIGNAL_SOURCE_RESOURCE_METADATA';
  /**
   * Signal comes from SCC findings.
   */
  public const SIGNAL_SOURCE_SIGNAL_SOURCE_SECURITY_FINDINGS = 'SIGNAL_SOURCE_SECURITY_FINDINGS';
  /**
   * Signal comes from recommender hub.
   */
  public const SIGNAL_SOURCE_SIGNAL_SOURCE_RECOMMENDER = 'SIGNAL_SOURCE_RECOMMENDER';
  /**
   * Signal comes from modern observability platform.
   */
  public const SIGNAL_SOURCE_SIGNAL_SOURCE_MODERN_OBSERVABILITY = 'SIGNAL_SOURCE_MODERN_OBSERVABILITY';
  /**
   * Unspecified.
   */
   ...
   */
  public const SIGNAL_TYPE_SIGNAL_TYPE_RESOURCE_FAILOVER_PROTECTED = 'SIGNAL_TYPE_RESOURCE_FAILOVER_PROTECTED';
  /**
   ...
   * regions.
   */
  public const SIGNAL_TYPE_SIGNAL_TYPE_GROUP_MULTIREGIONAL = 'SIGNAL_TYPE_GROUP_MULTIREGIONAL';
  /**
   ...
   */
  public const SIGNAL_TYPE_SIGNAL_TYPE_QUERY_STATS_LOGGED = 'SIGNAL_TYPE_QUERY_STATS_LOGGED';
  /**
   ...
   */
  public const SIGNAL_TYPE_SIGNAL_TYPE_EXCESSIVE_LOGGING_OF_PARSER_STATS = 'SIGNAL_TYPE_EXCESSIVE_LOGGING_OF_PARSER_STATS';
  /**
   * Represents if the log_planner_stats database flag for a Cloud SQL for
   * PostgreSQL instance is not set to off.
   */
  public const SIGNAL_TYPE_SIGNAL_TYPE_EXCESSIVE_LOGGING_OF_PLANNER_STATS = 'SIGNAL_TYPE_EXCESSIVE_LOGGING_OF_PLANNER_STATS';
  /**
   ...
   * PostgreSQL instance is not set to off.
   */
  public const SIGNAL_TYPE_SIGNAL_TYPE_LOGGING_QUERY_STATS = 'SIGNAL_TYPE_LOGGING_QUERY_STATS';
  /**
  ...
  protected $automatedBackupPolicyInfoType = AutomatedBackupPolicyInfo::class;
  protected $automatedBackupPolicyInfoDataType = '';
  protected $backupRunInfoType = BackupRunInfo::class;
  protected $backupRunInfoDataType = '';
  protected $deletionProtectionInfoType = DeletionProtectionInfo::class;
  protected $deletionProtectionInfoDataType = '';
  protected $inefficientQueryInfoType = InefficientQueryInfo::class;
  protected $inefficientQueryInfoDataType = '';
  protected $maintenanceRecommendationInfoType = MaintenanceRecommendationInfo::class;
  protected $maintenanceRecommendationInfoDataType = '';
  protected $outdatedMinorVersionInfoType = OutdatedMinorVersionInfo::class;
  protected $outdatedMinorVersionInfoDataType = '';
  protected $recommendationInfoType = RecommendationInfo::class;
  protected $recommendationInfoDataType = '';
  protected $resourceSuspensionInfoType = ResourceSuspensionInfo::class;
  protected $resourceSuspensionInfoDataType = '';
  protected $sccInfoType = SCCInfo::class;
  protected $sccInfoDataType = '';
  protected $shortBackupRetentionInfoType = RetentionSettingsInfo::class;
  protected $shortBackupRetentionInfoDataType = '';
  /**
   * Event time when signal was recorded by source service.
   *
   * @var string
   */
  public $signalEventTime;
  /**
   ...
   *
   * @param AutomatedBackupPolicyInfo $automatedBackupPolicyInfo
   */
  public function setAutomatedBackupPolicyInfo(AutomatedBackupPolicyInfo $automatedBackupPolicyInfo)
  {
  ...
  {
    return $this->automatedBackupPolicyInfo;
  }
  /**
   * Backup run information applies to signals with types
   * SIGNAL_TYPE_LAST_BACKUP_FAILED and SIGNAL_TYPE_LAST_BACKUP_OLD.
   *
   * @param BackupRunInfo $backupRunInfo
   */
  public function setBackupRunInfo(BackupRunInfo $backupRunInfo)
  {
  ...
  {
    return $this->backupRunInfo;
  }
  /**
   * Deletion protection information applies to signals with type
   * SIGNAL_TYPE_NO_DELETION_PROTECTION
   *
   * @param DeletionProtectionInfo $deletionProtectionInfo
   */
  public function setDeletionProtectionInfo(DeletionProtectionInfo $deletionProtectionInfo)
  {
   ...
   *
   * @param MaintenanceRecommendationInfo $maintenanceRecommendationInfo
   */
  public function setMaintenanceRecommendationInfo(MaintenanceRecommendationInfo $maintenanceRecommendationInfo)
  {
  ...
  {
    return $this->maintenanceRecommendationInfo;
  }
  /**
   * Outdated minor version information applies to signals with type
   * SIGNAL_TYPE_OUTDATED_MINOR_VERSION.
   *
   * @param OutdatedMinorVersionInfo $outdatedMinorVersionInfo
   */
  public function setOutdatedMinorVersionInfo(OutdatedMinorVersionInfo $outdatedMinorVersionInfo)
  {
  ...
  {
    return $this->outdatedMinorVersionInfo;
  }
  /**
   * Recommendation information applies to recommendations.
   *
   * @param RecommendationInfo $recommendationInfo
   */
  public function setRecommendationInfo(RecommendationInfo $recommendationInfo)
  {
   ...
   *
   * @param ResourceSuspensionInfo $resourceSuspensionInfo
   */
  public function setResourceSuspensionInfo(ResourceSuspensionInfo $resourceSuspensionInfo)
  {
  ...
  {
    return $this->resourceSuspensionInfo;
  }
  /**
   * SCC information applies to SCC signals.
   *
   * @param SCCInfo $sccInfo
   */
  public function setSccInfo(SCCInfo $sccInfo)
  {
   ...
   *
   * @param RetentionSettingsInfo $shortBackupRetentionInfo
   */
  public function setShortBackupRetentionInfo(RetentionSettingsInfo $shortBackupRetentionInfo)
  {
  ...
  {
    return $this->shortBackupRetentionInfo;
  }
  /**
   * Event time when signal was recorded by source service.
   *
   * @param string $signalEventTime
   */
  public function setSignalEventTime($signalEventTime)
  {
  ...
  {
    return $this->signalEventTime;
  }
  /**
   * Where the signal is coming from.
   *
   * Accepted values: SIGNAL_SOURCE_UNSPECIFIED,
   * SIGNAL_SOURCE_RESOURCE_METADATA, SIGNAL_SOURCE_SECURITY_FINDINGS,
   * SIGNAL_SOURCE_RECOMMENDER, SIGNAL_SOURCE_MODERN_OBSERVABILITY
   *
   * @param self::SIGNAL_SOURCE_* $signalSource
   */
  public function setSignalSource($signalSource)
  {
    $this->signalSource = $signalSource;
  }
  /**
   * @return self::SIGNAL_SOURCE_*
   */
   ...
   * SIGNAL_TYPE_RESOURCE_FAILOVER_PROTECTED, SIGNAL_TYPE_GROUP_MULTIREGIONAL,
   * SIGNAL_TYPE_NO_AUTOMATED_BACKUP_POLICY, SIGNAL_TYPE_SHORT_BACKUP_RETENTION,
   * SIGNAL_TYPE_LAST_BACKUP_FAILED, SIGNAL_TYPE_LAST_BACKUP_OLD,
   ...
   * SIGNAL_TYPE_MINIMAL_ERROR_LOGGING, SIGNAL_TYPE_QUERY_STATS_LOGGED,
   ...
   * SIGNAL_TYPE_LOGGING_QUERY_STATS, SIGNAL_TYPE_NOT_LOGGING_TEMPORARY_FILES,
   ...
   * SIGNAL_TYPE_NO_DELETION_PROTECTION, SIGNAL_TYPE_NO_POINT_IN_TIME_RECOVERY,
   * SIGNAL_TYPE_RESOURCE_SUSPENDED, SIGNAL_TYPE_EXPENSIVE_COMMANDS,
   * SIGNAL_TYPE_NO_MAINTENANCE_POLICY_CONFIGURED,
   * SIGNAL_TYPE_INEFFICIENT_QUERY, SIGNAL_TYPE_READ_INTENSIVE_WORKLOAD,
   * SIGNAL_TYPE_MEMORY_LIMIT, SIGNAL_TYPE_MAX_SERVER_MEMORY,
   * SIGNAL_TYPE_LARGE_ROWS, SIGNAL_TYPE_HIGH_WRITE_PRESSURE,
...
class_alias(AdditionalDetail::class, 'Google_Service_DatabaseCenter_AdditionalDetail');
