...
class DirectVpcIngressConnectionInfo extends \Google\Model
{
  /**
...
class_alias(DirectVpcIngressConnectionInfo::class, 'Google_Service_NetworkManagement_DirectVpcIngressConnectionInfo');
