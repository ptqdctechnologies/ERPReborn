...
class AnswerReference extends \Google\Model
{
  protected $documentReferenceType = DocumentReference::class;
...
class_alias(AnswerReference::class, 'Google_Service_DeveloperKnowledge_AnswerReference');
