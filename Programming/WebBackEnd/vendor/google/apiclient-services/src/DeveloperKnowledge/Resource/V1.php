 ...
 *   $v1 = $developerknowledgeService->v1;
 *  </code>
 */
class V1 extends \Google\Service\Resource
{
  /**
   * Answers a query using grounded generation. (v1.answerQuery)
   *
...
class_alias(V1::class, 'Google_Service_DeveloperKnowledge_Resource_V1');
