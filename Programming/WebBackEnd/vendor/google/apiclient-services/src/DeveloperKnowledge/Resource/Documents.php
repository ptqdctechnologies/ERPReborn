...
class Documents extends \Google\Service\Resource
{
   ...
   * fields support `=`, `<`, `<=`, `>`, and `>=` operators. Timestamps must be in
   * RFC-3339 format, e.g., `"2025-01-01T00:00:00Z"`. You can combine expressions
   ...
   * Examples: * Filter by `Document.content_length_bytes`: `content_length_bytes
