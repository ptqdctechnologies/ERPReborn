...
class GoogleCloudCesV1mainImage extends \Google\Model
{
  /**
...
class_alias(GoogleCloudCesV1mainImage::class, 'Google_Service_Contactcenterinsights_GoogleCloudCesV1mainImage');
