...
class GoogleCloudContactcenterinsightsV1alpha1ConversationTranscriptTranscriptSegment extends \Google\Collection
{
   ...
   */
  public $text;
  protected $turnLevelAudioType = GoogleCloudContactcenterinsightsV1alpha1ConversationDataSourceTurnLevelAudio::class;
   ...
   *
   * @param GoogleCloudContactcenterinsightsV1alpha1ConversationDataSourceTurnLevelAudio $turnLevelAudio
   */
  public function setTurnLevelAudio(GoogleCloudContactcenterinsightsV1alpha1ConversationDataSourceTurnLevelAudio $turnLevelAudio)
  {
...
class_alias(GoogleCloudContactcenterinsightsV1alpha1ConversationTranscriptTranscriptSegment::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1ConversationTranscriptTranscriptSegment');
