...
class ParameterVersion extends \Google\Model
{
   ...
   */
  public const CHECKSUM_SOURCE_CHECKSUM_SOURCE_UNSPECIFIED = 'CHECKSUM_SOURCE_UNSPECIFIED';
  /**
   * The checksum was generated by the server.
   */
  public const CHECKSUM_SOURCE_SERVER_GENERATED = 'SERVER_GENERATED';
  /**
   ...
   * USER_SPECIFIED
   *
   * @param self::CHECKSUM_SOURCE_* $checksumSource
   */
  public function setChecksumSource($checksumSource)
  {
    $this->checksumSource = $checksumSource;
  }
  /**
   * @return self::CHECKSUM_SOURCE_*
   */
