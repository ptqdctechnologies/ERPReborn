...
class PolicyResponse extends \Google\Model
{
  ...
  protected $groupResponseType = PolicyGroupResponse::class;
  protected $groupResponseDataType = '';
  protected $keyedGroupResponseType = PolicyKeyedGroupResponse::class;
  protected $keyedGroupResponseDataType = '';
   ...
   *
   * @param PolicyGroupResponse $groupResponse
   */
  public function setGroupResponse(PolicyGroupResponse $groupResponse)
  {
   ...
   *
   * @param PolicyKeyedGroupResponse $keyedGroupResponse
   */
  public function setKeyedGroupResponse(PolicyKeyedGroupResponse $keyedGroupResponse)
  {
    $this->keyedGroupResponse = $keyedGroupResponse;
  }
  /**
   * @return PolicyKeyedGroupResponse
   */
  public function getKeyedGroupResponse()
  {
    return $this->keyedGroupResponse;
  }
  /**
...
class_alias(PolicyResponse::class, 'Google_Service_AndroidPublisher_PolicyResponse');
