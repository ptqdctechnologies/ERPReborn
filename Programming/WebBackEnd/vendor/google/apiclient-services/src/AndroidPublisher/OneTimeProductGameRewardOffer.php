...
class OneTimeProductGameRewardOffer extends \Google\Model
{
  /**
...
class_alias(OneTimeProductGameRewardOffer::class, 'Google_Service_AndroidPublisher_OneTimeProductGameRewardOffer');
