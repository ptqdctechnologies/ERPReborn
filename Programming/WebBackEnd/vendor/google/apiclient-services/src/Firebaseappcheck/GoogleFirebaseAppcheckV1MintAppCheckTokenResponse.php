...
class GoogleFirebaseAppcheckV1MintAppCheckTokenResponse extends \Google\Model
{
  /**
   * The App Check token, used to access backend services protected by App
   * Check. App Check tokens are signed
...
class_alias(GoogleFirebaseAppcheckV1MintAppCheckTokenResponse::class, 'Google_Service_Firebaseappcheck_GoogleFirebaseAppcheckV1MintAppCheckTokenResponse');
