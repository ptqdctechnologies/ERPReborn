...
class NutrientQuantity extends \Google\Model
{
  /**
   ...
   */
  public $nutrient;
  protected $quantityType = WeightQuantity::class;
   ...
   */
  public function setQuantity(WeightQuantity $quantity)
  {
...
class_alias(NutrientQuantity::class, 'Google_Service_GoogleHealthAPI_NutrientQuantity');
