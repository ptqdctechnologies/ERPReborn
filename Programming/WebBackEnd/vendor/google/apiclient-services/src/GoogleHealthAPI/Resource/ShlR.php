 ...
 *   $r = $healthService->shl_r;
 *  </code>
 */
class ShlR extends \Google\Service\Resource
{
  /**
   * Forward a resource request for a given SHL (r.get)
   *
   ...
   * q
   * @param string $resourceToken Required. Encoded, encrypted message containing
   * resource access details
   * @param array $optParams Optional parameters.
   * @return HttpBody
   * @throws \Google\Service\Exception
   */
  public function get($externalShlId, $resourceToken, $optParams = [])
  {
    $params = ['externalShlId' => $externalShlId, 'resourceToken' => $resourceToken];
...
class_alias(ShlR::class, 'Google_Service_GoogleHealthAPI_Resource_ShlR');
