...
class GoogleCloudAiplatformV1CreateServingProfileOperationMetadata extends \Google\Model
{
...
class_alias(GoogleCloudAiplatformV1CreateServingProfileOperationMetadata::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1CreateServingProfileOperationMetadata');
