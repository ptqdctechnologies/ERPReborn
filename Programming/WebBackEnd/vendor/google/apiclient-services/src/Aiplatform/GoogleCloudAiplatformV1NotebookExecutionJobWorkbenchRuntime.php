...
class_alias(GoogleCloudAiplatformV1NotebookExecutionJobWorkbenchRuntime::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1NotebookExecutionJobWorkbenchRuntime');
