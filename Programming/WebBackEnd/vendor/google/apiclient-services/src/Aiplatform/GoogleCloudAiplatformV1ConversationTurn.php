...
class GoogleCloudAiplatformV1ConversationTurn extends \Google\Collection
{
  protected $collection_key = 'events';
  protected $eventsType = GoogleCloudAiplatformV1AgentEvent::class;
   ...
   *
   * @param GoogleCloudAiplatformV1AgentEvent[] $events
   */
  ...
  /**
   * @return GoogleCloudAiplatformV1AgentEvent[]
   */
...
class_alias(GoogleCloudAiplatformV1ConversationTurn::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1ConversationTurn');
