...
class GoogleCloudAiplatformV1NotebookExecutionJobCustomEnvironmentSpecShieldedInstanceConfig extends \Google\Model
{
  /**
  ...
  /**
   * Optional. Whether the VM instance has Secure Boot enabled. Disabled by
   * default.
   *
   * @var bool
   */
...
class_alias(GoogleCloudAiplatformV1NotebookExecutionJobCustomEnvironmentSpecShieldedInstanceConfig::class, 'Google_Service_Aiplatform_GoogleCloudAiplatformV1NotebookExecutionJobCustomEnvironmentSpecShieldedInstanceConfig');
