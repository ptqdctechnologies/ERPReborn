...
class CloudAiLargeModelsVisionGenerateVideoRequestVideo extends \Google\Model
{
  /**
  ...
  public $gcsUri;
  /**
   * The MIME type of the content of the video. Only the video in the below
   * listed MIME types are supported. - video/mp4
   *
   * @var string
   */
  public $mimeType;
...
class_alias(CloudAiLargeModelsVisionGenerateVideoRequestVideo::class, 'Google_Service_Aiplatform_CloudAiLargeModelsVisionGenerateVideoRequestVideo');
