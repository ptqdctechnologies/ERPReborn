...
class_alias(CloudAiLargeModelsVisionExperimentsResponseProEditResult::class, 'Google_Service_Aiplatform_CloudAiLargeModelsVisionExperimentsResponseProEditResult');
