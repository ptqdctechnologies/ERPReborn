...
class CloudAiLargeModelsVisionGenerateVideoRequestAudio extends \Google\Model
{
  /**
   * Blob ID of the audio. This is used for storing the large audio in the
   * request.
   *
   * @var string
   */
...
class_alias(CloudAiLargeModelsVisionGenerateVideoRequestAudio::class, 'Google_Service_Aiplatform_CloudAiLargeModelsVisionGenerateVideoRequestAudio');
