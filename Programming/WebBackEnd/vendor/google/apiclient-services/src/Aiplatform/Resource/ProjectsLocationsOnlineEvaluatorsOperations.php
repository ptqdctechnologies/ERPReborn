 ...
 *   $operations = $aiplatformService->projects_locations_onlineEvaluators_operations;
 *  </code>
 */
class ProjectsLocationsOnlineEvaluatorsOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listProjectsLocationsOnlineEvaluatorsOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsOnlineEvaluatorsOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsOnlineEvaluatorsOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsOnlineEvaluatorsOperations');
