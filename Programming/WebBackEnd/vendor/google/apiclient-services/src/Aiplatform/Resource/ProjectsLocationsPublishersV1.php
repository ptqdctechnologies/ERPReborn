 ...
 *   $v1 = $aiplatformService->projects_locations_publishers_v1;
 *  </code>
 */
class ProjectsLocationsPublishersV1 extends \Google\Service\Resource
{
  /**
   ...
   * will be specified in the request. (v1.responses)
   *
   ...
   */
  public function responses($endpoint, GoogleApiHttpBody $postBody, $optParams = [])
  {
    $params = ['endpoint' => $endpoint, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
    return $this->call('responses', [$params], GoogleApiHttpBody::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(ProjectsLocationsPublishersV1::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsPublishersV1');
