 ...
 *   $operations = $aiplatformService->projects_locations_servingProfiles_operations;
 *  </code>
 */
class ProjectsLocationsServingProfilesOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listProjectsLocationsServingProfilesOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsServingProfilesOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsServingProfilesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsServingProfilesOperations');
