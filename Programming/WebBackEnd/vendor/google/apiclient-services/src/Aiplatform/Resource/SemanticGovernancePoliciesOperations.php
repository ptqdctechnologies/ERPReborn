 ...
 *   $operations = $aiplatformService->semanticGovernancePolicies_operations;
 *  </code>
 */
class SemanticGovernancePoliciesOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listSemanticGovernancePoliciesOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listSemanticGovernancePoliciesOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(SemanticGovernancePoliciesOperations::class, 'Google_Service_Aiplatform_Resource_SemanticGovernancePoliciesOperations');
