 ...
 *   $operations = $aiplatformService->projects_locations_memoryBanks_memories_operations;
 *  </code>
 */
class ProjectsLocationsMemoryBanksMemoriesOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listProjectsLocationsMemoryBanksMemoriesOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsMemoryBanksMemoriesOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsMemoryBanksMemoriesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsMemoryBanksMemoriesOperations');
