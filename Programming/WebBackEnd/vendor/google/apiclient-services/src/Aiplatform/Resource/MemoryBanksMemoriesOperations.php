 ...
 *   $operations = $aiplatformService->memoryBanks_memories_operations;
 *  </code>
 */
class MemoryBanksMemoriesOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listMemoryBanksMemoriesOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listMemoryBanksMemoriesOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(MemoryBanksMemoriesOperations::class, 'Google_Service_Aiplatform_Resource_MemoryBanksMemoriesOperations');
