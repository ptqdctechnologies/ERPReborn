 ...
 *   $operations = $aiplatformService->tuningJobs_operations;
 *  </code>
 */
class TuningJobsOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listTuningJobsOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listTuningJobsOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(TuningJobsOperations::class, 'Google_Service_Aiplatform_Resource_TuningJobsOperations');
