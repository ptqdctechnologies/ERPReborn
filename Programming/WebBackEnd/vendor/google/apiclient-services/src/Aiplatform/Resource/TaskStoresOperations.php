 ...
 *   $operations = $aiplatformService->taskStores_operations;
 *  </code>
 */
class TaskStoresOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listTaskStoresOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listTaskStoresOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(TaskStoresOperations::class, 'Google_Service_Aiplatform_Resource_TaskStoresOperations');
