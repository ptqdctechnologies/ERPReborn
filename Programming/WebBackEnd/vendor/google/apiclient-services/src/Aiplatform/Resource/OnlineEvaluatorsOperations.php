 ...
 *   $operations = $aiplatformService->onlineEvaluators_operations;
 *  </code>
 */
class OnlineEvaluatorsOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listOnlineEvaluatorsOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listOnlineEvaluatorsOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(OnlineEvaluatorsOperations::class, 'Google_Service_Aiplatform_Resource_OnlineEvaluatorsOperations');
