 ...
 *   $operations = $aiplatformService->projects_locations_taskStores_operations;
 *  </code>
 */
class ProjectsLocationsTaskStoresOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listProjectsLocationsTaskStoresOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsTaskStoresOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsTaskStoresOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsTaskStoresOperations');
