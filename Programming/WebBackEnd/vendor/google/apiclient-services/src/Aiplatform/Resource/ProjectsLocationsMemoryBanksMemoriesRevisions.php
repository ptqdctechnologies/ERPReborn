 ...
 *   $revisions = $aiplatformService->projects_locations_memoryBanks_memories_revisions;
 *  </code>
 */
class ProjectsLocationsMemoryBanksMemoriesRevisions extends \Google\Service\Resource
{
  /**
   ...
   * (revisions.listProjectsLocationsMemoryBanksMemoriesRevisions)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsMemoryBanksMemoriesRevisions($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsMemoryBanksMemoriesRevisions::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsMemoryBanksMemoriesRevisions');
