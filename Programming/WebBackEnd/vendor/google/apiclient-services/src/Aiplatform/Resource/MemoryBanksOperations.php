 ...
 *   $operations = $aiplatformService->memoryBanks_operations;
 *  </code>
 */
class MemoryBanksOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listMemoryBanksOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listMemoryBanksOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(MemoryBanksOperations::class, 'Google_Service_Aiplatform_Resource_MemoryBanksOperations');
