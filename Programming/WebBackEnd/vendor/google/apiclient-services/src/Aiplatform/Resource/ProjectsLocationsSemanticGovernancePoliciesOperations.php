 ...
 *   $operations = $aiplatformService->projects_locations_semanticGovernancePolicies_operations;
 *  </code>
 */
class ProjectsLocationsSemanticGovernancePoliciesOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listProjectsLocationsSemanticGovernancePoliciesOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsSemanticGovernancePoliciesOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsSemanticGovernancePoliciesOperations::class, 'Google_Service_Aiplatform_Resource_ProjectsLocationsSemanticGovernancePoliciesOperations');
