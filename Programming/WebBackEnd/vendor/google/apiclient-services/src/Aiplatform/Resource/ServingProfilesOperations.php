 ...
 *   $operations = $aiplatformService->servingProfiles_operations;
 *  </code>
 */
class ServingProfilesOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listServingProfilesOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listServingProfilesOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(ServingProfilesOperations::class, 'Google_Service_Aiplatform_Resource_ServingProfilesOperations');
