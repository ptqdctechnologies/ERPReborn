...
class IngestAudienceMembersResponse extends \Google\Collection
{
...
class_alias(IngestAudienceMembersResponse::class, 'Google_Service_DataManager_IngestAudienceMembersResponse');
