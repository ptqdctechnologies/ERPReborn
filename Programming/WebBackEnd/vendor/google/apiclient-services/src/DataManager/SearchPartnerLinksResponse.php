...
class SearchPartnerLinksResponse extends \Google\Collection
{
  ...
  protected $partnerLinksType = PartnerLink::class;
...
class_alias(SearchPartnerLinksResponse::class, 'Google_Service_DataManager_SearchPartnerLinksResponse');
