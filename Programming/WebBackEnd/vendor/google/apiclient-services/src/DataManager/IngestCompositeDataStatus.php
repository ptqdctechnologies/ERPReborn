...
class IngestCompositeDataStatus extends \Google\Collection
{
  /**
  ...
  protected $collection_key = 'dataTypeCounts';
...
class_alias(IngestCompositeDataStatus::class, 'Google_Service_DataManager_IngestCompositeDataStatus');
