...
class RemoveCompositeDataStatus extends \Google\Collection
{
...
class_alias(RemoveCompositeDataStatus::class, 'Google_Service_DataManager_RemoveCompositeDataStatus');
