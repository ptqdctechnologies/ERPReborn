...
class GetHealthOperationMetadataHealthInfo extends \Google\Model
{
   ...
   * Output only. The availability SLO status.
   *
   * Accepted values: AVAILABILITY_SLO_STATUS_UNSPECIFIED,
   * AVAILABILITY_SLO_STATUS_IN_SLO, AVAILABILITY_SLO_STATUS_OUT_OF_SLO,
   ...
   * Output only. The health status.
   *
   * Accepted values: HEALTH_STATUS_UNSPECIFIED, HEALTH_STATUS_HEALTHY,
   ...
   * Output only. The repair category.
   *
   * Accepted values: REPAIR_CATEGORY_UNSPECIFIED,
   * REPAIR_CATEGORY_PLANNED_MAINTENANCE, REPAIR_CATEGORY_EMERGENT_MAINTENANCE,
   ...
   * Output only. The reason for unhealthy status.
   *
   * Accepted values: UNHEALTHY_REASON_UNSPECIFIED, UNHEALTHY_REASON_REPAIRING,
   * UNHEALTHY_REASON_PENDING_USER_APPROVAL, UNHEALTHY_REASON_UNSCHEDULABLE
   *
...
class_alias(GetHealthOperationMetadataHealthInfo::class, 'Google_Service_DeploymentManager_GetHealthOperationMetadataHealthInfo');
