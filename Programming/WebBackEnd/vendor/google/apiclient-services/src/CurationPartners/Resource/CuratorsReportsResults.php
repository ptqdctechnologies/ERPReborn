...
use Google\Service\CurationPartners\FetchReportResultRowsResponse;
 ...
 *   $results = $curationpartnersService->curators_reports_results;
 *  </code>
 */
class CuratorsReportsResults extends \Google\Service\Resource
{
  /**
...
class_alias(CuratorsReportsResults::class, 'Google_Service_CurationPartners_Resource_CuratorsReportsResults');
