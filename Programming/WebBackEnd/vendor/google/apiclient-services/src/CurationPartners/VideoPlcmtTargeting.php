...
class VideoPlcmtTargeting extends \Google\Collection
{
  /**
  ...
  protected $collection_key = 'videoPlcmtTypes';
  /**
  ...
  /**
   * Required. The list of targeted video plcmts types. If empty, inventory will
   * be targeted regardless of video plcmt type.
   *
   * @var string[]
   */
  public $videoPlcmtTypes;
   ...
   * be targeted regardless of video plcmt type.
   *
   * @param string[] $videoPlcmtTypes
   */
  public function setVideoPlcmtTypes($videoPlcmtTypes)
  {
    $this->videoPlcmtTypes = $videoPlcmtTypes;
  }
  /**
   * @return string[]
   */
  public function getVideoPlcmtTypes()
  {
    return $this->videoPlcmtTypes;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(VideoPlcmtTargeting::class, 'Google_Service_CurationPartners_VideoPlcmtTargeting');
