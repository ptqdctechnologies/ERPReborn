...
class SalesforceMarketingCloudSourceConfig extends \Google\Model
{
   ...
   * @var string
   */
  public $fullRefreshPollingInterval;
   ...
   * used. The duration must be between 1 and 24 hours, inclusive.
   *
   * @param string $fullRefreshPollingInterval
   */
  public function setFullRefreshPollingInterval($fullRefreshPollingInterval)
  {
    $this->fullRefreshPollingInterval = $fullRefreshPollingInterval;
  }
  /**
   * @return string
   */
  public function getFullRefreshPollingInterval()
  {
    return $this->fullRefreshPollingInterval;
  }
  /**
...
class_alias(SalesforceMarketingCloudSourceConfig::class, 'Google_Service_Datastream_SalesforceMarketingCloudSourceConfig');
