...
class GoogleCloudDiscoveryengineV1DataConnector extends \Google\Collection
{
   ...
   */
  public const CONNECTOR_TYPE_GOOGLE_WORKSPACE = 'GOOGLE_WORKSPACE';
  /**
   * Default value.
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1ActionConfig $actionConfig
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1AlertPolicyConfig[] $alertPolicyConfigs
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1BAPConfig $bapConfig
   */
   ...
   * GOOGLE_CHAT, GOOGLE_SITES, REMOTE_MCP, GOOGLE_WORKSPACE
   *
   ...
   *
   * @param GoogleCloudDiscoveryengineV1DestinationConfig[] $destinationConfigs
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1DataConnectorEndUserConfig $endUserConfig
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1DataConnectorSourceEntity[] $entities
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1DataConnectorFederatedConfig $federatedConfig
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1IdentityScheduleConfig $identityScheduleConfig
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1DataConnectorRealtimeSyncConfig $realtimeSyncConfig
   */
