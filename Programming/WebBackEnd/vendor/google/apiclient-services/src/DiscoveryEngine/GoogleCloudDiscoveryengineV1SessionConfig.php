...
class GoogleCloudDiscoveryengineV1SessionConfig extends \Google\Model
{
  /**
   * Default value.
   */
  ...
  protected $sessionTtlType = GoogleCloudDiscoveryengineV1SessionConfigSessionTtl::class;
   ...
   *
   * @param GoogleCloudDiscoveryengineV1SessionConfigSessionTtl $sessionTtl
   */
  public function setSessionTtl(GoogleCloudDiscoveryengineV1SessionConfigSessionTtl $sessionTtl)
  {
    $this->sessionTtl = $sessionTtl;
  }
  /**
   * @return GoogleCloudDiscoveryengineV1SessionConfigSessionTtl
   */
...
class_alias(GoogleCloudDiscoveryengineV1SessionConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1SessionConfig');
