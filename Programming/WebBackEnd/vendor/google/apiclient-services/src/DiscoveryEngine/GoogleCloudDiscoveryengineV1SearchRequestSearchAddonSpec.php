...
class GoogleCloudDiscoveryengineV1SearchRequestSearchAddonSpec extends \Google\Model
{
  /**
...
class_alias(GoogleCloudDiscoveryengineV1SearchRequestSearchAddonSpec::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1SearchRequestSearchAddonSpec');
