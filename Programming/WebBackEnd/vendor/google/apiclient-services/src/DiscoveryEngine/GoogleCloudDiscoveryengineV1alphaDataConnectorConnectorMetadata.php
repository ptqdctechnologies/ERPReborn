...
class GoogleCloudDiscoveryengineV1alphaDataConnectorConnectorMetadata extends \Google\Model
{
  /**
...
class_alias(GoogleCloudDiscoveryengineV1alphaDataConnectorConnectorMetadata::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaDataConnectorConnectorMetadata');
