...
class GoogleCloudDiscoveryengineV1betaProjectCustomerProvidedConfigResourceAccessControlConfig extends \Google\Model
{
  /**
...
class_alias(GoogleCloudDiscoveryengineV1betaProjectCustomerProvidedConfigResourceAccessControlConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaProjectCustomerProvidedConfigResourceAccessControlConfig');
