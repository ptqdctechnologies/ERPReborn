...
class GoogleCloudDiscoveryengineV1betaUserInfoPreciseLocation extends \Google\Model
{
  /**
...
class_alias(GoogleCloudDiscoveryengineV1betaUserInfoPreciseLocation::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaUserInfoPreciseLocation');
