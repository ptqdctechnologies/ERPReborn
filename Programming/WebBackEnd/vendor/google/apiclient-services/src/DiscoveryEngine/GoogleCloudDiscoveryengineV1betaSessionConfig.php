...
class GoogleCloudDiscoveryengineV1betaSessionConfig extends \Google\Model
{
  /**
   * Default value.
   */
  ...
  protected $sessionTtlType = GoogleCloudDiscoveryengineV1betaSessionConfigSessionTtl::class;
   ...
   *
   * @param GoogleCloudDiscoveryengineV1betaSessionConfigSessionTtl $sessionTtl
   */
  public function setSessionTtl(GoogleCloudDiscoveryengineV1betaSessionConfigSessionTtl $sessionTtl)
  {
    $this->sessionTtl = $sessionTtl;
  }
  /**
   * @return GoogleCloudDiscoveryengineV1betaSessionConfigSessionTtl
   */
...
class_alias(GoogleCloudDiscoveryengineV1betaSessionConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaSessionConfig');
