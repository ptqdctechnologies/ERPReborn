...
class_alias(ProjectsLocationsCollectionsDataStoresWidgetConfigs::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsCollectionsDataStoresWidgetConfigs');
