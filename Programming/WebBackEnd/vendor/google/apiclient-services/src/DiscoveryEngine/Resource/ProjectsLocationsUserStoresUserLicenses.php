...
class ProjectsLocationsUserStoresUserLicenses extends \Google\Service\Resource
{
   ...
   * fields (only `user_principal` is supported for now): * `user_principal` If
   * not set, the default ordering is by `user_principal`. Examples: *
   ...
   * fewer items than requested. If unspecified, defaults to 100. The maximum
