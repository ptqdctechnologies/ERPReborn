 ...
 *   $widgetConfigs = $discoveryengineService->projects_locations_dataStores_widgetConfigs;
 *  </code>
 */
class ProjectsLocationsDataStoresWidgetConfigs extends \Google\Service\Resource
{
  /**
   ...
   * `WidgetConfig.UiSettings.ModelConfigInfo` the backend computes. `ADMIN` is
   * set by the Cloud Console admin "Feature Management" page
...
class_alias(ProjectsLocationsDataStoresWidgetConfigs::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsDataStoresWidgetConfigs');
