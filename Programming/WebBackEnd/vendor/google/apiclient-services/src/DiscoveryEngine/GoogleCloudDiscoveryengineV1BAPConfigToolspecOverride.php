...
class GoogleCloudDiscoveryengineV1BAPConfigToolspecOverride extends \Google\Collection
{
...
class_alias(GoogleCloudDiscoveryengineV1BAPConfigToolspecOverride::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1BAPConfigToolspecOverride');
