...
class GoogleCloudDiscoveryengineV1SearchRequest extends \Google\Collection
{
   ...
   * results.
   *
   * @param GoogleCloudDiscoveryengineV1SearchRequestDisplaySpec $displaySpec
   */
   ...
   * is returned.
   *
   * @param GoogleCloudDiscoveryengineV1SearchRequestFacetSpec[] $facetSpecs
   */
   ...
   * Raw image query.
   *
   * @param GoogleCloudDiscoveryengineV1SearchRequestImageQuery $imageQuery
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1SearchRequestNaturalLanguageQueryUnderstandingSpec $naturalLanguageQueryUnderstandingSpec
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1SearchRequestQueryExpansionSpec $queryExpansionSpec
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1SearchRequestRelevanceScoreSpec $relevanceScoreSpec
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1SearchRequestSearchAsYouTypeSpec $searchAsYouTypeSpec
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1SearchRequestSessionSpec $sessionSpec
   */
   ...
   *
   * @param GoogleCloudDiscoveryengineV1SearchRequestSpellCorrectionSpec $spellCorrectionSpec
   */
