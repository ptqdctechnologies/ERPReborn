...
class GoogleCloudDiscoveryengineV1betaLicenseConfig extends \Google\Model
{
  /**
...
class_alias(GoogleCloudDiscoveryengineV1betaLicenseConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaLicenseConfig');
