...
class GoogleCloudDiscoveryengineV1alphaUserInfoPreciseLocation extends \Google\Model
{
  /**
...
class_alias(GoogleCloudDiscoveryengineV1alphaUserInfoPreciseLocation::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaUserInfoPreciseLocation');
