...
class_alias(GoogleCloudDiscoveryengineV1ProjectCustomerProvidedConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1ProjectCustomerProvidedConfig');
