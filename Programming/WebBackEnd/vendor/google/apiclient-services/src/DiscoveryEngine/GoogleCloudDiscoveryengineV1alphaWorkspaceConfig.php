...
class GoogleCloudDiscoveryengineV1alphaWorkspaceConfig extends \Google\Model
{
  /**
...
class_alias(GoogleCloudDiscoveryengineV1alphaWorkspaceConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaWorkspaceConfig');
