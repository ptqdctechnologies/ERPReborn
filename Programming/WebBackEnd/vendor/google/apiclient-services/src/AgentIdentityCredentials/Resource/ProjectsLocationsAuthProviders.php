 ...
 *   $authProviders = $agentidentitycredentialsService->projects_locations_authProviders;
 *  </code>
 */
...
class_alias(ProjectsLocationsAuthProviders::class, 'Google_Service_AgentIdentityCredentials_Resource_ProjectsLocationsAuthProviders');
