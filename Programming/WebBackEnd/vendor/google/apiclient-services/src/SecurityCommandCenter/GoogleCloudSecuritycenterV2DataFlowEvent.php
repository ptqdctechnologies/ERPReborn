...
class GoogleCloudSecuritycenterV2DataFlowEvent extends \Google\Model
{
...
class_alias(GoogleCloudSecuritycenterV2DataFlowEvent::class, 'Google_Service_SecurityCommandCenter_GoogleCloudSecuritycenterV2DataFlowEvent');
