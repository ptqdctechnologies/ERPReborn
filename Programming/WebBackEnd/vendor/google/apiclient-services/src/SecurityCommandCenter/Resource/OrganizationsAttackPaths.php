...
{
  /**
   * (attackPaths.listOrganizationsAttackPaths)
   *
   * @param string $parent
...
class_alias(OrganizationsAttackPaths::class, 'Google_Service_SecurityCommandCenter_Resource_OrganizationsAttackPaths');
