 ...
 *  </code>
 */
class ProjectsSecurityHealthAnalyticsSettingsCustomModules extends \Google\Service\Resource
{
  /**
...
class_alias(ProjectsSecurityHealthAnalyticsSettingsCustomModules::class, 'Google_Service_SecurityCommandCenter_Resource_ProjectsSecurityHealthAnalyticsSettingsCustomModules');
