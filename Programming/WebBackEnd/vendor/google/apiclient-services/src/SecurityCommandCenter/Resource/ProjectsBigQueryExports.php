 ...
 *   $bigQueryExports = $securitycenterService->projects_bigQueryExports;
 *  </code>
 */
class ProjectsBigQueryExports extends \Google\Service\Resource
{
  /**
  ...
  /**
   * (bigQueryExports.listProjectsBigQueryExports)
   *
   * @param string $parent
   * @param array $optParams Optional parameters.
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsBigQueryExports($parent, $optParams = [])
  {
...
class_alias(ProjectsBigQueryExports::class, 'Google_Service_SecurityCommandCenter_Resource_ProjectsBigQueryExports');
