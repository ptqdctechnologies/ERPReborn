...
class GoogleCloudSecuritycenterV2Requests extends \Google\Model
{
  /**
   * @var int
   */
...
class_alias(GoogleCloudSecuritycenterV2Requests::class, 'Google_Service_SecurityCommandCenter_GoogleCloudSecuritycenterV2Requests');
