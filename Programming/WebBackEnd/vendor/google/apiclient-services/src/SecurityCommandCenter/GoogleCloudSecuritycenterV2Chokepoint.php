...
class GoogleCloudSecuritycenterV2Chokepoint extends \Google\Collection
{
...
class_alias(GoogleCloudSecuritycenterV2Chokepoint::class, 'Google_Service_SecurityCommandCenter_GoogleCloudSecuritycenterV2Chokepoint');
