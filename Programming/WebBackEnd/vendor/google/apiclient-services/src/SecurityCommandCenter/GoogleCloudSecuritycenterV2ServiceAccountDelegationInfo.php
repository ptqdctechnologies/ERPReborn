...
class GoogleCloudSecuritycenterV2ServiceAccountDelegationInfo extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(GoogleCloudSecuritycenterV2ServiceAccountDelegationInfo::class, 'Google_Service_SecurityCommandCenter_GoogleCloudSecuritycenterV2ServiceAccountDelegationInfo');
