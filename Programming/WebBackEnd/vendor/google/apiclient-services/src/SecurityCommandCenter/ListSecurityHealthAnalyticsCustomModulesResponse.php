...
class ListSecurityHealthAnalyticsCustomModulesResponse extends \Google\Collection
{
...
class_alias(ListSecurityHealthAnalyticsCustomModulesResponse::class, 'Google_Service_SecurityCommandCenter_ListSecurityHealthAnalyticsCustomModulesResponse');
