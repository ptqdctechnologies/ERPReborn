...
class ListEffectiveEventThreatDetectionCustomModulesResponse extends \Google\Collection
{
  ...
  {
    $this->effectiveEventThreatDetectionCustomModules = $effectiveEventThreatDetectionCustomModules;
  }
  /**
...
class_alias(ListEffectiveEventThreatDetectionCustomModulesResponse::class, 'Google_Service_SecurityCommandCenter_ListEffectiveEventThreatDetectionCustomModulesResponse');
