...
class GoogleCloudSecuritycenterV2SensitivityScore extends \Google\Model
{
...
class_alias(GoogleCloudSecuritycenterV2SensitivityScore::class, 'Google_Service_SecurityCommandCenter_GoogleCloudSecuritycenterV2SensitivityScore');
