...
class GoogleCloudSecuritycenterV2ExternalExposure extends \Google\Collection
{
   ...
   */
  public $hostnameUri;
  protected $httpResponseType = GoogleCloudSecuritycenterV2HttpResponse::class;
  ...
  /**
   * @param GoogleCloudSecuritycenterV2HttpResponse[] $httpResponse
   */
  ...
  /**
   * @return GoogleCloudSecuritycenterV2HttpResponse[]
   */
...
class_alias(GoogleCloudSecuritycenterV2ExternalExposure::class, 'Google_Service_SecurityCommandCenter_GoogleCloudSecuritycenterV2ExternalExposure');
