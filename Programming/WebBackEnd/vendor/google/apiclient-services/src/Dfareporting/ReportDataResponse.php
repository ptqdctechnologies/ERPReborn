...
class ReportDataResponse extends \Google\Collection
{
  protected $collection_key = 'rows';
  protected $columnHeadersType = ColumnHeader::class;
  ...
  protected $rowsType = ReportDataRow::class;
  protected $rowsDataType = 'array';
  protected $totalRowType = ReportDataRow::class;
  protected $totalRowDataType = '';

  /**
   * Output only. Ordered descriptors of the requested column fields.
   *
   * @param ColumnHeader[] $columnHeaders
   */
   ...
   *
   * @param ReportDataRow $totalRow
   */
  public function setTotalRow(ReportDataRow $totalRow)
  {
...
class_alias(ReportDataResponse::class, 'Google_Service_Dfareporting_ReportDataResponse');
