...
class GoogleApiServiceusageV2alphaImpact extends \Google\Model
{
  /**
...
class_alias(GoogleApiServiceusageV2alphaImpact::class, 'Google_Service_ServiceUsage_GoogleApiServiceusageV2alphaImpact');
