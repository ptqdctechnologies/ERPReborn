...
class AclRule extends \Google\Model
{
   ...
   * hidden.  - "writerWithoutPrivateAccess" - Provides read and write access to
   * the calendar. Private events will appear to users with
   ...
   * Provides read access to the calendar's ACLs.  - "owner" - Provides manager
   * access to the calendar. This role has all of the permissions of the writer
   * role with the additional ability to modify access levels of other users.
