...
class Events extends \Google\Collection
{
   ...
   * event details will be hidden.  - "writerWithoutPrivateAccess" - The user
   * has read and write access to the calendar. Private events will appear to
   * users with writerWithoutPrivateAccess access, but event details will be
   * hidden.  - "writer" - The user has read and write access to the calendar.
   * Private events will appear to users with writer access, and event details
   * will be visible.  - "owner" - The user has manager access to the calendar.
   * This role has all of the permissions of the writer role with the additional
   * ability to see and modify access levels of other users. Important: the
   * owner role is different from the calendar's data owner. A calendar has a
   * single data owner, but can have multiple users with owner role.
   *
   * @var string
   */
  public $accessRole;
