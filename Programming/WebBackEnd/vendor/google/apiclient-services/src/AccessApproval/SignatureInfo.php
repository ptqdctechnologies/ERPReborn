...
class SignatureInfo extends \Google\Model
{
   ...
   */
  public const GOOGLE_KEY_ALGORITHM_KEM_ECDH_P256 = 'KEM_ECDH_P256';
  /**
   * Key encapsulation: Elliptic Curve Diffie-Hellman with NIST P-384 key that
   * returns shared secret.
   */
  public const GOOGLE_KEY_ALGORITHM_KEM_ECDH_P384 = 'KEM_ECDH_P384';
  /**
   * Key encapsulation: Elliptic Curve Diffie-Hellman with NIST P-521 key that
   * returns shared secret.
   */
  public const GOOGLE_KEY_ALGORITHM_KEM_ECDH_P521 = 'KEM_ECDH_P521';
  /**
