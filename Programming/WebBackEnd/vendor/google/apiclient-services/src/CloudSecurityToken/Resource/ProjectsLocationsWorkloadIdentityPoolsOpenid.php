 ...
 *   $openid = $stsService->projects_locations_workloadIdentityPools_openid;
 *  </code>
 */
class ProjectsLocationsWorkloadIdentityPoolsOpenid extends \Google\Service\Resource
{
  /**
...
class_alias(ProjectsLocationsWorkloadIdentityPoolsOpenid::class, 'Google_Service_CloudSecurityToken_Resource_ProjectsLocationsWorkloadIdentityPoolsOpenid');
