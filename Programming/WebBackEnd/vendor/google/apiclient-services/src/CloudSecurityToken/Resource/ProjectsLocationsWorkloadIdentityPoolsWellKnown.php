 ...
 *   $well_known = $stsService->projects_locations_workloadIdentityPools_well_known;
 *  </code>
 */
class ProjectsLocationsWorkloadIdentityPoolsWellKnown extends \Google\Service\Resource
{
  /**
...
class_alias(ProjectsLocationsWorkloadIdentityPoolsWellKnown::class, 'Google_Service_CloudSecurityToken_Resource_ProjectsLocationsWorkloadIdentityPoolsWellKnown');
