 ...
 *   $locations = $stsService->organizations_locations;
 *  </code>
 */
...
class_alias(OrganizationsLocations::class, 'Google_Service_CloudSecurityToken_Resource_OrganizationsLocations');
