...
class MaliciousContentStaticResult extends \Google\Model
{
  /**
...
class_alias(MaliciousContentStaticResult::class, 'Google_Service_ContainerAnalysis_MaliciousContentStaticResult');
