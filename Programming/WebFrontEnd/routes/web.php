...
$varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoiYWxkaS5tdWx5YWRpIiwiaWF0IjoxNzI0MTI5MjI5fQ.NTdhMDc0OGRlMzIwZGYyNjQ0ODQ2NWQxM2M0NGQ1MmI2MTBiNTU4YjFlZWYyZGRkZDE1NTkxOWMzN2Y2NzA4Zg';
...
Route::group(['middleware' => ['prevent-back-history', 'SessionLogin']], function () {    
    ...
    Route::post('ModifyBudgetStore', 'Budget\BudgetController@ModifyBudgetStore')->name('Budget.ModifyBudgetStore');
    Route::get('PreviewModifyBudget', 'Budget\BudgetController@PreviewModifyBudget')->name('Budget.PreviewModifyBudget');
