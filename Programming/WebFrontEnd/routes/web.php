...
$varAPIWebToken =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoid2lzbnUudHJlbmdnb25vIiwiaWF0IjoxNzg0NTE5NzQ3fQ.YzQwODVmY2M1YjBlMDU2OTU1YzdjMTA5M2E5ZTM2ZmQzNTYzZTg5YWY5MThjMmU3NGExZWFjNjQ5YWI0MDEzOQ';
...
Route::group(['middleware' => ['prevent-back-history', 'SessionLogin']], function () {
    ...
    // ADVANCE REQUEST
    Route::get('AdvancePickList', 'Process\Advance\AdvanceRequestController@AdvancePickList')->name('AdvanceRequest.AdvancePickList');
    ...
    // ADVANCE SETTLEMENT
    Route::get('AdvanceSettlementPickList', 'Process\Advance\AdvanceSettlementController@AdvanceSettlementPickList')->name('AdvanceSettlement.AdvanceSettlementPickList');
