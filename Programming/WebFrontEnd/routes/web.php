...
$varAPIWebToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dnZWRJbkFzIjoiYWxkaS5tdWx5YWRpIiwiaWF0IjoxNzEzNDEwMjcwfQ.Mzc2OGJiZDlmNzUxNjE5ODc3MWEyZTI0Zjk1ZTM0NzYyOTQ4YTMwNzEzMjgzYTNhOWIyMDVkODg2YWEwNDFkYQ';
...
Route::group(['middleware' => ['prevent-back-history', 'SessionLogin']], function () {
    ...
    Route::post('RevisionBusinessTripSettlement', 'Process\BusinessTrip\BusinessTripSettlementController@RevisionBusinessTripSettlementIndex')->name('BusinessTripSettlement.RevisionBusinessTripSettlement');
