...
<div class="content-wrapper">
  <section class="content">
    <div class="container-fluid">
      <div class="card">
        <form method="post" enctype="multipart/form-data" action="{{ route('PPM.store') }}" id="formCreatePR">
          @csrf
          <div class="tab-content p-3" id="nav-tabContent">
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <a class="btn btn-outline btn-danger btn-sm float-right cancelDetailPR">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <a href="{{ route('PR.index') }}" class="btn btn-outline btn-danger btn-sm float-right remove-arf-list">
...
@include('HumanResources.PieceMeal.Functions.Footer.footerPPM')
@endsection