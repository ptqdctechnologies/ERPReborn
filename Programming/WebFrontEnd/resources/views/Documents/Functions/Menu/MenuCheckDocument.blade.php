                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    ...
                                                    <input required="" id="businessDocumentNumber" style="border-radius:0;background-color:white;" readonly name="businessDocumentNumber" type="text" class="form-control" value="{{ $businessDocumentNumber }}">
