                    ...
                    <div class="form-group">
                      <table>
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td>{{ $data['content']['accumulatedValue']['baseCurrencyISOCode'] }}</td>
                        </tr>
                        <tr>
                    ...
                    <div class="form-group">
                      <table>
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td>{{ $data['content']['bankAccount']['bankName'] }}</td>
                        </tr>
                        <tr>
                          <td style="padding-top: 5px;"><label>Account Name</label></td>
                          <td>:</td>
                          <td>{{ $data['content']['bankAccount']['bankAccount'] }}</td>
                        </tr>
                        <tr>
                          <td style="padding-top: 5px;"><label>Account Number</label></td>
                          <td>:</td>
                          <td>{{ $data['content']['bankAccount']['bankAccountName'] }}</td>
                        </tr>
                      </table>
                    </div>
                  </div>
              ...
              <div class="col-12 InternalNotes">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-12">
                        <textarea name="" id="" cols="140" rows="3" style="border:1px solid #e9ecef;"> {{ $data['content']['remarks'] }} </textarea>
                      </div>
                    </div>
                  </div>
                </div>
