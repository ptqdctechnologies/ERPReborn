                                    ...
                                    <table class="table table-striped table-hover table-sticky table-sm">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center" style="vertical-align: middle; width: 125px; min-width: 125px; max-width: 125px; left: 250px; z-index: 10;">Currency</th>
                                                ...
                                                <th class="text-center" style="vertical-align: middle; width: 125px; min-width: 125px; max-width: 125px; left: 625px; z-index: 10;text-wrap-mode: nowrap;">Payment Note</th>
                                                <th class="text-center" style="vertical-align: middle; width: 125px; min-width: 125px; max-width: 125px; left: 750px; z-index: 10;text-wrap-mode: nowrap;">Internal Note</th>
                                                <th class="text-center" style="vertical-align: middle; width: 125px; min-width: 125px; max-width: 125px; left: 875px; z-index: 10;">Remark</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="padding: 8px; width: 125px; min-width: 125px; max-width: 125px; position: sticky; background-color: white; left: 625px; z-index: 10;"><?= $dataHeader[count($dataHeader) - 1]['beneficiaryWorkerName']; ?></td>
                                                ...
                                                <td style="padding: 8px; width: 125px; min-width: 125px; max-width: 125px; position: sticky; background-color: white; left: 875px; z-index: 10;"><?= $dataHeader[count($dataHeader) - 1]['content']['remarks']; ?></td>
                                    ...
                                    <table class="table table-striped table-hover table-sticky table-sm">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center" style="position: sticky;vertical-align: middle;width: 40px;min-width: 40px;max-width: 40px;left: 415px;z-index: 10;">Qty</th>
                                                <th class="text-center" style="position: sticky;vertical-align: middle;width: 125px;min-width: 125px;max-width: 125px;left: 455px;z-index: 10;">Price</th>
                                                <th class="text-center" style="position: sticky;vertical-align: middle;width: 125px;min-width: 125px;max-width: 125px;left: 580px;z-index: 10;">Total</th>
                                                <th class="text-center" style="position: sticky;vertical-align: middle;width: 125px;min-width: 125px;max-width: 125px;left: 705px;z-index: 10;">Note</th>
                                            ...
                                            @if(sizeof($dataDetail))
                                                @for($i = 0; $i < count($dataDetail); $i++) 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 8px;width: 40px;min-width: 40px;max-width: 40px;position: sticky;background-color: white;left: 415px;z-index: 10;">{{ number_format($quantity, 2) }}</td>
                                                        <td style="padding: 8px;width: 125px;min-width: 125px;max-width: 125px;position: sticky;background-color: white;left: 455px;z-index: 10;">{{ number_format($price, 2) }}</td>
                                                        <td style="padding: 8px;width: 125px;min-width: 125px;max-width: 125px;position: sticky;background-color: white;left: 580px;z-index: 10;">{{ number_format($quantity * $price, 2) }}</td>
                                                        <td style="padding: 8px;width: 125px;min-width: 125px;max-width: 125px;position: sticky;background-color: white;left: 705px;z-index: 10;">{{ $dataDetail[$i][count($dataDetail[$i]) - 1]['content']['remarks'] }}</td>
                                        ...
                                        <tfoot>
                                            <tr style="height: 40px;">
                                                <th colspan="6" style="padding: 8px;position: sticky;background-color: white;width: 455px;min-width: 455px;max-width: 455px;left: 0px;z-index: 10;">VAT</th>
                                                <th style="padding: 8px;position: sticky;background-color: white;width: 125px;min-width: 125px;max-width: 125px;left: 580px;z-index: 10;">-</th>
                                                <th style="padding: 8px;position: sticky;background-color: white;width: 125px;min-width: 125px;max-width: 125px;left: 705px;z-index: 10;">-</th>
                                            ...
                                            <tr style="height: 40px;">
                                                <th colspan="6" style="padding: 8px;position: sticky;background-color: white;width: 455px;min-width: 455px;max-width: 455px;left: 0px;z-index: 10;">GRAND TOTAL</th>
                                                <th style="padding: 8px;position: sticky;background-color: white;width: 125px;min-width: 125px;max-width: 125px;left: 580px;z-index: 10;">-</th>
                                                <th style="padding: 8px;position: sticky;background-color: white;width: 125px;min-width: 125px;max-width: 125px;left: 705px;z-index: 10;">-</th>
