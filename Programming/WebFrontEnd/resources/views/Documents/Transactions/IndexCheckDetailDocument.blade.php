      ...
      <div class="container-fluid">
        ...
        <div class="row mb-1" style="background-color:#4B586A;">
          <div class="col-sm-6" style="height:30px;">
            <label style="font-size:15px;position:relative;top:7px;color:white;">Check Document</label>
          </div>
        </div>
          ...
          <div class="tab-content p-3" id="nav-tabContent">
            <div class="row">
              <form method="post" action="{{ route($resubmit['url']) }}" id="FormSubmitRevision">
                ...
                <input type="hidden" id="refID" name="{{ $resubmit['name'] }}" value="{{ $resubmit['value'] }}"
              ...
              <div class="col-12 text-right">
                <!-- CANCEL -->
                <a class="btn btn-default btn-sm" onclick="cancelForm('{{ route('MyDocument.index') }}')"
                ...
                <!-- RESUBMIT -->
                <button class="btn btn-default btn-sm btn-resubmit"
                  style="background-color:#e9ecef;border:1px solid #ced4da;margin-right:10px;">
                  <img src="{{ asset('AdminLTE-master/dist/img/reset.png') }}" width="13" alt="" title="Resubmit" />
                  Resubmit
                </button>
                <?php } ?>
                ...
                <?php if ($statusApprover == "YES") { ?>
                <!-- APPROVE -->
                <a onclick="ApproveButton({{ $businessDocument_RefID }})" class="btn btn-default btn-sm"
                  style="background-color:#e9ecef;border:1px solid #ced4da;margin-left:10px;">
                  <img src="{{ asset('AdminLTE-master/dist/img/save.png') }}" width="13" alt="" title="Approve"> Approve
                </a>

                <!-- REJECT -->
                <a onclick="RejectButton({{ $businessDocument_RefID }}, {{ $varWorkerCareerInternal }})"
