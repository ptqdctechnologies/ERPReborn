<div id="mySearchStockMovement" class="modal fade" role="dialog" aria-labelledby="contohModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <label class="card-title">Select Stock Movement</label>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">

                <form method="post" enctype="multipart/form-data" action="{{ route('DeliveryOrderRequest.SearchStockMovement') }}" id="FormSubmitSearchStockMovement">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <button class="btn btn-default btn-sm" style="float: right;position: relative;right:10px;" type="submit" id="SubmitSearchStockMovement" >
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body table-responsive p-0" style="min-height: 390px;">
                                <table class="table table-head-fixed text-nowrap TableSearchSmInDor" id="TableSearchSmInDor">
                                    <thead>
                                        <tr>
                                            <th>No</th>
