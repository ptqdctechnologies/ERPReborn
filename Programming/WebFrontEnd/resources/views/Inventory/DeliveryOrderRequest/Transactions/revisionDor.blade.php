                ...
                <div class="card">
                    <form method="post" enctype="multipart/form-data" action="#" name="formHeaderDor">
                        <div class="tab-content p-3" id="nav-tabContent">
                            @include('ProcurementAndCommercial.Functions.setHeaderDor')
                    </form>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    @include('ProcurementAndCommercial.Functions.sectPrDetailDor')
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @include('ProcurementAndCommercial.Functions.footerFunctionDor')
    @endsection