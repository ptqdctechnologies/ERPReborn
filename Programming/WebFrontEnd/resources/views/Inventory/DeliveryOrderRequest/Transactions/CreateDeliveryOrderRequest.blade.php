            ...
            <div class="container-fluid">
                ...
                @if($var == 0)
                    <div class="card" style="position:relative;bottom:10px;">
                        <form method="post" enctype="multipart/form-data" action="{{ route('DeliveryOrderRequest.store') }}"
                            id="FormSubmitDor">
                            @csrf
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td style="display: flex;">
                                                                            <textarea name="var_remark" id="remark" rows="2"
                                                                                cols="150" class="form-control"></textarea>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
