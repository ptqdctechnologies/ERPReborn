                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left"
                                ...
                                <li class="nav-item">
                                    <a id="create_material_disposal" href="{{ route('MaterialDisposal.create') }}"
                                        class="nav-link" style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Create Material Disposal</i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="revision_material_disposal" href="javascript:;" class="nav-link"
                                        data-toggle="modal" data-target="#materialDisposalRevisionModal"
                                        style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Revision Material Disposal</i>
                                    </a>
                                </li>
                            </ul>
                        </li>
