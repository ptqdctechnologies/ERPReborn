<div class="col-sm-12 col-md-12 col-lg-3">
    <form id="formReportAccountPayable" method="post" action="{{ route('MaterialReceive.ReportMaterialReceiveSummaryStore') }}">
        @csrf
        <div class="row p-0 align-items-center" style="margin-bottom: 1rem;">
            ...
            <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
                ...
                <div class="d-none">
                    <input id="project_name_second1" style="border-radius:0;" name="project_name_second1" class="form-control invisible" readonly value="<?= $dataReport['project']['name'] ?? ''; ?>" />
                </div>
            </div>
        </div>
...
<div class="col-sm-12 col-md-12 col-lg-3">
        <div class="row p-0 align-items-center" style="margin-bottom: 1rem;">
            <label class="col-sm-3 col-md-4 col-lg-4 col-form-label p-0 text-bold">Receive At</label>
            <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
                <div>
                    <input id="project_code_second1" style="border-radius:0;" name="project_code_second1" class="form-control" readonly value="<?= $dataReport['project']['code'] ?? ''; ?>" />
                    <input id="project_id_second1" style="border-radius:0;" name="project_id_second1" class="form-control" hidden value="<?= $dataReport['project']['id'] ?? ''; ?>" />
...
<div class="col-sm-12 col-md-12 col-lg-3 d-flex flex-column flex-column-reverse">
    ...
    <form method="post" action="{{ route('MaterialReceive.PrintExportReportMaterialReceiveSummary') }}">
    @csrf
...
<!-- <div class="col-12 ShowDocument">
  <div class="card">
    <form method="post" enctype="multipart/form-data" action="{{ route('MaterialReceive.ReportMaterialReceiveSummaryStore') }}">
      @csrf
      <div class="card-body">
        <div class="row">
          <div class="col-md-2">
          ...
          <div class="col-md-2">
            <div class="form-group">
              <table>
                <tr>
                  <th style="padding-top: 7px;"><label>Receive&nbsp;At&nbsp;</label></th>
                  <td>
                    <div class="input-group">
                        <input id="site_code_second" style="border-radius:0;" name="site_code_second" class="form-control" size="34" value="<?= $dataReport['siteCode'] ?? ''; ?>" readonly>
                        <input id="site_id_second" style="border-radius:0;" name="site_id_second" class="form-control" hidden>
            ...
            <div class="form-group">
              <table>
                <tr>
                  ...
                  <form method="post" enctype="multipart/form-data" action="{{ route('MaterialReceive.PrintExportReportMaterialReceiveSummary') }}">
                    @csrf
                    <td>
                      <select name="print_type" id="print_type" class="form-control">
                        <option value="PDF">Export PDF</option>
