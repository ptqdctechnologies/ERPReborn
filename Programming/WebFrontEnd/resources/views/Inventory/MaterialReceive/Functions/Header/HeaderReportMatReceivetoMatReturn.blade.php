...
<div class="col-sm-12 col-md-12 col-lg-4">
    ...
    <div class="row p-0 align-items-center" style="margin-bottom: 1rem;">
        <label class="col-sm-3 col-md-4 col-lg-4 col-form-label p-0 text-bold">Material Receive Number</label>
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
            <div>
                <span id="Trigger" class="input-group-text form-control" data-toggle="modal" data-target="#" style="border-radius:0;cursor:pointer;">
                    <i class="fas fa-gift"></i>
                </span>
            </div>
            <div>
                <input type="text" id="material_receive_name" class="form-control" style="border-radius:0;background-color:white;" readonly />
                <input type="hidden" id="material_receive_id" class="form-control" style="border-radius:0;" name="material_receive_id" />
                <input type="hidden" id="material_receive_code" class="form-control" style="border-radius:0;" name="material_receive_code" />
            </div>
        </div>
    </div>
    ...
    <div class="row p-0 align-items-center">
        <label class="col-sm-3 col-md-4 col-lg-4 col-form-label p-0 text-bold">Material Return Number</label>
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
            <div>
                <span id="Trigger" class="input-group-text form-control" data-toggle="modal" data-target="#" style="border-radius:0;cursor:pointer;">
                    <i class="fas fa-gift"></i>
            ...
            <div>
                <input type="text" id="material_return_name" class="form-control" style="border-radius:0;background-color:white;" readonly />
                <input type="hidden" id="material_return_id" class="form-control" style="border-radius:0;" name="material_return_id" />
                <input type="hidden" id="material_return_code" class="form-control" style="border-radius:0;" name="material_return_code" />
            </div>
        </div>
    </div>
</div>
