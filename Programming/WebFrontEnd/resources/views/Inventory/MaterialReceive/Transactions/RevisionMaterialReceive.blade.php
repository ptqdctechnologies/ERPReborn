            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <form method="post" action="{{ route('SelectWorkFlow') }}" id="FormSubmitRevisionMaterialReceive">
                        ...
                        <input type="hidden" name="warehouseInboundOrder_RefID" id="warehouseInboundOrder_RefID"
                            value="<?= $header['warehouseInboundOrderRefID']; ?>">
                        <input type="hidden" name="transporter_RefID" id="transporter_RefID"
                            value="<?= $header['transporterRefID']; ?>">
                        ...
                        <div class="tab-content px-3 pb-2" id="nav-tabContent">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <button type="button" class="btn btn-default btn-sm float-right"
                                        onclick="cancelForm('{{ route('MaterialReceive.index', ['var' => 1]) }}')"
