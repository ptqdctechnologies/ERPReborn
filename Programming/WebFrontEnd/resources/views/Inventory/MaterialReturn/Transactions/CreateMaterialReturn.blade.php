...
<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid">
            ...
            @if($var == 0)
            <div class="card">
                <!-- <form method="post" action="{{ route('SelectWorkFlow') }}" id="form_submit_material_return"> -->
                <form method="post" action="{{ route('MaterialReturn.store') }}" id="form_submit_material_return">
                @csrf
                                            ...
                                            <div class="col-md-12 col-lg-5">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
                                                        ...
                                                        <div>
                                                            <input id="material_receive_number" class="form-control" size="16" readonly style="border-radius:0; background-color: white; cursor: default;">
                                ...
                                <div class="card">
                                    ...
                                    <div class="wrapper-budget card-body table-responsive p-0" style="height: 230px;">
                                        <table class="table table-head-fixed text-nowrap table-sm" id="material_return_details_table">
                                            <thead>
                                                <tr>
                                                    <th style="padding-top: 10px;padding-bottom: 10px;border-right:1px solid #e9ecef;text-align: center;">Work ID</th>
...
<div class="modal fade" id="material_return_submit_modal" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="wrapper-budget card-body table-responsive p-0" style="max-height:200px;">
                    <table class="table table-head-fixed text-nowrap table-sm" id="material_return_list_table_modal" style="border: 1px solid #dee2e6;">
                        <tbody></tbody>
                    </table>
                </div>
                <div class="card-body">
                    <table style="float:right;">
                        <tr>
                            <th id="material_return_list_total_modal"></th>
                        </tr>
                    </table>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" id="material_return_cancel_button_modal" class="btn btn-default btn-sm" data-dismiss="modal" style="background-color:#e9ecef;border:1px solid #ced4da;">
                    <img src="{{ asset('AdminLTE-master/dist/img/cancel.png') }}" width="13" alt="" title="Cancel Material Return Modal"> No, cancel
                </button>
                <button type="button" id="material_return_submit_button_modal" class="btn btn-default btn-sm" onclick="submitForm();" style="margin-right: 5px;background-color:#e9ecef;border:1px solid #ced4da;">
                    <img src="{{ asset('AdminLTE-master/dist/img/save.png') }}" width="13" alt="" title="Submit Material Return Modal"> Yes, save it
                </button>
            </div>
        </div>
    </div>
