...
<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- CONTENT -->
            <div class="card">
                <form method="POST" action="{{ route('MaterialReturn.UpdateRevisionMaterialReturn') }}" id="form_submit_material_return">
                @csrf
                    <input type="hidden" name="DocumentTypeID" id="DocumentTypeID" />
                    <input type="hidden" name="var_combinedBudget_RefID" id="var_combinedBudget_RefID" value="<?= $header['combinedBudget_RefID']; ?>" />
                    <input type="hidden" name="warehouseOutboundOrder_RefID" id="warehouseOutboundOrder_RefID" value="<?= $header['warehouseOutboundOrder_RefID']; ?>" />
                                        ...
                                        <div class="row py-3" style="gap: 15px;">
                                            ...
                                            <div class="col-md-12 col-lg-5">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
                                                        <div>
                                                            <input id="transporter_name" style="border-radius:0;" class="form-control" size="20" readonly value="<?= $header['transporterCode'] . " - " . $header['transporterName']; ?>" />
