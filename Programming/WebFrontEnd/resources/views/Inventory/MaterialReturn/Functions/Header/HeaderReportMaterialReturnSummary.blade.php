<div class="col-sm-12 col-md-12 col-lg-3">
    ...
    <div class="row p-0 align-items-center" style="margin-bottom: 1rem;">
        <label class="col-sm-3 col-md-4 col-lg-5 col-form-label p-0 text-bold">Material Receive Number</label>
    ...
    <div class="row p-0 align-items-center">
        <label class="col-sm-3 col-md-4 col-lg-5 col-form-label p-0 text-bold">Budget</label>
        <div class="col-sm-9 col-md-8 col-lg-6 d-flex p-0 justify-content-sm-end justify-content-md-end">
            <div>
                <span id="myProjectsTrigger" class="input-group-text form-control" data-toggle="modal" data-target="#myProjects" style="border-radius:0;cursor:pointer;">
                    <i class="fas fa-gift"></i>
...
<div class="col-sm-12 col-md-12 col-lg-3">
    <!-- TRANSPORTER -->
    <div class="row p-0 align-items-center" style="margin-bottom: 1rem;">
        <label class="col-sm-3 col-md-4 col-lg-5 col-form-label p-0 text-bold">Transporter</label>
        <div class="col-sm-9 col-md-8 col-lg-6 d-flex p-0 justify-content-sm-end justify-content-md-end">
            <div>
                <span id="myProjectsTrigger" class="input-group-text form-control" data-toggle="modal" data-target="#myProjects" style="border-radius:0;cursor:pointer;">
                    <i class="fas fa-gift"></i>
            ...
            <div>
                <input type="text" id="transporter_name" class="form-control" style="border-radius:0;background-color:white;" readonly />
                <input type="hidden" id="transporter_id" class="form-control" style="border-radius:0;" name="transporter_id" />
                <input type="hidden" id="transporter_code" class="form-control" style="border-radius:0;" name="transporter_code" />
            </div>
        </div>
    </div>
