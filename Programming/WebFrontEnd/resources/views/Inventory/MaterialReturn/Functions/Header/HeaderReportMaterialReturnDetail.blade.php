<div class="card">
    <form method="post" action="{{ route('Inventory.ReportMatReturnDetailStore') }}" id="FormSubmitReportMaterialReturnDetail">
    @csrf
    <div class="card-body">
        <div class="row">
            <!-- MR NUMBER -->
            <div class="col-sm-12 col-md-5 col-lg-4">
                <div class="form-group">
                    <table class="col-lg-10">
                        <tr>
                            <th style="padding-top: 10px;"><label style="min-width: max-content;">MR Number&nbsp;</label></th>
                            <td class="col-9 p-0">
