                                        ...
                                        <table class="table table-head-fixed w-100" id="table_summary">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="padding-top: 10px;padding-bottom: 10px;border:1px solid #e9ecef;text-align: center;background-color:#4B586A;color:white;">Quantity</th>
