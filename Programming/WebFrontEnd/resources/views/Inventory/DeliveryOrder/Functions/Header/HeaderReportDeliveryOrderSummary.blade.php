<div class="col-12 ShowDocument">
  <div class="card">
    <form method="post" enctype="multipart/form-data" action="{{ route('DeliveryOrder.ReportDeliveryOrderSummaryStore') }}">
      @csrf
      <div class="card-body">
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="form-group">
              <table>
                <tr>
                  ...
                  <form method="post" enctype="multipart/form-data" action="{{ route('DeliveryOrder.PrintExportReportDeliveryOrderSummary') }}">
                    @csrf
                    <td>
