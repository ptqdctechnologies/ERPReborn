<div class="card">
    <form method="post" action="{{ route('Inventory.ReportDOSummaryStore') }}" id="FormSubmitReportDOSummary">
    @csrf
    <div class="card-body">
        <div class="row">
            <!-- BUDGET -->
                ...
                <div class="form-group">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="col-9 p-0">
                                <div class="input-group">
                                    <input id="warehouse_from_id" style="border-radius:0;" name="warehouse_from_id" class="form-control" hidden>
                                    <input id="warehouse_from" style="border-radius:0;" name="warehouse_from" class="form-control">
                                    <div class="input-group-append">
                                        <span style="border-radius:0;" class="input-group-text form-control">
                ...
                <div class="form-group mt-3 mt-sm-3 mt-md-0 d-flex d-sm-flex d-md-block justify-content-end justify-content-sm-end">
                    <table>
                        <tr>
                            ...
                            <form method="post" action="{{ route('Inventory.PrintExportReportDOSummary') }}" id="FormSubmitReportDOSummary">
                                @csrf
                                <td>
