    ...
    <div class="row py-3" style="gap: 15px;">
        ...
        <div class="col-md-12 col-lg-5">
            ...
            <div class="row" style="margin-bottom: 1rem;">
                ...
                <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
                    <div>
                        <input id="transporter_phone" style="border-radius:0;" class="form-control" size="20" value="<?= $header['transporterPhone']; ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
                    <div>
                        <input id="transporter_fax" style="border-radius:0;" class="form-control" size="20" value="<?= $header['transporterFax']; ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12 col-lg-5">
            ...
            <div class="row" style="margin-bottom: 1rem;">
                ...
                <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
                    <div>
                        <input id="transporter_contact" style="border-radius:0;" class="form-control" size="20" value="<?= $header['transporterContact']; ?>" readonly>
                    </div>
                </div>
            </div>
