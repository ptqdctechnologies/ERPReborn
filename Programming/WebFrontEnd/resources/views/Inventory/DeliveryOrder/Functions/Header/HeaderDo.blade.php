    ...
    <div class="col-md-12 col-lg-5">
      ...
      <div class="row purchase-order-components" style="display: none;margin-top: 1rem;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
          ...
          <div>
            <input id="purchase_order_number" style="border-radius:0; background-color: white;" class="form-control"
              readonly>
      ...
      <div class="row internal-use-components" style="display: none; margin-top: 1rem;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
          <div>
            <span style="border-radius:0;" class="input-group-text form-control">
              <a href="javascript:;" id="internal_use_budget_trigger" data-toggle="modal" data-target="#myProjectSecond"
                style="display: block;">
          ...
          <div>
            <input id="internal_use_budget_id" name="internal_use_budget_id" style="border-radius:0;"
              class="form-control" hidden>
            <input id="internal_use_budget_code" style="border-radius:0;" class="form-control" hidden>
            <input id="internal_use_budget_name" style="border-radius:0; background-color: white;" class="form-control"
              readonly>
          </div>
        </div>
      </div>
      ...
      <div class="row internal-use-components" style="display: none; margin-top: 1rem;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
          ...
          <div>
            <input id="internal_use_site_id" class="form-control" style="border-radius:0;" name="internal_use_site_id"
              hidden>
            <input id="internal_use_site_code" class="form-control" style="border-radius:0;" hidden>
            <input id="internal_use_site_name" class="form-control" style="border-radius:0; background-color: white;"
              readonly>
          </div>
        </div>
      </div>
      ...
      <div class="row stock-movement-components" style="display: none; margin-top: 1rem;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
          <div>
            <span style="border-radius:0;" class="input-group-text form-control">
              <a href="javascript:;" id="stock_movement_budget_trigger" data-toggle="modal"
                data-target="#myProjectSecond" style="display: block;">
                <img src="{{ asset('AdminLTE-master/dist/img/box.png') }}" width="13"
                  alt="stock_movement_budget_trigger">
              </a>
          ...
          <div>
            <input id="stock_movement_budget_id" class="form-control" style="border-radius:0;"
              name="stock_movement_budget_id" hidden>
            <input id="stock_movement_budget_code" class="form-control" style="border-radius:0;" hidden>
            <input id="stock_movement_budget_name" class="form-control"
      ...
      <div class="row stock-movement-components" style="display: none; margin-top: 1rem;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
          <div>
            <span style="border-radius:0;" class="input-group-text form-control">
              <a href="javascript:;" id="stock_movement_requester_trigger" data-toggle="modal"
                data-target="#myRequesters">
                <img src="{{ asset('AdminLTE-master/dist/img/box.png') }}" width="13"
                  alt="stock_movement_requester_trigger">
              </a>
            </span>
          </div>
          <div>
            <input id="stock_movement_requester_id" class="form-control" style="border-radius:0;"
              name="stock_movement_requester_id" hidden>
            <input id="stock_movement_requester_position" class="form-control" style="border-radius:0;" hidden>
            <input id="stock_movement_requester_name" class="form-control"
              style="border-radius:0; background-color: white;" readonly>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-12 col-lg-5">
      ...
      <div class="row purchase-order-components" style="display: none;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
          <div>
            ...
            <textarea id="purchase_order_delivery_from" name="purchase_order_delivery_from" rows="3"
              style="border-radius:0;" class="form-control" disabled></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="row purchase-order-components" style="margin-top: 1rem; display: none;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
          <div>
            ...
            <textarea id="purchase_order_delivery_to" name="purchase_order_delivery_to" rows="3"
              style="border-radius:0;" class="form-control" disabled></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="row internal-use-components" style="display: none;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
          ...
          <div>
            <input id="internal_use_delivery_from_id" class="form-control" style="border-radius:0;"
              name="internal_use_delivery_from_id" hidden>
            <input id="internal_use_delivery_from_name" class="form-control" style="border-radius:0;"
              name="internal_use_delivery_from_name" hidden>
            <input id="internal_use_delivery_from_address" class="form-control"
              style="border-radius:0; background-color: white;" readonly>
          </div>
        </div>
      </div>
      ...
      <div class="row internal-use-components" style="margin-top: 1rem; display: none;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
          ...
          <div>
            <input id="internal_use_delivery_to_id" class="form-control" style="border-radius:0;"
              name="internal_use_delivery_to_id" hidden>
            <input id="internal_use_delivery_to_name" class="form-control" style="border-radius:0;"
              name="internal_use_delivery_to_name" hidden>
            <input id="internal_use_delivery_to_address" class="form-control"
              style="border-radius:0; background-color: white;" readonly>
          </div>
        </div>
      </div>
      ...
      <div class="row stock-movement-components" style="display: none;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-4 d-flex p-0">
          <select id="stock_movement_status" name="stock_movement_status" class="form-control"
            onchange="stockMovementStatusValue(this);">
      ...
      <div class="row stock-movement-components" style="margin-top: 1rem; display: none;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
          ...
          <div>
            <input id="stock_movement_delivery_from_id" class="form-control" style="border-radius:0;"
              name="stock_movement_delivery_from_id" hidden>
            <input id="stock_movement_delivery_from_name" class="form-control" style="border-radius:0;"
              name="stock_movement_delivery_from_name" hidden>
            <input id="stock_movement_delivery_from_address" class="form-control"
              style="border-radius:0; background-color: white;" readonly>
          </div>
        </div>
      </div>
      ...
      <div class="row stock-movement-components" style="margin-top: 1rem; display: none;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
          ...
          <div>
            <input id="stock_movement_delivery_to_id" class="form-control" name="stock_movement_delivery_to_id"
              style="border-radius:0;" hidden>
            <input id="stock_movement_delivery_to_name" class="form-control" name="stock_movement_delivery_to_name"
              style="border-radius:0;" hidden>
            <input id="stock_movement_delivery_to_address" class="form-control"
              style="border-radius: 0; background-color: white;" readonly>
          </div>
        </div>
      </div>
