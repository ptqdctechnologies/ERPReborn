                ...
                <div class="card">
                  ...
                  <div class="card-body table-responsive p-0 DetailBsf">
                    <table class="table text-nowrap table-sm" style="text-align: center;width:100%;">
                      <thead>
                        <tr>
                          <th rowspan="2" style="padding-bottom:17px;border:2px solid #e9ecef;width:14%;"> BRF Number</th>
...
@include('Advance.BusinessTrip.Functions.Footer.FooterBusinessTripSettlementRevision')
@endsection