...
<script type="text/javascript">
    $(document).ready(function() {
        $(".CancelDetailBsf").click(function() {
            ...
            var total_amount2 = $('#total_amount2').val();
            var description = $("#putDescription").val();
            var statusEditBsfRevision = $("#statusEditBsfRevision").val();


            if (statusEditBsfRevision == "Yes") {
...
<script>
    ...
    function EditExpenseListCart(t) {
        ...
        $("#brf_date").val($this.data("id19"));
        $("#putDescription").val($this.data("id15"));
        $("#brf_number_detail").val($this.data("id16"));
