<div id="brfNumberPopUp" class="modal fade" role="dialog" style="margin-top: 250px;margin-left:8px;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-body">
                    <form action="{{ route('BRF.revisionBrf') }}" method="post">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input required="" id="searchBrfNumberRevision" style="border-radius:0;" name="searchBrfNumberRevision" type="text" class="form-control">
