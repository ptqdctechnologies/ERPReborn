                  ...
                  <div class="card">
                    <div class="card-header">
                      <label class="card-title">
                        ...
                        <a id="advance_number2" data-toggle="modal" data-target="#mySearchArf" title="Select Advance Number"><img src="{{ asset('AdminLTE-master/dist/img/add.png') }}" width="13" alt=""></a>
