    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(data, function(key, value2) {
                ...
                '</td>' +
                '<td style="border:1px solid #e9ecef;">' + '<span id="getWorkId">' + value2.combinedBudgetSubSectionLevel2_RefID + '</span>' + '</td>' +
