            ...
            success: function(data) {
                ...
                $.each(data, function(key, val2) {
                    ...
                    var html = '<tr>' +
                        ...
                        '</td>' +
                        '<td style="border:1px solid #e9ecef;">' + '<span id="getWorkId">' + val2.combinedBudgetSubSectionLevel2_RefID + '</span>' + '</td>' +
