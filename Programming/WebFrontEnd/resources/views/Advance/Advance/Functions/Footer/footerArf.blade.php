    ...
    $('#addFromDetailtoCart').click(function(ev){
        ...
        if(tamp == 1){
            ...
            if(val != ""){
                $.ajax({
                    type: "POST",
                    url: '{!! route("ARF.StoreValidateArf") !!}?putProductName=' + $('#putProductName').val(),
                    success: function(data) {
                        ...
                        if(data == "200"){
                            ...
                            $("body").on("click", ".remove", function () {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: '{!! route("ARF.StoreValidateArf2") !!}?putProductName=' + ProductId,
                                });
                            });
                            $("body").on("click", ".edit", function () {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: '{!! route("ARF.StoreValidateArf2") !!}?putProductName=' + id2,
                                });
