            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, val) {
                        ...
                        t.row.add([
                                '<tr id="myRow">' +
                                '<td><center><a class="btn btn-outline-danger btn-rounded btn-sm my-0 remove-val-list delete-arf" style="border-radius: 100px;"><i class="fa fa-trash"></i></a></center></td>',
