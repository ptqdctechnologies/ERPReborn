<div class="card-body table-responsive p-0"  style="height: 180px;" id="tableShowHideArfDetail">
    <table class="table table-head-fixed text-nowrap table-striped tableArfDetail">
        <thead>
            <tr>
                ...
                <th style="padding-top: 10px;padding-bottom: 10px;border:1px solid #e9ecef;text-align: center;">Material Name</th>
                <th style="padding-top: 10px;padding-bottom: 10px;border:1px solid #e9ecef;text-align: center;">Qty Available</th>
                <th style="padding-top: 10px;padding-bottom: 10px;border:1px solid #e9ecef;text-align: center;">Qty ARF</th>
