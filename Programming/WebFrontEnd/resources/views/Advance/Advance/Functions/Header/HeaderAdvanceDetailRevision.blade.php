            ...
            <div class="form-group">
                <table>
                    <tr>
                        ...
                        <td>
                            <div class="input-group" style="width: 70%;">
                                <input id="bank_name" style="border-radius:0;" name="bank_name" class="form-control" readonly value="{{ $dataAdvance['bankAccount']['beneficiary']['bankName'] }}">
                                <div class="input-group-append">
                                    <span style="border-radius:0;" class="input-group-text form-control">
                        ...
                        <td>
                            <div class="input-group" style="width: 140%;position:relative;right:38%;">
                                <input id="bank_name_full" style="border-radius:0;" class="form-control" name="bank_name_full" readonly value="{{ $dataAdvance['bankAccount']['beneficiary']['bankName'] }}">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="input-group" style="width: 70%;">
                                <input id="beneficiaryBankAccount_RefID" style="border-radius:0;" class="form-control" name="beneficiaryBankAccount_RefID" value="{{ $dataAdvance['bankAccount']['beneficiary']['bankAccountNumber'] }}" hidden>
                                <input id="bank_account" style="border-radius:0;" name="bank_account" class="form-control" readonly value="{{ $dataAdvance['bankAccount']['beneficiary']['bankAccountNumber'] }}">
                                <div class="input-group-append">
                                    <span style="border-radius:0;" class="input-group-text form-control">
                        ...
                        <td>
                            <div class="input-group" style="width: 140%;position:relative;right:38%;">
                                <input id="account_name" style="border-radius:0;" class="form-control" name="account_name" readonly value="{{ $dataAdvance['bankAccount']['beneficiary']['bankAccountName'] }}">
                            </div>
                        </td>
                    </tr>
                </table>
