                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                <input name="requester" id="requester" style="border-radius:0;" type="text" class="col-4 form-control" readonly value="{{ $dataRevisi['involvedPersons'][0]['requesterWorkerName'] }}">
                                <input name="requester_id" id="requester_id" style="border-radius:0;" type="hidden" class="form-control" readonly value="{{ $dataRevisi['involvedPersons'][0]['requesterWorkerJobsPosition_RefID'] }}">
                                ...
                                <input id="requester_detail" style="border-radius:0;" class="col-7 form-control" name="requester_detail" readonly value="{{ $dataRevisi['involvedPersons'][0]['requesterWorkerJobsPositionName']}}">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                <input name="beneficiary" id="beneficiary" style="border-radius:0;" type="text" class="col-4 form-control" readonly value="{{ $dataRevisi['involvedPersons'][0]['beneficiaryWorkerName'] }}">
                                <input name="beneficiary_id" id="beneficiary_id" style="border-radius:0;" type="hidden" class="form-control" readonly value="{{ $dataRevisi['involvedPersons'][0]['beneficiaryWorkerJobsPosition_RefID']}}">
                                <div class="input-group-append">
                                    <span style="border-radius:0;" class="input-group-text form-control">
                                ...
                                <input id="beneficiary_detail" style="border-radius:0;" class="col-7 form-control" name="beneficiary_detail" value="{{ $dataRevisi['involvedPersons'][0]['beneficiaryWorkerJobsPositionName'] }}" readonly>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                ...
                                <input id="bank_account" style="border-radius:0;" name="bank_account" class="col-4 form-control" readonly value="{{ $dataRevisi['bankAccount']['beneficiary']['bankAccountNumber'] }}">
                                <div class="input-group-append">
                                    <span style="border-radius:0;" class="input-group-text form-control">
                                ...
                                <input id="bank_account_detail" style="border-radius:0;" class="col-7 form-control" name="bank_account_detail" readonly value="{{ $dataRevisi['bankAccount']['beneficiary']['bankAccountName'] }}">
                            </div>
                        </td>
                    </tr>
                </table>
