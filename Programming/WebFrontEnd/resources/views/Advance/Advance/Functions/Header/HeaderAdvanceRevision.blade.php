          ...
          <tr>
            ...
            <td>
              <div class="input-group" style="width: 70%;">
                <input id="projectcode" style="border-radius:0;" name="projectcode" class="form-control" readonly value="{{$dataAdvance['itemList']['ungrouped'][0]['entities']['combinedBudgetCode']}}">
      ...
      <div class="form-group">
        <table>
          <tr>
            ...
            <td>
              <div class="input-group" style="width: 70%;">
                <input id="sitecode" style="border-radius:0;" name="sitecode" class="form-control" readonly value="{{$dataAdvance['itemList']['ungrouped'][0]['entities']['combinedBudgetSectionCode']}}">
                <div class="input-group-append">
                  <span style="border-radius:0;" class="input-group-text form-control">
