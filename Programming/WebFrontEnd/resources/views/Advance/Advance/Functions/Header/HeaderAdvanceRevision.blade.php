      ...
      <div class="form-group">
        <table>
          <tr>
            ...
            <td>
              <div class="input-group">
                <input id="sitecode" style="border-radius:0;" name="var_sub_budget_code" class="form-control" readonly value="{{$dataAdvanceRevisions['entities']['combinedBudgetSection_RefID']}}">
                <div class="input-group-append">
                  <span style="border-radius:0;" class="input-group-text form-control">
            ...
            <td>
              <div class="input-group">
                <input id="sitename" style="border-radius:0;" class="form-control" name="var_sub_budget_code2" readonly value="{{$dataAdvanceRevisions['entities']['combinedBudgetSectionName']}}">
              </div>
            </td>
          </tr>
        </table>
        ...
        <table>
          <tr>
            ...
            <td style="padding-top: 10px;">
              <div class="input-group">
                <input name="var_request_name" id="request_name" style="border-radius:0;" type="text" class="form-control" readonly value="{{ $dataRequester['name'] }}" required>
                <input name="var_request_name_id" id="request_name_id" style="border-radius:0;" type="hidden" class="form-control" value="{{ $dataRequester['workerJobsPosition_RefID'] }}" readonly required>
                ...
                <div class="input-group-append">
                  <span style="border-radius:0;" class="input-group-text form-control">
                    <a id="request_name2" data-toggle="modal" data-target="#popUpRequesterAdvance"><img src="{{ asset('AdminLTE-master/dist/img/box.png') }}" width="13" alt=""></a>
                  </span>
                </div>
              </div>
            </td>
