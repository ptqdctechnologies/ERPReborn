                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left" style="padding: 10px;font-size:14px;background-color:#4B586A;margin-top:8px;">
                                <li class="nav-item">
                                    <a href="{{ route('TaxRecon.index') }}" class="nav-link" style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Create Tax Reconciliation</i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="btn_revision_tax_recon" href="javascript:;" class="nav-link" data-toggle="modal" data-target="#myPopUpTaxReconRevision" style="color:white;padding-bottom:10px;cursor:pointer">
                                        <i class="far fa-file nav-icon-sm"> Revision Tax Reconciliation</i>
                                    </a>
                                </li>
                            </ul>
                        </li>
