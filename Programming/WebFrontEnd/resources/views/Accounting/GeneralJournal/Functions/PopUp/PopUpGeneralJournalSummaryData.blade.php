<div class="modal fade" id="generalJournalFormModal" tabindex="-1" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default btn-sm" onclick="SubmitForm('CANCEL');" style="background-color:#e9ecef;border:1px solid #ced4da;">
          <img src="{{ asset('AdminLTE-master/dist/img/cancel.png') }}" width="13" alt="" title="Cancel General Journal List Cart"> No, cancel
        </button>
        ...
        <button type="button" id="submitArf" class="btn btn-default btn-sm" onclick="SubmitForm('SUBMIT');" style="margin-right: 5px;background-color:#e9ecef;border:1px solid #ced4da;">
          <img src="{{ asset('AdminLTE-master/dist/img/save.png') }}" width="13" alt="" title="Submit to General Journal"> Yes, save it
        </button>
      </div>
    </div>
  </div>
