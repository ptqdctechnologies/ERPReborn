...
<div class="wrapper-budget card-body table-responsive p-0" style="height: 230px;">
    <table class="table table-head-fixed text-nowrap table-sm" id="journal_posting_table">
        <thead>
            <tr>
                ...
                <th style="padding-top: 10px;padding-bottom: 10px;border-right:1px solid #e9ecef;text-align: center;">Supplier</th>
            </tr>
        </thead>
        <tbody id="journal_posting_body_table"></tbody>
        <tfoot>
            <tr id="journal_posting_loading_table" style="display: none;">
...
<div class="card-body">
    <div class="row">
        <div class="col">
            <div class="text-red" id="postingDetailsMessage" style="display: none;">
        ...
        <div class="col" style="margin-right: 20px; font-size: 0.77rem; color: #212529; font-weight: 600; display: none;">
            <div class="text-right">
                Total: <span id="total_posting_table">0.00</span>
            </div>
