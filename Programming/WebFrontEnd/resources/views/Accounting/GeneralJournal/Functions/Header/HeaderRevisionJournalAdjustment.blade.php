...
<div class="wrapper-budget card-body table-responsive p-0" style="height: 230px;">
    <table class="table table-head-fixed text-nowrap table-sm" id="journal_adjustment_table">
        <thead>
            <tr>
        ...
        <tbody id="journal_adjustment_body_table"></tbody>
        <tfoot>
            <tr id="journal_adjustment_loading_table" style="display: none;">
