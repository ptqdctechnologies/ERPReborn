<div class="col-sm-12 col-md-12 col-lg-3">
    ...
    <div class="row p-0 align-items-center">
        <label class="col-sm-3 col-md-4 col-lg-4 col-form-label p-0 text-bold">Account Name</label>
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
            <div>
                <span id="myInstitutionBankAccountTrigger" class="input-group-text form-control" data-toggle="modal"
                    data-target="#myInstitutionBankAccount" style="border-radius:0;cursor:pointer;">
            ...
            <div>
                <div class="input-group" id="general_ledger_date_range_container">
                    <div class="input-group-prepend"
                        ...
                        <span class="input-group-text" id="general_ledger_date_range_container_icon"
                            style="border-radius: 0;">
                            <i class="far fa-calendar-alt" style="width: 13px; height: 13px;"></i>
                        </span>
                    </div>
                    <input readonly type="text" class="form-control"
                        style="height: 21.8px;border-radius:0;background-color:white;" id="general_ledger_date_range"
                        name="general_ledger_date_range" />
                </div>
            </div>
        </div>
    </div>
