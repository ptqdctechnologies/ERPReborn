        ...
        <div class="col-md-12 col-lg-5">
                ...
                <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
                    <div>
                        <div class="input-group">
                            <input id="purchase_order_number" class="form-control" readonly
                                style="border-radius:0; cursor: default;"
            ...
            <div class="row" style="margin-top: 1rem;">
                ...
                <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
                    <div>
                        <div class="input-group">
                            <input id="purchase_order_supplier_id" style="border-radius:0;" class="form-control"
                                value="<?= $header['supplier_RefID']; ?>" hidden>
                            <input id="purchase_order_supplier" style="border-radius:0;" class="form-control"
                                value="<?= $header['supplierCode'] . ' - ' . $header['supplierName']; ?>" readonly>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        <div class="input-group">
                            <input id="purchase_order_payment_term" style="border-radius:0;" class="form-control"
                                value="<?= $header['paymentTerm']; ?>" readonly>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 col-lg-5">
            ...
            <div class="row" style="margin-bottom: 1rem;">
                ...
                <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
                    <div>
                        <div class="input-group">
                            <input id="total_payment" style="border-radius:0;" class="form-control"
                                value="<?= $header['totalPayment']; ?>" readonly>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        <div class="input-group">
                            <textarea id="purchase_order_delivery_from" cols="20" rows="4" class="form-control"
                                readonly><?= $header['deliveryFrom']; ?> - <?= $header['supplierAddress']; ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        <div class="input-group">
                            <textarea id="purchase_order_delivery_to" cols="20" rows="4" class="form-control"
                                readonly><?= $header['deliveryTo']; ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
