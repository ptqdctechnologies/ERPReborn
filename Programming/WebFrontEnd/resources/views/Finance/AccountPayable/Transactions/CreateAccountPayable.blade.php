                ...
                <div class="tab-content px-3 pb-2" id="nav-tabContent">
                  <div class="row">
                    <div class="col">
                      ...
                      <a onclick="cancelForm('{{ route('AccountPayable.index', ['var' => 1]) }}')"
                        class="btn btn-default btn-sm float-right" style="background-color:#e9ecef;border:1px solid #ced4da;">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <div
            style="line-height: 1.42857143; margin: 0; font-size: 18px; font-weight: 500; color: inherit; font-family: inherit;">
            Modal title
          </div>
        ...
        <div class="modal-body">
          Lorem ipsum dolor sit amet consectetur adipiscing elit a auctor, bibendum urna feugiat nibh turpis blandit
          pellentesque per, senectus nulla morbi scelerisque potenti placerat at laoreet. Et ac magnis tellus interdum
          condimentum eget curabitur sollicitudin sed, facilisi fringilla placerat tristique rutrum nam morbi proin dui
          ligula, malesuada sociosqu sodales praesent imperdiet suspendisse luctus accumsan. Sed nec dis semper facilisi
          maecenas dapibus placerat odio nulla metus nostra fermentum, consequat inceptos taciti volutpat ligula torquent
          aliquam curae ante lacinia.
        </div>
