                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        ...
                        @include('Finance.Invoice.Functions.Header.HeaderInvoice')
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        ...
                        <!-- BODY -->
                        <div class="wrapper-budget card-body table-responsive p-0"
                          style="height: 227px; border-bottom: 1px solid #e9ecef;">
                          <table class="table table-head-fixed text-nowrap table-sm" id="invoice_details_table">
                            <thead>
                              <tr>
                                <th
                                  style="padding-top: 10px;padding-bottom: 10px;border-right:1px solid #e9ecef;text-align: center;width: 20%;">
                                  Sub Budget
                                </th>
                                <th
                                  style="padding-top: 10px;padding-bottom: 10px;border-right:1px solid #e9ecef;text-align: center;width: 17%;">
                                  CO</th>
                                <th
                                  style="padding-top: 10px;padding-bottom: 10px;border-right:1px solid #e9ecef;text-align: center;width: 17%;">
                                  Prev. Progress</th>
                                ...
                                <th
                                  ...
                                  Curr. Invoice</th>
                                <th
                                  style="padding-top: 10px;padding-bottom: 10px;border-right:1px solid #e9ecef;text-align: center;width: 18%;">
                                  Balance CO</th>
                                <th
                                  style="padding-top: 10px;padding-bottom: 10px;background-color:#4B586A;border-right:1px solid #fff;text-align: center;color: white;width: 12%;padding-right: 5px !important;">
                                  Progress (%)</th>
                                <th
                                  style="padding-top: 10px;padding-bottom: 10px;background-color:#4B586A;border-right:1px solid #fff;text-align: center;color: white;width: 12%;padding-right: 5px !important;">
                                  Invoice Value</th>
                            ...
                            <tfoot>
                              <tr id="invoice_loading_table" style="display: none;">
                                <td colspan="10" class="p-0" style="border: 0px; height: 150px; background-color: red;">
                            ...
                            <div class="col">
                              ...
                              <div class="row d-flex" style="gap: 5%; margin-left: auto;">
                                <div class="d-flex" style="gap: 8px; margin-bottom: 1rem;">
                                  <label>VAT</label>
                                  <select type="text" id="ppn" class="form-control" name="ppn" onchange="onChangeVAT(this)"
                                ...
                                <div id="invoice_vat_percentage" style="gap: 8px; margin-bottom: 1rem; display: none;">
                                  <label>VAT (%)</label>
                                  <select id="vatOption" name="vatValue" style="border-radius:0;width:auto;"
                    ...
                    <div class="col">
                      <button type="button" class="btn btn-default btn-sm float-right" onclick="validationForm()"
                        ...
                        <img src="{{ asset('AdminLTE-master/dist/img/save.png') }}" width="13" alt=""
                          title="Submit Material Receive"> Submit
                      </button>

                      <button type="button" class="btn btn-default btn-sm float-right"
                        onclick="cancelForm('{{ route('Invoice.index', ['var' => 1]) }}')"
