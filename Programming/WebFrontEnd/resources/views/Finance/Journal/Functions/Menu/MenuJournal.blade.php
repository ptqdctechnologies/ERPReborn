                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left" style="padding: 10px;font-size:14px;background-color:#4B586A;margin-top:8px;">
                                ...
                                <li class="nav-item">
                                    <a id="btn_revision_journal" href="javascript:;" class="nav-link" data-toggle="modal" data-target="#myPopUpJournalRevision" style="color:white;padding-bottom:10px;cursor:pointer">
