<div id="myPopUpJournalRevision" class="modal fade" role="dialog" aria-hidden="true" style="margin-top: 180px;margin-left:6px;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <input required="" id="modal_journal_document_number" style="border-radius:0;" name="modal_journal_document_number" type="text" class="form-control" required readonly>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
...
<script>
    $('.btn-edit').on('click', function() {
        var journalRefID = $('#modal_journal_id').val();
        ...
        if (journalRefID) {
            ...
            $('#modal_journal_document_number_icon').css("border", "1px solid red");
        }
    });
