@extends('Partials.app')
  @section('main')
    ...
    @include('Purchase.OrderPicking.Functions.PopUp.searchPR')
        ...
        <div class="container-fluid">
          <div class="row mb-1" style="background-color:#4B586A;">
            <div class="col-sm-6" style="height:30px;">
              <label style="font-size:15px;position:relative;top:7px;color:white;">Order Picking</label>
            </div>
          </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="card">
                          ...
                          @include('Purchase.OrderPicking.Functions.Header.HeaderOrderPickingDetail')
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="card">
                          <div class="card-header">
                            <label class="card-title">
                            Order Picking Detail &nbsp;&nbsp; || &nbsp;&nbsp; Select PR Number
                          ...
                          @include('Purchase.OrderPicking.Functions.Table.TablePurchaseRequestDetail')
                        </div>
                      </div>
                    </div>
                    <nav class="w-100">
    ...
    @include('Purchase.OrderPicking.Functions.Footer.footerPO')
  @endsection