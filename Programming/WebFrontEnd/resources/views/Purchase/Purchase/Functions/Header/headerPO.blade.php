                ...
                <div class="form-group">
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="border:1px solid #e9ecef;">
                                <div class="input-group">
                                <input id="deliverTo" style="border-radius:0;" class="form-control" readonly>
                                <div class="input-group-append">
                                    <span style="border-radius:0;" class="input-group-text form-control">
                                    <a href="#"><i id="deliverTo2" data-toggle="modal" data-target="#myDeliverTo" class="fas fa-gift" style="color:grey;"></i></a>
                                    </span>
                                </div>
                                </div>
                            </td>
