                ...
                success: function(data) {
                    ...
                    if (data == "200") {
                        ...
                        var html = '<tr>' +
                            ...
                            '&nbsp;<button type="button" class="btn btn-xs EditPurchaseOrder" data-dismiss="modal" data-id1="' + product_id + '" data-id2="' + pr_number + '" data-id3="' + product_name + '" data-id4="' + uom + '" data-id5="' + qtyCek + '" data-id6="' + priceCek + '" data-id7="' + totalPO + '" style="border: 1px solid #ced4da;padding-left:2px;padding-right:2px;padding-top:2px;padding-bottom:2px;border-radius:3px;"><img src="AdminLTE-master/dist/img/edit.png" width="17" alt="" title="Edit"></button> ' +
                        ...
                        $("body").on("click", ".EditPurchaseOrder", function() {
                            ...
                            $("#pr_number4").val($this.data("id2"));
                            $("#product_id").val($this.data("id1"));
                            $("#product_name").val($this.data("id3"));
                            $("#uom").val($this.data("id4"));
                            $("#qtyCek").val($this.data("id5"));
