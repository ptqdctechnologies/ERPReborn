                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <label class="card-title">
                                                    Edit Existing Procurement Request (PR) Overhead
                                                </label>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="input-group">
                                                                            <input name="product_id" id="putProductId" style="border-radius:0;" type="text" class="form-control">
                                                                    ...
                                                                    <td>
                                                                        <input name="product_name" id="putProductName" style="border-radius:0;" type="text" class="form-control">
                                                                    </td>
                                                                </tr>
                                                                <tr>
