  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card" style="position:relative;bottom:10px;">
        <form method="post" enctype="multipart/form-data" action="{{ route('ProcurementRequest.store') }}" id="FormSubmitProcReq">
          @csrf
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  @include('Purchase.ProcurementRequest.Functions.Header.HeaderProcReq')
                </div>
              </div>
            </div>
...
@include('Purchase.ProcurementRequest.Functions.Footer.FooterProcurementRequest')
@endsection