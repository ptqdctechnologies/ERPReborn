...
<form method="post" enctype="multipart/form-data" action="{{ route('PO.submitData') }}" name="formPO">
            ...
            <div class="tab-pane fade" id="amountdueto" role="tabpanel" aria-labelledby="product-desc-tab">
              <div class="row">
                <div class="col-12">
                  ...
                  <a href="{{ route('PO.index') }}" class="btn btn-outline btn-danger btn-sm float-right remove-arf-list">
                    <i class="fa fa-times" aria-hidden="true" title="Cancel Advance List Cart">Cancel</i>
                  </a>
