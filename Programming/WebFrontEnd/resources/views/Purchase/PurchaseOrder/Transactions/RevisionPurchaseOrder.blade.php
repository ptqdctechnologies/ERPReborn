    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          <form method="post" action="{{ route('SelectWorkFlow') }}" id="FormSubmitRevisionPurchaseOrder">
            ...
            <input type="hidden" name="transactionTaxDetail_RefID" id="transactionTaxDetail_RefID"
              value="<?= $header['transactionTaxDetailRefID']; ?>" />
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <input type="text" id="dataInput_Log_FileUpload" name="dataInput_Log_FileUpload_1"
                            style="display:none" value="<?= $header['fileID']; ?>">
      ...
      ''; ?>
            ...
            <div class="tab-content px-3 pb-2" id="nav-tabContent">
              <div class="row">
                <div class="col">
                  <button id="button_submit" type="button" class="btn btn-default btn-sm float-right"
                    onclick="validationForm()" style="background-color:#e9ecef;border:1px solid #ced4da;">
                    <img src="{{ asset('AdminLTE-master/dist/img/save.png') }}" width="13" alt=""
                      title="Submit to Purchase Order"> Submit
                  </button>

                  <button type="button" class="btn btn-default btn-sm float-right"
                    onclick="cancelForm('{{ route('PurchaseOrder.index', ['var' => 1]) }}')"
                    style="margin-right: 5px;background-color:#e9ecef;border:1px solid #ced4da;">
                    <img src="{{ asset('AdminLTE-master/dist/img/cancel.png') }}" width="13" alt=""
                      title="Cancel Purchase Order List Cart"> Cancel
                  </button>
                </div>
              </div>
            </div>
