        ...
        <div class="container-fluid">
            <div class="row mb-1" style="background-color:#4B586A;">
                <div class="col-sm-6" style="height:30px;">
                    <label style="font-size:15px;position:relative;top:7px;color:white;">PO to DO Report</label>
                </div>
            </div>
            <div class="card">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row p-1" style="row-gap: 1rem;">
                                        @include('Purchase.PurchaseOrder.Functions.Header.HeaderReportPOtoDO')
                                    </div>
                                </div>
                            </div>
                        </div>
...
@include('Purchase.PurchaseOrder.Functions.Footer.footerReportPOtoDO')
@endsection