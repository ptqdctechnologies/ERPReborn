        ...
        <div class="modal-content" style="width:90%;">
            <div class="modal-header">
                <div class="modal-body">
                    <span style="font-size: 15px;position:relative;left:35%;font-weight:bold;">Purchase Order Revision</span><br><br><br>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <span style="border-radius:0;" class="input-group-text form-control" id="purchaseOrder_number_icon">
                                                            <a data-toggle="modal" data-target="#mySearchPO"><img src="{{ asset('AdminLTE-master/dist/img/box.png') }}" width="13" alt=""></a>
                                                        </span>
                                                    </div>
                                                </div>
                                            </td>                                            
