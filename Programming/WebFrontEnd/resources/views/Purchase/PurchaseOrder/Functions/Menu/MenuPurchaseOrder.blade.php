                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left"
                                ...
                                <li class="nav-item">
                                    <a id="create_purchase_order" href="{{ route('PurchaseOrder.index') }}"
                                        class="nav-link" style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Create Purchase Order</i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="revision_purchase_order" href="javascript:;"
                                        class="nav-link myPopUpPORevision" data-toggle="modal"
                                        data-target="#myPopUpPORevision"
