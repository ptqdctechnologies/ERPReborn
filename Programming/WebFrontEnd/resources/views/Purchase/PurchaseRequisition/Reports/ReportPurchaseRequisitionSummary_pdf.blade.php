...
<body>
    <div class="card-body table-responsive p-0">
        ...
        <div style="text-align: center; font-size: 20px; font-weight: bold;">Purchase Requisition Summary Report</div>
        ...
        <table class="TableReportAdvanceSummary" style="margin-left: 1px; width: 100%; margin-top: 30px;" id="TableReportAdvanceSummary">
            ...
            <tr>
                ...
                <td>
                    <div style="margin-top: 4px;">
                        <?= Session::get("dataPDFReportPurchaseRequisitionSummary.number"); ?>
                    </div>
                </td>
                <td>
                    <div style="margin-top: 4px;">
