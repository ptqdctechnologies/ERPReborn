            ...
            <div class="container-fluid">
                <div class="row mb-1" style="background-color:#4B586A;">
                    <div class="col-sm-6" style="height:30px;">
                        <label style="font-size:15px;position:relative;top:7px;color:white;">Purchase Requisition Detail
                            Report</label>
                    </div>
                </div>
                <div class="card">
                                ...
                                <div class="col-12 ShowTableReportPRDetailSummary" style="font-weight: bold;">
                                    <div class="card">
                                        <div class="card-header">
                                            <center>
                                                <h3><span style="text-transform:uppercase;font-weight:bold;">Purchase
                                                        Requisition</span></h3>
                                            </center>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td>{{ $dataGeneral['budget']['combinedBudgetCodeList'][0] }} -
                                                                    {{ $dataGeneral['budget']['combinedBudgetNameList'][0] }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding-top: 5px;"><label>Sub Budget Code</label>
                                                                </td>
                                                                <td>:</td>
                                                                <td>{{ $dataGeneral['budget']['combinedBudgetSectionCodeList'][0] }}
                                                                    -
                                                                    {{ $dataGeneral['budget']['combinedBudgetSectionNameList'][0] }}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                ...
                                                @foreach($dataDetail as $dataDetails)
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td style="border:1px solid #4B586A;color:#4B586A;">
                                                            {{ $dataDetails['entities']['product_RefID'] }}</td>
                                                        <td style="border:1px solid #4B586A;color:#4B586A;">
                                                            {{ $dataDetails['entities']['productName'] }}</td>
                                                        <td style="border:1px solid #4B586A;color:#4B586A;">
                                                            {{ $dataDetails['entities']['quantity'] }}</td>
                                                        <td style="border:1px solid #4B586A;color:#4B586A;">
                                                            {{ $dataDetails['entities']['productUnitPriceCurrencyValue'] }}</td>
                                                        <td style="border:1px solid #4B586A;color:#4B586A;">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <th style="padding-top: 10px;padding-bottom: 10px;border:1px solid #4B586A;color:#4B586A;"
                                                            colspan="5">GRAND TOTAL PURCHASE REQUISITION</th>
                                                        <td style="border:1px solid #4B586A;color:#4B586A;"><span
                                                                id="GrandTotal">{{ number_format($total, 2) }}</span></td>
