                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left"
                                ...
                                <li class="nav-item">
                                    <a id="create_purchase_requisition" href="{{ route('PurchaseRequisition.index') }}"
                                        class="nav-link" style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Create Purchase Request</i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="revision_purchase_requisition" class="nav-link" data-toggle="modal"
                                        data-target="#myPopUpPurchaseRequisitionRevision"
