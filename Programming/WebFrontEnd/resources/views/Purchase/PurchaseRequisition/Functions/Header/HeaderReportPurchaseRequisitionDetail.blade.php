<div class="card">
    <form method="post" action="{{ route('PurchaseRequisition.ReportPurchaseRequisitionDetailStore') }}" id="FormSubmitReportDORDetail">
    @csrf
    <div class="card-body">
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <table>
                        <tr>
                            ...
                            <form method="post" action="{{ route('PurchaseRequisition.PrintExportReportPurchaseRequisitionDetail') }}" id="FormSubmitReportDORDetail">
                            @csrf
                                <td>
