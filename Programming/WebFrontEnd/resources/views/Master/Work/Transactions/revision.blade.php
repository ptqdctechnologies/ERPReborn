...
@section('main')
    ...
    @include('Master.Work.Functions.PopUp.revision')
                                ...
                                <div class="col">
                                    <button type="button" class="btn btn-default btn-sm float-right" data-toggle="modal"
                                        ...
                                        <img src="{{ asset('AdminLTE-master/dist/img/save.png') }}" width="13" alt=""
                                            title="Submit to Work"> Submit
                                    </button>
                                    <button type="button" class="btn btn-default btn-sm float-right"
                                        onclick="cancelForm('{{ route('Work.index') }}')"
                                        style="background-color:#e9ecef;border:1px solid #ced4da;">
                                        <img src="{{ asset('AdminLTE-master/dist/img/cancel.png') }}" width="13" alt=""
                                            title="Cancel to Work"> Cancel
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    @include('Master.Work.Functions.Footer.revision')
