                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left"
                                ...
                                <li class="nav-item">
                                    <a id="create_work" href="{{ route('Work.create') }}" class="nav-link"
                                        style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Create Work</i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="revision_work" href="javascript:;" class="nav-link" data-toggle="modal"
                                        data-target="#workRevisionModal" style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Revision Work</i>
                                    </a>
                                </li>
                            </ul>
                        </li>
