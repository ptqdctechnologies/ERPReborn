          ...
          <tr>
            ...
            <td>
              <div class="input-group">
                <select class="form-control" style="width: 100%;" name="origin_budget" id="origin_budget" readonly>
                  <option selected="selected" value="{{ $origin_budget }}">{{ $origin_budget }}</option>
                </select>
              </div>
            </td>
            <td>
      ...
      <div class="form-group">
        <table>
          <tr>
            ...
            <td>
              <div class="input-group">
                <input id="projectcode" style="border-radius:0;" name="project_code" class="form-control" readonly value="{{ $project }}">
            ...
            <td>
              <input id="projectname" style="border-radius:0;" class="form-control" name="projek_name" readonly value="{{ $projectDetail }}">
            </td>
            <td>
      ...
      <div class="form-group">
        <table>
          <tr>
            ...
            <td>
              <div class="input-group">
                <input id="sitecode" style="border-radius:0;" name="sitecode" class="form-control"  readonly value="{{ $site }}">
                <div class="input-group-append">
                  <span style="border-radius:0;" class="input-group-text form-control">
