    ...
    <div class="row py-3" style="gap: 1rem;">
        ...
        <div class="col-md-12 col-lg-4">
            ...
            <div class="row" style="margin-top: 1rem;">
                ...
                <div class="col-4 d-flex justify-content-sm-end justify-content-md-end pr-0">
                    <div>
                    ...
                    <div>
                        <input type="text" id="uom_name" class="form-control" style="border-radius:0;"
                            value="<?= $header['unitOfMeasureName']; ?>" readonly />
                        <input type="hidden" id="uom_value" class="form-control" style="border-radius:0;"
                            name="uom_value" value="<?= $header['unitOfMeasureID']; ?>" />
                    </div>
                </div>
            </div>
        </div>
