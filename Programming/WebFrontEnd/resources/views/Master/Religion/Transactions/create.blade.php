        ...
        <div class="container-fluid">
            <div class="card">
                <div class="tab-content p-3" id="nav-tabContent">
                    <form method="post" enctype="multipart/form-data" action="{{ route('Religion.store') }}" name="formHeaderMret">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    <input autocomplete="off" id="Religion_code" name="Religion_code" class="form-control">
                                                                </div>
                                                            </td>
                                                        </tr>
