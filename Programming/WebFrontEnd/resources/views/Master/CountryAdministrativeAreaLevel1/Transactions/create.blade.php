        ...
        <div class="container-fluid">
            <div class="card">
                <div class="tab-content p-3" id="nav-tabContent">
                    <form method="post" enctype="multipart/form-data" action="{{ route('CountryAdministrativeAreaLevel1.store') }}" name="formHeaderMret">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <label class="card-title">
                                            Set Country Administrative Area Level 1
                                        </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <table>
                                                        <tr>
                                                            <td><label>CountryAdministrativeAreaLevel1</label></td>
                                                            <td>
                                                                <div class="input-group">
                                                                    <input autocomplete="off" id="CountryAdministrativeAreaLevel1_code" name="CountryAdministrativeAreaLevel1_code" class="form-control">
                                                                </div>
                                                            </td>
                                                        </tr>
