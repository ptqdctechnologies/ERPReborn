                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left"
                                ...
                                <li class="nav-item">
                                    <a id="create_rate" href="{{ route('Rate.create') }}" class="nav-link"
                                        style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Create Rate</i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="revision_rate" href="javascript:;" class="nav-link" data-toggle="modal"
                                        data-target="#rateRevisionModal" style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Revision Rate</i>
                                    </a>
                                </li>
                            </ul>
                        </li>
