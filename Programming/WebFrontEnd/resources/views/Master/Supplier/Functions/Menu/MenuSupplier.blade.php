                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left"
                                ...
                                <li class="nav-item">
                                    <a id="create_supplier" href="{{ route('Supplier.create') }}" class="nav-link"
                                        style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Create Supplier</i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="revision_supplier" href="javascript:;" class="nav-link" data-toggle="modal"
                                        data-target="#mySupplierRevision" style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Revision Supplier</i>
                                    </a>
                                </li>
                            </ul>
                        </li>
