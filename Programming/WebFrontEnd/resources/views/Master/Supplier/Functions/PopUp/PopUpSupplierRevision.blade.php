                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <form id="editForm" action="{{ route('Loan.RevisionLoan') }}"
                                                    method="POST">
                                                    @csrf
                                                    <input id="modal_loan_id" style="border-radius:0;"
                                                        name="modal_loan_id" type="hidden" class="form-control">
                                                </form>

                                                <div class="input-group-append" style="cursor: pointer;">
                                                    <span style="border-radius:0;" class="input-group-text form-control"
                                                        id="modal_supplier_document_number_icon">
                                                ...
                                                <input required="" id="modal_supplier_document_number"
                                                    style="border-radius:0;" name="modal_supplier_document_number"
...
<script>
    $('.btn-edit').on('click', function () {
        ...
        if (loanRefID) {
            ...
            $('#modal_supplier_document_number').focus();
            $('#modal_supplier_document_number').css("border", "1px solid red");
        }
    });

    $('.btn-cancel').on('click', function () {
        $('#modal_loan_id').val("");
        $('#modal_supplier_document_number').val("");
    });
</script>