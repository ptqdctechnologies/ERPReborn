                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Edit Existing ARF</label>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Edit Existing ARF (Overhead)</label>                                        
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Edit Existing ARF (Sales)</label>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Revision ARF (Overhead)</label>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Revision ARF (Sales)</label>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Generate Checklist Item for ARF Pulsa</label>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Create New ARF Pulsa/Voucher</label>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Edit Existing ARF Pulsa/Voucher</label>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('ASF.indexOverhead') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Create New ASF (Overhead)</label>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ASF.indexSales') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Create New ASF (Sales)</label>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ASF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Edit Existing ASF</label>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ASF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Edit Existing ASF (Overhead) </label>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ASF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Edit Existing ASF (Sales)</label>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ASF.indexPulsaVoucher') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Create New ASF Pulsa/Voucher<label>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Edit Existing BRF</label>                                        
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>BRF Revision</label>                                        
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('BRF.fundBRF') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Fund Business Trip Payment</label>                                        
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('BRF.BRFtoBRFP') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>BRF to BRFP</label>                                        
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('ARF.index') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Edit Existing BSF</label>                                        
                                            </a>
                                        </li>                                        
                                        <li class="nav-item">
                                            <a href="{{ route('BSF.BSFtoBRF') }}" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>BSF to BRF</label>                                        
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item">                                    
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="" class="nav-link">
                                                <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                                <label>Edit Existing Progress Piece Meal</label>
                                            </a>
                                        </li>                                    
                                    </ul>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">                                
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        <i class="far fa-file nav-icon-sm" style="color:#FF69B4;"></i>
                                        <label>Master Spesialist Supplier</label>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
