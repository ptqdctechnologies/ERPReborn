<div id="mySearchWarehouse3" class="modal fade" role="dialog" aria-labelledby="contohModalScrollableTitle" aria-hidden="true">
...
<script>
    function searchTranoNoPo() {
        ...
        table = document.getElementById("tableGetWarehouse3");
