    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bankListModalLabel"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body table-responsive p-0">
                                <table class="table table-head-fixed w-100" id="bankListTable">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Acronym</th>
...
<script>
    function getBankList() {
        let table = $('#bankListTable').DataTable({
            processing: true,
            serverSide: true,
            destroy: true,
            info: true,
            ...
            ajax: {
                ...
                beforeSend: function () {
                    $('#bankListTable tbody').empty();
                    $("#bankListLoadingTable").show();
                },
                complete: function () {
                    $("#bankListLoadingTable").hide();
                },
            ...
            initComplete: function () {
                ...
                let $filter = $('#bankListTable_filter');
