<div class="card-body table-responsive p-0" style="height: 250px;" id="tableShowHideBOQ2">
    <table class="table table-head-fixed text-nowrap table-striped">
        ...
        <tbody id="showContentBOQ2">
            ...
            <td>
                ...
                <button type="reset" class="btn btn-outline-primary btn-sm float-right klikArfDetail1" title="Submit" style="border-radius: 100px;" disabled>
                    <i class="fas fa-file" aria-hidden="true"></i>
                </button>
                
                @else
                <button type="reset" class="btn btn-outline-success btn-sm float-right klikArfDetail1" title="Submit" style="border-radius: 100px;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="reset" class="btn btn-outline-primary btn-sm float-right klikArfDetail2" title="Submit" style="border-radius: 100px;" disabled>
                        <i class="fas fa-file" aria-hidden="true"></i>
                    </button>
                    
                    @else
                    <button type="reset" class="btn btn-outline-success btn-sm float-right klikArfDetail2" title="Submit" style="border-radius: 100px;">
                        <i class="fas fa-plus" aria-hidden="true"></i>
                    </button>
                    @endif
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="reset" class="btn btn-outline-primary btn-sm float-right klikArfDetail3" title="Submit" style="border-radius: 100px;" disabled>
                        <i class="fas fa-file" aria-hidden="true"></i>
                    </button>
                    
                    @else
                    <button type="reset" class="btn btn-outline-success btn-sm float-right klikArfDetail3" title="Submit" style="border-radius: 100px;">
                        <i class="fas fa-plus" aria-hidden="true"></i>
                    </button>
                    @endif
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="reset" class="btn btn-outline-primary btn-sm float-right klikArfDetail4" title="Submit" style="border-radius: 100px;" disabled>
                        <i class="fas fa-file" aria-hidden="true"></i>
                    </button>
                    
                    @else
                    <button type="reset" class="btn btn-outline-success btn-sm float-right klikArfDetail4" title="Submit" style="border-radius: 100px;">
                        <i class="fas fa-plus" aria-hidden="true"></i>
                    </button>
                    @endif
                </td>
