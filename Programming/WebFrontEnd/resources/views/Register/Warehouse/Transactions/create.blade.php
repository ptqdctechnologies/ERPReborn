    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card" style="position:relative;bottom:10px;">
                <form method="post" enctype="multipart/form-data" action="{{ route('Warehouse.store') }}" id="FormSubmitWarehouse">
                    @csrf
                                                ...
                                                <div class="form-group">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    <input id="code" style="border-radius:0;" name="code" class="col form-control">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    <input id="name" style="border-radius:0;" name="name" class="col form-control">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    <textarea name="address" id="address" cols="30" rows="5" class="col form-control"></textarea>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    <textarea name="description" id="description" cols="30" rows="5" class="col form-control"></textarea>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
