        ...
        <div class="container-fluid">
            <div class="card">
                <div class="tab-content p-3" id="nav-tabContent">
                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ route('CountryAdministrativeAreaLevel1.update', $datax['sys_ID']) }}" name="formHeaderMret">
                        <div class="row">
                            @method('PUT')
                            @csrf
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <label class="card-title">
                                            Edit Country Administrative Area Level 1
                                        </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <table>
                                                        <tr>
                                                            <td><label>CountryAdministrativeAreaLevel1 Code</label></td>
                                                            <td>
                                                                <div class="input-group">
                                                                    <input autocomplete="off" id="tranoType" name="CountryAdministrativeAreaLevel1_code" class="form-control" value="{{ $datax['name'] }}">
                                                                </div>
                                                            </td>
                                                        </tr>
