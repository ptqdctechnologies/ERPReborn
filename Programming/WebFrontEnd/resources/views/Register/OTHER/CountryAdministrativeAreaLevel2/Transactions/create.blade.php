        ...
        <div class="container-fluid">
            <div class="card">
                <div class="tab-content p-3" id="nav-tabContent">
                    <form method="post" enctype="multipart/form-data" action="{{ route('CountryAdministrativeAreaLevel2.store') }}" name="formHeaderMret">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <label class="card-title">
                                            Set Country Administrative Area Level 2
                                        </label>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    <input autocomplete="off" id="CountryAdministrativeAreaLevel2_code" name="CountryAdministrativeAreaLevel2_code" class="form-control">
                                                                </div>
                                                            </td>
                                                        </tr>
