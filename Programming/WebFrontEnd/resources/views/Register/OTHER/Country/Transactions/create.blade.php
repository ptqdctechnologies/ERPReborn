        ...
        <div class="container-fluid">
            <div class="card">
                <div class="tab-content p-3" id="nav-tabContent">
                    <form method="post" enctype="multipart/form-data" action="{{ route('Country.store') }}" name="formHeaderMret">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    <input autocomplete="off" id="Country_code" name="Country_code" class="form-control">
                                                                </div>
                                                            </td>
                                                        </tr>
