        ...
        <div class="container-fluid">
            <div class="card">
                <div class="tab-content p-3" id="nav-tabContent">
                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ route('Country.update', $datax['sys_ID']) }}" name="formHeaderMret">
                        <div class="row">
                            @method('PUT')
                            @csrf
                            <div class="col-12">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    <input autocomplete="off" id="tranoType" name="Country_code" class="form-control" value="{{ $datax['name'] }}">
                                                                </div>
                                                            </td>
                                                        </tr>
