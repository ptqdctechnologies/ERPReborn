<div class="modal fade" id="budgetProgressRevisionModal" tabindex="-1"
    aria-labelledby="budgetProgressRevisionModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="budgetProgressRevisionModalLabel"
                    style="font-size: 15px; font-weight:bold; text-align: center;">
                    BUDGET PROGRESS REVISION
                </h5>
                    ...
                    <div class="card mb-0" style="width: fit-content;">
                        <div class="card-body d-flex align-items-center justify-content-center" style="gap: 1rem;">
                            ...
                            <div class="form-group d-flex">
                                <div>
                                    <span id="modal_budget_progress_document_number_icon"
