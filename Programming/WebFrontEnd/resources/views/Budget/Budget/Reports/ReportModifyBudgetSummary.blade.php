            ...
            <div class="container-fluid">
                <div class="row mb-1" style="background-color:#4B586A;">
                    <div class="col-sm-6" style="height:30px;">
                        <label style="font-size:15px;position:relative;top:7px;color:white;">Modify Budget Summary
                            Report</label>
                    </div>
                </div>
                <div class="card">
                                                ...
                                                <div class="form-group">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td><b>:</b></td>
                                                            <td><b><?= $dataReport['dataHeader']['budget'] . " - " . $dataReport['dataHeader']['budget_name']; ?></b>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th style="padding-top: 7px;"><label>Sub Budget&nbsp;</label>
                                                            </th>
                                                            <td><b>:</b></td>
                                                            <td><b><?= $dataReport['dataHeader']['sub_budget'] . " - " . $dataReport['dataHeader']['sub_budget_name']; ?></b>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                            ...
                            <div class="col-12 ShowTableReportDOSummary">
                                <div class="card">
                                    <div class="card-body table-responsive p-0">
                                        <table class="table table-head-fixed text-nowrap TableReportDOSummary"
                                            id="DefaultFeatures">
                                            <thead>
                                                <tr>
                                                    <th
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th colspan="3"
                                                        style="padding-top: 10px;padding-bottom: 10px;border:1px solid #e9ecef;background-color:#4B586A;color:white;">
                                                        Grand Total</th>
                                                    <th
                                                        style="padding-top: 10px;padding-bottom: 10px;border:1px solid #e9ecef;background-color:#4B586A;color:white;">
                                                        <?= number_format($dataReport['total'], 2, '.', ','); ?></th>
                                                    <th
                                                        style="padding-top: 10px;padding-bottom: 10px;border:1px solid #e9ecef;background-color:#4B586A;color:white;">
                                                    </th>
                                                    <th
