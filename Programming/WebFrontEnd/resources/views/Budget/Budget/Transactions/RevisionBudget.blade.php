...
@section('main')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <!-- BODY -->
                                    @include('Budget.Budget.Functions.Header.HeaderRevisionBudget')
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <!-- BODY -->
                                    @include('Budget.Budget.Functions.Header.HeaderRevisionImportFromExcel')
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <!-- BODY -->
                                    @include('Budget.Budget.Functions.Header.HeaderRevisionTimeline')
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col">
                                <button type="button" class="btn btn-default btn-sm float-right" onclick=""
                                    ...
                                    <img src="{{ asset('AdminLTE-master/dist/img/save.png') }}" width="13" alt=""
                                        title="Submit to Budget"> Submit
                                </button>

                                <a onclick="cancelForm('{{ route('Budget.index', ['var' => 1]) }}')"
                                    class="btn btn-default btn-sm float-right"
                                    style="background-color:#e9ecef;border:1px solid #ced4da;">
                                    <img src="{{ asset('AdminLTE-master/dist/img/cancel.png') }}" width="13" alt=""
                                        title="Cancel Budget List Cart"> Cancel
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    @include('Budget.Budget.Functions.Footer.FooterRevisionBudget')
