                ...
                <div class="col-5 d-flex">
                    ...
                    <div style="flex: 100%;">
                        <div class="input-group">
                            <input id="project_name" style="border-radius:0; background-color: white;" name="project_name" class="form-control" readonly>
                            <input id="project_code" style="border-radius:0;" name="project_code" class="form-control" hidden>
                            <input id="project_id" style="border-radius:0;" name="project_id" class="form-control" hidden>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 col-lg-5">
            <div class="row">
                ...
                <div class="col-5 d-flex">
                    ...
                    <div style="flex: 100%;">
                        <div class="input-group">
                            <input id="site_name" style="border-radius:0; background-color: white;" name="site_name" class="form-control" readonly>
                            <input id="site_code" style="border-radius:0;" name="site_code" class="form-control" hidden>
                            <input id="site_id" style="border-radius:0;" name="site_id" class="form-control" hidden>
                        </div>
                    </div>
                </div>
            </div>
