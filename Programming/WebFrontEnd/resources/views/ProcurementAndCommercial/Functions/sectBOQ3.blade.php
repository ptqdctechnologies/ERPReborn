                                            ...
                                            <table class="table table-head-fixed text-nowrap table-striped" id="arfTableDisableEnable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="progress progress-xs" style="height: 14px;border-radius:8px;">
                                                                <div class="progress-bar progress-bar-danger" style="width: {{$y2}}%"></div>
                                                            </div>
                                                            <small>
                                                                <center>{{ $y2 }} %</center>
                                                            </small>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="progress progress-xs" style="height: 14px;border-radius:8px;">
                                                                <div class="progress-bar progress-bar-danger" style="width: {{$y3}}%"></div>
                                                            </div>
                                                            <small>
                                                                <center>{{ $y3 }} %</center>
                                                            </small>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="progress progress-xs" style="height: 14px;border-radius:8px;">
                                                                <div class="progress-bar progress-bar-danger" style="width: {{$y4}}%"></div>
                                                            </div>
                                                            <small>
                                                                <center>{{ $y4 }} %</center>
                                                            </small>
