    ...
    <table class="table table-head-fixed text-nowrap table-striped" id="arfTableDisableEnable">
        ...
        <tbody>
            ...
            <!-- <tr>
                ...
                <td><span class="tag tag-success" id="getCurrency1">ARF-02</span></td>
            ...
            <tr>
                ...
                <td><span class="tag tag-success" id="getCurrency1">ARF-03</span></td>
            ...
            <tr>
                ...
                <td><span class="tag tag-success" id="getCurrency1">ARF-04</span></td>
