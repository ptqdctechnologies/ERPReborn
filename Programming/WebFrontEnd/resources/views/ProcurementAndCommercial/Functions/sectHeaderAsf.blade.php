                ...
                <div class="form-group">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input required="" id="managerAsfUid" style="border-radius:0;" name="projek_code" type="text" class="form-control">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input required="" id="currencyCode" style="border-radius:0;" name="projek_code" type="text" class="form-control">
                                    <div class="input-group-append">
                                        <span style="border-radius:0;" class="input-group-text form-control">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input required="" id="financeArfUid" style="border-radius:0;" name="projek_code" type="text" class="form-control">
                                    <div class="input-group-append">
                                        <span style="border-radius:0;" class="input-group-text form-control">
                        ...
                        <tr>
                            ...
                            <td>
                                <input required="" id="projectname" style="border-radius:0;width:30px;" readonly="" class="form-control">
                            </td>
                        </tr>
                    </table>
                </div>
