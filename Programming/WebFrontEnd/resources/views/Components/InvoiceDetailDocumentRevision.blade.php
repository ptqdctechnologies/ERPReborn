    ...
    <div class="table-fixed" style="flex: 0 0 auto;">
        <table class="table table-striped table-hover table-sm">
            <thead>
                ...
                <tr>
                    <th class="text-center" style="vertical-align: middle; width: 170px; min-width: 170px; max-width: 170px; left: 0px; z-index: 10;position: sticky; background-color: white;">Sub Budget Code</th>
                    <th class="text-center" style="vertical-align: middle; width: 145px; min-width: 145px; max-width: 145px; left: 170px; z-index: 10;position: sticky; background-color: white;">Customer Order</th>
                    <th class="text-center" style="vertical-align: middle; width: 145px; min-width: 145px; max-width: 145px; left: 315px; z-index: 10;position: sticky; background-color: white;">Invoice Value</th>
                    <th class="text-center" style="vertical-align: middle; width: 110px; min-width: 110px; max-width: 110px; left: 460px; z-index: 10;position: sticky; background-color: white;">Progress (%)</th>
                </tr>
            </thead>
            <tbody>
                <tr>
    ...
    <div class="table-scroll" style="overflow-x: auto; width: 100%;">
        <table class="table table-striped table-hover table-sm">
            <thead>
                ...
                <tr>
                    <th class="text-center" style="background-color:#4B586A;color:white;border-right:1px solid #e9ecef;vertical-align: middle;width: 80px; min-width: 80px; max-width: 80px;">Invoice Value</th>
                    <th class="text-center" style="background-color:#4B586A;color:white;border-right:1px solid #e9ecef;vertical-align: middle;width: 125px; min-width: 125px; max-width: 125px;">Progress (%)</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="padding: 8px;width: 80px; min-width: 80px; max-width: 80px;">25,000,000.00</td>
                    <td style="padding: 8px;width: 125px; min-width: 125px; max-width: 125px;">3</td>
                </tr>
            </tbody>
        </table>
    </div>
