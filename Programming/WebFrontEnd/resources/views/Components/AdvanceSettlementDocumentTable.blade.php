        ...
        <table class="table table-head-fixed text-nowrap mb-0">
            <thead>
                <tr>
                    ...
                    <th colspan="3" rowspan="2" style="padding-top: 10px;padding-bottom: 10px;border-right:1px solid #e9ecef;text-align: center; vertical-align: middle;background-color:#4B586A;color: white;">Request</th>
            ...
            <tbody>
                ...
                <?php foreach ($dataDetails as $dataDetail) { ?>
                    ...
                    <tr>
                        ...
                        {{-- <td style="border:1px solid #4B586A;color:#4B586A;"><?php number_format($dataDetail['balance'] ?? 0, 2); ?></td> --}}
                        ...
                        {{-- <td style="border:1px solid #4B586A;color:#4B586A;"><?php number_format($balanceSettlement ?? 0, 2); ?></td> --}}
                    </tr>
                <?php } ?>
            </tbody>
