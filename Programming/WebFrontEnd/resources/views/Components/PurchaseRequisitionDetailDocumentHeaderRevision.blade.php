    ...
    <table class="table table-striped table-hover table-sticky table-sm">
        <thead>
                ...
                @if(sizeof($dataHeaderTransactionHistory))
                    @for($i = count($dataHeaderTransactionHistory) - 1; $i >= 0; $i--) 
                        ...
                        @if ($i === count($dataHeaderTransactionHistory) - 1)
                            <th colspan="4" style="vertical-align: middle;left: 0px;z-index: 10;line-height: normal;position: sticky; background-color: white;" class="text-center">
            ...
            <tr>
                ...
                <th class="text-center" style="vertical-align: middle; width: 250px; min-width: 250px; max-width: 250px; left: 320px; z-index: 10;position: sticky; background-color: white;">Remark</th>
                ...
                @if(sizeof($dataHeaderTransactionHistory))
                    @for($i = count($dataHeaderTransactionHistory) - 1; $i >= 0; $i--)
                        @if ($i === count($dataHeaderTransactionHistory) - 1)
                            ...
                            <td style="padding: 8px; width: 250px; min-width: 250px; max-width: 250px; position: sticky; background-color: white; left: 320px; z-index: 10;"><?= $dataHeaderTransactionHistory[count($dataHeaderTransactionHistory) - 1]['content']['remarks']; ?></td>
                        @else
