    ...
    <table class="table table-striped table-hover table-sticky table-sm">
        <thead>
                ...
                @if(sizeof($dataHeaderTransactionHistory))
                    @for($i = count($dataHeaderTransactionHistory) - 1; $i >= 0; $i--) 
                        ...
                        @if ($i === count($dataHeaderTransactionHistory) - 1)
                            <th class="text-center" colspan="7" style="vertical-align: middle;left: 0px;z-index: 10;line-height: normal;position: sticky; background-color: white;">
            ...
            <tr>
                ...
                <th class="text-center" style="vertical-align: middle; width: 125px; min-width: 125px; max-width: 125px; left: 525px; z-index: 10;position: sticky; background-color: white;">Price</th>
                <th class="text-center" style="vertical-align: middle; width: 125px; min-width: 125px; max-width: 125px; left: 650px; z-index: 10;position: sticky; background-color: white;">Total</th>
            ...
            @if(sizeof($dataDetailGetTransactionHistory))
                @for($i = count($dataDetailGetTransactionHistory) - 1; $i >= 0; $i--)
                    <tr>
                        ...
                        <td style="padding: 8px; width: 125px; min-width: 125px; max-width: 125px; position: sticky; background-color: white; left: 525px; z-index: 10;">{{ number_format($dataDetailGetTransactionHistory[$i][count($dataDetailGetTransactionHistory[$i]) - 1]['content']['productUnitPriceCurrencyValue'] ?? 203, 2) }}</td>
                        <td style="padding: 8px; width: 125px; min-width: 125px; max-width: 125px; position: sticky; background-color: white; left: 650px; z-index: 10;">{{ number_format($dataDetailGetTransactionHistory[$i][count($dataDetailGetTransactionHistory[$i]) - 1]['content']['priceCurrencyValue'] ?? 98712, 2) }}</td>
                        ...
                        @for($n = count($dataDetailGetTransactionHistory[$i]) - 1; $n >= 0; $n--)
                            @if ($n !== count($dataDetailGetTransactionHistory[$i]) - 1)
                                ...
                                <td style="padding: 8px;width: 125px; min-width: 125px; max-width: 125px;">{{ number_format($dataDetailGetTransactionHistory[$i][$n]['content']['productUnitPriceCurrencyValue'] ?? 3872, 2) }}</td>
                                <td style="padding: 8px;width: 125px; min-width: 125px; max-width: 125px;">{{ number_format($dataDetailGetTransactionHistory[$i][$n]['content']['priceCurrencyValue'] ?? 623, 2) }}</td>
                            @endif
                        @endfor
                    </tr>
                @endfor
