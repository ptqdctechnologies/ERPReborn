        ...
        <table class="table table-striped table-hover table-sm">
            <thead>
                ...
                <tr>
                    ...
                    <th class="text-center" rowspan="2" style="vertical-align: middle;width: 420px;min-width: 420px;max-width: 420px;left: 370px;z-index: 10;position: sticky; background-color: white;">Note</th>
                </tr>
            </thead>
            <tbody>
                @for($i = count($dataDetailGetTransactionHistory) - 1; $i >= 0; $i--)
                    <tr>
                        ...
                        <td style="padding: 8px;width: 420px;min-width: 420px;max-width: 420px;position: sticky;background-color: white;left: 370px;z-index: 10;">{{ $dataDetailGetTransactionHistory[$i][count($dataDetailGetTransactionHistory[$i]) - 1]['content']['remarks'] }}</td>
                    </tr>
                @endfor
            </tbody>
        </table>
