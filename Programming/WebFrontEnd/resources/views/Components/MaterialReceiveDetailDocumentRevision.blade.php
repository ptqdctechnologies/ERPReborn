<div class="wrapper-budget table-responsive table-height">
    <table class="table table-striped table-hover table-sticky table-sm">
        <thead>
                ...
                @if(sizeof($dataHeaderTransactionHistory))
                    @for($i = count($dataHeaderTransactionHistory) - 1; $i >= 0; $i--) 
                        ...
                        @if ($i === count($dataHeaderTransactionHistory) - 1)
                            <th class="text-center" colspan="5" style="vertical-align: middle;left: 0px;z-index: 10;line-height: normal;position: sticky;background-color: white;">
            ...
            <tr>
                <th class="text-center" rowspan="2" style="vertical-align: middle;width: 125px;min-width: 125px;max-width: 125px;left: 0px;z-index: 10;position: sticky; background-color: white;">Product Code</th>
                <th class="text-center" rowspan="2" style="vertical-align: middle;width: 125px;min-width: 125px;max-width: 125px;left: 125px;z-index: 10;position: sticky; background-color: white;">Product Name</th>
                <th class="text-center" rowspan="2" style="vertical-align: middle;width: 40px;min-width: 40px;max-width: 40px;left: 250px;z-index: 10;position: sticky; background-color: white;">UOM</th>
                <th class="text-center" rowspan="2" style="vertical-align: middle;width: 80px;min-width: 80px;max-width: 80px;left: 290px;z-index: 10;position: sticky; background-color: white;">Qty</th>
                <th class="text-center" rowspan="2" style="vertical-align: middle;width: 250px;min-width: 250px;max-width: 250px;left: 370px;z-index: 10;position: sticky; background-color: white;">Note</th>
            ...
            @if(sizeof($dataDetailGetTransactionHistory))
                @for($i = count($dataDetailGetTransactionHistory) - 1; $i >= 0; $i--)
                    ...
                    <tr style="height: 40px;">
                        ...
                        <td style="padding: 8px;width: 250px;min-width: 250px;max-width: 250px;position: sticky;background-color: white;left: 370px;z-index: 10;">{{ $dataDetailGetTransactionHistory[$i][count($dataDetailGetTransactionHistory[$i]) - 1]['content']['remarks'] }}</td>
