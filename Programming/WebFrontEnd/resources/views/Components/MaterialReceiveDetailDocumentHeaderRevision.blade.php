        ...
        <table class="table table-striped table-hover table-sm">
            <thead>
                ...
                <tr>
                    ...
                    <th class="text-center" rowspan="2" style="vertical-align: middle;width: 290px; min-width: 290px; max-width: 290px; position: sticky; background-color: white; left: 500px; z-index: 10;position: sticky; background-color: white;">Remark</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    @for($i = count($dataHeaderTransactionHistory) - 1; $i >= 0; $i--)
                        @if ($i === count($dataHeaderTransactionHistory) - 1)
                            ...
                            <td style="padding: 8px; width: 290px; min-width: 290px; max-width: 290px; position: sticky; background-color: white; left: 500px; z-index: 10;"><?= $dataHeaderTransactionHistory[count($dataHeaderTransactionHistory) - 1]['content']['remarks']; ?></td>
                        @endif
                    @endfor
                </tr>
            </tbody>
