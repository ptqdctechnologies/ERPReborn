<div class="wrapper-budget table-responsive table-height">
    <table class="table table-striped table-hover table-sticky table-sm">
        <thead>
                ...
                @if(sizeof($dataHeaderTransactionHistory))
                    @for($i = count($dataHeaderTransactionHistory) - 1; $i >= 0; $i--) 
                        ...
                        @if ($i === count($dataHeaderTransactionHistory) - 1)
                            <th colspan="5" style="vertical-align: middle;left: 0px;z-index: 10;line-height: normal;position: sticky; background-color: white;" class="text-center">
            ...
            @if(sizeof($dataHeaderTransactionHistory))
            <tr>
                <th class="text-center" rowspan="2" style="vertical-align: middle;width: 125px; min-width: 125px; max-width: 125px; position: sticky; background-color: white; left: 0px; z-index: 10;position: sticky; background-color: white;">DO Number</th>
                <th class="text-center" rowspan="2" style="vertical-align: middle;width: 125px; min-width: 125px; max-width: 125px; position: sticky; background-color: white; left: 125px; z-index: 10;position: sticky; background-color: white;">Requester</th>
                <th class="text-center" rowspan="2" style="vertical-align: middle;width: 125px; min-width: 125px; max-width: 125px; position: sticky; background-color: white; left: 250px; z-index: 10;position: sticky; background-color: white;">Delivery From</th>
                <th class="text-center" rowspan="2" style="vertical-align: middle;width: 125px; min-width: 125px; max-width: 125px; position: sticky; background-color: white; left: 375px; z-index: 10;position: sticky; background-color: white;">Delivery To</th>
                <th class="text-center" rowspan="2" style="vertical-align: middle;width: 250px; min-width: 250px; max-width: 250px; position: sticky; background-color: white; left: 500px; z-index: 10;position: sticky; background-color: white;">Remark</th>
                ...
                @if(sizeof($dataHeaderTransactionHistory))
                    @for($i = count($dataHeaderTransactionHistory) - 1; $i >= 0; $i--)
                        @if ($i === count($dataHeaderTransactionHistory) - 1)
                            ...
                            <td style="padding: 8px; width: 125px; min-width: 125px; max-width: 125px; position: sticky; background-color: white; left: 250px; z-index: 10;"><?= $dataHeaderTransactionHistory[count($dataHeaderTransactionHistory) - 1]['beneficiaryWorkerName']; ?></td>
                            ...
                            <td style="padding: 8px; width: 250px; min-width: 250px; max-width: 250px; position: sticky; background-color: white; left: 500px; z-index: 10;"><?= $dataHeaderTransactionHistory[count($dataHeaderTransactionHistory) - 1]['content']['remarks']; ?></td>
                        @else
                            ...
                            <td style="padding: 8px;width: 125px; min-width: 125px; max-width: 125px;">{{ $dataHeaderTransactionHistory[$i]['beneficiaryWorkerName'] ?? '-' }}</td>
                            <td style="padding: 8px;width: 250px; min-width: 250px; max-width: 250px;">{{ $dataHeaderTransactionHistory[$i]['content']['remarks'] ?? '-' }}</td>
                        @endif
                    @endfor
                @endif
            </tr>
