...
<div class="col-12 col-md-5 col-lg-5">
    <div class="form-group">
        ...
        <div class="row">
            ...
            <form target="_blank" method="POST" action="{{ route('CheckDocument.Export') }}">
                @csrf
                <input type="hidden" name="transaction_RefID" id="transaction_RefID"
                    value="<?= $transactionDetail_RefID; ?>">
