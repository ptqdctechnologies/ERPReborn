        ...
        <thead>
            ...
            @if(sizeof($dataHeaderTransactionHistory))
                <tr>
                    ...
                    <th style="vertical-align: middle; width: 125px; min-width: 125px; max-width: 125px; left: 125px; z-index: 10;position: sticky; background-color: white;" class="text-center">Delivery From</th>
                    <th style="vertical-align: middle; width: 125px; min-width: 125px; max-width: 125px; left: 250px; z-index: 10;position: sticky; background-color: white;" class="text-center">Delivery To</th>
                    <th style="vertical-align: middle; width: 80px; min-width: 80px; max-width: 80px; left: 375px; z-index: 10;position: sticky; background-color: white;" class="text-center">Currency</th>
                    <th style="vertical-align: middle; width: 200px; min-width: 200px; max-width: 200px; left: 455px; z-index: 10;position: sticky; background-color: white;" class="text-center">Remark</th>
                ...
                @if(sizeof($dataHeaderTransactionHistory))
                    @for($i = count($dataHeaderTransactionHistory) - 1; $i >= 0; $i--)
                        @if ($i === count($dataHeaderTransactionHistory) - 1)
                            ...
                            <td style="padding: 8px; width: 80px; min-width: 80px; max-width: 80px; position: sticky; background-color: white; left: 375px; z-index: 10;"><?= $dataHeaderTransactionHistory[count($dataHeaderTransactionHistory) - 1]['beneficiaryWorkerName']; ?></td>
                            <td style="padding: 8px; width: 200px; min-width: 200px; max-width: 200px; position: sticky; background-color: white; left: 455px; z-index: 10;"><?= $dataHeaderTransactionHistory[count($dataHeaderTransactionHistory) - 1]['content']['remarks']; ?></td>
                        @else
