        ...
        <table class="table table-striped table-hover table-sm">
            <thead>
                ...
                <tr>
                    ...
                    <th style="vertical-align: middle; width: 320px; min-width: 320px; max-width: 320px; left: 455px; z-index: 10;position: sticky; background-color: white;" class="text-center">Remark</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    @for($i = count($dataHeaderTransactionHistory) - 1; $i >= 0; $i--)
                        @if ($i === count($dataHeaderTransactionHistory) - 1)
                            ...
                            <td style="padding: 8px; width: 320px; min-width: 320px; max-width: 320px; position: sticky; background-color: white; left: 455px; z-index: 10;"><?= $dataHeaderTransactionHistory[count($dataHeaderTransactionHistory) - 1]['content']['remarks']; ?></td>
                        @endif
                    @endfor
                </tr>
            </tbody>
