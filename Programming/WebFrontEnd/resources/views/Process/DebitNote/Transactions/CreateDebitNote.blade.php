                ...
                @if($var == 0)
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row py-3" style="gap: 15px;">
                                                            ...
                                                            <div class="col-md-12 col-lg-5">
                                                                <div class="row">
                                                                    <label
                                                                        class="col-sm-3 col-md-4 col-lg-4 col-form-label p-0">Reference
                                                                        Number</label>
                                                                    <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
                                                                        <div>
                                                                            <span style="border-radius:0;"
                                                                                class="input-group-text form-control">
                                                                                <a href="javascript:;" id="debit_note_reference_trigger"
                                                                                    data-toggle="modal"
                                                                                    data-target="#myGetModalReimbursementAccountPayable"
                                                                                    style="display: block;">
                                                                        ...
                                                                        <div>
                                                                            <div class="input-group">
                                                                                <input id="debit_note_reference_number"
                                                                                    style="border-radius:0; background: white;"
                                                                                    class="form-control" readonly>
                                                                                <input id="debit_note_reference_id"
                                                                                    name="debit_note_reference_id"
                                                                ...
                                                                <div class="row" id="debit_note_reference_message"
                                                            ...
                                                            <div class="col-md-12 col-lg-5">
                                                                <div class="row">
                                                                    <label
                                                                        class="col-sm-3 col-md-4 col-lg-4 col-form-label p-0">Customer</label>
                                                                    <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
                                                                        <div>
                                                                            <div class="input-group">
                                                                                <input id="debit_note_partner_number"
                                                                                    style="border-radius:0;" class="form-control"
                                                                                    readonly>
                                                                                <input id="debit_note_partner_id"
                                                                                    name="debit_note_partner_id"
                                                                                    style="border-radius:0;" class="form-control"
                                                                                    hidden>
                                                                            </div>
                                                                        </div>
                        ...
                        ''; ?>
                                            ...
                                            <div class="col-12">
                                                <div class="card">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th
                                                                        ...
                                                                        Budget</th>
                                                                    <th
                                                                        style="padding-top: 10px;padding-bottom: 10px;border-right:1px solid #e9ecef;text-align: left;">
                                                                        Product</th>
                                                                    <th
                                                                        style="padding-top: 10px;padding-bottom: 10px;border-right:1px solid #e9ecef;text-align: center;">
                                                                        Qty</th>
                                                                    ...
                                                                    <th
                                                                        ...
                                                                        Balance</th>
                                                                    <th
                                                                        style="padding-top: 10px;padding-bottom: 10px;background-color:#4B586A;border-right:1px solid #fff;text-align: center;color: white;width: 100px;">
                                                                        DN Value</th>
                                                                    <th
                                                                        style="padding-top: 10px;padding-bottom: 10px;background-color:#4B586A;border-right:1px solid #fff;text-align: center;color: white;width: 100px;">
                                                                        DN Tax</th>
                                                                    <th
                                                                        style="padding-top: 10px;padding-bottom: 10px;background-color:#4B586A;border-right:1px solid #fff;text-align: center;color: white;width: 150px;">
                                                                        COA</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody></tbody>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="text-red" id="debit_note_details_message"
                                                                    style="display: none;">
                                                                    Please input at least one item.
                                                                </div>
                                                            </div>
                                                            <div id="debit_note_details_total" class="col text-right"
                                    ...
                                    <div class="tab-content px-3 pb-2" id="nav-tabContent">
                                        <div class="row">
                                            <div class="col">
                                                <button type="button" id="debit_note_submit_button"
                                                    ...
                                                    <img src="{{ asset('AdminLTE-master/dist/img/save.png') }}" width="13" alt="submit"
                                                        title="Submit Debit Note"> Submit
                                                </button>

                                                <a id="debit_note_cancel_button" class="btn btn-default btn-sm float-right"
                                                    onclick="cancelForm('{{ route('DebitNote.index', ['var' => 1]) }}')"
                                                    style="background-color:#e9ecef;border:1px solid #ced4da;">
                                                    <img src="{{ asset('AdminLTE-master/dist/img/cancel.png') }}" width="13"
                                                        alt="cancel" title="Cancel Debit Note"> Cancel
                                                </a>
                                            </div>
                                        </div>
                                    </div>
