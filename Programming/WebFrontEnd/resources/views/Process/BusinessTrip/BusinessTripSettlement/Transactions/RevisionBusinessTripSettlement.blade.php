...
@section('main')
        ...
        <div class="row mb-1" style="background-color:#4B586A;">
          <div class="col-sm-6" style="height:30px;">
            <label style="font-size:15px;position:relative;top:7px;color:white;">
              Revision Business Trip Settlement Form
            </label>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  @include('Process.BusinessTrip.BusinessTripSettlement.Functions.Header.HeaderBusinessTripSettlementRevision')
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="card-body">
                    <div class="row py-3">
                      <div class="col-lg-5">
                        <div class="row">
                          <div class="col p-0">
                            <input type="text" id="dataInput_Log_FileUpload" name="dataInput_Log_FileUpload_1"
                              style="display:none">
                    ...
                    <div class="row py-3 justify-content-between" style="gap: 1rem;">
                      ...
                      <div class="col-md-12 col-lg-3">
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="taxi" style="border-radius:0;" autocomplete="off"
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="airplane" style="border-radius:0;" autocomplete="off"
                                class="form-control number-without-negative">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="train" style="border-radius:0;" autocomplete="off"
                                class="form-control number-without-negative">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="bus" style="border-radius:0;" autocomplete="off"
                                class="form-control number-without-negative">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="ship" style="border-radius:0;" autocomplete="off"
                                class="form-control number-without-negative">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="tol_road" style="border-radius:0;" autocomplete="off"
                                class="form-control number-without-negative">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="park" style="border-radius:0;" autocomplete="off"
                                class="form-control number-without-negative">
                            </div>
                          </div>
                        </div>
                        ...
                        <!-- EXCESS BAGAGE -->
                        <div class="row" style="margin-bottom: 1rem;">
                          <label for="excess_bagage" class="col-sm-3 col-md-4 col-lg-6 col-form-label p-0">8. Excess
                            Bagage</label>
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="excess_bagage" style="border-radius:0;" autocomplete="off"
                                class="form-control number-without-negative">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="fuel" style="border-radius:0;" autocomplete="off"
                                class="form-control number-without-negative">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="hotel" style="border-radius:0;" autocomplete="off"
                                class="form-control number-without-negative">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="mess" style="border-radius:0;" autocomplete="off"
                                class="form-control number-without-negative">
                            </div>
                          </div>
                        </div>
                        ...
                        <!-- GUEST HOUSE -->
                        <div class="row" style="margin-bottom: 1rem;">
                          <label for="guest_house" class="col-sm-3 col-md-4 col-lg-6 col-form-label p-0">12. Guest
                            House</label>
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input id="guest_house" style="border-radius:0;" autocomplete="off"
                                class="form-control number-without-negative">
                            </div>
                          </div>
                        </div>
                        ...
                        <!-- TOTAL TRANSPORT -->
                        <div class="row">
                          <label for="total_transport" class="col-sm-3 col-md-4 col-lg-6 col-form-label p-0 text-bold">Sub
                            Total</label>
                          <div class="col-sm-9 col-md-8 col-lg-4 p-0">
                            <div class="input-group">
                              <input disabled id="total_transport" style="border-radius:0;" type="text"
                                class="form-control">
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-12 col-lg-2">
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-12 col-sm-12 col-md-12 col-lg-8 p-0">
                            <input id="entertainment" style="border-radius:0;" autocomplete="off"
                              class="form-control number-without-negative">
                          </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 1rem;">
                          ...
                          <div class="col-12 col-sm-12 col-md-12 col-lg-8 p-0">
                            <input id="other" style="border-radius:0;" autocomplete="off"
                              class="form-control number-without-negative">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row py-3 px-2" style="border: 1px solid rgba(0,0,0,.1); border-radius: 2px;">
                          <div class="col">
                            ...
                            <div class="row" style="margin-bottom: 1rem;">
                              <div class="col">
                                <div class="row">
                                  <label for="taxi" class="col-sm-3 col-md-4 col-lg-7 col-form-label p-0">Total
                                    BRF</label>
                                  <div class="col-sm-9 col-md-8 col-lg-3 p-0">
                                    <div class="input-group">
                                      <input disabled id="total_business_trip_request" name="total_business_trip_request"
                            ...
                            <div class="row" style="margin-bottom: 1rem;">
                              <div class="col">
                                <div class="row">
                                  ...
                                  <div class="col-sm-9 col-md-8 col-lg-3 p-0">
                                    <div class="input-group">
                                      <input disabled id="total_settlement" name="total_settlement"
                                        style="border-radius:0;" autocomplete="off"
                                        class="form-control number-without-negative">
                                    </div>
                                  </div>
                            ...
                            <div class="row" style="margin-bottom: 1rem;">
                              <div class="col">
                                <div class="row">
                                  ...
                                  <div class="col-sm-9 col-md-8 col-lg-3 p-0">
                                    <div class="input-group">
                                      <input disabled id="total_unsettlement" name="total_unsettlement"
                                        style="border-radius:0;" autocomplete="off"
                                        class="form-control number-without-negative">
                                    </div>
                                  </div>
                            ...
                            <div class="row">
                              <div class="col">
                                <div class="row">
                                  ...
                                  <div class="col-sm-9 col-md-8 col-lg-3 p-0">
                                    <div class="input-group">
                                      <input disabled id="total_balanced" name="total_balanced" style="border-radius:0;"
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row py-3">
                      <textarea name="var_remark" id="remark" rows="2" cols="150" class="form-control"
                        placeholder="Tulis remark disini"><?= $remark; ?></textarea>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="px-3 pb-3">
            <div style="display: flex; justify-content: flex-end; gap: 8px;">
              <button class="btn btn-default btn-sm button-submit" id="cancelButton" type="button"
                onclick="cancelForm('{{ route('BusinessTripSettlement.index', ['var' => 1]) }}')">
  ...
  @include('Process.BusinessTrip.BusinessTripSettlement.Functions.Footer.FooterBusinessTripSettlementRevision')
