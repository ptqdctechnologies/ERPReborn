    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ route('BusinessTripSettlement.SearchBusinessTripRequest') }}" id="FormSubmitSearchBussinesTrip">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body table-responsive p-0" style="min-height: 390px;">
                                <table class="table table-head-fixed text-nowrap TableSearchBrfInBsf" id="TableSearchBrfInBsf">
                                    <thead>
                                        <tr>
                                            <th>No</th>
