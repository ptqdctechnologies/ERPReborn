        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="tab-content p-3" id="nav-tabContent">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row p-1" style="row-gap: 1rem;">
                                        @include('Process.BusinessTrip.BusinessTripRequest.Functions.Header.HeaderReportBusinessTripRequestSummary')
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php }; Session::forget("isButtonReportBusinessTripRequestSummarySubmit"); ?>
                </div>
            </div>
        </div>
    </section>
