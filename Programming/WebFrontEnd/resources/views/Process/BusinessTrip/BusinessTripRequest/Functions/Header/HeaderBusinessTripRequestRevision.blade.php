    ...
    <div class="col-md-12 col-lg-5">
      <div class="row">
        ...
        <div class="col-5 d-flex">
          ...
          <div style="flex: 100%;">
            <input id="project_code_second" style="border-radius:0;" class="form-control" size="17" hidden value="<?= $budget['code']; ?>" />
            <input id="project_id_second" style="border-radius:0;" class="form-control" hidden value="<?= $budget['id']; ?>" />
            <input id="project_name_second" style="border-radius:0;" class="form-control" readonly value="<?= $budget['code'] ?? ''; ?> - <?= $budget['name'] ?? ''; ?>" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-12 col-lg-5">
      <div class="row">
        ...
        <div class="col-5 d-flex">
          ...
          <div style="flex: 100%;">
            <input id="site_code_second" style="border-radius:0;" class="form-control" size="17" hidden value="<?= $subBudget['code']; ?>" />
            <input id="site_id_second" style="border-radius:0;" class="form-control" hidden value="<?= $subBudget['id']; ?>" />
            <input id="site_name_second" style="border-radius:0;" class="form-control" readonly value="<?= $subBudget['code'] ?? ''; ?> - <?= $subBudget['name'] ?? ''; ?>" />
          </div>
        </div>
      </div>
    </div>
