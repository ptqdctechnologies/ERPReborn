<div class="col-sm-12 col-md-12 col-lg-4">
    <form method="POST" action="{{ route('BusinessTripRequest.ReportBusinessTripRequestSummaryStore') }}">
    @csrf
    <!-- BUDGET -->
    <div class="row p-0 align-items-center" style="margin-bottom: 1rem;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
            <div>
                <input id="project_code_second" style="border-radius:0;" name="project_code_second" class="form-control" size="34" readonly>
    ...
    <div class="row p-0 align-items-center">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
            <div>
                <input id="site_code_second" style="border-radius:0;" name="site_code_second" class="form-control" size="34" readonly>
...
<div class="col-sm-12 col-md-12 col-lg-4">
    ...
    <div class="row p-0 align-items-center">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0">
            <div>
                <input id="beneficiary_second_person_name" style="border-radius:0;" name="beneficiary_second_person_name" class="form-control" size="34" readonly>
