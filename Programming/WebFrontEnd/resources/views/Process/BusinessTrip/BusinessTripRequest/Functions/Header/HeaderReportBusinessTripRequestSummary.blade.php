            ...
            <div>
                <div class="input-group" id="business_trip_date_range_container">
                    <div class="input-group-prepend"
                        ...
                        <span class="input-group-text" id="business_trip_date_range_container_icon"
                            style="border-radius: 0;">
                            <i class="far fa-calendar-alt" style="width: 13px; height: 13px;"></i>
                        </span>
                    </div>
                    <input readonly type="text" class="form-control"
                        style="height: 21.8px;border-radius:0;background-color:white;" id="business_trip_date_range"
                        name="business_trip_date_range" />
                </div>
            </div>
        </div>
    </div>
