                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left"
                                ...
                                <li class="nav-item">
                                    <a id="create_business_trip" href="{{ route('BusinessTripRequest.index') }}"
                                        class="nav-link" style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Create Business Trip Request</i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="revision_business_trip" class="nav-link" data-toggle="modal"
                                        data-target="#businessTripRevisionModal"
