...
@section('main')
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <form method="post" action="{{ route('SelectWorkFlow') }}" id="FormRevisionBusinessTrip">
            ...
            <input hidden id="personBusinessTripRefID" name="personBusinessTripRefID"
              value="<?= $personBusinessTripRefID; ?>" />
            <input hidden id="personBusinessTripDetailRefID" name="personBusinessTripDetailRefID"
              value="<?= $personBusinessTripDetailRefID; ?>" />
                    ...
                    <div class="wrapper-budget table-responsive card-body p-0" style="height: 12em;">
                      <table id="budgetTable" class="table table-head-fixed text-wrap table-sm">
                        <thead>
                          <tr>
                            <th
                              style="padding-top: 10px !important; padding-bottom: 10px !important; text-align: center !important;">
                            </th>
                            <th
                              style="padding-top: 10px !important; padding-bottom: 10px !important; text-align: center !important;">
                              Work</th>
              ...
              <div style="display: flex; justify-content: flex-end; gap: 8px;">
                ...
                <button type="button" class="btn btn-default btn-sm float-right" onclick="validationForm()"
                  ...
                  <img src="{{ asset('AdminLTE-master/dist/img/save.png') }}" width="13" alt=""
                    title="Submit to Business Trip"> Submit
                </button>
              </div>
            </div>
          </form>
  ...
  <div class="modal fade" id="businessTripRevisionFormModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md" role="document"
      style="height: -webkit-fill-available; display: flex; align-items: center;">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"
            ...
            <img src="{{ asset('AdminLTE-master/dist/img/cancel.png') }}" width="13" alt=""
              title="Cancel Advance List Cart"> No, cancel
          </button>

          <button type="button" id="revisionBRF" class="btn btn-default btn-sm" onclick="SubmitForm();"
            style="margin-left: 5px;background-color:#e9ecef;border:1px solid #ced4da;">
            <img src="{{ asset('AdminLTE-master/dist/img/save.png') }}" width="13" alt="" title="Submit to Advance"> Yes,
            save it
          </button>
        </div>
      </div>
