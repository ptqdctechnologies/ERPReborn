<div class="col-sm-12 col-md-12 col-lg-3">
  ...
  <div class="row p-0 align-items-center" style="margin-bottom: 1rem;">
    ...
    <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
      <div>
        <span class="input-group-text form-control" data-toggle="modal" data-target="#loanListModal"
...
<div class="col-sm-12 col-md-12 col-lg-3">
  ...
  <div class="row p-0 align-items-center" style="margin-top: 1rem;">
    ...
    <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
      <div>
        <div class="input-group" id="loan_to_settlement_date_range_container">
          <div class="input-group-prepend" style="margin-right: 0px; width: 27.78px;cursor: pointer;height: 21.8px;">
            <span class="input-group-text" id="loan_to_settlement_date_range_container_icon" style="border-radius: 0;">
              <i class="far fa-calendar-alt" style="width: 13px; height: 13px;"></i>
            </span>
          </div>
          <input readonly type="text" class="form-control"
            style="height: 21.8px;border-radius:0;background-color:white;" id="loan_to_settlement_date_range"
            name="loan_to_settlement_date_range" />
        </div>
      </div>
    </div>
  </div>
