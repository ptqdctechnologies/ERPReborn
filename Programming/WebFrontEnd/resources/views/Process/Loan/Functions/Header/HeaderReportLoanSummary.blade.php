<div class="col-12 ShowDocument">
  <div class="card">
    <form method="post" enctype="multipart/form-data" action="{{ route('Loan.ReportLoanSummaryStore') }}">
      @csrf
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-2-5">
            <div class="form-group">
              <table>
                <tr>
                  <th style="padding-top: 7px;"><label>Creditor&nbsp;</label></th>
                  <td>
                    <div class="input-group" style="width:200px;">
          ...
          <div class="col-md-2-5">
            <div class="form-group">
              <table>
                <tr>
                  <th style="padding-top: 7px;"><label>Debitor</label></th>
                  <td>
                    <div class="input-group" style="width:200px;">
                        <input id="site_code_second" style="border-radius:0;" name="site_code_second" class="form-control" size="34" value="<?= $dataReport['siteCode'] ?? ''; ?>" readonly>
                        <input id="site_id_second" style="border-radius:0;" name="site_id_second" class="form-control" hidden>
            ...
            <div class="form-group">
              <table>
                <tr>
                  ...
                  <form method="post" enctype="multipart/form-data" action="{{ route('Loan.PrintExportReportLoanSummary') }}">
                    @csrf
                    <td>
