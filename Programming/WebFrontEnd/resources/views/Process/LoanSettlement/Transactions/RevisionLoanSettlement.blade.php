...
@section('main')
    ...
    @include('Process.LoanSettlement.Functions.PopUp.PopUpLoanSettlementRevision')
                                    ...
                                    <div class="card-body">
                                        <div class="row py-3">
                                            <textarea name="var_remark" id="remark" rows="2" cols="150" class="form-control"
                                                placeholder="Tulis remark disini"><?= $header['remark']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-content px-3 pb-2" id="nav-tabContent">
                        <div class="row">
                            <div class="col">
                                ...
                                <a onclick="cancelForm('{{ route('LoanSettlement.index', ['var' => 1]) }}')"
