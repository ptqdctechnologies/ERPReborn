                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <form id="editForm" action="{{ route('LoanSettlement.RevisionLoanSettlement') }}" method="POST">
                                                    @csrf
                                                    <input id="modal_loan_settlement_id" style="border-radius:0;" name="modal_loan_settlement_id" type="hidden" class="form-control">
                                                </form>

                                                <div class="input-group-append" style="cursor: pointer;">
                                                    <span style="border-radius:0;" class="input-group-text form-control" id="modal_loan_settlement_document_number_icon">
                                                        <a data-toggle="modal" data-target="#myLoanSettlements">
                                                            <img src="{{ asset('AdminLTE-master/dist/img/box.png') }}" width="13" alt="">
                                                        </a>
                                                    </span>
                                                </div>
                                                <input required="" id="modal_loan_settlement_document_number" style="border-radius:0;" name="modal_loan_settlement_document_number" type="text" class="form-control" required readonly>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
...
<script>
    $('.btn-edit').on('click', function() {
        var advance_RefID = $('#modal_loan_settlement_id').val();
        ...
        if (advance_RefID) {
            ...
            $('#modal_loan_settlement_document_number_icon').css("border", "1px solid red");
        }
    });
