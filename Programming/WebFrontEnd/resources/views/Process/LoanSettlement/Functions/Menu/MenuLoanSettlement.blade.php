                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left"
                                ...
                                <li class="nav-item">
                                    <a id="create_loan_settlement" href="{{ route('LoanSettlement.index') }}"
                                        class="nav-link" style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Create Loan Settlement</i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="revision_loan_settlement" class="nav-link myPopUpArfRevision"
                                        data-toggle="modal" data-target="#loanSettlementRevisionModal"
                                        style="color:white;padding-bottom:10px;cursor:pointer">
                                        <i class="far fa-file nav-icon-sm"> Revision Loan Settlement</i>
                                    </a>
                                </li>
                            </ul>
                        </li>
