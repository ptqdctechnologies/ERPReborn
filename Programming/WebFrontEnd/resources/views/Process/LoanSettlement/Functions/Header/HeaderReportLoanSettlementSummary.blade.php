<div class="col-sm-12 col-md-12 col-lg-3">
    ...
    <div class="row p-0 align-items-center" style="margin-top: 1rem;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
            <div>
                <div class="input-group" id="loan_settlement_date_range_container">
                    <div class="input-group-prepend"
                        style="margin-right: 0px; width: 27.78px;cursor: pointer;height: 21.8px;">
                        <span class="input-group-text" id="loan_settlement_date_range_container_icon"
                            style="border-radius: 0;">
                            <i class="far fa-calendar-alt" style="width: 13px; height: 13px;"></i>
                        </span>
                    </div>
                    <input readonly type="text" class="form-control"
                        style="height: 21.8px;border-radius:0;background-color:white;" id="loan_settlement_date_range"
                        name="loan_settlement_date_range" />
                </div>
            </div>
        </div>
    </div>
...
<div class="col-sm-12 col-md-12 col-lg-3">
    ...
    <div class="row p-0 align-items-center">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
            ...
            <div>
                <input type="text" id="creditor_name" class="form-control"
                    style="border-radius:0;background-color:white;" readonly />
                <input type="hidden" id="creditor_id" class="form-control" style="border-radius:0;"
                    name="creditor_id" />
                <input type="hidden" id="creditor_code" class="form-control" style="border-radius:0;"
                    name="creditor_code" />
            </div>
        </div>
    </div>
    ...
    <div class="row p-0 align-items-center" style="margin-top: 1rem;">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
            ...
            <div>
                <input type="text" id="debitor_name" class="form-control"
                    style="border-radius:0;background-color:white;" readonly />
                <input type="hidden" id="debitor_id" class="form-control" style="border-radius:0;" name="debitor_id" />
                <input type="hidden" id="debitor_code" class="form-control" style="border-radius:0;"
                    name="debitor_code" />
            </div>
        </div>
    </div>
