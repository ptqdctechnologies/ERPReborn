<div class="col-sm-12 col-md-12 col-lg-3">
    ...
    <div class="row p-0 align-items-center" style="margin-bottom: 1rem;">
        <label class="col-sm-3 col-md-4 col-lg-4 col-form-label p-0 text-bold">CN Number</label>
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
            ...
            <div>
                <input type="text" id="cn_number" class="form-control" style="border-radius:0;background-color:white;"
                    readonly />
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
            <div>
                <span id="mySitesTrigger" class="input-group-text form-control" data-toggle="modal"
                    data-target="#mySites" style="border-radius:0;cursor:pointer;">
                    <i class="fas fa-gift"></i>
                </span>
            </div>
            <div>
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
            ...
            <div>
                ...
                <input type="hidden" id="requester_id" class="form-control" style="border-radius:0;"
                    name="requester_id" />
                <input type="hidden" id="requester_code" class="form-control" style="border-radius:0;"
                    name="requester_code" />
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
            ...
            <div>
                ...
                <input type="hidden" id="beneficiary_id" class="form-control" style="border-radius:0;"
                    name="beneficiary_id" />
                <input type="hidden" id="beneficiary_code" class="form-control" style="border-radius:0;"
...
<div class="col-sm-12 col-md-12 col-lg-3">
    ...
    <div class="row p-0 align-items-center">
        ...
        <div class="col-sm-9 col-md-8 col-lg-7 d-flex p-0 justify-content-sm-end justify-content-md-end">
            <div>
                <div class="input-group" id="credit_note_date_range_container">
                    <div class="input-group-prepend"
                        style="margin-right: 0px; width: 27.78px;cursor: pointer;height: 21.8px;">
                        <span class="input-group-text" id="credit_note_date_range_container_icon"
                            style="border-radius: 0;">
                            <i class="far fa-calendar-alt" style="width: 13px; height: 13px;"></i>
                        </span>
                    </div>
                    <input readonly type="text" class="form-control"
                        style="height: 21.8px;border-radius:0;background-color:white;" id="credit_note_date_range"
                        name="credit_note_date_range" />
                </div>
            </div>
        </div>
    </div>
