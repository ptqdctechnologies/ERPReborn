                                ...
                                <ul class="navbar-nav ml-auto left">
                                    <li class="nav-item dropdown user-menu">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left" style="padding: 10px;font-size:14px;background-color:#4B586A;margin-top:8px;">
                                            <li class="nav-item">
                                                <a href="{{ route('CreditNote.index') }}" class="nav-link" style="color:white;padding-bottom:10px;">
                                                    <i class="far fa-file nav-icon-sm"> Create Credit Note</i>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        <div class="row py-3" style="gap: 15px;">
                                            ...
                                            <div class="col-md-12 col-lg-5">
                                                        ...
                                                        <div>
                                                            <span style="border-radius:0;" class="input-group-text form-control">
                                                                <a href="javascript:;" id="myInvoiceTrigger" data-toggle="modal" data-target="#myInvoice" style="display: block;">
                                                                    <img src="{{ asset('AdminLTE-master/dist/img/box.png') }}" width="13" alt="myInvoiceTrigger">
                                                                </a>

                                                                <div id="loadingInvoice" class="spinner-border spinner-border-sm" role="status" style="display: none;">
                                                ...
                                                <div class="row" id="invoiceMessage" style="margin-top: .3rem; display: none;">
...
@include('Process.CreditNote.Functions.Footer.FooterCreditNote')
@endsection