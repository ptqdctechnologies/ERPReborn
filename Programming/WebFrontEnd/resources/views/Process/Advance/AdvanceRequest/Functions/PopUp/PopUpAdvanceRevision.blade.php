<div class="modal fade" id="myPopUpArfRevision" tabindex="-1" aria-labelledby="myPopUpArfRevisionLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myPopUpArfRevisionLabel"
                    ...
                    <div class="card mb-0" style="width: fit-content;">
                        <div class="card-body d-flex align-items-center justify-content-center" style="gap: 1rem;">
                            ...
                            <div class="form-group d-flex">
                                <div>
                                    <span id="modal_advance_document_number_icon" class="input-group-text form-control"
                                        data-toggle="modal" data-target="#myGetModalAdvance"
                                        style="cursor:pointer; border-radius: 0;">
                                        <i class="fas fa-gift"></i>
                                    </span>
                                </div>
                                <div>
                                    <input id="modal_advance_document_number" class="form-control"
                                        style="border-radius:0; background-color: white;" readonly />
                                    <input id="modal_advance_id" class="form-control" name="modal_advance_id"
...
<script>
    $('#btn-edit').on('click', function () {
        const categorySupplierRefID = $('#modal_advance_id').val();
