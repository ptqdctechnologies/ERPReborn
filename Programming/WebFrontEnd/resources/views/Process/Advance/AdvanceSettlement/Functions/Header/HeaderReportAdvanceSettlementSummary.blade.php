<div class="col-sm-12 col-md-12 col-lg-4">
    <form method="POST" action="{{ route('AdvanceSettlement.ReportAdvanceSettlementSummaryStore') }}">
    @csrf
    <!-- BUDGET -->
...
<div class="col-sm-12 col-md-12 col-lg-4 d-flex flex-column flex-column-reverse">
    ...
    <!-- EXPORT -->
    <form method="POST" action="{{ route('AdvanceSettlement.PrintExportReportAdvanceSettlementSummary') }}">
    @csrf
