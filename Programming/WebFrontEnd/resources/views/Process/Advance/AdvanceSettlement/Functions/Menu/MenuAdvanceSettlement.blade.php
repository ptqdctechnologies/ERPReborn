                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left"
                                ...
                                <li class="nav-item">
                                    <a id="create_advance_settlement" href="{{ route('AdvanceSettlement.index') }}"
                                        class="nav-link" style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Create Advance Settlement</i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="revision_advance_settlement" href="javascript:;"
                                        class="nav-link myPopUpAdvanceSettlementRevision" data-toggle="modal"
                                        data-target="#myPopUpAdvanceSettlementRevision"
