<div class="col-12 ShowDocument">
  <div class="card">
    <form method="post" enctype="multipart/form-data" action="{{ route('AdvanceRequest.ReportAdvanceToASFStore') }}">
      @csrf
      <div class="card-body">
        <div class="row">
          <div class="col-md-3">
...
<!-- <div class="col-sm-12 col-md-12 col-lg-4">
    <form method="POST" action="{{ route('AdvanceRequest.ReportAdvanceToASFStore') }}">
    @csrf
