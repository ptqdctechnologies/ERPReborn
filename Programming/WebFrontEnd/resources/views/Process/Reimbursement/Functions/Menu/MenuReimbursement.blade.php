                    ...
                    <ul class="navbar-nav ml-auto left">
                        <li class="nav-item dropdown user-menu">
                            <a class="nav-link dropdown-toggle" data-toggle="dropdown"
                                style="color:#4B586A;font-size:12px;padding:2px;cursor:pointer;">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-left"
                                ...
                                <li class="nav-item">
                                    <a id="create_reimbursement" href="{{ route('Reimbursement.index') }}"
                                        class="nav-link" style="color:white;padding-bottom:10px;">
                                        <i class="far fa-file nav-icon-sm"> Create Reimbursement</i>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="revision_reimbursement" class="nav-link" data-toggle="modal"
                                        data-target="#reimbursementRevisionModal"
                                        style="color:white;padding-bottom:10px;cursor:pointer;">
                                        <i class="far fa-file nav-icon-sm"> Revision Reimbursement</i>
                                    </a>
                                </li>
                            </ul>
                        </li>
