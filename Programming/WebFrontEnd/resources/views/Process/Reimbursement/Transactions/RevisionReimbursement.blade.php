...
@section('main')
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <form method="post" action="{{ route('SelectWorkFlow') }}" id="FormSubmitReimbursement">
                        ...
                        <input type="hidden" name="reimbursement_RefID" id="reimbursement_RefID"
                            value="<?= $header['sys_RefID']; ?>" />
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        @include('Process.Reimbursement.Functions.Header.HeaderRevisionReimbursement')
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        @include('Process.Reimbursement.Functions.Header.HeaderRevisionReimbursementDetail')
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="collapse"
                                                    aria-label="Collapse Section File Attachment">
                                                    <i class="fas fa-angle-down btn-sm" style="color:black;"></i>
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="collapse"
                                                    aria-label="Collapse Section Budget Details">
                                                    <i class="fas fa-angle-down btn-sm" style="color:black;"></i>
                                                </button>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table table-head-fixed text-nowrap table-sm"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th
                                                            ...
                                                            Qty</th>
                                                        <th
                                                            style="padding-top: 10px;padding-bottom: 10px;border-right:1px solid #e9ecef;text-align: center;background: #4B586A;color: white;width: 100px;">
                                                            Price</th>
                                                        <th
                                                            style="padding-top: 10px;padding-bottom: 10px;border-right:1px solid #e9ecef;text-align: center;background: #4B586A;color: white;width: 150px;">
                                                            Total</th>
                                                    </tr>
                                                </thead>
                                                <tbody></tbody>
                                                <tfoot>
                                                    ...
                                                    <tr class="errorMessageContainerBudgetDetails">
                                                        <td colspan="6" class="p-0" style="border: 0px;">
                                                            <div
                                                                class="d-flex flex-column justify-content-center align-items-center py-3">
                                                                <div id="errorMessageBudgetDetails" class="mt-3 text-red"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row py-3">
                                                <textarea name="var_remark" id="remark"
                                                    class="form-control"><?= $header['remark']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-content px-3 pb-2" id="nav-tabContent">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <a onclick="cancelReimbursement()" class="btn btn-default btn-sm float-right"
    ...
    <div class="modal fade" id="reimbursementFormModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document"
            style="height: calc(100vh - 3.5rem); display: flex; align-items: center;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="wrapper-budget card-body table-responsive p-0" style="max-height:200px;">
                        <table class="table table-head-fixed text-nowrap table-sm" id="tableRemList"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"
                        style="background-color:#e9ecef;border:1px solid #ced4da;">
                        <img src="{{ asset('AdminLTE-master/dist/img/cancel.png') }}" width="13" alt=""
                            title="Cancel Rem List Cart"> No, cancel
                    </button>

                    <button type="button" id="submitRem" class="btn btn-default btn-sm" onclick="submitForm();"
                        style="margin-right: 5px;background-color:#e9ecef;border:1px solid #ced4da;">
                        <img src="{{ asset('AdminLTE-master/dist/img/save.png') }}" width="13" alt="" title="Submit to Rem">
                        Yes, save it
                    </button>
                </div>
            </div>
    ...
    @include('Process.Reimbursement.Functions.Footer.FooterRevisionReimbursement')
