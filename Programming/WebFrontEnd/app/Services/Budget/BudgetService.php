...
class BudgetService
{
    ...
    public function getCombinedBudgetStockDetail($combinedBudgetRefID, $warehouseRefID, $combinedBudgetSectionRefID)
    {
        $sessionToken = Session::get('SessionLogin');
        $sessionBranch = Session::get('SessionBranch');
        ...
        return Helper_APICall::setCallAPIGateway(
            ...
            [
                'parameter' => [
                    ...
                    'warehouse_RefID' => (int) $warehouseRefID,
                    'branch_RefID' => (int) $sessionBranch,
                    'combinedBudgetSection_RefID' => (int) $combinedBudgetSectionRefID
                ],
                'SQLStatement' => [
                    'pick' => null,
                    'sort' => null,
