...
class CountryAdministrativeAreaLevel4Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Register.CountryAdministrativeAreaLevel4.Transactions.index')->with('data', $varData['data']);
    }

    public function create()
    {
        return view('Register.CountryAdministrativeAreaLevel4.Transactions.create');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('Register.CountryAdministrativeAreaLevel4.Transactions.edit')->with('data', $varData['data']);
    }
