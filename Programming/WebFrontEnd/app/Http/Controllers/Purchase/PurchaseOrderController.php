        ...
        try {
            ...
            if ($dataPurchaseOrderSummary) {
                if ($type === "PDF") {
                    ...
                    return Excel::download(new ExportReportPurchaseOrderSummary($dataPurchaseOrderSummary, $budgetName, $subBudgetName, $supplierName, $poDate), 'Export Report Purchase Order Summary.xlsx');
                } else {
