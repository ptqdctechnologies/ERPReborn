...
class PurchaseRequisitionController extends Controller
{
    ...
    //         $dataReport = $isSubmitButton ? $request->session()->get('dataReportPurchaseRequisitionSummary', []) : [];
    ...
    //         return view('Purchase.PurchaseRequisition.Reports.ReportPurchaseRequisitionSummary', $compact);
    //     } catch (\Throwable $th) {
    //         Log::error("ReportPurchaseRequisitionSummary Function Error at " . $th->getMessage());
    //         return redirect()->back()->with('NotFound', 'Process Error');
    //     }
    // }

    // public function ReportPurchaseRequisitionSummaryData($project_id, $site_id, $project_name, $project_code, $site_code) 
    // {
    //     try {
    //         $varAPIWebToken             = Session::get('SessionLogin');
    ...
    //             [
    //                 "DocumentNumber"                      => "PR/QDC/2025/000067",
    ...
    //             ],
    //             [
    //                 "DocumentNumber"                      => "PR/QDC/2025/000070",
    ...
    //             ],
    //             [
    //                 "DocumentNumber"                      => "PR/QDC/2025/000066",
    ...
    //             ],
    //             [
    //                 "DocumentNumber"                      => "PR/QDC/2025/000068",
    ...
    //         Session::put("dataReportPurchaseRequisitionSummary", $compact);

    //         return $compact;
    //     } catch (\Throwable $th) {
    //         Log::error("ReportPurchaseRequisitionSummaryData Error at " . $th->getMessage());
    //         return redirect()->back()->with('NotFound', 'Process Error');
    //     }
    // }
    ...
    //             Session::forget("dataReportPurchaseRequisitionSummary");
        
    //             return redirect()->route('PurchaseRequisition.ReportPurchaseRequisitionSummary')->with('NotFound', $message);
    //         }

    //         $compact = $this->ReportPurchaseRequisitionSummaryData($project_id, $site_id, $project_name, $project_code, $site_code);
    ...
    //         return redirect()->route('PurchaseRequisition.ReportPurchaseRequisitionSummary');
    //     } catch (\Throwable $th) {
    //         Log::error("ReportPurchaseRequisitionSummaryStore Error at " . $th->getMessage());
    //         return redirect()->back()->with('NotFound', 'Process Error');
    //     }
    // }
    ...
    // {
    //     try {
    //         $dataReport = Session::get("dataReportPurchaseRequisitionSummary");
    //         $print_type = $request->print_type;
    ...
    //             return redirect()->route('PurchaseRequisition.ReportPurchaseRequisitionSummary')->with('NotFound', 'Budget, & Sub Budget Cannot Empty');
    //         }

    //         if ($dataReport) {
    //             if ($print_type === "PDF") {
    //                 $pdf = PDF::loadView('Purchase.PurchaseRequisition.Reports.PrintReportPurchaseRequisitionSummary', ['dataReport' => $dataReport])->setPaper('a4', 'landscape');
    //                 $pdf->output();
    //                 $dom_pdf = $pdf->getDomPDF();
    ...
    //         }
    //     } catch (\Throwable $th) {
    //         Log::error("PrintExportReportPurchaseRequisitionSummary Error at " . $th->getMessage());
    //         return redirect()->back()->with('NotFound', 'Process Error');
    //     }
    // }
