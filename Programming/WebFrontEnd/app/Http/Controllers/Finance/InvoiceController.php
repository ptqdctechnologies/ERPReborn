    ...
    public function ReportInvoiceToCNStore(Request $request)
    {
        try {
            ...
            if (!$project_id && !$site_id && !$requester_id && !$beneficiary_id) {
                ...
                return redirect()->route('Invoice.ReportInvoiceToCN')->with('NotFound', 'Budget, Sub Budget, Requester, & Beneficiary Cannot Be Empty');
            }
            ...
            return redirect()->route('Invoice.ReportInvoiceToCN');
        } catch (\Throwable $th) {
    ...
    public function PrintExportReportInvoiceToCN(Request $request)
    {
        try {
            ...
            if ($dataReport) {
                ...
                return redirect()->route('Invoice.ReportInvoiceToCN')->with('NotFound', 'Budget, Sub Budget, Requester, & Beneficiary Cannot Empty');
            }
        } catch (\Throwable $th) {
