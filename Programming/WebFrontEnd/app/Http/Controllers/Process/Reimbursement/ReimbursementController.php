...
class ReimbursementController extends Controller
{
    ...
    public function picklist(Request $request)
    {
        ...
        $response = $this->reimbursementService->picklist($formatted);
        ...
        $reimbursementData = $response['data']['data'];

        return response()->json([
            'draw' => intval($request->input('draw')),
            'recordsTotal' => $reimbursementData['header']['dataCount'],
            'recordsFiltered' => $reimbursementData['header']['dataCount'],
            'data' => $reimbursementData['content']['itemList']
        ]);
    }
