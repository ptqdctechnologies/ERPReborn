...
class ExportReportDODetail implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    public function collection()
    {
        $data = Session::get("dataExcelReportDODetail");
        return collect($data);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $totalCell = count(Session::get("dataExcelReportDODetail"));
