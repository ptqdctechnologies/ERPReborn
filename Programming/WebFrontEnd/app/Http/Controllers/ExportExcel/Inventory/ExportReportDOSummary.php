...
class ExportReportDOSummary implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    public function collection()
    {
        $data = Session::get("dataExcelReportDOSummary");
        return collect($data);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $totalCell = count(Session::get("dataExcelReportDOSummary"));
