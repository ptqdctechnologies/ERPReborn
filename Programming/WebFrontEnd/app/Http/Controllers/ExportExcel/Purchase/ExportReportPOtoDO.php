...
class ExportReportPOtoDO implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    ...
    {
        $data = Session::get("dataReportPOtoDO");
    ...
    public function headings(): array
    {
        ...
        return [
            ...
            ["", "", "", "", "", "", "", "", "", "", "",""],
            ["No","PO Number","PO Date","Product Id","Product Name","Qty PO","DO Number","DO Date","To","From","Transporter","Qty DO"]
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $datas = Session::get("dataReportPOtoDO");
