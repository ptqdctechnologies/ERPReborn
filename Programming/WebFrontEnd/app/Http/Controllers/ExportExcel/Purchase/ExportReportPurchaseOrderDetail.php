...
class ExportReportPurchaseOrderDetail implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    public function collection()
    {
        $data = Session::get("dataExcelReportPurchaseOrderDetail");
        return collect($data);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $totalCell = count(Session::get("dataExcelReportPurchaseOrderDetail"));
