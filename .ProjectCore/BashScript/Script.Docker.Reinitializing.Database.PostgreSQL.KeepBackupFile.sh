...
#                        PostgreSQL dengan tetap mempertahankan File Backup yang terbentuk
# ▪ Execution Syntax   : ./BashScript/Script.Docker.Reinitializing.Database.PostgreSQL.KeepBackupFile.sh
#                        <FullPathFromRoot>/BashScript/Script.Docker.Reinitializing.Database.PostgreSQL.KeepBackupFile.sh
...
varFileName='/var/lib/postgresql/temp/dump-dbERPReborn-SysConfig.sql';
...
varFileName='/var/lib/postgresql/temp/dump-dbERPReborn-Data-OLTP.sql';
varDBMasterHost='192.168.1.24';
varDBMasterPort='5432';
...
varFileName='/var/lib/postgresql/temp/dump-dbERPReborn-Data-BinaryObject.sql';
varDBMasterHost='192.168.1.24';
varDBMasterPort='5432';
...
varFileName='/var/lib/postgresql/temp/dump-dbERPReborn.sql';
varDBMasterHost='192.168.1.24';
varDBMasterPort='5432';
...
#---> Change Ownership
sudo chown -R $(id -u):$(id -g) ./../ERPReborn-TemporaryStorage/BindMount/PostgreSQL
